...
define i8* @"$fo58"(i8* nocapture readonly, i8*) {
...
define i64 @"$fo47"(i8* nocapture readonly, i64) {
...
define i32 @main() local_unnamed_addr {
  ...
  store i64 (i8*, i64)* @"$fo47", i64 (i8*, i64)** %25, align 8
  ...
  store i8* (i8*, i8*)* @"$fo58", i8* (i8*, i8*)** %34, align 8
