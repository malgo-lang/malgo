...
define i32 @main51() local_unnamed_addr {
  br label %tailrecurse.i

tailrecurse.i:                                    ; preds = %tailrecurse.i, %0
  %.tr3.i = phi i64 [ 0, %0 ], [ %4, %tailrecurse.i ]
  %1 = tail call i64 @fib53(i64 %.tr3.i)
  %2 = tail call {}* @print_int(i64 %1)
  %3 = tail call {}* @newline()
  %4 = add nuw nsw i64 %.tr3.i, 1
  %exitcond = icmp eq i64 %4, 31
  br i1 %exitcond, label %fib_loop52.exit, label %tailrecurse.i

fib_loop52.exit:                                  ; preds = %tailrecurse.i
...
define {}* @fib_loop52(i64, i64) local_unnamed_addr {
  br label %tailrecurse

tailrecurse:                                      ; preds = %tailrecurse, %2
  %.tr3 = phi i64 [ %1, %2 ], [ %7, %tailrecurse ]
  %3 = tail call i64 @fib53(i64 %.tr3)
...
define i64 @fib53(i64) local_unnamed_addr #0 {
  %2 = icmp slt i64 %0, 2
...
define {}* @newline54() local_unnamed_addr {
  %1 = tail call {}* @newline()
  ret {}* %1
}
...
define {}* @print_int55(i64) local_unnamed_addr {
...
tailrecurse.i.i:                                  ; preds = %tailrecurse.i.i, %0
  %.tr3.i.i = phi i64 [ 0, %0 ], [ %4, %tailrecurse.i.i ]
  %1 = tail call i64 @fib53(i64 %.tr3.i.i)
  %2 = tail call {}* @print_int(i64 %1)
  %3 = tail call {}* @newline()
  %4 = add nuw nsw i64 %.tr3.i.i, 1
  %exitcond.i = icmp eq i64 %4, 31
  br i1 %exitcond.i, label %main51.exit, label %tailrecurse.i.i

main51.exit:                                      ; preds = %tailrecurse.i.i
  %5 = tail call i8* @GC_malloc(i64 0)
  ret i32 0
}
