...
define i64 @add42.20(i8*, i64) {
  ...
  store { i64, i64 }* (i8*, { i64 (i8*, i64)*, i8* }*, { i64, i64 }*)* @map.17, { i64, i64 }* (i8*, { i64 (i8*, i64)*, i8* }*, { i64, i64 }*)** %6
  ...
  store i64 (i8*, i64)* @add42.20, i64 (i8*, i64)** %10
...
define { i64, i64 }* @map.17(i8*, { i64 (i8*, i64)*, i8* }*, { i64, i64 }*) {
  %4 = bitcast i8* %0 to {}*
  ...
  store { i64, i64 }* (i8*, { i64 (i8*, i64)*, i8* }*, { i64, i64 }*)* @map.17, { i64, i64 }* (i8*, { i64 (i8*, i64)*, i8* }*, { i64, i64 }*)** %7
  ...
  store i64 (i8*, i64)* @add42.20, i64 (i8*, i64)** %11
...
define i32 @main() {
  ...
  store i64 (i8*, i64)* @add42.20, i64 (i8*, i64)** %13
