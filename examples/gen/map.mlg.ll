...
define { i64, i64 }* @map36(i8*, { i64 (i8*, i64)*, i8* }*, { i64, i64 }*) {
  %4 = bitcast i8* %0 to {}*
  ...
  store { i64, i64 }* (i8*, { i64 (i8*, i64)*, i8* }*, { i64, i64 }*)* @map36, { i64, i64 }* (i8*, { i64 (i8*, i64)*, i8* }*, { i64, i64 }*)** %7
  ...
  store i64 (i8*, i64)* @add4235, i64 (i8*, i64)** %15
...
define i64 @add4235(i8*, i64) {
  ...
  store { i64, i64 }* (i8*, { i64 (i8*, i64)*, i8* }*, { i64, i64 }*)* @map36, { i64, i64 }* (i8*, { i64 (i8*, i64)*, i8* }*, { i64, i64 }*)** %6
  ...
  store i64 (i8*, i64)* @add4235, i64 (i8*, i64)** %14
...
define i32 @main() {
  ...
  store i64 (i8*, i64)* @add4235, i64 (i8*, i64)** %17
  %18 = call i8* @GC_malloc(i64 0)
  %19 = bitcast i8* %18 to {}*
