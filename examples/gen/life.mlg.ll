...
define i1* @copy_bool_array374(i1*, i64) {
...
define i1 @view372(i8*, i1*, i64, i64) {
  ...
  store i1 (i8*, i1*, i64, i64)* @view372, i1 (i8*, i1*, i64, i64)** %12
...
define {}* @set371(i8*, i1*, i64, i64, i1) {
  ...
  store {}* (i8*, i1*, i64, i64, i1)* @set371, {}* (i8*, i1*, i64, i64, i1)** %11
...
define {}* @init_cells370(i8*, i1*, i64) {
  ...
  store {}* (i8*, i1*, i64)* @init_cells370, {}* (i8*, i1*, i64)** %11
  %12 = call i8* @GC_malloc(i64 0)
  %13 = bitcast i8* %12 to {}*
...
else_0:                                           ; preds = %3
  %22 = call i1 @rand_bool376()
  %23 = getelementptr i1, i1* %1, i64 %2
  store i1 %22, i1* %23
  %24 = call i8* @GC_malloc(i64 0)
  %25 = bitcast i8* %24 to {}*
  %26 = add i64 %2, 1
  %27 = call {}* @init_cells370(i8* %0, i1* %1, i64 %26)
  store {}* %27, {}** %19
  br label %end_0
...
define {}* @go_x368(i8*, i64) {
  ...
  store {}* (i8*, i64)* @go_x368, {}* (i8*, i64)** %14
  %15 = call i8* @GC_malloc(i64 0)
  %16 = bitcast i8* %15 to {}*
...
else_0:                                           ; preds = %2
  ...
  %29 = call i8 @to_char369(i1 %28)
  %30 = call {}* @print_char379(i8 %29)
  %31 = add i64 %1, 1
  %32 = call {}* @go_x368(i8* %0, i64 %31)
  store {}* %32, {}** %21
  br label %end_0
...
define {}* @go_y367(i8*, i64) {
  ...
  %13 = bitcast i8* %12 to { {}* (i8*, i64)*, i8* }*
  %14 = getelementptr { {}* (i8*, i64)*, i8* }, { {}* (i8*, i64)*, i8* }* %13, i32 0, i32 0
  store {}* (i8*, i64)* @go_y367, {}* (i8*, i64)** %14
  %15 = call i8* @GC_malloc(i64 0)
  %16 = bitcast i8* %15 to {}*
  %17 = getelementptr { {}* (i8*, i64)*, i8* }, { {}* (i8*, i64)*, i8* }* %13, i32 0, i32 1
  store i8* %0, i8** %17
  ...
  store {}* (i8*, i64)* @go_x368, {}* (i8*, i64)** %37
...
define {}* @print_cells366(i8*, i1*) {
  ...
  store {}* (i8*, i1*)* @print_cells366, {}* (i8*, i1*)** %12
  %13 = call i8* @GC_malloc(i64 0)
  %14 = bitcast i8* %13 to {}*
  ...
  store {}* (i8*, i64)* @go_y367, {}* (i8*, i64)** %35
...
define i1 @next_state364(i8*, i1*, i64, i64) {
  ...
  store i1 (i8*, i1*, i64, i64)* @next_state364, i1 (i8*, i1*, i64, i64)** %10
...
define {}* @go_x363(i8*, i64) {
  ...
  store {}* (i8*, i64)* @go_x363, {}* (i8*, i64)** %18
...
define {}* @go_y362(i8*, i64) {
  ...
  %17 = bitcast i8* %16 to { {}* (i8*, i64)*, i8* }*
  %18 = getelementptr { {}* (i8*, i64)*, i8* }, { {}* (i8*, i64)*, i8* }* %17, i32 0, i32 0
  store {}* (i8*, i64)* @go_y362, {}* (i8*, i64)** %18
  %19 = call i8* @GC_malloc(i64 0)
  %20 = bitcast i8* %19 to {}*
  %21 = getelementptr { {}* (i8*, i64)*, i8* }, { {}* (i8*, i64)*, i8* }* %17, i32 0, i32 1
  store i8* %0, i8** %21
  ...
  store {}* (i8*, i64)* @go_x363, {}* (i8*, i64)** %47
...
define {}* @update_cells361(i8*, i1*) {
  ...
  store {}* (i8*, i1*)* @update_cells361, {}* (i8*, i1*)** %14
  %15 = call i8* @GC_malloc(i64 0)
  %16 = bitcast i8* %15 to {}*
  ...
  %19 = bitcast i8* %18 to {}*
  %20 = mul i64 %9, %11
  %21 = call i1* @copy_bool_array374(i1* %1, i64 %20)
  ...
  store {}* (i8*, i64)* @go_y362, {}* (i8*, i64)** %45
...
define {}* @loop360(i8*, i64) {
  ...
  store {}* (i8*, i64)* @loop360, {}* (i8*, i64)** %12
  %13 = call i8* @GC_malloc(i64 0)
  %14 = bitcast i8* %13 to {}*
...
then_0:                                           ; preds = %2
  ...
  %30 = call {}* @newline378()
  %31 = call {}* @sleep375(i64 1)
  %32 = sub i64 %1, 1
  %33 = call {}* @loop360(i8* %0, i64 %32)
  store {}* %33, {}** %19
  br label %end_0
...
end_0:                                            ; preds = %cond_0
  ...
  store i1 (i8*, i1*, i64, i64)* @view372, i1 (i8*, i1*, i64, i64)** %21
  %22 = call i8* @GC_malloc(i64 0)
  %23 = bitcast i8* %22 to {}*
  ...
  store {}* (i8*, i1*, i64, i64, i1)* @set371, {}* (i8*, i1*, i64, i64, i1)** %35
  %36 = call i8* @GC_malloc(i64 0)
  %37 = bitcast i8* %36 to {}*
  ...
  store {}* (i8*, i1*, i64)* @init_cells370, {}* (i8*, i1*, i64)** %52
  ...
  store {}* (i8*, i1*)* @print_cells366, {}* (i8*, i1*)** %72
  ...
  store i1 (i8*, i1*, i64, i64)* @next_state364, i1 (i8*, i1*, i64, i64)** %86
  ...
  store {}* (i8*, i1*)* @update_cells361, {}* (i8*, i1*)** %109
  ...
  %115 = call {}* @gen_seed377()
  %116 = call {}* @pulsar373(i1* %4)
  ...
  store {}* (i8*, i64)* @loop360, {}* (i8*, i64)** %131
