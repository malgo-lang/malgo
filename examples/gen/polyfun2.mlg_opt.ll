...
define i64 @"$f204"(i8* nocapture readonly, i8*) {
...
define i8* @"$f189"(i8* nocapture readonly, i8*) {
...
define i64 @"$f139"(i8* nocapture readonly, i8*) {
...
body_0:
  ...
  store i64 (i8*, i8*)* @"$f139", i64 (i8*, i8*)** %11, align 8
  ...
  store i8* (i8*, i8*)* @"$f189", i8* (i8*, i8*)** %66, align 8
  ...
  store i64 (i8*, i8*)* @"$f204", i64 (i8*, i8*)** %82, align 8
