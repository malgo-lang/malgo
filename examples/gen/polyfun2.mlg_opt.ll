...
define i8* @"$fo164"(i8* nocapture readonly, i8*) {
...
define i64 @"$fo113"(i8* nocapture readonly, i8*) {
...
define i8* @"$fo86"(i8* nocapture readonly, i8* nocapture readonly) {
  ...
  store i8* (i8*, i8*)* @"$fo93", i8* (i8*, i8*)** %8, align 8
...
body_0:
  ...
  store i8* (i8*, i8*)* @"$fo86", i8* (i8*, i8*)** %6, align 8
  ...
  store i64 (i8*, i8*)* @"$fo113", i64 (i8*, i8*)** %20, align 8
  ...
  store i8* (i8*, i8*)* @"$fo164", i8* (i8*, i8*)** %68, align 8
