...
define external ccc  i64 @$f204(i8* , i8* )    {
...
define external ccc  i8* @$f189(i8* , i8* )    {
...
define external ccc  i64 @$f139(i8* , i8* )    {
...
; <label>:0:
  ...
  store  i64 (i8*, i8*)* @$f139, i64 (i8*, i8*)** %18 
...
end_1:
  ...
  store  i8* (i8*, i8*)* @$f189, i8* (i8*, i8*)** %93 
  ...
  store  i64 (i8*, i8*)* @$f204, i64 (i8*, i8*)** %108 
