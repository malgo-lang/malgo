...
body_1:                                           ; preds = %cond_1
  ...
  store i64 (i8*, i64)* @"$fo129", i64 (i8*, i64)** %66
...
end_2:                                            ; preds = %cond_2
  ...
  store i8* (i8*, i8*)* @"$fo167", i8* (i8*, i8*)** %107
  ...
  store i8* (i8*, i8*)* @"$fo195", i8* (i8*, i8*)** %132
