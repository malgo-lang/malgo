...
define { i64 (i8*, i64)*, i8* }* @add.13(i64) local_unnamed_addr {
  ...
  store i64 (i8*, i64)* @add_inner.12, i64 (i8*, i64)** %6, align 8
...
define i64 @add_inner.12(i8*, i64) {
...
define i32 @main() local_unnamed_addr {
  ...
  store i64 (i8*, i64)* @add_inner.12, i64 (i8*, i64)** %4, align 8
  %5 = getelementptr i8, i8* %3, i64 8
  %6 = bitcast i8* %5 to i8**
  store i8* %1, i8** %6, align 8
  %7 = tail call i8* @GC_malloc(i64 16)
  %8 = bitcast i8* %7 to i64 (i8*, i64)**
  store i64 (i8*, i64)* @add_inner.12, i64 (i8*, i64)** %8, align 8
