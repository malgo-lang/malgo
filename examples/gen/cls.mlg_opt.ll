...
define i32 @main19() local_unnamed_addr {
  ...
  store i64 (i8*, i64)* @add_inner21, i64 (i8*, i64)** %5, align 8
  ...
  %12 = tail call i64 %10(i8* %11, i64 4)
  ret i32 0
}

declare i8* @GC_malloc(i64) local_unnamed_addr

define { i64 (i8*, i64)*, i8* }* @add20(i64) local_unnamed_addr {
  ...
  %7 = bitcast i8* %5 to i64 (i8*, i64)**
  store i64 (i8*, i64)* @add_inner21, i64 (i8*, i64)** %7, align 8
...
define i64 @add_inner21(i8*, i64) {
  ...
  store i64 (i8*, i64)* @add_inner21, i64 (i8*, i64)** %6, align 8
