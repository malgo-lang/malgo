...
@"$globle_str_586" = unnamed_addr constant [3 x i8] c" O\00"
@"$globle_str_587" = unnamed_addr constant [3 x i8] c" .\00"
@"$globle_str_588" = unnamed_addr constant [2 x i8] c"\0A\00"
@"$globle_str_589" = unnamed_addr constant [2 x i8] c"\0A\00"
...
then_0:                                           ; preds = %2, %then_0
  ...
  %. = select i1 %22, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @"$globle_str_586", i64 0, i64 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @"$globle_str_587", i64 0, i64 0)
...
else_1:                                           ; preds = %then_0, %2
  %33 = tail call {}* @print(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$globle_str_588", i64 0, i64 0))
  ret {}* %33
}
...
then_0.i:                                         ; preds = %then_0, %then_0.i
  ...
  %..i = select i1 %40, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @"$globle_str_586", i64 0, i64 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @"$globle_str_587", i64 0, i64 0)
...
loopj9.exit:                                      ; preds = %then_0.i, %then_0
  %51 = tail call {}* @print(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$globle_str_588", i64 0, i64 0))
  %52 = add i64 %.tr34, 1
...
else_0:                                           ; preds = %loopj9.exit, %2
  %60 = tail call {}* @print(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$globle_str_589", i64 0, i64 0))
  ret {}* %60
}
