...
then_0:                                           ; preds = %2, %then_0
  ...
  %. = select i1 %22, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @"$globle_str_354", i64 0, i64 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @"$globle_str_355", i64 0, i64 0)
...
else_1:                                           ; preds = %then_0, %2
  %33 = tail call {}* @print(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$globle_str_356", i64 0, i64 0))
  ret {}* %33
}
...
then_0.i:                                         ; preds = %then_0, %then_0.i
  ...
  %..i = select i1 %40, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @"$globle_str_354", i64 0, i64 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @"$globle_str_355", i64 0, i64 0)
...
loopj10.exit:                                     ; preds = %then_0.i, %then_0
  %51 = tail call {}* @print(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$globle_str_356", i64 0, i64 0))
  %52 = add i64 %.tr34, 1
...
else_0:                                           ; preds = %loopj10.exit, %2
  %60 = tail call {}* @print(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$globle_str_357", i64 0, i64 0))
  ret {}* %60
}
