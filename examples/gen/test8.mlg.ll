...
define i64 @f26(i8*, i64) {
  ...
  store i64 (i8*, i64)* @f26, i64 (i8*, i64)** %8
  ...
  store i64 (i8*, i64)* @g25, i64 (i8*, i64)** %16
...
define i32 @main() {
  ...
  store i64 (i8*, i64)* @f26, i64 (i8*, i64)** %9
  ...
  store i64 (i8*, i64)* @g25, i64 (i8*, i64)** %23
