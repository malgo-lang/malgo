...
define i64 @g.16(i8*, i64) {
  ...
  store i64 (i8*, i64)* @f.12, i64 (i8*, i64)** %8
  ...
  store i64 (i8*, i64)* @g.16, i64 (i8*, i64)** %12
  %13 = getelementptr { i64 (i8*, i64)*, i8* }, { i64 (i8*, i64)*, i8* }* %11, i32 0, i32 1
  store i8* %0, i8** %13
  %14 = call i64 @f.12(i8* %0, i64 %5)
  %15 = add i64 %14, %1
  ret i64 %15
}
...
define i32 @main() {
  ...
  store i64 (i8*, i64)* @f.12, i64 (i8*, i64)** %7
  ...
  store i64 (i8*, i64)* @g.16, i64 (i8*, i64)** %15
