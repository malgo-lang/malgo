...
define {}* @print195(i8*) local_unnamed_addr {
...
define {}* @println194(i8*) local_unnamed_addr {
...
define {}* @print_int193(i64) local_unnamed_addr {
...
define {}* @print_float192(double) local_unnamed_addr {
...
define {}* @flush191() local_unnamed_addr {
  %1 = tail call {}* @flush()
  ret {}* %1
}
...
; Function Attrs: nounwind
define i8 @getChar190() local_unnamed_addr #0 {
...
define i64 @ord189(i8) local_unnamed_addr {
...
define i8 @chr188(i64) local_unnamed_addr {
...
define i64 @size187(i8*) local_unnamed_addr {
...
define {}* @newline186() local_unnamed_addr {
  %1 = tail call {}* @newline()
  ret {}* %1
}
...
define i8* @substring185(i8*, i64, i64) local_unnamed_addr {
...
define i8* @concat184(i8*, i8*) local_unnamed_addr {
...
define i1 @not183(i1) local_unnamed_addr {
  %2 = tail call i1 @not(i1 %0)
  ret i1 %2
}

define {}* @println_int182(i64) local_unnamed_addr {
  %2 = tail call {}* @print_int(i64 %0)
  %3 = tail call {}* @newline()
  ret {}* %3
}

define {}* @println_float181(double) local_unnamed_addr {
  %2 = tail call {}* @print_float(double %0)
  %3 = tail call {}* @newline()
  ret {}* %3
}
...
define i64 @fib180(i64) local_unnamed_addr #1 {
  %2 = icmp slt i64 %0, 2
...
define {}* @do_nothing179() local_unnamed_addr {
...
define i64 @add2178(i8*, i64) {
  ...
  store i64 (i8*, i64)* @add2178, i64 (i8*, i64)** %6, align 8
...
define i64 @add177(i64) local_unnamed_addr {
...
define double @area176(double) local_unnamed_addr #2 {
  %2 = fmul double %0, %0
  %3 = fmul double %2, 3.140000e+00
  ret double %3
}

define {}* @print_fib175(i64) local_unnamed_addr {
  %2 = tail call i64 @fib180(i64 %0)
...
define i64 @"$lambda174"(i8*, i64) {
  ...
  store i64 (i8*, i64)* @"$lambda174", i64 (i8*, i64)** %4, align 8
...
define i32 @main() local_unnamed_addr {
  ...
  store i64 (i8*, i64)* @add2178, i64 (i8*, i64)** %11, align 8
  ...
  store i64 (i8*, i64)* @"$lambda174", i64 (i8*, i64)** %25, align 8
