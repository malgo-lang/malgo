...
@"$globle_str_410" = unnamed_addr constant [6 x i8] c"malgo\00"
@"$globle_str_411" = unnamed_addr constant [14 x i8] c"Hello, world!\00"
@"$globle_str_412" = unnamed_addr constant [11 x i8] c"fib(10) = \00"
@"$globle_str_413" = unnamed_addr constant [4 x i8] c"foo\00"
@"$globle_str_414" = unnamed_addr constant [4 x i8] c"bar\00"
...
define {}* @println_float15(double) local_unnamed_addr {
...
define double @area26(double) local_unnamed_addr #2 {
  %2 = fmul double %0, %0
  %3 = fmul double %2, 3.140000e+00
  ret double %3
}

define i64 @add224(i8*, i64) {
  %3 = bitcast i8* %0 to i64*
  %4 = load i64, i64* %3, align 8
  %5 = tail call i8* @GC_malloc(i64 16)
  %6 = bitcast i8* %5 to i64 (i8*, i64)**
  store i64 (i8*, i64)* @add224, i64 (i8*, i64)** %6, align 8
...
define i64 @add22(i64) local_unnamed_addr {
  ...
  store i64 (i8*, i64)* @add224, i64 (i8*, i64)** %5, align 8
  ...
  store i64 (i8*, i64)* @add224, i64 (i8*, i64)** %10, align 8
...
define i64 @"$lambda304"(i8*, i64) {
  %3 = tail call i8* @GC_malloc(i64 16)
  %4 = bitcast i8* %3 to i64 (i8*, i64)**
  store i64 (i8*, i64)* @"$lambda304", i64 (i8*, i64)** %4, align 8
...
define i32 @main() local_unnamed_addr {
  ...
  %1 = tail call {}* @println(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$globle_str_411", i64 0, i64 0))
  %2 = tail call {}* @print(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$globle_str_412", i64 0, i64 0))
  ...
  store i64 (i8*, i64)* @add224, i64 (i8*, i64)** %15, align 8
  ...
  store i64 (i8*, i64)* @"$lambda304", i64 (i8*, i64)** %25, align 8
  %26 = getelementptr i8, i8* %24, i64 8
  %27 = bitcast i8* %26 to i8**
  store i8* %23, i8** %27, align 8
  %28 = tail call i8* @GC_malloc(i64 16)
  %29 = bitcast i8* %28 to i64 (i8*, i64)**
  store i64 (i8*, i64)* @"$lambda304", i64 (i8*, i64)** %29, align 8
  %30 = getelementptr i8, i8* %28, i64 8
  %31 = bitcast i8* %30 to i8**
  store i8* %23, i8** %31, align 8
  %32 = tail call {}* @print_int(i64 12)
  %33 = tail call {}* @newline()
  %34 = tail call i8* @substring(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @"$globle_str_410", i64 0, i64 0), i64 1, i64 3)
  %35 = tail call {}* @println(i8* %34)
  %36 = tail call i8* @concat(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"$globle_str_413", i64 0, i64 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"$globle_str_414", i64 0, i64 0))
