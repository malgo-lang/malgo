...
define { i64 (i8*, i64)*, i8* }* @"$lambda.30"(i8*, i64) {
  %3 = tail call i8* @GC_malloc(i64 16)
  %4 = bitcast i8* %3 to { i64 (i8*, i64)*, i8* }* (i8*, i64)**
  store { i64 (i8*, i64)*, i8* }* (i8*, i64)* @"$lambda.30", { i64 (i8*, i64)*, i8* }* (i8*, i64)** %4, align 8
  ...
  store i64 (i8*, i64)* @"$lambda.31", i64 (i8*, i64)** %11, align 8
...
define i64 @"$lambda.31"(i8*, i64) {
  %3 = bitcast i8* %0 to i64*
  %4 = load i64, i64* %3, align 8
  %5 = tail call i8* @GC_malloc(i64 16)
  %6 = bitcast i8* %5 to i64 (i8*, i64)**
  store i64 (i8*, i64)* @"$lambda.31", i64 (i8*, i64)** %6, align 8
...
define i64 @"$lambda.28"(i8*, i64) {
  %3 = tail call i8* @GC_malloc(i64 16)
  %4 = bitcast i8* %3 to i64 (i8*, i64)**
  store i64 (i8*, i64)* @"$lambda.28", i64 (i8*, i64)** %4, align 8
  %5 = getelementptr i8, i8* %3, i64 8
  %6 = bitcast i8* %5 to i8**
  store i8* %0, i8** %6, align 8
  %7 = add i64 %1, 1
...
then_0:
  ...
  store i64 (i8*, i64)* @"$lambda.28", i64 (i8*, i64)** %2, align 8
  ...
  store { i64 (i8*, i64)*, i8* }* (i8*, i64)* @"$lambda.30", { i64 (i8*, i64)*, i8* }* (i8*, i64)** %7, align 8
