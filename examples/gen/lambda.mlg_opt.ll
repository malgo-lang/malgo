...
then_0:
  ...
  store { i64 (i8*, i64)*, i8* }* (i8*, i64)* @"$lambda42", { i64 (i8*, i64)*, i8* }* (i8*, i64)** %9, align 8
...
define { i64 (i8*, i64)*, i8* }* @"$lambda42"(i8*, i64) {
  %3 = tail call i8* @GC_malloc(i64 16)
  %4 = bitcast i8* %3 to { i64 (i8*, i64)*, i8* }* (i8*, i64)**
  store { i64 (i8*, i64)*, i8* }* (i8*, i64)* @"$lambda42", { i64 (i8*, i64)*, i8* }* (i8*, i64)** %4, align 8
  ...
  store i64 (i8*, i64)* @"$lambda43", i64 (i8*, i64)** %14, align 8
...
define i64 @"$lambda44"(i8*, i64) {
  %3 = tail call i8* @GC_malloc(i64 16)
  %4 = bitcast i8* %3 to i64 (i8*, i64)**
  store i64 (i8*, i64)* @"$lambda44", i64 (i8*, i64)** %4, align 8
  %5 = tail call i8* @GC_malloc(i64 0)
  %6 = getelementptr i8, i8* %3, i64 8
  %7 = bitcast i8* %6 to i8**
  store i8* %0, i8** %7, align 8
...
define {}* @newline45() local_unnamed_addr {
  %1 = tail call {}* @newline()
  ret {}* %1
}
...
define {}* @print_int46(i64) local_unnamed_addr {
  %2 = tail call {}* @print_int(i64 %0)
  ret {}* %2
}

define i32 @main() local_unnamed_addr {
  %1 = tail call i32 @main41()
  ret i32 0
}
