...
define external ccc  {i64 (i8*, i64)*, i8*}* @$lambda27(i8* , i64 )    {
  %3 = bitcast i8* %0 to {}* 
  ...
  store  {i64 (i8*, i64)*, i8*}* (i8*, i64)* @$lambda27, {i64 (i8*, i64)*, i8*}* (i8*, i64)** %6 
  ...
  store  i64 (i8*, i64)* @$lambda26, i64 (i8*, i64)** %14 
...
define external ccc  i64 @$lambda26(i8* , i64 )    {
  ...
  store  i64 (i8*, i64)* @$lambda26, i64 (i8*, i64)** %8 
