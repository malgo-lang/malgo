...
define i32 @main41() {
  ...
  store i64 (i8*, i64)* @"$lambda44", i64 (i8*, i64)** %6
  ...
  store { i64 (i8*, i64)*, i8* }* (i8*, i64)* @"$lambda42", { i64 (i8*, i64)*, i8* }* (i8*, i64)** %17
...
define { i64 (i8*, i64)*, i8* }* @"$lambda42"(i8*, i64) {
  ...
  store { i64 (i8*, i64)*, i8* }* (i8*, i64)* @"$lambda42", { i64 (i8*, i64)*, i8* }* (i8*, i64)** %6
  %7 = call i8* @GC_malloc(i64 0)
  %8 = bitcast i8* %7 to {}*
  ...
  store i64 (i8*, i64)* @"$lambda43", i64 (i8*, i64)** %20
  %21 = call i8* @GC_malloc(i64 0)
  %22 = bitcast i8* %21 to {}*
