...
define { i64 (i8*, i64)*, i8* }* @"$lambda.30"(i8*, i64) {
  ...
  store { i64 (i8*, i64)*, i8* }* (i8*, i64)* @"$lambda.30", { i64 (i8*, i64)*, i8* }* (i8*, i64)** %6
  ...
  store i64 (i8*, i64)* @"$lambda.31", i64 (i8*, i64)** %14
...
define i64 @"$lambda.31"(i8*, i64) {
  ...
  store i64 (i8*, i64)* @"$lambda.31", i64 (i8*, i64)** %8
...
define i64 @"$lambda.28"(i8*, i64) {
  ...
  store i64 (i8*, i64)* @"$lambda.28", i64 (i8*, i64)** %6
...
define i32 @main() {
  ...
  store { i64 (i8*, i64)*, i8* }* (i8*, i64)* @"$lambda.30", { i64 (i8*, i64)*, i8* }* (i8*, i64)** %13
