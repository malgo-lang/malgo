...
define external ccc  i8* @$fo111(i8* , i8* )    {
...
define external ccc  i64 @$fo84(i8* , i8* )    {
...
define external ccc  i8* @$fo60(i8* , i8* )    {
  ...
  store  i8* (i8*, i8*)* @$fo67, i8* (i8*, i8*)** %11 
...
define external ccc  i8* @$fo67(i8* , i8* )    {
...
; <label>:0:
  ...
  store  i64 (i8*, i8*)* @$fo84, i64 (i8*, i8*)** %23 
...
end_0:
  ...
  store  i8* (i8*, i8*)* @$fo111, i8* (i8*, i8*)** %58 
