...
define i32 @main() {
  ...
  store i8* %20, i8** %24
  %25 = call i8* @GC_malloc(i64 ptrtoint ({ { i64 (i8*, i8*)*, i8* }*, i64 }* getelementptr inbounds ({ { i64 (i8*, i8*)*, i8* }*, i64 }, { { i64 (i8*, i8*)*, i8* }*, i64 }* null, i32 1) to i64))
  ...
  store i64 1, i64* %28
  %29 = mul i64 ptrtoint (i1** getelementptr (i1*, i1** null, i32 1) to i64), 1
  %30 = call i8* @GC_malloc(i64 %29)
  %31 = bitcast i8* %30 to { { i64 (i8*, i8*)*, i8* }*, i64 }**
  %32 = call i8* @GC_malloc(i64 ptrtoint ({ { { i64 (i8*, i8*)*, i8* }*, i64 }**, i64 }* getelementptr inbounds ({ { { i64 (i8*, i8*)*, i8* }*, i64 }**, i64 }, { { { i64 (i8*, i8*)*, i8* }*, i64 }**, i64 }* null, i32 1) to i64))
...
end_0:                                            ; preds = %cond_0
  ...
  %67 = call i8* %48(i8* %50, i8* %66)
  %68 = ptrtoint i8* %67 to i64
  %69 = call {}* @print_int7(i64 %68)
  ret i32 0
}
