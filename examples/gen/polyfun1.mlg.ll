...
define external ccc  i64 @$fo95(i8* , i8* )    {
...
define external ccc  i8* @$fo80(i8* , i8* )    {
...
define external ccc  i64 @$fo55(i8* , i8* )    {
...
; <label>:0:
  ...
  store  i64 (i8*, i8*)* @$fo55, i64 (i8*, i8*)** %11 
...
end_0:
  ...
  store  i8* (i8*, i8*)* @$fo80, i8* (i8*, i8*)** %42 
  ...
  store  i64 (i8*, i8*)* @$fo95, i64 (i8*, i8*)** %57 
