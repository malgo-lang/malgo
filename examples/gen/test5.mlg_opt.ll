...
define i32 @main26() local_unnamed_addr {
  ...
  store { i64 (i8*, i64)*, i8* }* (i8*, i64)* @k28, { i64 (i8*, i64)*, i8* }* (i8*, i64)** %5, align 8
  ...
  store i64 (i8*, i64, i64)* @f27, i64 (i8*, i64, i64)** %14, align 8
...
define i64 @f27(i8*, i64, i64) {
  ...
  store i64 (i8*, i64, i64)* @f27, i64 (i8*, i64, i64)** %11, align 8
  %12 = tail call i8* @GC_malloc(i64 0)
  %13 = getelementptr i8, i8* %10, i64 8
  %14 = bitcast i8* %13 to i8**
  store i8* %0, i8** %14, align 8
  %15 = tail call i8* @GC_malloc(i64 0)
  %16 = tail call { i64 (i8*, i64)*, i8* }* @k28(i8* %0, i64 undef)
...
define { i64 (i8*, i64)*, i8* }* @k28(i8*, i64) {
  %3 = bitcast i8* %0 to i64*
  %4 = load i64, i64* %3, align 8
  %5 = tail call i8* @GC_malloc(i64 16)
  %6 = bitcast i8* %5 to { i64 (i8*, i64)*, i8* }* (i8*, i64)**
  store { i64 (i8*, i64)*, i8* }* (i8*, i64)* @k28, { i64 (i8*, i64)*, i8* }* (i8*, i64)** %6, align 8
  ...
  store i64 (i8*, i64, i64)* @f27, i64 (i8*, i64, i64)** %12, align 8
  ...
  store i64 (i8*, i64)* @"$lambda29", i64 (i8*, i64)** %22, align 8
...
define i64 @"$lambda29"(i8*, i64) {
  %3 = bitcast i8* %0 to i64*
  %4 = load i64, i64* %3, align 8
  %5 = tail call i8* @GC_malloc(i64 16)
  %6 = bitcast i8* %5 to i64 (i8*, i64)**
  store i64 (i8*, i64)* @"$lambda29", i64 (i8*, i64)** %6, align 8
  %7 = tail call i8* @GC_malloc(i64 0)
  %8 = getelementptr i8, i8* %5, i64 8
  %9 = bitcast i8* %8 to i8**
  store i8* %0, i8** %9, align 8
