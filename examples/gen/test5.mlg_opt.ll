...
define i64 @f.20(i8*, i64, i64) {
  ...
  store { i64 (i8*, i64)*, i8* }* (i8*, i64)* @k.15, { i64 (i8*, i64)*, i8* }* (i8*, i64)** %5, align 8
  %6 = getelementptr i8, i8* %4, i64 8
  %7 = bitcast i8* %6 to i8**
  store i8* %0, i8** %7, align 8
  %8 = tail call i8* @GC_malloc(i64 16)
  %9 = bitcast i8* %8 to i64 (i8*, i64, i64)**
  store i64 (i8*, i64, i64)* @f.20, i64 (i8*, i64, i64)** %9, align 8
  ...
  store { i64 (i8*, i64)*, i8* }* (i8*, i64)* @k.15, { i64 (i8*, i64)*, i8* }* (i8*, i64)** %15, align 8
  %16 = getelementptr i8, i8* %14, i64 8
  %17 = bitcast i8* %16 to i8**
  store i8* %0, i8** %17, align 8
  %18 = tail call i8* @GC_malloc(i64 16)
  %19 = bitcast i8* %18 to i64 (i8*, i64, i64)**
  store i64 (i8*, i64, i64)* @f.20, i64 (i8*, i64, i64)** %19, align 8
  ...
  store i64 (i8*, i64)* @"$lambda.22", i64 (i8*, i64)** %25, align 8
  ...
  store i64 (i8*, i64)* @"$lambda.22", i64 (i8*, i64)** %30, align 8
...
define { i64 (i8*, i64)*, i8* }* @k.15(i8*, i64) {
  ...
  store { i64 (i8*, i64)*, i8* }* (i8*, i64)* @k.15, { i64 (i8*, i64)*, i8* }* (i8*, i64)** %6, align 8
  %7 = getelementptr i8, i8* %5, i64 8
  %8 = bitcast i8* %7 to i8**
  store i8* %0, i8** %8, align 8
  %9 = tail call i8* @GC_malloc(i64 16)
  %10 = bitcast i8* %9 to i64 (i8*, i64, i64)**
  store i64 (i8*, i64, i64)* @f.20, i64 (i8*, i64, i64)** %10, align 8
  ...
  store i64 (i8*, i64)* @"$lambda.22", i64 (i8*, i64)** %17, align 8
...
define i64 @"$lambda.22"(i8*, i64) {
  ...
  store i64 (i8*, i64)* @"$lambda.22", i64 (i8*, i64)** %6, align 8
  %7 = getelementptr i8, i8* %5, i64 8
  %8 = bitcast i8* %7 to i8**
  store i8* %0, i8** %8, align 8
  %9 = add i64 %4, %1
...
define i32 @main() local_unnamed_addr {
  ...
  store { i64 (i8*, i64)*, i8* }* (i8*, i64)* @k.15, { i64 (i8*, i64)*, i8* }* (i8*, i64)** %4, align 8
  ...
  store { i64 (i8*, i64)*, i8* }* (i8*, i64)* @k.15, { i64 (i8*, i64)*, i8* }* (i8*, i64)** %14, align 8
  %15 = getelementptr i8, i8* %13, i64 8
  %16 = bitcast i8* %15 to i8**
  store i8* %7, i8** %16, align 8
  %17 = tail call i8* @GC_malloc(i64 16)
  %18 = bitcast i8* %17 to i64 (i8*, i64, i64)**
  store i64 (i8*, i64, i64)* @f.20, i64 (i8*, i64, i64)** %18, align 8
  ...
  store { i64 (i8*, i64)*, i8* }* (i8*, i64)* @k.15, { i64 (i8*, i64)*, i8* }* (i8*, i64)** %23, align 8
  ...
  store i64 (i8*, i64, i64)* @f.20, i64 (i8*, i64, i64)** %27, align 8
  ...
  store i64 (i8*, i64)* @"$lambda.22", i64 (i8*, i64)** %33, align 8
  ...
  store i64 (i8*, i64)* @"$lambda.22", i64 (i8*, i64)** %37, align 8
