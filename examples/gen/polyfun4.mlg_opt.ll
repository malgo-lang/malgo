...
define { { i64, { i8**, i64 }* }* (i8*, i8*)*, i8* }* @"$lambda71"(i8*, i64) {
  %3 = tail call i8* @GC_malloc(i64 16)
  %4 = bitcast i8* %3 to { { i64, { i8**, i64 }* }* (i8*, i8*)*, i8* }* (i8*, i64)**
  store { { i64, { i8**, i64 }* }* (i8*, i8*)*, i8* }* (i8*, i64)* @"$lambda71", { { i64, { i8**, i64 }* }* (i8*, i8*)*, i8* }* (i8*, i64)** %4, align 8
  ...
  store { i64, { i8**, i64 }* }* (i8*, i8*)* @"$lambda70", { i64, { i8**, i64 }* }* (i8*, i8*)** %11, align 8
...
define { i64, { i8**, i64 }* }* @"$lambda70"(i8*, i8*) {
body_0:
  %2 = bitcast i8* %0 to i64*
  %3 = load i64, i64* %2, align 8
  %4 = tail call i8* @GC_malloc(i64 16)
  %5 = bitcast i8* %4 to { i64, { i8**, i64 }* }* (i8*, i8*)**
  store { i64, { i8**, i64 }* }* (i8*, i8*)* @"$lambda70", { i64, { i8**, i64 }* }* (i8*, i8*)** %5, align 8
...
define i64 @"$lambda63"(i8*, i64 returned) {
  %3 = tail call i8* @GC_malloc(i64 16)
  %4 = bitcast i8* %3 to i64 (i8*, i64)**
  store i64 (i8*, i64)* @"$lambda63", i64 (i8*, i64)** %4, align 8
  %5 = getelementptr i8, i8* %3, i64 8
  %6 = bitcast i8* %5 to i8**
  store i8* %0, i8** %6, align 8
  ret i64 %1
...
define i32 @main() local_unnamed_addr {
  ...
  store { { i64, { i8**, i64 }* }* (i8*, i8*)*, i8* }* (i8*, i64)* @"$lambda71", { { i64, { i8**, i64 }* }* (i8*, i8*)*, i8* }* (i8*, i64)** %12, align 8
