...
define i32 @main35() {
  ...
  store i1 (i8*, i64)* @even38, i1 (i8*, i64)** %9
  ...
  store i1 (i8*, i64)* @odd37, i1 (i8*, i64)** %23
  ...
  %34 = call {}* @print_bool36(i1 %33)
  ret i32 0
}

declare {}* @print_bool(i1)

define {}* @print_bool36(i1) {
...
define i1 @odd37(i8*, i64) {
  ...
  store i1 (i8*, i64)* @even38, i1 (i8*, i64)** %8
  ...
  store i1 (i8*, i64)* @odd37, i1 (i8*, i64)** %16
