...
define i1 @odd.22(i8*, i64) {
  ...
  store i1 (i8*, i64)* @even.16, i1 (i8*, i64)** %8
  ...
  store i1 (i8*, i64)* @odd.22, i1 (i8*, i64)** %12
...
else_0:                                           ; preds = %2
  %16 = sub i64 %1, 1
  %17 = call i1 @even.16(i8* %0, i64 %16)
  store i1 %17, i1* %15
  br label %endif_0
...
define i32 @main() {
  ...
  store i1 (i8*, i64)* @even.16, i1 (i8*, i64)** %7
  ...
  store i1 (i8*, i64)* @odd.22, i1 (i8*, i64)** %15
