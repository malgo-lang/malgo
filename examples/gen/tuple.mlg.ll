...
define i64 @fst_int34({ i64, i8* }*) {
  %2 = getelementptr { i64, i8* }, { i64, i8* }* %0, i32 0, i32 0
  %3 = load i64, i64* %2
  ret i64 %3
}

define i8* @snd_str33({ i64, i8* }*) {
...
define i32 @main() {
  ...
  %9 = bitcast i8* %8 to {}*
  %10 = call i64 @fst_int34({ i64, i8* }* %3)
  %11 = call {}* @print_int37(i64 %10)
  %12 = call i8* @snd_str33({ i64, i8* }* %3)
  %13 = call {}* @println36(i8* %12)
  ret i32 0
}
