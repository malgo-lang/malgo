...
define i8* @"$fo108"(i8* nocapture readonly, i8*) {
...
define i64 @"$fo81"(i8* nocapture readonly, i8*) {
...
define i8* @"$fo57"(i8* nocapture readonly, i8* nocapture readonly) {
  ...
  store i8* (i8*, i8*)* @"$fo64", i8* (i8*, i8*)** %8, align 8
...
body_0:
  ...
  store i8* (i8*, i8*)* @"$fo57", i8* (i8*, i8*)** %6, align 8
  ...
  store i64 (i8*, i8*)* @"$fo81", i64 (i8*, i8*)** %15, align 8
  ...
  store i8* (i8*, i8*)* @"$fo108", i8* (i8*, i8*)** %37, align 8
