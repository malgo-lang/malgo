...
define i64 @"$lambda15"(i8*, i64) {
  %3 = bitcast i8* %0 to i64*
  %4 = load i64, i64* %3, align 8
  %5 = tail call i8* @GC_malloc(i64 16)
  %6 = bitcast i8* %5 to i64 (i8*, i64)**
  store i64 (i8*, i64)* @"$lambda15", i64 (i8*, i64)** %6, align 8
...
define { i64 (i8*, i64)*, i8* }* @"$lambda14"(i8*, i64) {
  %3 = tail call i8* @GC_malloc(i64 16)
  %4 = bitcast i8* %3 to { i64 (i8*, i64)*, i8* }* (i8*, i64)**
  store { i64 (i8*, i64)*, i8* }* (i8*, i64)* @"$lambda14", { i64 (i8*, i64)*, i8* }* (i8*, i64)** %4, align 8
  ...
  store i64 (i8*, i64)* @"$lambda15", i64 (i8*, i64)** %14, align 8
...
define i32 @main() local_unnamed_addr {
  ...
  store { i64 (i8*, i64)*, i8* }* (i8*, i64)* @"$lambda14", { i64 (i8*, i64)*, i8* }* (i8*, i64)** %3, align 8
