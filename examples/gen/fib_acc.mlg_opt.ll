...
else_0.i.preheader:                               ; preds = %1, %fib_acc2.exit
  %.tr2 = phi i64 [ %10, %fib_acc2.exit ], [ %0, %1 ]
  br label %else_0.i

then_0:                                           ; preds = %fib_acc2.exit, %1
...
else_0.i:                                         ; preds = %else_0.i.preheader, %else_0.i
  ...
  br i1 %7, label %fib_acc2.exit, label %else_0.i

fib_acc2.exit:                                    ; preds = %else_0.i
...
else_0.i.preheader.i:                             ; preds = %fib_acc2.exit.i, %0
  %indvar = phi i64 [ %indvar.next, %fib_acc2.exit.i ], [ 0, %0 ]
  %.tr2.i = phi i64 [ %15, %fib_acc2.exit.i ], [ 30, %0 ]
  %1 = sub i64 30, %indvar
  %2 = sub i64 29, %indvar
  %xtraiter = and i64 %1, 7
  %3 = icmp ult i64 %2, 7
  br i1 %3, label %fib_acc2.exit.i.unr-lcssa, label %else_0.i.preheader.i.new
...
else_0.i.i:                                       ; preds = %else_0.i.i, %else_0.i.preheader.i.new
  ...
  br i1 %niter.ncmp.7, label %fib_acc2.exit.i.unr-lcssa, label %else_0.i.i

fib_acc2.exit.i.unr-lcssa:                        ; preds = %else_0.i.i, %else_0.i.preheader.i
  ...
  br i1 %lcmp.mod, label %fib_acc2.exit.i, label %else_0.i.i.epil

else_0.i.i.epil:                                  ; preds = %fib_acc2.exit.i.unr-lcssa, %else_0.i.i.epil
  %.tr36.i.i.epil = phi i64 [ %12, %else_0.i.i.epil ], [ %.tr36.i.i.unr, %fib_acc2.exit.i.unr-lcssa ]
  %.tr25.i.i.epil = phi i64 [ %.tr36.i.i.epil, %else_0.i.i.epil ], [ %.tr25.i.i.unr, %fib_acc2.exit.i.unr-lcssa ]
  %epil.iter = phi i64 [ %epil.iter.sub, %else_0.i.i.epil ], [ %xtraiter, %fib_acc2.exit.i.unr-lcssa ]
  %12 = add i64 %.tr25.i.i.epil, %.tr36.i.i.epil
  %epil.iter.sub = add i64 %epil.iter, -1
  %epil.iter.cmp = icmp eq i64 %epil.iter.sub, 0
  br i1 %epil.iter.cmp, label %fib_acc2.exit.i, label %else_0.i.i.epil, !llvm.loop !0

fib_acc2.exit.i:                                  ; preds = %else_0.i.i.epil, %fib_acc2.exit.i.unr-lcssa
  %.tr36.i.i.lcssa = phi i64 [ %.tr36.i.i.lcssa.ph, %fib_acc2.exit.i.unr-lcssa ], [ %.tr36.i.i.epil, %else_0.i.i.epil ]
