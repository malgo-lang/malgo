...
define i64 @fib_acc.22(i64, i64, i64) local_unnamed_addr #0 {
  %4 = icmp slt i64 %0, 1
  br i1 %4, label %endif_0, label %else_0
...
define {}* @print_int.8(i64) local_unnamed_addr {
...
else_0.i.preheader.i:                             ; preds = %fib_acc.22.exit.i, %0
  ...
  %3 = icmp ult i64 %2, 7
  br i1 %3, label %fib_acc.22.exit.i.unr-lcssa, label %else_0.i.preheader.i.new
...
else_0.i.i:                                       ; preds = %else_0.i.i, %else_0.i.preheader.i.new
  ...
  br i1 %niter.ncmp.7, label %fib_acc.22.exit.i.unr-lcssa, label %else_0.i.i

fib_acc.22.exit.i.unr-lcssa:                      ; preds = %else_0.i.i, %else_0.i.preheader.i
  ...
  br i1 %lcmp.mod, label %fib_acc.22.exit.i, label %else_0.i.i.epil

else_0.i.i.epil:                                  ; preds = %fib_acc.22.exit.i.unr-lcssa, %else_0.i.i.epil
  %.tr36.i.i.epil = phi i64 [ %12, %else_0.i.i.epil ], [ %.tr36.i.i.unr, %fib_acc.22.exit.i.unr-lcssa ]
  %.tr25.i.i.epil = phi i64 [ %.tr36.i.i.epil, %else_0.i.i.epil ], [ %.tr25.i.i.unr, %fib_acc.22.exit.i.unr-lcssa ]
  %epil.iter = phi i64 [ %epil.iter.sub, %else_0.i.i.epil ], [ %xtraiter, %fib_acc.22.exit.i.unr-lcssa ]
  %12 = add i64 %.tr25.i.i.epil, %.tr36.i.i.epil
  %epil.iter.sub = add i64 %epil.iter, -1
  %epil.iter.cmp = icmp eq i64 %epil.iter.sub, 0
  br i1 %epil.iter.cmp, label %fib_acc.22.exit.i, label %else_0.i.i.epil, !llvm.loop !0
