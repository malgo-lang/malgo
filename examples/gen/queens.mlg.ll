...
then_1:
  store  i8* getelementptr inbounds ([3 x i8], [3 x i8]* @$globle_str_586, i32 0, i32 0), i8** %21 
  br label %end_0 
else_0:
  store  i8* getelementptr inbounds ([3 x i8], [3 x i8]* @$globle_str_587, i32 0, i32 0), i8** %21 
  br label %end_0 
end_0:
  %22 = load  i8*, i8** %21 
  ...
  br label %end_1 
else_1:
  %26 =  call ccc  {}*  @print0(i8*  getelementptr inbounds ([2 x i8], [2 x i8]* @$globle_str_588, i32 0, i32 0))  
  store  {}* %26, {}** %15 
  br label %end_1 
end_1:
  %27 = load  {}*, {}** %15 
...
then_0:
  ...
  br label %end_0 
else_0:
  %31 =  call ccc  {}*  @print0(i8*  getelementptr inbounds ([2 x i8], [2 x i8]* @$globle_str_589, i32 0, i32 0))  
  store  {}* %31, {}** %13 
  br label %end_0 
end_0:
  %32 = load  {}*, {}** %13 
