...
define {}* @print_bool.23(i1) local_unnamed_addr {
...
else_0:                                           ; preds = %2
  %14 = add i64 %1, -1
  %15 = tail call i1 @odd.22(i8* nonnull %0, i64 %14)
  br label %endif_0

endif_0:                                          ; preds = %2, %else_0
...
define i32 @main() local_unnamed_addr {
  ...
  store i1 (i8*, i64)* @even.16, i1 (i8*, i64)** %4, align 8
  ...
  %13 = tail call i1 @odd.22(i8* %7, i64 34)
