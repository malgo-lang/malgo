...
define i32 @main35() local_unnamed_addr {
  ...
  store i1 (i8*, i64)* @even38, i1 (i8*, i64)** %5, align 8
  ...
  store i1 (i8*, i64)* @odd37, i1 (i8*, i64)** %14, align 8
...
define {}* @print_bool36(i1) local_unnamed_addr {
  %2 = tail call {}* @print_bool(i1 %0)
  ret {}* %2
}

define i1 @odd37(i8*, i64) {
  %3 = bitcast i8* %0 to i64*
  %4 = load i64, i64* %3, align 8
  %5 = tail call i8* @GC_malloc(i64 16)
  %6 = bitcast i8* %5 to i1 (i8*, i64)**
  store i1 (i8*, i64)* @even38, i1 (i8*, i64)** %6, align 8
  ...
  store i1 (i8*, i64)* @odd37, i1 (i8*, i64)** %12, align 8
...
else_0:                                           ; preds = %2
  %18 = add i64 %1, -1
  %19 = tail call i1 @even38(i8* nonnull %0, i64 %18)
  br label %end_0
...
else_0:                                           ; preds = %2
  %18 = add i64 %1, -1
  %19 = tail call i1 @odd37(i8* nonnull %0, i64 %18)
  br label %end_0
