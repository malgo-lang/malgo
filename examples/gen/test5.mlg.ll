...
define i32 @main26() {
  ...
  store { i64 (i8*, i64)*, i8* }* (i8*, i64)* @k28, { i64 (i8*, i64)*, i8* }* (i8*, i64)** %9
  ...
  store i64 (i8*, i64, i64)* @f27, i64 (i8*, i64, i64)** %23
...
define i64 @f27(i8*, i64, i64) {
  ...
  store i64 (i8*, i64, i64)* @f27, i64 (i8*, i64, i64)** %17
  %18 = call i8* @GC_malloc(i64 0)
  %19 = bitcast i8* %18 to {}*
  ...
  %22 = bitcast i8* %21 to {}*
  %23 = call { i64 (i8*, i64)*, i8* }* @k28(i8* %0, i64 %1)
...
define { i64 (i8*, i64)*, i8* }* @k28(i8*, i64) {
  ...
  store { i64 (i8*, i64)*, i8* }* (i8*, i64)* @k28, { i64 (i8*, i64)*, i8* }* (i8*, i64)** %8
  ...
  store i64 (i8*, i64, i64)* @f27, i64 (i8*, i64, i64)** %16
  ...
  store i64 (i8*, i64)* @"$lambda29", i64 (i8*, i64)** %30
...
define i64 @"$lambda29"(i8*, i64) {
  ...
  store i64 (i8*, i64)* @"$lambda29", i64 (i8*, i64)** %8
  %9 = call i8* @GC_malloc(i64 0)
  %10 = bitcast i8* %9 to {}*
