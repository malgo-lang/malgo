...
define external ccc  {i64 (i8*, i64)*, i8*}* @k1(i8* , i64 )    {
  ...
  store  i64 (i8*, i64)* @$lambda43, i64 (i8*, i64)** %16 
...
define external ccc  i64 @f4(i8* , i64 , i64 )    {
  %4 = bitcast i8* %0 to {{{i64 (i8*, i64)*, i8*}* (i8*, i64)*, i8*}*}* 
  %5 = getelementptr  {{{i64 (i8*, i64)*, i8*}* (i8*, i64)*, i8*}*}, {{{i64 (i8*, i64)*, i8*}* (i8*, i64)*, i8*}*}* %4, i32 0, i32 0 
  %6 = load  {{i64 (i8*, i64)*, i8*}* (i8*, i64)*, i8*}*, {{i64 (i8*, i64)*, i8*}* (i8*, i64)*, i8*}** %5 
  %7 =  call ccc  i8*  @GC_malloc(i64  ptrtoint ({i64 (i8*, i64, i64)*, i8*}* getelementptr inbounds ({i64 (i8*, i64, i64)*, i8*}, {i64 (i8*, i64, i64)*, i8*}* inttoptr (i32 0 to {i64 (i8*, i64, i64)*, i8*}*), i32 1) to i64))  
  %8 = bitcast i8* %7 to {i64 (i8*, i64, i64)*, i8*}* 
  %9 = getelementptr  {i64 (i8*, i64, i64)*, i8*}, {i64 (i8*, i64, i64)*, i8*}* %8, i32 0, i32 0 
  store  i64 (i8*, i64, i64)* @f4, i64 (i8*, i64, i64)** %9 
  %10 = getelementptr  {i64 (i8*, i64, i64)*, i8*}, {i64 (i8*, i64, i64)*, i8*}* %8, i32 0, i32 1 
  store  i8* %0, i8** %10 
  %11 = getelementptr  {{i64 (i8*, i64)*, i8*}* (i8*, i64)*, i8*}, {{i64 (i8*, i64)*, i8*}* (i8*, i64)*, i8*}* %6, i32 0, i32 0 
  %12 = load  {i64 (i8*, i64)*, i8*}* (i8*, i64)*, {i64 (i8*, i64)*, i8*}* (i8*, i64)** %11 
  %13 = getelementptr  {{i64 (i8*, i64)*, i8*}* (i8*, i64)*, i8*}, {{i64 (i8*, i64)*, i8*}* (i8*, i64)*, i8*}* %6, i32 0, i32 1 
  %14 = load  i8*, i8** %13 
  %15 =  call ccc  {i64 (i8*, i64)*, i8*}*  %12(i8*  %14, i64  %1)  
  %16 = getelementptr  {i64 (i8*, i64)*, i8*}, {i64 (i8*, i64)*, i8*}* %15, i32 0, i32 0 
...
define external ccc  i64 @$lambda43(i8* , i64 )    {
  %3 = bitcast i8* %0 to {i64}* 
  %4 = getelementptr  {i64}, {i64}* %3, i32 0, i32 0 
  %5 = load  i64, i64* %4 
  ...
  store  i64 (i8*, i64)* @$lambda43, i64 (i8*, i64)** %8 
...
define external ccc  i32 @main()    {
  ...
  store  i8* %4, i8** %8 
  %9 =  call ccc  i8*  @GC_malloc(i64  ptrtoint ({{{i64 (i8*, i64)*, i8*}* (i8*, i64)*, i8*}*}* getelementptr inbounds ({{{i64 (i8*, i64)*, i8*}* (i8*, i64)*, i8*}*}, {{{i64 (i8*, i64)*, i8*}* (i8*, i64)*, i8*}*}* inttoptr (i32 0 to {{{i64 (i8*, i64)*, i8*}* (i8*, i64)*, i8*}*}*), i32 1) to i64))  
  %10 = bitcast i8* %9 to {{{i64 (i8*, i64)*, i8*}* (i8*, i64)*, i8*}*}* 
  %11 = getelementptr  {{{i64 (i8*, i64)*, i8*}* (i8*, i64)*, i8*}*}, {{{i64 (i8*, i64)*, i8*}* (i8*, i64)*, i8*}*}* %10, i32 0, i32 0 
  store  {{i64 (i8*, i64)*, i8*}* (i8*, i64)*, i8*}* %6, {{i64 (i8*, i64)*, i8*}* (i8*, i64)*, i8*}** %11 
  %12 = bitcast {{{i64 (i8*, i64)*, i8*}* (i8*, i64)*, i8*}*}* %10 to i8* 
  ...
  store  i64 (i8*, i64, i64)* @f4, i64 (i8*, i64, i64)** %15 
