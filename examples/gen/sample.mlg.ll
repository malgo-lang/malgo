...
define i32 @main174() {
  ...
  %4 = call {}* @println195(i8* %3)
  %5 = bitcast [11 x i8]* @2 to i8*
  %6 = call {}* @print196(i8* %5)
  %7 = call i64 @fib181(i64 10)
  %8 = call {}* @println_int183(i64 %7)
  %9 = call {}* @do_nothing180()
  %10 = call i64 @add178(i64 2)
  %11 = call {}* @println_int183(i64 %10)
  %12 = call {}* @println_int183(i64 %1)
  ...
  store i64 (i8*, i64)* @"$lambda175", i64 (i8*, i64)** %18
  ...
  %29 = call {}* @println_int183(i64 %28)
  %30 = call i8* @substring186(i8* %2, i64 1, i64 3)
  %31 = call {}* @println195(i8* %30)
  %32 = bitcast [4 x i8]* @3 to i8*
  %33 = bitcast [4 x i8]* @4 to i8*
  %34 = call i8* @concat185(i8* %32, i8* %33)
  %35 = call {}* @println195(i8* %34)
  %36 = call {}* @println_float182(double 3.140000e+00)
  %37 = call double @area177(double 1.000000e+01)
  %38 = call {}* @println_float182(double %37)
  ret i32 0
}
...
define i64 @"$lambda175"(i8*, i64) {
  ...
  store i64 (i8*, i64)* @"$lambda175", i64 (i8*, i64)** %6
...
define {}* @print_fib176(i64) {
  %2 = call i64 @fib181(i64 %0)
  %3 = call {}* @print_int194(i64 %2)
  ret {}* %3
}

define double @area177(double) {
  %2 = fmul double %0, %0
  %3 = fmul double %2, 3.140000e+00
  ret double %3
}

define i64 @add178(i64) {
  ...
  store i64 (i8*, i64)* @add2179, i64 (i8*, i64)** %10
...
define i64 @add2179(i8*, i64) {
  ...
  store i64 (i8*, i64)* @add2179, i64 (i8*, i64)** %8
...
define {}* @do_nothing180() {
  %1 = call i8* @GC_malloc(i64 0)
  %2 = bitcast i8* %1 to {}*
  ret {}* %2
}

define i64 @fib181(i64) {
  %2 = icmp sle i64 %0, 1
  %3 = alloca i64
...
else_0:                                           ; preds = %1
  %4 = sub i64 %0, 1
  %5 = call i64 @fib181(i64 %4)
  %6 = sub i64 %0, 2
  %7 = call i64 @fib181(i64 %6)
  %8 = add i64 %5, %7
  store i64 %8, i64* %3
  br label %end_0
...
define {}* @println_float182(double) {
  %2 = call {}* @print_float193(double %0)
  %3 = call {}* @newline187()
  ret {}* %3
}

define {}* @println_int183(i64) {
  %2 = call {}* @print_int194(i64 %0)
  %3 = call {}* @newline187()
  ret {}* %3
}
...
define i8* @substring186(i8*, i64, i64) {
