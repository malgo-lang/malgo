...
define external ccc  i64 @$lambda304(i8* , i64 )    {
  %3 = bitcast i8* %0 to {}* 
  ...
  store  i64 (i8*, i64)* @$lambda304, i64 (i8*, i64)** %6 
...
define external ccc  i32 @main()    {
  ...
  %1 = add   i64 42, 1 
  %2 =  call ccc  {}*  @println1(i8*  getelementptr inbounds ([14 x i8], [14 x i8]* @$globle_str_411, i32 0, i32 0))  
  %3 =  call ccc  {}*  @print0(i8*  getelementptr inbounds ([11 x i8], [11 x i8]* @$globle_str_412, i32 0, i32 0))  
  ...
  store  i64 (i8*, i64)* @$lambda304, i64 (i8*, i64)** %15 
  ...
  %23 =  call ccc  i8*  @substring10(i8*  getelementptr inbounds ([6 x i8], [6 x i8]* @$globle_str_410, i32 0, i32 0), i64  1, i64  3)  
  %24 =  call ccc  {}*  @println1(i8*  %23)  
  %25 =  call ccc  i8*  @concat11(i8*  getelementptr inbounds ([4 x i8], [4 x i8]* @$globle_str_413, i32 0, i32 0), i8*  getelementptr inbounds ([4 x i8], [4 x i8]* @$globle_str_414, i32 0, i32 0))  
