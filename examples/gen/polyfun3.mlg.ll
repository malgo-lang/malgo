...
define i32 @main() {
  ...
  store i8* %15, i8** %19
  %20 = call i8* @GC_malloc(i64 ptrtoint ({ { i8* (i8*, i8*)*, i8* }*, i64 }* getelementptr inbounds ({ { i8* (i8*, i8*)*, i8* }*, i64 }, { { i8* (i8*, i8*)*, i8* }*, i64 }* null, i32 1) to i64))
  ...
  store i64 1, i64* %23
  %24 = mul i64 ptrtoint (i1** getelementptr (i1*, i1** null, i32 1) to i64), 1
  %25 = call i8* @GC_malloc(i64 %24)
  %26 = bitcast i8* %25 to { { i8* (i8*, i8*)*, i8* }*, i64 }**
  %27 = call i8* @GC_malloc(i64 ptrtoint ({ { { i8* (i8*, i8*)*, i8* }*, i64 }**, i64 }* getelementptr inbounds ({ { { i8* (i8*, i8*)*, i8* }*, i64 }**, i64 }, { { { i8* (i8*, i8*)*, i8* }*, i64 }**, i64 }* null, i32 1) to i64))
...
end_0:                                            ; preds = %cond_0
  ...
  %57 = call i8* %43(i8* %45, i8* %56)
  %58 = ptrtoint i8* %57 to i64
  %59 = call {}* @print_int7(i64 %58)
  ret i32 0
}
