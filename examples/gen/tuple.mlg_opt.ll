...
define i32 @main33() local_unnamed_addr {
...
define i8* @snd_str34({ i64, i8* }* nocapture readonly) local_unnamed_addr #0 {
...
; Function Attrs: norecurse nounwind readonly
define i64 @fst_int35({ i64, i8* }* nocapture readonly) local_unnamed_addr #0 {
...
define {}* @newline36() local_unnamed_addr {
  %1 = tail call {}* @newline()
  ret {}* %1
}
...
define {}* @println37(i8*) local_unnamed_addr {
