...
define i8* @snd_str.21({ i64, i8* }* nocapture readonly) local_unnamed_addr #0 {
...
; Function Attrs: norecurse nounwind readonly
define i64 @fst_int.18({ i64, i8* }* nocapture readonly) local_unnamed_addr #0 {
...
define {}* @println.10(i8*) local_unnamed_addr {
