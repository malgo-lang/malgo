...
then_0:                                           ; preds = %2, %then_0
  %16 = phi { {}* (i8*, i1*)*, i8* }* [ %36, %then_0 ], [ %10, %2 ]
  %17 = phi { {}* (i8*, i1*)*, i8* }* [ %35, %then_0 ], [ %7, %2 ]
  %18 = phi i1* [ %34, %then_0 ], [ %4, %2 ]
  ...
  store {}* (i8*, i64)* @loop.224, {}* (i8*, i64)** %38, align 8
  %39 = getelementptr i8, i8* %37, i64 8
  %40 = bitcast i8* %39 to i8**
  store i8* %0, i8** %40, align 8
  %41 = icmp sgt i64 %33, 0
  br i1 %41, label %then_0, label %else_0
...
define {}* @init_cells.94(i8*, i1* nocapture, i64) {
  ...
  %16 = bitcast i8* %15 to {}*
  br i1 %14, label %else_0, label %endif_0

else_0:                                           ; preds = %3, %else_0
  %17 = phi {}* [ %30, %else_0 ], [ %16, %3 ]
  %.tr34 = phi i64 [ %20, %else_0 ], [ %2, %3 ]
  %18 = tail call i1 @rand_bool({}* %17)
  %19 = getelementptr i1, i1* %1, i64 %.tr34
  store i1 %18, i1* %19, align 1
  %20 = add i64 %.tr34, 1
  %21 = load i64, i64* %4, align 8
  %22 = load i64, i64* %7, align 8
  %23 = tail call i8* @GC_malloc(i64 16)
  %24 = bitcast i8* %23 to {}* (i8*, i1*, i64)**
  store {}* (i8*, i1*, i64)* @init_cells.94, {}* (i8*, i1*, i64)** %24, align 8
  ...
  %29 = tail call i8* @GC_malloc(i64 0)
  %30 = bitcast i8* %29 to {}*
  br i1 %28, label %else_0, label %endif_0.loopexit

endif_0.loopexit:                                 ; preds = %else_0
  %31 = bitcast i8* %29 to {}*
  br label %endif_0

endif_0:                                          ; preds = %endif_0.loopexit, %3
  %.lcssa = phi {}* [ %16, %3 ], [ %31, %endif_0.loopexit ]
  ret {}* %.lcssa
}
