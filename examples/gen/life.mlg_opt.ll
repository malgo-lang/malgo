...
define {}* @print_char379(i8) local_unnamed_addr {
...
define {}* @newline378() local_unnamed_addr {
  %1 = tail call {}* @newline()
  ret {}* %1
}
...
define {}* @gen_seed377() local_unnamed_addr {
...
define i1 @rand_bool376() local_unnamed_addr {
...
define {}* @sleep375(i64) local_unnamed_addr {
...
define i1* @copy_bool_array374(i1*, i64) local_unnamed_addr {
...
define {}* @pulsar373(i1*) local_unnamed_addr {
...
define i1 @view372(i8*, i1* nocapture readonly, i64, i64) {
  ...
  store i1 (i8*, i1*, i64, i64)* @view372, i1 (i8*, i1*, i64, i64)** %11, align 8
...
define noalias {}* @set371(i8*, i1* nocapture, i64, i64, i1) {
  %6 = bitcast i8* %0 to i64*
  %7 = load i64, i64* %6, align 8
  %8 = tail call i8* @GC_malloc(i64 16)
  %9 = bitcast i8* %8 to {}* (i8*, i1*, i64, i64, i1)**
  store {}* (i8*, i1*, i64, i64, i1)* @set371, {}* (i8*, i1*, i64, i64, i1)** %9, align 8
...
define {}* @init_cells370(i8*, i1* nocapture, i64) {
  ...
  store {}* (i8*, i1*, i64)* @init_cells370, {}* (i8*, i1*, i64)** %10, align 8
...
else_0:                                           ; preds = %3, %else_0
  ...
  store {}* (i8*, i1*, i64)* @init_cells370, {}* (i8*, i1*, i64)** %26, align 8
...
define i8 @to_char369(i1) local_unnamed_addr #0 {
end_0:
  %. = select i1 %0, i8 35, i8 95
  ret i8 %.
}

define {}* @go_x368(i8*, i64) {
  ...
  store {}* (i8*, i64)* @go_x368, {}* (i8*, i64)** %15, align 8
...
else_0:                                           ; preds = %2, %else_0
  ...
  store {}* (i8*, i64)* @go_x368, {}* (i8*, i64)** %38, align 8
...
tailrecurse:                                      ; preds = %else_0, %2
  ...
  %14 = tail call i8* @GC_malloc(i64 16)
  %15 = bitcast i8* %14 to {}* (i8*, i64)**
  store {}* (i8*, i64)* @go_y367, {}* (i8*, i64)** %15, align 8
  %16 = tail call i8* @GC_malloc(i64 0)
  %17 = getelementptr i8, i8* %14, i64 8
  %18 = bitcast i8* %17 to i8**
  store i8* %0, i8** %18, align 8
  ...
  store {}* (i8*, i64)* @go_x368, {}* (i8*, i64)** %33, align 8
...
define {}* @print_cells366(i8*, i1*) {
  ...
  store {}* (i8*, i1*)* @print_cells366, {}* (i8*, i1*)** %12, align 8
  %13 = tail call i8* @GC_malloc(i64 0)
  ...
  store {}* (i8*, i64)* @go_y367, {}* (i8*, i64)** %30, align 8
  %31 = tail call i8* @GC_malloc(i64 0)
...
; Function Attrs: norecurse nounwind readnone
define i64 @to_int365(i1) local_unnamed_addr #0 {
end_0:
  %. = zext i1 %0 to i64
  ret i64 %.
}

define i1 @next_state364(i8*, i1*, i64, i64) {
copyelem_0:
  ...
  store i1 (i8*, i1*, i64, i64)* @next_state364, i1 (i8*, i1*, i64, i64)** %7, align 8
...
define {}* @go_x363(i8*, i64) {
  ...
  store {}* (i8*, i64)* @go_x363, {}* (i8*, i64)** %21, align 8
  %22 = tail call i8* @GC_malloc(i64 0)
  %23 = getelementptr i8, i8* %20, i64 8
...
else_0:                                           ; preds = %2, %else_0
  ...
  store {}* (i8*, i64)* @go_x363, {}* (i8*, i64)** %52, align 8
...
tailrecurse:                                      ; preds = %else_0, %2
  ...
  %20 = tail call i8* @GC_malloc(i64 16)
  %21 = bitcast i8* %20 to {}* (i8*, i64)**
  store {}* (i8*, i64)* @go_y362, {}* (i8*, i64)** %21, align 8
  %22 = tail call i8* @GC_malloc(i64 0)
  %23 = getelementptr i8, i8* %20, i64 8
  %24 = bitcast i8* %23 to i8**
  store i8* %0, i8** %24, align 8
  ...
  store {}* (i8*, i64)* @go_x363, {}* (i8*, i64)** %45, align 8
...
define {}* @update_cells361(i8*, i1*) {
  ...
  store {}* (i8*, i1*)* @update_cells361, {}* (i8*, i1*)** %15, align 8
  %16 = tail call i8* @GC_malloc(i64 0)
  %17 = getelementptr i8, i8* %14, i64 8
  %18 = bitcast i8* %17 to i8**
  store i8* %0, i8** %18, align 8
  ...
  store {}* (i8*, i64)* @go_y362, {}* (i8*, i64)** %41, align 8
  %42 = tail call i8* @GC_malloc(i64 0)
...
define {}* @loop360(i8*, i64) {
  ...
  store {}* (i8*, i64)* @loop360, {}* (i8*, i64)** %12, align 8
  %13 = tail call i8* @GC_malloc(i64 0)
  %14 = getelementptr i8, i8* %11, i64 8
  %15 = bitcast i8* %14 to i8**
  store i8* %0, i8** %15, align 8
...
then_0:                                           ; preds = %2, %then_0
  ...
  %37 = tail call i8* @GC_malloc(i64 16)
  %38 = bitcast i8* %37 to {}* (i8*, i64)**
  store {}* (i8*, i64)* @loop360, {}* (i8*, i64)** %38, align 8
  %39 = tail call i8* @GC_malloc(i64 0)
  %40 = getelementptr i8, i8* %37, i64 8
  %41 = bitcast i8* %40 to i8**
  store i8* %0, i8** %41, align 8
...
end_0:                                            ; preds = %copyelem_0
  ...
  store i1 (i8*, i1*, i64, i64)* @view372, i1 (i8*, i1*, i64, i64)** %40, align 8
  ...
  store {}* (i8*, i1*, i64, i64, i1)* @set371, {}* (i8*, i1*, i64, i64, i1)** %49, align 8
  ...
  store {}* (i8*, i1*, i64)* @init_cells370, {}* (i8*, i1*, i64)** %61, align 8
  ...
  store {}* (i8*, i1*)* @print_cells366, {}* (i8*, i1*)** %76, align 8
  ...
  store i1 (i8*, i1*, i64, i64)* @next_state364, i1 (i8*, i1*, i64, i64)** %85, align 8
  ...
  store {}* (i8*, i1*)* @update_cells361, {}* (i8*, i1*)** %103, align 8
  ...
  store {}* (i8*, i64)* @loop360, {}* (i8*, i64)** %120, align 8
