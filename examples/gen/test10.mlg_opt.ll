...
define i64 @"$lambda.10"(i8*, i64) {
  ...
  store i64 (i8*, i64)* @"$lambda.10", i64 (i8*, i64)** %4, align 8
...
define i64 @f.3(i64, i64) local_unnamed_addr {
