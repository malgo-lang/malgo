...
define { i64, i64 }* @map36(i8*, { i64 (i8*, i64)*, i8* }* nocapture readonly, { i64, i64 }* nocapture readonly) {
  %4 = tail call i8* @GC_malloc(i64 16)
  %5 = bitcast i8* %4 to { i64, i64 }* (i8*, { i64 (i8*, i64)*, i8* }*, { i64, i64 }*)**
  store { i64, i64 }* (i8*, { i64 (i8*, i64)*, i8* }*, { i64, i64 }*)* @map36, { i64, i64 }* (i8*, { i64 (i8*, i64)*, i8* }*, { i64, i64 }*)** %5, align 8
  ...
  store i64 (i8*, i64)* @add4235, i64 (i8*, i64)** %11, align 8
...
define i64 @add4235(i8*, i64) {
  %3 = tail call i8* @GC_malloc(i64 16)
  %4 = bitcast i8* %3 to { i64, i64 }* (i8*, { i64 (i8*, i64)*, i8* }*, { i64, i64 }*)**
  store { i64, i64 }* (i8*, { i64 (i8*, i64)*, i8* }*, { i64, i64 }*)* @map36, { i64, i64 }* (i8*, { i64 (i8*, i64)*, i8* }*, { i64, i64 }*)** %4, align 8
  ...
  store i64 (i8*, i64)* @add4235, i64 (i8*, i64)** %10, align 8
...
define i32 @main() local_unnamed_addr {
  ...
  store { i64, i64 }* (i8*, { i64 (i8*, i64)*, i8* }*, { i64, i64 }*)* @map36, { i64, i64 }* (i8*, { i64 (i8*, i64)*, i8* }*, { i64, i64 }*)** %3, align 8
