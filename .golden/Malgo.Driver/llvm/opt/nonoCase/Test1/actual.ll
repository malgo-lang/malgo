...
define internal ptr @"test/testcases/malgo/Test1.mlg.malgo_print_string"(ptr nocapture nofree readnone %0, ptr %"test/testcases/malgo/Test1.mlg.$p_41_0") {
  %2 = tail call ptr @malgo_print_string(ptr %"test/testcases/malgo/Test1.mlg.$p_41_0")
  ret ptr %2
}
...
define internal ptr @"test/testcases/malgo/Test1.mlg.#let_closure_79"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
...
define internal ptr @"test/testcases/malgo/Test1.mlg.if"(ptr nocapture nofree readnone %0, ptr nofree %"test/testcases/malgo/Test1.mlg.$true_42_0") {
  %2 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0 = tail call ptr @malgo_malloc(i64 noundef 8)
  store ptr %"test/testcases/malgo/Test1.mlg.$true_42_0", ptr %let_capture_0, align 8
...
define internal ptr @"test/testcases/malgo/Test1.mlg.#fun_closure_81"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readnone %1) {
...
define internal ptr @"test/testcases/malgo/Test1.mlg.#fun_closure_83"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readnone %1) {
  %malgo_print_string_0 = load ptr, ptr %0, align 8
  %3 = load ptr, ptr %malgo_print_string_0, align 8
  %4 = getelementptr { ptr, ptr }, ptr %malgo_print_string_0, i64 0, i32 1
  %5 = load ptr, ptr %4, align 8
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/Test1.mlg.if", ptr %if_func_0.i, align 8
  ...
  store ptr @"test/testcases/malgo/Test1.mlg.#let_closure_79", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/Test1.mlg.malgo_print_string", ptr %malgo_print_string_func_0.i, align 8
  ...
  store ptr @"test/testcases/malgo/Test1.mlg.#fun_closure_81", ptr %fun_func_0.i, align 8
  ...
  store ptr @"test/testcases/malgo/Test1.mlg.malgo_print_string", ptr %malgo_print_string_func_1.i, align 8
  ...
  store ptr @"test/testcases/malgo/Test1.mlg.#fun_closure_83", ptr %fun_func_1.i, align 8
