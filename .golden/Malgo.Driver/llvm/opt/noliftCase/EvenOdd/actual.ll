...
define internal i32 @"test/testcases/malgo/EvenOdd.mlg.#let_closure_2945"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
...
define internal ptr @"runtime/malgo/Builtin.mlg.malgo_sub_int32_t"(ptr nocapture nofree readnone %0, i32 %"runtime/malgo/Builtin.mlg.$p_1814_0") {
  ...
  store ptr @"test/testcases/malgo/EvenOdd.mlg.#let_closure_2945", ptr %let_func_0, align 8
  ret ptr %2
}

define internal i32 @"test/testcases/malgo/EvenOdd.mlg.#let_closure_2946"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(12) %0, i32 %1) {
  %malgo_sub_int32_t_0 = load ptr, ptr %0, align 8
...
define internal noundef ptr @"test/testcases/malgo/EvenOdd.mlg.even"(ptr nocapture nofree readnone %0, ptr nocapture nofree readonly align 4 %"test/testcases/malgo/EvenOdd.mlg.$int32#_51_0") {
...
switch-unboxed_default_0:                         ; preds = %"switch_branch_runtime/malgo/Builtin.mlg.Int32#_0"
  ...
  store ptr %8, ptr %let_capture_0, align 8
  %p_0 = getelementptr { ptr, i32 }, ptr %let_capture_0, i64 0, i32 1
  store i32 %6, ptr %p_0, align 4
  store ptr %let_capture_0, ptr %7, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %7, i64 0, i32 1
  store ptr @"test/testcases/malgo/EvenOdd.mlg.#let_closure_2946", ptr %let_func_0, align 8
  ...
  %13 = tail call noundef ptr @"test/testcases/malgo/EvenOdd.mlg.odd"(ptr poison, ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(1) %10)
  br label %common.ret
}

define internal i32 @"test/testcases/malgo/EvenOdd.mlg.#let_closure_2947"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(12) %0, i32 %1) {
  %malgo_sub_int32_t_0 = load ptr, ptr %0, align 8
  %p_addr_0 = getelementptr { ptr, i32 }, ptr %0, i64 0, i32 1
  %p_0 = load i32, ptr %p_addr_0, align 4
  %3 = load ptr, ptr %malgo_sub_int32_t_0, align 8
...
define internal noundef ptr @"test/testcases/malgo/EvenOdd.mlg.odd"(ptr nocapture nofree readnone %0, ptr nocapture nofree readonly align 4 %"test/testcases/malgo/EvenOdd.mlg.$int32#_61_0") {
"switch_branch_runtime/malgo/Builtin.mlg.Int32#_0":
...
switch-unboxed_default_0:                         ; preds = %"switch_branch_runtime/malgo/Builtin.mlg.Int32#_0"
  ...
  %13 = tail call noundef ptr @"test/testcases/malgo/EvenOdd.mlg.even"(ptr poison, ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(1) %10)
  br label %common.ret
}

define internal ptr @"test/testcases/malgo/EvenOdd.mlg.#fun_closure_2948"(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %1) {
common.ret:
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/EvenOdd.mlg.#fun_closure_2948", ptr %fun_func_0.i, align 8
  %4 = tail call ptr @malgo_malloc(i64 noundef 8)
  ...
  %7 = tail call ptr @"test/testcases/malgo/EvenOdd.mlg.even"(ptr poison, ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(1) %4)
