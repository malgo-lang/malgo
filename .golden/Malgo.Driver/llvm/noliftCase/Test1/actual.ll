...
define internal ptr @"test/testcases/malgo/Test1.mlg.#let_closure_95"(ptr %0, ptr %1) {
...
"switch_branch_test/testcases/malgo/Test1.mlg.False_0": ; preds = %2
...
define internal ptr @"test/testcases/malgo/Test1.mlg.#let_closure_94"(ptr %0, ptr %1) {
  ...
  store ptr @"test/testcases/malgo/Test1.mlg.#let_closure_95", ptr %let_func_0, align 8
  ret ptr %3
}
...
define internal ptr @"test/testcases/malgo/Test1.mlg.if"(ptr %0, ptr %"test/testcases/malgo/Test1.mlg.$true_42_0") {
  ...
  store ptr @"test/testcases/malgo/Test1.mlg.#let_closure_94", ptr %let_func_0, align 8
  ret ptr %2
}

define internal ptr @"test/testcases/malgo/Test1.mlg.#let_closure_97"(ptr %0, ptr %1) {
  %t_addr_0 = getelementptr { ptr, ptr }, ptr %0, i32 0, i32 0
  %t_0 = load ptr, ptr %t_addr_0, align 8
...
define internal ptr @"test/testcases/malgo/Test1.mlg.#let_closure_96"(ptr %0, ptr %1) {
  ...
  %t_0 = getelementptr { ptr, ptr }, ptr %let_capture_0, i32 0, i32 0
  store ptr %1, ptr %t_0, align 8
  %d_1 = getelementptr { ptr, ptr }, ptr %let_capture_0, i32 0, i32 1
...
define internal ptr @"test/testcases/malgo/Test1.mlg.#fun_closure_98"(ptr %0, ptr %1) {
  %3 = call ptr @malgo_print_string(ptr @str99)
  ret ptr %3
}

define internal ptr @"test/testcases/malgo/Test1.mlg.#fun_closure_100"(ptr %0, ptr %1) {
...
define internal ptr @"test/testcases/malgo/Test1.mlg.main"(ptr %0, ptr %"test/testcases/malgo/Test1.mlg.$$__63_0") {
  ...
  store ptr @"test/testcases/malgo/Test1.mlg.#let_closure_96", ptr %let_func_0, align 8
  ...
  store ptr @"test/testcases/malgo/Test1.mlg.#fun_closure_98", ptr %fun_func_0, align 8
  ...
  store ptr @"test/testcases/malgo/Test1.mlg.#fun_closure_100", ptr %fun_func_1, align 8
