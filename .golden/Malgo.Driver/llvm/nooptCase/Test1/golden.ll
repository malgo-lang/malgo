...
define internal ptr @"test/testcases/malgo/Test1.mlg.main"(ptr %0, ptr %"test/testcases/malgo/Test1.mlg.$$__63_0") {
  ...
  store ptr @"test/testcases/malgo/Test1.mlg.#fun_closure_83", ptr %fun_func_0, align 8
  ...
  store ptr @"test/testcases/malgo/Test1.mlg.#fun_closure_84", ptr %fun_func_1, align 8
...
define internal ptr @"test/testcases/malgo/Test1.mlg.$raw_fun_81"(ptr %0, ptr %"test/testcases/malgo/Test1.mlg.$$__67_0") {
  %2 = call ptr @"test/testcases/malgo/Test1.mlg.malgo_print_string"(ptr null, ptr @str85)
  ret ptr %2
}

define internal ptr @"test/testcases/malgo/Test1.mlg.$raw_fun_82"(ptr %0, ptr %"test/testcases/malgo/Test1.mlg.$$__73_0") {
  %2 = call ptr @"test/testcases/malgo/Test1.mlg.malgo_print_string"(ptr null, ptr @str86)
  ret ptr %2
}

define internal ptr @"test/testcases/malgo/Test1.mlg.#let_closure_87"(ptr %0, ptr %1) {
...
define internal ptr @"test/testcases/malgo/Test1.mlg.if"(ptr %0, ptr %"test/testcases/malgo/Test1.mlg.$true_42_0") {
  ...
  store ptr @"test/testcases/malgo/Test1.mlg.#let_closure_87", ptr %let_func_0, align 8
  ret ptr %2
}

define internal ptr @"test/testcases/malgo/Test1.mlg.#let_closure_88"(ptr %0, ptr %1) {
...
define internal ptr @"test/testcases/malgo/Test1.mlg.$raw_let_79"(ptr %0, ptr %"test/testcases/malgo/Test1.mlg.$true_42_0", ptr %"test/testcases/malgo/Test1.mlg.$t_43_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"test/testcases/malgo/Test1.mlg.#let_closure_88", ptr %let_func_0, align 8
  ret ptr %2
}
