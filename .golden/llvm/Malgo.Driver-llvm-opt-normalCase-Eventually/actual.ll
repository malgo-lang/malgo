...
define internal ptr @"test/testcases/malgo/Eventually.mlg.#let_closure_3372"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  tail call void @malgo_hash_table_insert(ptr %2, ptr noundef nonnull @str3373, ptr noundef nonnull %3)
  ...
  tail call void @malgo_hash_table_insert(ptr %2, ptr noundef nonnull @str3374, ptr noundef nonnull %4)
  store ptr %2, ptr @"test/testcases/malgo/Eventually.mlg.eventually", align 8
  %5 = tail call ptr @malgo_hash_table_get(ptr %2, ptr noundef nonnull @str3373)
  %6 = tail call ptr @malgo_hash_table_get(ptr %2, ptr noundef nonnull @str3374)
...
define internal ptr @"test/testcases/malgo/Eventually.mlg.#fun_closure_3417"(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %1) {
  ...
  %4 = tail call ptr @malgo_hash_table_get(ptr %3, ptr noundef nonnull @str3373)
  %5 = tail call ptr @malgo_hash_table_get(ptr %3, ptr noundef nonnull @str3374)
