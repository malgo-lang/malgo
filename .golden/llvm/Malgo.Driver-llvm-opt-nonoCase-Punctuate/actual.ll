; ModuleID = './test/tmp/malgo_test/nono/Punctuate.ll'
...
define internal noundef ptr @"Punctuate.#let_closure_215"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
...
define internal ptr @"Punctuate.#let_closure_217"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %1) {
...
switch_branch_Prelude.Nil_0.i:                    ; preds = %2
  %4 = tail call ptr @malgo_malloc(i64 noundef 1)
  store i8 0, ptr %4, align 1
  br label %common.ret1

switch_branch_Prelude.Cons_0.i:                   ; preds = %2
  ...
  store ptr @"Punctuate.#let_closure_215", ptr %let_func_0.i.i, align 8
  br i1 %switch1.i, label %switch_branch_Prelude.Nil_1.i, label %switch_branch_Prelude.Cons_1.i

switch_branch_Prelude.Nil_1.i:                    ; preds = %switch_branch_Prelude.Cons_0.i
...
common.ret1:                                      ; preds = %switch_branch_Prelude.Nil_0.i, %switch_branch_Prelude.Nil_1.i, %switch_branch_Prelude.Cons_1.i
  %common.ret1.op = phi ptr [ %26, %switch_branch_Prelude.Cons_1.i ], [ %4, %switch_branch_Prelude.Nil_0.i ], [ %15, %switch_branch_Prelude.Nil_1.i ]
  ret ptr %common.ret1.op

switch_branch_Prelude.Cons_1.i:                   ; preds = %switch_branch_Prelude.Cons_0.i
  ...
  store ptr @"Punctuate.#let_closure_215", ptr %let_func_0.i5.i, align 8
  %18 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %18, align 8
  %punctuate_func_0.i = getelementptr { ptr, ptr }, ptr %18, i64 0, i32 1
  store ptr @Prelude.punctuate, ptr %punctuate_func_0.i, align 8
  ...
  store ptr @"Punctuate.#let_closure_217", ptr %let_func_0.i7.i, align 8
  %20 = tail call ptr @"Punctuate.#let_closure_217"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %let_capture_0.i6.i, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %8)
...
define internal ptr @Prelude.punctuate(ptr nocapture nofree readnone %0, ptr nofree %"Prelude.$__725_0") {
  %2 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0 = tail call ptr @malgo_malloc(i64 noundef 8)
  store ptr %"Prelude.$__725_0", ptr %let_capture_0, align 8
  store ptr %let_capture_0, ptr %2, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i64 0, i32 1
...
define internal ptr @"Punctuate.#let_closure_218"(ptr nocapture nofree readonly %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %1) {
  %3 = load i8, ptr %1, align 1
  %switch.i = icmp eq i8 %3, 0
  br i1 %switch.i, label %switch_branch_Prelude.Nil_0.i, label %switch_branch_Prelude.Cons_0.i
...
common.ret1:                                      ; preds = %switch_branch_Prelude.Cons_0.i, %switch_branch_Prelude.Nil_0.i
  %common.ret1.op = phi ptr [ %4, %switch_branch_Prelude.Nil_0.i ], [ %20, %switch_branch_Prelude.Cons_0.i ]
  ret ptr %common.ret1.op
...
switch_branch_Prelude.Cons_0.i:                   ; preds = %2
  ...
  store ptr @Prelude.mapList, ptr %mapList_func_0.i, align 8
  %16 = tail call ptr @malgo_malloc(i64 noundef 16)
  ...
  store ptr @"Punctuate.#let_closure_218", ptr %let_func_0.i2.i, align 8
  %17 = tail call ptr @"Punctuate.#let_closure_218"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %let_capture_0.i1.i, ptr nocapture nofree readonly %8)
...
define internal ptr @Prelude.mapList(ptr nocapture nofree readnone %0, ptr nofree %"Prelude.$__777_0") {
  %2 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0 = tail call ptr @malgo_malloc(i64 noundef 8)
  store ptr %"Prelude.$__777_0", ptr %let_capture_0, align 8
  store ptr %let_capture_0, ptr %2, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i64 0, i32 1
...
define internal ptr @Prelude.concatString(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %"Prelude.$nil_974_0") {
...
common.ret:                                       ; preds = %switch_branch_Prelude.Cons_0, %switch_branch_Prelude.Nil_0
  %common.ret.op = phi ptr [ %4, %switch_branch_Prelude.Nil_0 ], [ %16, %switch_branch_Prelude.Cons_0 ]
...
switch_branch_Prelude.Nil_0:                      ; preds = %1
  ...
  store ptr @str210, ptr %5, align 8
  br label %common.ret

switch_branch_Prelude.Cons_0:                     ; preds = %1
  %6 = getelementptr { i8, { ptr, ptr } }, ptr %"Prelude.$nil_974_0", i64 0, i32 1
  %7 = load ptr, ptr %6, align 8
  %8 = getelementptr { i8, { ptr, ptr } }, ptr %"Prelude.$nil_974_0", i64 0, i32 1, i32 1
  ...
  store ptr @"Punctuate.#let_closure_398", ptr %let_func_0.i, align 8
  ...
  %13 = tail call ptr @Prelude.concatString(ptr poison, ptr nocapture nofree readonly %9)
...
define internal ptr @"Punctuate.#let_closure_290"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
  %p_0 = load ptr, ptr %0, align 8
...
define internal ptr @"Punctuate.#let_closure_397"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
  ...
  store ptr @"Punctuate.#let_closure_290", ptr %let_func_0.i.i, align 8
...
define internal noundef ptr @"Punctuate.#let_closure_398"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 8 %1) {
  ...
  store ptr @"Punctuate.#let_closure_397", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"Punctuate.#let_closure_290", ptr %let_func_0.i.i.i.i, align 8
...
define internal noundef ptr @Punctuate.Symbol(ptr nocapture nofree readnone %0, ptr nofree %"Punctuate.$p_113_0") {
  %2 = tail call noundef ptr @malgo_malloc(i64 noundef 16)
  store i8 0, ptr %2, align 1
  %3 = getelementptr { i8, { ptr } }, ptr %2, i64 0, i32 1, i32 0
  store ptr %"Punctuate.$p_113_0", ptr %3, align 8
  ret ptr %2
}

define internal noundef ptr @Punctuate.SList(ptr nocapture nofree readnone %0, ptr nofree %"Punctuate.$p_117_0") {
  %2 = tail call noundef ptr @malgo_malloc(i64 noundef 16)
  store i8 2, ptr %2, align 1
  %3 = getelementptr { i8, { ptr } }, ptr %2, i64 0, i32 1, i32 0
  store ptr %"Punctuate.$p_117_0", ptr %3, align 8
  ret ptr %2
}

define internal ptr @"Punctuate.<>"(ptr nocapture nofree readnone %0, ptr nofree %"Punctuate.$eta_119_0") {
  %2 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %2, align 8
  ...
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i = tail call ptr @malgo_malloc(i64 noundef 8)
  store ptr %"Punctuate.$eta_119_0", ptr %let_capture_0.i, align 8
...
define internal ptr @Punctuate.show(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %"Punctuate.$symbol_120_0") {
...
common.ret:                                       ; preds = %switch_branch_Punctuate.SList_0, %switch_branch_Punctuate.SInt_0, %switch_branch_Punctuate.Symbol_0
  %common.ret.op = phi ptr [ %11, %switch_branch_Punctuate.Symbol_0 ], [ %31, %switch_branch_Punctuate.SInt_0 ], [ %65, %switch_branch_Punctuate.SList_0 ]
  ret ptr %common.ret.op
...
switch_branch_Punctuate.Symbol_0:                 ; preds = %1
  ...
  store ptr @"Punctuate.#let_closure_398", ptr %let_func_0.i.i, align 8
  %11 = tail call ptr @"Punctuate.#let_closure_398"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %let_capture_0.i.i, ptr nocapture nofree readonly align 8 %4)
  br label %common.ret

switch_branch_Punctuate.SInt_0:                   ; preds = %1
  %12 = getelementptr { i8, { ptr } }, ptr %"Punctuate.$symbol_120_0", i64 0, i32 1
  ...
  store ptr @Builtin.appendString, ptr %appendString_func_0.i1, align 8
  %19 = tail call ptr @malgo_malloc(i64 noundef 16)
  ...
  store ptr @"Punctuate.#let_closure_398", ptr %let_func_0.i.i3, align 8
...
switch_branch_Punctuate.SList_0:                  ; preds = %1
  %32 = getelementptr { i8, { ptr } }, ptr %"Punctuate.$symbol_120_0", i64 0, i32 1
  ...
  store ptr @Builtin.appendString, ptr %appendString_func_0.i4, align 8
  ...
  store ptr @"Punctuate.#let_closure_398", ptr %let_func_0.i.i6, align 8
  ...
  store ptr @"Punctuate.#let_closure_217", ptr %let_func_0.i, align 8
  ...
  store ptr @"Punctuate.#let_closure_218", ptr %let_func_0.i8, align 8
  %48 = tail call ptr @"Punctuate.#let_closure_218"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %let_capture_0.i7, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %33)
  ...
  store ptr @Prelude.concatString, ptr %concatString_func_0, align 8
  %53 = tail call ptr @Prelude.concatString(ptr poison, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %51)
  ...
  store ptr @Builtin.appendString, ptr %appendString_func_0.i9, align 8
  ...
  store ptr @"Punctuate.#let_closure_398", ptr %let_func_0.i.i11, align 8
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @Punctuate.Symbol, ptr %Symbol_func_0.i, align 8
  %10 = tail call ptr @malgo_malloc(i64 noundef 16)
  store i8 0, ptr %10, align 1
  ...
  store ptr @Punctuate.Symbol, ptr %Symbol_func_1.i, align 8
  %18 = tail call ptr @malgo_malloc(i64 noundef 16)
  ...
  store ptr @"Punctuate.#let_closure_215", ptr %let_func_0.i2.i, align 8
  %22 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %22, align 8
  %"String#_func_2.i" = getelementptr { ptr, ptr }, ptr %22, i64 0, i32 1
  store ptr @"Builtin.String#", ptr %"String#_func_2.i", align 8
  %23 = tail call ptr @malgo_malloc(i64 noundef 16)
  ...
  store ptr @Punctuate.Symbol, ptr %Symbol_func_2.i, align 8
  %26 = tail call ptr @malgo_malloc(i64 noundef 16)
  ...
  store ptr @"Punctuate.#let_closure_215", ptr %let_func_0.i4.i, align 8
  ...
  store ptr @Punctuate.SList, ptr %SList_func_0.i, align 8
  %35 = tail call ptr @malgo_malloc(i64 noundef 16)
  ...
  store ptr @Prelude.Cons, ptr %Cons_func_3.i, align 8
  %38 = tail call ptr @malgo_malloc(i64 noundef 16)
  ...
  store ptr @"Punctuate.#let_closure_215", ptr %let_func_0.i6.i, align 8
  ...
  store ptr @Punctuate.SList, ptr %SList_func_1.i, align 8
  %47 = tail call ptr @malgo_malloc(i64 noundef 16)
  ...
  store ptr @Prelude.Cons, ptr %Cons_func_4.i, align 8
  ...
  store ptr @"Punctuate.#let_closure_215", ptr %let_func_0.i8.i, align 8
  ...
  store ptr @Punctuate.SList, ptr %SList_func_2.i, align 8
  ...
  %62 = tail call ptr @Punctuate.show(ptr poison, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(1) %59)
