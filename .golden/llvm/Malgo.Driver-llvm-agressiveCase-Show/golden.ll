...
@str3851 = unnamed_addr constant [5 x i8] c"show\00"
@str3852 = unnamed_addr constant [3 x i8] c", \00"
@str3853 = unnamed_addr constant [2 x i8] c")\00"
...
define internal ptr @"test/testcases/malgo/Show.mlg.#let_closure_3854"(ptr %0, ptr %1) {
...
define internal ptr @"test/testcases/malgo/Show.mlg.#let_closure_3855"(ptr %0, ptr %1) {
  %d_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %d_0 = load ptr, ptr %d_addr_0, align 8
...
define internal ptr @"test/testcases/malgo/Show.mlg.#let_closure_3856"(ptr %0, ptr %1) {
  %d_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %d_0 = load ptr, ptr %d_addr_0, align 8
...
"switch_branch_Tuple#_0":                         ; preds = %1
  ...
  store ptr @str3850, ptr %11, align 8
  %12 = call ptr @malgo_hash_table_get(ptr %"test/testcases/malgo/Show.mlg.$showDictA_187_0", ptr @str3851)
  %13 = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 0
  %14 = load ptr, ptr %13, align 8
  %15 = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 1
  %16 = load ptr, ptr %15, align 8
  ...
  %21 = call ptr @malgo_hash_table_get(ptr %"test/testcases/malgo/Show.mlg.$showDictB_188_0", ptr @str3851)
  ...
  store ptr @str3853, ptr %29, align 8
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_3854", ptr %let_func_0, align 8
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_3855", ptr %let_func_1, align 8
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_3856", ptr %let_func_2, align 8
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_3857", ptr %let_func_3, align 8
...
define internal ptr @"test/testcases/malgo/Show.mlg.#fun_closure_3858"(ptr %0, ptr %1) {
...
define internal ptr @"test/testcases/malgo/Show.mlg.$showTuple2_curry_186"(ptr %0, ptr %"test/testcases/malgo/Show.mlg.$showDictA_187_0", ptr %"test/testcases/malgo/Show.mlg.$showDictB_188_0") {
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#fun_closure_3858", ptr %fun_func_0, align 8
  %3 = call ptr @malgo_hash_table_new()
  call void @malgo_hash_table_insert(ptr %3, ptr @str3851, ptr %2)
  ret ptr %3
}
...
define internal ptr @"test/testcases/malgo/Show.mlg.<>"(ptr %0, ptr %"test/testcases/malgo/Show.mlg.$x_137_0") {
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_3859", ptr %let_func_0, align 8
  ret ptr %2
}
...
define internal ptr @"test/testcases/malgo/Show.mlg.showTuple2"(ptr %0, ptr %"test/testcases/malgo/Show.mlg.$showDictA_149_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_3860", ptr %let_func_0, align 8
  ret ptr %2
}
...
define internal ptr @"test/testcases/malgo/Show.mlg.$raw_let_3848"(ptr %0, ptr %"test/testcases/malgo/Show.mlg.$cast_230_0", ptr %"test/testcases/malgo/Show.mlg.$x_3802_0") {
  %2 = call ptr @malgo_hash_table_get(ptr %"test/testcases/malgo/Show.mlg.$cast_230_0", ptr @str3851)
...
define internal ptr @"test/testcases/malgo/Show.mlg.show"(ptr %0, ptr %"test/testcases/malgo/Show.mlg.$record_119_0") {
  %2 = call ptr @malgo_hash_table_get(ptr %"test/testcases/malgo/Show.mlg.$record_119_0", ptr @str3851)
  ret ptr %2
}
...
define internal ptr @"test/testcases/malgo/Show.mlg.$raw_let_3846"(ptr %0, ptr %"test/testcases/malgo/Show.mlg.$showDict_121_0", ptr %"test/testcases/malgo/Show.mlg.$x_122_0") {
  %2 = call ptr @malgo_hash_table_get(ptr %"test/testcases/malgo/Show.mlg.$showDict_121_0", ptr @str3851)
  %3 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 0
  %4 = load ptr, ptr %3, align 8
  %5 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  %6 = load ptr, ptr %5, align 8
...
define internal void @"malgo_load_test/testcases/malgo/Show.mlg"() {
  ...
  call void @malgo_hash_table_insert(ptr %2, ptr @str3851, ptr %1)
