...
define internal i32 @"test/testcases/malgo/Seq.mlg.#let_closure_3025"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  %p_0 = load i32, ptr %0, align 4
  ...
  store ptr @"test/testcases/malgo/Seq.mlg.#let_closure_3020", ptr %let_func_0.i, align 8
  %p_0.i = load i32, ptr %let_capture_0.i, align 4
  %4 = tail call i32 @malgo_add_int32_t(i32 %p_0.i, i32 %1)
  ret i32 %4
}

define internal i32 @"test/testcases/malgo/Seq.mlg.#let_closure_3026"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  %p_0 = load i32, ptr %0, align 4
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i = tail call ptr @malgo_malloc(i64 noundef 4)
  store i32 %p_0, ptr %let_capture_0.i, align 4
