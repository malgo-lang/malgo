...
define internal i32 @"test/testcases/malgo/TestLet.mlg.#let_closure_2366"(ptr nocapture nofree readnone %0, i32 %1) {
  %3 = tail call i32 @malgo_add_int32_t(i32 noundef 1, i32 %1)
  ret i32 %3
}

define internal i32 @"test/testcases/malgo/TestLet.mlg.#let_closure_2367"(ptr nocapture nofree readnone %0, i32 %1) {
  %3 = tail call i32 @malgo_add_int32_t(i32 noundef 1, i32 %1)
  ret i32 %3
}
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/TestLet.mlg.#let_closure_2366", ptr %let_func_0.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestLet.mlg.#let_closure_2367", ptr %let_func_1.i, align 8
