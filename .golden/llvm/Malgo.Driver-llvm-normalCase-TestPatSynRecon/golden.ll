...
define internal ptr @"TestPatSynRecon.#let_closure_2990"(ptr %0, ptr %1) {
...
define internal ptr @"TestPatSynRecon.#fun_closure_2991"(ptr %0, ptr %1) {
  %3 = call ptr @"TestPatSynRecon.$raw_fun_2989"(ptr null, ptr %1)
  ret ptr %3
}
...
define internal ptr @TestPatSynRecon.main(ptr %0, ptr %"TestPatSynRecon.$$__114_0") {
  ...
  store ptr @"TestPatSynRecon.#fun_closure_2991", ptr %fun_func_0, align 8
...
define internal i64 @"TestPatSynRecon.#let_closure_2992"(ptr %0, i64 %1) {
  %x_addr_0 = getelementptr { i64 }, ptr %0, i32 0, i32 0
  %x_0 = load i64, ptr %x_addr_0, align 4
  %3 = call i64 @"TestPatSynRecon.$raw_let_2988"(ptr null, i64 %x_0, i64 %1)
  ret i64 %3
}
...
define internal ptr @"TestPatSynRecon.+#"(ptr %0, i64 %"TestPatSynRecon.$x_83_0") {
  ...
  store ptr @"TestPatSynRecon.#let_closure_2992", ptr %let_func_0, align 8
  ret ptr %2
}

define internal i64 @"TestPatSynRecon.#let_closure_2993"(ptr %0, i64 %1) {
  %x_addr_0 = getelementptr { i64 }, ptr %0, i32 0, i32 0
  %x_0 = load i64, ptr %x_addr_0, align 4
...
define internal i64 @"TestPatSynRecon.$raw_let_2988"(ptr %0, i64 %"TestPatSynRecon.$x_83_0", i64 %"TestPatSynRecon.$y_84_0") {
  %2 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ ptr, ptr }, ptr null, i32 1) to i64))
  %let_capture_0 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ i64 }, ptr null, i32 1) to i64))
  %x_0 = getelementptr { i64 }, ptr %let_capture_0, i32 0, i32 0
  store i64 %"TestPatSynRecon.$x_83_0", ptr %x_0, align 4
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"TestPatSynRecon.#let_closure_2993", ptr %let_func_0, align 8
...
define internal i64 @"TestPatSynRecon.#let_closure_2994"(ptr %0, i64 %1) {
...
define internal ptr @"TestPatSynRecon.$raw_fun_2989"(ptr %0, ptr %"TestPatSynRecon.$i_132_0") {
