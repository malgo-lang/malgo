; ModuleID = './test/tmp/malgo_test/nolift/TestEither.ll'
...
define internal ptr @"Builtin.toStringInt32#"(ptr nocapture nofree readnone %0, i32 %"Builtin.$x_2179_0") {
  %2 = tail call ptr @malgo_int32_t_to_string(i32 %"Builtin.$x_2179_0")
  ret ptr %2
}

define internal i32 @"TestEither.#let_closure_3545"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
...
define internal ptr @"TestEither.#let_closure_3547"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define internal ptr @"TestEither.#fun_closure_3548"(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %1) {
...
common.ret:                                       ; preds = %switch_branch_TestEither.Right_0, %switch_branch_TestEither.Left_0
  %common.ret.op = phi ptr [ %9, %switch_branch_TestEither.Left_0 ], [ %17, %switch_branch_TestEither.Right_0 ]
...
define internal ptr @"TestEither.#let_closure_3567"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
  %d_0 = load ptr, ptr %0, align 8
  %3 = load ptr, ptr %1, align 8
  %4 = getelementptr { ptr, ptr }, ptr %1, i64 0, i32 1
  %5 = load ptr, ptr %4, align 8
...
define internal ptr @"TestEither.#let_closure_3568"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define internal ptr @"TestEither.#let_closure_3566"(ptr nocapture nofree readonly %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(1) %1) {
  %3 = load i8, ptr %1, align 8
  %switch = icmp eq i8 %3, 0
  br i1 %switch, label %switch_branch_TestEither.Left_0, label %switch_branch_TestEither.Right_0

common.ret:                                       ; preds = %switch_branch_TestEither.Right_0, %switch_branch_TestEither.Left_0
  %common.ret.op = phi ptr [ %6, %switch_branch_TestEither.Left_0 ], [ %29, %switch_branch_TestEither.Right_0 ]
  ret ptr %common.ret.op
...
define internal ptr @"TestEither.#let_closure_3569"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
  %d_0 = load ptr, ptr %0, align 8
  %3 = load ptr, ptr %1, align 8
  %4 = getelementptr { ptr, ptr }, ptr %1, i64 0, i32 1
  %5 = load ptr, ptr %4, align 8
...
define internal ptr @"TestEither.#let_closure_3571"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
  %d_0 = load ptr, ptr %0, align 8
  %3 = load ptr, ptr %1, align 8
  %4 = getelementptr { ptr, ptr }, ptr %1, i64 0, i32 1
  %5 = load ptr, ptr %4, align 8
...
define internal ptr @"TestEither.#fun_closure_3570"(ptr nocapture nofree readonly %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(1) %1) {
  %3 = load i8, ptr %1, align 8
  %switch = icmp eq i8 %3, 0
  br i1 %switch, label %switch_branch_TestEither.Left_0, label %switch_branch_TestEither.Right_0
...
common.ret:                                       ; preds = %switch_branch_TestEither.Right_0, %switch_branch_TestEither.Left_0
  %common.ret.op = phi ptr [ %11, %switch_branch_TestEither.Left_0 ], [ %26, %switch_branch_TestEither.Right_0 ]
  ret ptr %common.ret.op
...
define internal ptr @"TestEither.#let_closure_3575"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
  %d_0 = load ptr, ptr %0, align 8
  %3 = load ptr, ptr %1, align 8
  %4 = getelementptr { ptr, ptr }, ptr %1, i64 0, i32 1
  %5 = load ptr, ptr %4, align 8
...
define internal ptr @"TestEither.#let_closure_3577"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
  %d_0 = load ptr, ptr %0, align 8
  %3 = load ptr, ptr %1, align 8
  %4 = getelementptr { ptr, ptr }, ptr %1, i64 0, i32 1
  %5 = load ptr, ptr %4, align 8
...
define internal ptr @"TestEither.#fun_closure_3576"(ptr nocapture nofree readonly %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(1) %1) {
  %3 = load i8, ptr %1, align 8
  %switch = icmp eq i8 %3, 0
  br i1 %switch, label %switch_branch_TestEither.Left_0, label %switch_branch_TestEither.Right_0
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"TestEither.#let_closure_3547", ptr %let_func_0.i, align 8
  ...
  store ptr @"TestEither.#fun_closure_3548", ptr %fun_func_0.i, align 8
  ...
  store ptr @"Builtin.addInt32#", ptr %"addInt32#_func_2.i", align 8
  %20 = tail call ptr @malgo_malloc(i64 noundef 16)
  ...
  store ptr @"TestEither.#let_closure_3545", ptr %let_func_0.i.i, align 8
  ...
  %"String#_func_1.i" = getelementptr { ptr, ptr }, ptr %28, i64 0, i32 1
  ...
  %putStr_1.i = getelementptr { ptr, ptr, ptr, ptr }, ptr %let_capture_12.i, i64 0, i32 1
  store ptr %29, ptr %putStr_1.i, align 8
  ...
  %Right_func_1.i = getelementptr { ptr, ptr }, ptr %31, i64 0, i32 1
  store ptr @TestEither.Right, ptr %Right_func_1.i, align 8
  %Right_1.i = getelementptr { ptr, ptr, ptr, ptr }, ptr %let_capture_12.i, i64 0, i32 3
  store ptr %31, ptr %Right_1.i, align 8
  store ptr %let_capture_12.i, ptr %27, align 8
  %let_func_6.i = getelementptr { ptr, ptr }, ptr %27, i64 0, i32 1
  store ptr @"TestEither.#let_closure_3566", ptr %let_func_6.i, align 8
  %32 = tail call ptr @"TestEither.#let_closure_3566"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(32) %let_capture_12.i, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(1) %25)
...
switch_branch_TestEither.Left_4.i:                ; preds = %1
  ...
  store ptr @"TestEither.#let_closure_3569", ptr %let_func_7.i, align 8
  ...
  store ptr @Prelude.putStrLn, ptr %putStrLn_func_4.i, align 8
  ...
  store ptr @Builtin.malgo_int32_t_to_string, ptr %malgo_int32_t_to_string_func_4.i, align 8
...
switch_branch_TestEither.Right_5.i:               ; preds = %1
  ...
  store ptr @"TestEither.#let_closure_3575", ptr %let_func_9.i, align 8
  ...
  store ptr @Prelude.putStrLn, ptr %putStrLn_func_6.i, align 8
  ...
  store ptr @Builtin.malgo_int32_t_to_string, ptr %malgo_int32_t_to_string_func_6.i, align 8
...
TestEither.main.exit:                             ; preds = %switch_branch_TestEither.Left_4.i, %switch_branch_TestEither.Right_5.i
  %.sink.i = phi ptr [ %50, %switch_branch_TestEither.Right_5.i ], [ %40, %switch_branch_TestEither.Left_4.i ]
  %"TestEither.#fun_closure_3576.sink.i" = phi ptr [ @"TestEither.#fun_closure_3576", %switch_branch_TestEither.Right_5.i ], [ @"TestEither.#fun_closure_3570", %switch_branch_TestEither.Left_4.i ]
  %.sink3.i = phi ptr [ %49, %switch_branch_TestEither.Right_5.i ], [ %39, %switch_branch_TestEither.Left_4.i ]
  %let_func_9.sink.i = phi ptr [ %let_func_9.i, %switch_branch_TestEither.Right_5.i ], [ %let_func_7.i, %switch_branch_TestEither.Left_4.i ]
  %fun_func_7.i = getelementptr { ptr, ptr }, ptr %.sink.i, i64 0, i32 1
  store ptr %"TestEither.#fun_closure_3576.sink.i", ptr %fun_func_7.i, align 8
