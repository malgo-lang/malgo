...
define internal ptr @_M4main40test_x2Ftestcases_x2Fmalgo_x2FSeq_x2Emlg8External(ptr %0, ptr %_M20_x24_x5F_x241a_x242b40test_x2Ftestcases_x2Fmalgo_x2FSeq_x2Emlg8Temporal_0) {
...
define internal ptr @_M29let_x2410c5_x5Fclosure_x24e2e40test_x2Ftestcases_x2Fmalgo_x2FSeq_x2Emlg8Internal(ptr %0, ptr %1) {
  %"int32#$10ae_addr_0" = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %"int32#$10ae_0" = load ptr, ptr %"int32#$10ae_addr_0", align 8
  %3 = call ptr @_M25raw_x5Flet_x2410c5_x24e2d40test_x2Ftestcases_x2Fmalgo_x2FSeq_x2Emlg8Temporal(ptr null, ptr %"int32#$10ae_0", ptr %1)
  ret ptr %3
}
...
define internal ptr @_M8addInt3234runtime_x2Fmalgo_x2FBuiltin_x2Emlg8External(ptr %0, ptr %_M17int32_x23_x2410ae34runtime_x2Fmalgo_x2FBuiltin_x2Emlg8Temporal_0) {
  ...
  store ptr @_M29let_x2410c5_x5Fclosure_x24e2e40test_x2Ftestcases_x2Fmalgo_x2FSeq_x2Emlg8Internal, ptr %"let$10c5_func_0", align 8
  ret ptr %2
}

define internal i32 @_M35let_x24715_x24c92_x5Fclosure_x24e2f40test_x2Ftestcases_x2Fmalgo_x2FSeq_x2Emlg8Internal(ptr %0, i32 %1) {
  %"p$10b0$10bd$c75_addr_0" = getelementptr { i32 }, ptr %0, i32 0, i32 0
  %"p$10b0$10bd$c75_0" = load i32, ptr %"p$10b0$10bd$c75_addr_0", align 4
  %3 = call i32 @malgo_add_int32_t(i32 %"p$10b0$10bd$c75_0", i32 %1)
  ret i32 %3
}

define internal ptr @_M25raw_x5Flet_x2410c5_x24e2d40test_x2Ftestcases_x2Fmalgo_x2FSeq_x2Emlg8Temporal(ptr %0, ptr %_M17int32_x23_x2410ae34runtime_x2Fmalgo_x2FBuiltin_x2Emlg8Temporal_0, ptr %_M17int32_x23_x2410af34runtime_x2Fmalgo_x2FBuiltin_x2Emlg8Temporal_0) {
...
"switch_branch_Int32#_1":                         ; preds = %"switch_branch_Int32#_0"
  ...
  %"let$715$c92_capture_0" = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ i32 }, ptr null, i32 1) to i64))
  %"p$10b0$10bd$c75_0" = getelementptr { i32 }, ptr %"let$715$c92_capture_0", i32 0, i32 0
  store i32 %6, ptr %"p$10b0$10bd$c75_0", align 4
  %"let$715$c92_capture_1" = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 0
  store ptr %"let$715$c92_capture_0", ptr %"let$715$c92_capture_1", align 8
  %"let$715$c92_func_0" = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 1
  store ptr @_M35let_x24715_x24c92_x5Fclosure_x24e2f40test_x2Ftestcases_x2Fmalgo_x2FSeq_x2Emlg8Internal, ptr %"let$715$c92_func_0", align 8
