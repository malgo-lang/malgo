...
define internal ptr @"test/testcases/malgo/Punctuate.mlg.#let_closure_3172"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
  %p_0 = load ptr, ptr %0, align 8
  %3 = tail call ptr @malgo_string_append(ptr %p_0, ptr %1)
  ret ptr %3
}

define internal ptr @"test/testcases/malgo/Punctuate.mlg.#let_closure_3174"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
  %p_0 = load ptr, ptr %0, align 8
  %3 = tail call ptr @malgo_string_append(ptr %p_0, ptr %1)
  ret ptr %3
}
...
common.ret:                                       ; preds = %"switch_branch_test/testcases/malgo/Punctuate.mlg.SList_0", %"switch_branch_test/testcases/malgo/Punctuate.mlg.SInt_0", %"switch_branch_test/testcases/malgo/Punctuate.mlg.Symbol_0"
  ...
  %"test/testcases/malgo/Punctuate.mlg.#let_closure_3179.sink" = phi ptr [ @"test/testcases/malgo/Punctuate.mlg.#let_closure_3179", %"switch_branch_test/testcases/malgo/Punctuate.mlg.SList_0" ], [ @"test/testcases/malgo/Punctuate.mlg.#let_closure_3174", %"switch_branch_test/testcases/malgo/Punctuate.mlg.SInt_0" ], [ @"test/testcases/malgo/Punctuate.mlg.#let_closure_3172", %"switch_branch_test/testcases/malgo/Punctuate.mlg.Symbol_0" ]
  ...
  store ptr %"test/testcases/malgo/Punctuate.mlg.#let_closure_3179.sink", ptr %let_func_3, align 8
...
"switch_branch_test/testcases/malgo/Punctuate.mlg.SList_0": ; preds = %1
  ...
  store ptr @str3177, ptr %35, align 8
  ...
  %39 = tail call ptr @malgo_string_append(ptr %p_0.i2, ptr noundef nonnull @str3177)
...
define internal ptr @"test/testcases/malgo/Punctuate.mlg.#let_closure_3181"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
  %p_0 = load ptr, ptr %0, align 8
...
common.ret1:                                      ; preds = %0, %"switch_branch_runtime/malgo/Prelude.mlg.Cons_0"
  %.sink = phi ptr [ %14, %"switch_branch_runtime/malgo/Prelude.mlg.Cons_0" ], [ @str3180, %0 ]
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @str3183, ptr %8, align 8
  %9 = tail call ptr @malgo_malloc(i64 noundef 16)
  ...
  store i8 0, ptr %11, align 1
  %12 = getelementptr { i8, { ptr } }, ptr %11, i64 0, i32 1, i32 0
  store ptr @str3184, ptr %12, align 8
  %13 = tail call ptr @malgo_malloc(i64 noundef 16)
