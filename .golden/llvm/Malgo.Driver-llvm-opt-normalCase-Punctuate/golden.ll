; ModuleID = './test/tmp/malgo_test/normal/Punctuate.ll'
...
common.ret:                                       ; preds = %switch_branch_Punctuate.SList_0, %switch_branch_Punctuate.SInt_0, %switch_branch_Punctuate.Symbol_0
  %.sink = phi ptr [ %43, %switch_branch_Punctuate.SList_0 ], [ %23, %switch_branch_Punctuate.SInt_0 ], [ %9, %switch_branch_Punctuate.Symbol_0 ]
  ...
  %.sink7 = phi ptr [ %39, %switch_branch_Punctuate.SList_0 ], [ %19, %switch_branch_Punctuate.SInt_0 ], [ %8, %switch_branch_Punctuate.Symbol_0 ]
...
switch_branch_Punctuate.SList_0:                  ; preds = %1
  ...
  store ptr @str3178, ptr %35, align 8
  ...
  %39 = tail call ptr @malgo_string_append(ptr %p_0.i2, ptr noundef nonnull @str3178)
...
define internal ptr @"Punctuate.#let_closure_3185"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
  %p_0 = load ptr, ptr %0, align 8
  ...
  store ptr @"Punctuate.#let_closure_3170", ptr %let_func_0.i.i, align 8
...
common.ret1:                                      ; preds = %0, %switch_branch_Prelude.Cons_0
  %.sink = phi ptr [ %14, %switch_branch_Prelude.Cons_0 ], [ @str3184, %0 ]
