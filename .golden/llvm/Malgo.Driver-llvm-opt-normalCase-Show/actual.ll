; ModuleID = './test/tmp/malgo_test/normal/Show.ll'
...
define internal ptr @"Show.#let_closure_3223"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
  %p_0 = load ptr, ptr %0, align 8
  %3 = tail call ptr @malgo_string_append(ptr %p_0, ptr %1)
  ret ptr %3
}

define internal noundef ptr @"Show.#let_closure_3229"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 8 %1) {
  ...
  store ptr @"Show.#let_closure_3235", ptr %let_func_0.i.i, align 8
...
define internal noundef ptr @"Show.#let_closure_3230"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 8 %1) {
  %d_0 = load ptr, ptr %0, align 8
  %3 = getelementptr i8, ptr %d_0, i64 8
  %d_0.val = load ptr, ptr %3, align 8
  %4 = getelementptr i8, ptr %1, i64 8
...
define internal noundef ptr @"Show.#let_closure_3231"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 8 %1) {
  %d_0 = load ptr, ptr %0, align 8
  %3 = getelementptr i8, ptr %d_0, i64 8
  %d_0.val = load ptr, ptr %3, align 8
  %4 = getelementptr i8, ptr %1, i64 8
...
define internal noundef ptr @"Show.#let_closure_3232"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 8 %1) {
  %d_0 = load ptr, ptr %0, align 8
  %3 = getelementptr i8, ptr %d_0, i64 8
  %d_0.val = load ptr, ptr %3, align 8
  %4 = getelementptr i8, ptr %1, i64 8
...
define internal ptr @"Show.#let_closure_3233"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
  %cast_0 = load ptr, ptr %0, align 8
  %3 = tail call ptr @malgo_hash_table_get(ptr %cast_0, ptr noundef nonnull @str3222)
...
define internal noundef ptr @"Show.#fun_closure_3234"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %0, ptr nocapture nofree readonly align 8 %1) {
  ...
  %7 = tail call ptr @malgo_hash_table_get(ptr %showDictA_0, ptr noundef nonnull @str3222)
  ...
  %14 = tail call ptr @malgo_hash_table_get(ptr %showDictB_0, ptr noundef nonnull @str3222)
  ...
  store ptr @"Show.#let_closure_3229", ptr %let_func_0.i, align 8
  ...
  store ptr @"Show.#let_closure_3223", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"Show.#let_closure_3230", ptr %let_func_1.i, align 8
  ...
  store ptr @"Show.#let_closure_3223", ptr %let_func_0.i9.i, align 8
  ...
  store ptr @"Show.#let_closure_3231", ptr %let_func_2.i, align 8
  ...
  store ptr @"Show.#let_closure_3223", ptr %let_func_0.i11.i, align 8
  ...
  store ptr @"Show.#let_closure_3232", ptr %let_func_3.i, align 8
  ...
  store ptr @"Show.#let_closure_3223", ptr %let_func_0.i13.i, align 8
...
define internal ptr @"Show.#let_closure_3235"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"Show.#fun_closure_3240", ptr %fun_func_0.i, align 8
  %3 = tail call ptr @malgo_hash_table_new()
  tail call void @malgo_hash_table_insert(ptr %3, ptr noundef nonnull @str3222, ptr noundef nonnull %2)
  ...
  store ptr @"Show.#fun_closure_3234", ptr %fun_func_0.i.i, align 8
  %7 = tail call ptr @malgo_hash_table_new()
  tail call void @malgo_hash_table_insert(ptr %7, ptr noundef nonnull @str3222, ptr noundef nonnull %6)
  ...
  store ptr @"Show.#let_closure_3233", ptr %let_func_0.i, align 8
...
define internal noundef ptr @"Show.#fun_closure_3240"(ptr nocapture nofree readnone %0, ptr nocapture nofree readonly align 4 %1) {
