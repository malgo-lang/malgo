...
define internal noundef ptr @"test/testcases/malgo/Show.mlg.#fun_closure_3221"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %0, ptr nocapture nofree readonly align 8 %1) {
  ...
  store ptr @str3228, ptr %6, align 8
  %7 = tail call ptr @malgo_hash_table_get(ptr %showDictA_0, ptr noundef nonnull @str3220)
  ...
  store ptr @str3229, ptr %13, align 8
  %14 = tail call ptr @malgo_hash_table_get(ptr %showDictB_0, ptr noundef nonnull @str3220)
  ...
  store ptr @str3230, ptr %20, align 8
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_3231", ptr %let_func_0.i, align 8
  ...
  store ptr %.val.i, ptr %let_capture_0.i.i, align 8
  store ptr %let_capture_0.i.i, ptr %23, align 8
  %let_func_0.i.i = getelementptr { ptr, ptr }, ptr %23, i64 0, i32 1
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_3227", ptr %let_func_0.i.i, align 8
  %24 = tail call ptr @malgo_string_append(ptr %.val.i, ptr %.val1.i)
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_3232", ptr %let_func_1.i, align 8
  ...
  store ptr %.val2.i, ptr %let_capture_0.i8.i, align 8
  store ptr %let_capture_0.i8.i, ptr %28, align 8
  %let_func_0.i9.i = getelementptr { ptr, ptr }, ptr %28, i64 0, i32 1
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_3227", ptr %let_func_0.i9.i, align 8
  %29 = tail call ptr @malgo_string_append(ptr %.val2.i, ptr %.val3.i)
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_3233", ptr %let_func_2.i, align 8
  ...
  store ptr %.val4.i, ptr %let_capture_0.i10.i, align 8
  store ptr %let_capture_0.i10.i, ptr %34, align 8
  %let_func_0.i11.i = getelementptr { ptr, ptr }, ptr %34, i64 0, i32 1
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_3227", ptr %let_func_0.i11.i, align 8
  %35 = tail call ptr @malgo_string_append(ptr %.val4.i, ptr %.val5.i)
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_3234", ptr %let_func_3.i, align 8
  ...
  store ptr %.val6.i, ptr %let_capture_0.i12.i, align 8
  store ptr %let_capture_0.i12.i, ptr %39, align 8
  %let_func_0.i13.i = getelementptr { ptr, ptr }, ptr %39, i64 0, i32 1
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_3227", ptr %let_func_0.i13.i, align 8
  %40 = tail call ptr @malgo_string_append(ptr %.val6.i, ptr %.val7.i)
...
define internal ptr @"test/testcases/malgo/Show.mlg.#let_closure_3223"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
  %x_0 = load ptr, ptr %0, align 8
  %3 = tail call ptr @malgo_string_append(ptr %x_0, ptr %1)
  ret ptr %3
}

define internal ptr @"test/testcases/malgo/Show.mlg.#let_closure_3227"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
  %p_0 = load ptr, ptr %0, align 8
  %3 = tail call ptr @malgo_string_append(ptr %p_0, ptr %1)
  ret ptr %3
}

define internal noundef ptr @"test/testcases/malgo/Show.mlg.#let_closure_3231"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 8 %1) {
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_3223", ptr %let_func_0.i.i, align 8
...
define internal noundef ptr @"test/testcases/malgo/Show.mlg.#let_closure_3232"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 8 %1) {
  %d_0 = load ptr, ptr %0, align 8
  %3 = getelementptr i8, ptr %d_0, i64 8
  %d_0.val = load ptr, ptr %3, align 8
  %4 = getelementptr i8, ptr %1, i64 8
...
define internal noundef ptr @"test/testcases/malgo/Show.mlg.#let_closure_3233"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 8 %1) {
  %d_0 = load ptr, ptr %0, align 8
  %3 = getelementptr i8, ptr %d_0, i64 8
  %d_0.val = load ptr, ptr %3, align 8
  %4 = getelementptr i8, ptr %1, i64 8
...
define internal noundef ptr @"test/testcases/malgo/Show.mlg.#let_closure_3234"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 8 %1) {
  %d_0 = load ptr, ptr %0, align 8
  %3 = getelementptr i8, ptr %d_0, i64 8
  %d_0.val = load ptr, ptr %3, align 8
  %4 = getelementptr i8, ptr %1, i64 8
...
define internal ptr @"test/testcases/malgo/Show.mlg.#let_closure_3235"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
  %cast_0 = load ptr, ptr %0, align 8
  %3 = tail call ptr @malgo_hash_table_get(ptr %cast_0, ptr noundef nonnull @str3220)
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#fun_closure_3240", ptr %fun_func_0.i, align 8
  %3 = tail call ptr @malgo_hash_table_new()
  tail call void @malgo_hash_table_insert(ptr %3, ptr noundef nonnull @str3220, ptr noundef nonnull %2)
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#fun_closure_3221", ptr %fun_func_0.i.i, align 8
  %7 = tail call ptr @malgo_hash_table_new()
  tail call void @malgo_hash_table_insert(ptr %7, ptr noundef nonnull @str3220, ptr noundef nonnull %6)
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_3235", ptr %let_func_0.i, align 8
...
define internal noundef ptr @"test/testcases/malgo/Show.mlg.#fun_closure_3240"(ptr nocapture nofree readnone %0, ptr nocapture nofree readonly align 4 %1) {
