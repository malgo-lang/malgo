; ModuleID = '/workspaces/malgo/.malgo-work/test/testcases/malgo/Echo.ll'
...
define internal ptr @Builtin.malgo_get_contents(ptr nocapture nofree readnone %0, ptr %"Builtin.$p_2166_0") {
  %2 = tail call ptr @malgo_get_contents(ptr %"Builtin.$p_2166_0")
  ret ptr %2
}
...
define internal noundef ptr @Builtin.getContents(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %"Builtin.$__3361_0") {
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @Builtin.getContents, ptr %getContents_func_0.i, align 8
  ...
  store ptr @Builtin.malgo_get_contents, ptr %malgo_get_contents_func_0.i.i, align 8
