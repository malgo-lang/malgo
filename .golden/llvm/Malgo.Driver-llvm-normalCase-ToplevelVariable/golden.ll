...
define internal i32 @"ToplevelVariable.#let_closure_3100"(ptr %0, i32 %1) {
  %p_addr_0 = getelementptr { i32 }, ptr %0, i32 0, i32 0
  %p_0 = load i32, ptr %p_addr_0, align 4
  %3 = call i32 @"ToplevelVariable.$raw_let_3095"(ptr null, i32 %p_0, i32 %1)
  ret i32 %3
}
...
"switch_branch_Builtin.Int32#_1":                 ; preds = %"switch_branch_Builtin.Int32#_0"
  ...
  store ptr @"ToplevelVariable.#let_closure_3100", ptr %let_func_0, align 8
...
define internal ptr @"ToplevelVariable.#let_closure_3101"(ptr %0, ptr %1) {
  %cast_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %cast_0 = load ptr, ptr %cast_addr_0, align 8
  %3 = call ptr @"ToplevelVariable.$raw_let_3094"(ptr null, ptr %cast_0, ptr %1)
  ret ptr %3
}
...
define internal ptr @ToplevelVariable.constId(ptr %0, ptr %"ToplevelVariable.$eta_87_0") {
  ...
  store ptr @"ToplevelVariable.#let_closure_3101", ptr %let_func_0, align 8
...
define internal ptr @"ToplevelVariable.$raw_let_3098"(ptr %0, ptr %"ToplevelVariable.$cast_2944_0", ptr %"ToplevelVariable.$__2969_0") {
  ret ptr %"ToplevelVariable.$cast_2944_0"
}

define internal ptr @"ToplevelVariable.$raw_let_3099"(ptr %0, ptr %"ToplevelVariable.$cast_2944_0", ptr %"ToplevelVariable.$__2981_0") {
  ret ptr %"ToplevelVariable.$cast_2944_0"
}

define internal ptr @"ToplevelVariable.$raw_let_3096"(ptr %0, ptr %"ToplevelVariable.$cast_2944_0", ptr %"ToplevelVariable.$__2957_0") {
  ret ptr %"ToplevelVariable.$cast_2944_0"
}

define internal ptr @"ToplevelVariable.$raw_let_3097"(ptr %0, ptr %"ToplevelVariable.$cast_2944_0", ptr %"ToplevelVariable.$__2957_0") {
  ret ptr %"ToplevelVariable.$cast_2944_0"
}

define internal ptr @"ToplevelVariable.$raw_let_3094"(ptr %0, ptr %"ToplevelVariable.$cast_84_0", ptr %"ToplevelVariable.$__2907_0") {
...
define internal ptr @"ToplevelVariable.#let_closure_3102"(ptr %0, ptr %1) {
  %a_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %a_0 = load ptr, ptr %a_addr_0, align 8
  %3 = call ptr @"ToplevelVariable.$raw_let_3093"(ptr null, ptr %a_0, ptr %1)
  ret ptr %3
}
...
define internal ptr @Prelude.const(ptr %0, ptr %"Prelude.$a_956_0") {
  ...
  store ptr @"ToplevelVariable.#let_closure_3102", ptr %let_func_0, align 8
  ret ptr %2
}

define internal ptr @"ToplevelVariable.#let_closure_3104"(ptr %0, ptr %1) {
  %cast_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %cast_0 = load ptr, ptr %cast_addr_0, align 8
  %3 = call ptr @"ToplevelVariable.$raw_let_3096"(ptr null, ptr %cast_0, ptr %1)
  ret ptr %3
}

define internal i32 @"ToplevelVariable.#let_closure_3105"(ptr %0, i32 %1) {
  %p_addr_0 = getelementptr { i32 }, ptr %0, i32 0, i32 0
  %p_0 = load i32, ptr %p_addr_0, align 4
...
define internal ptr @"ToplevelVariable.#let_closure_3106"(ptr %0, ptr %1) {
  %cast_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %cast_0 = load ptr, ptr %cast_addr_0, align 8
  %3 = call ptr @"ToplevelVariable.$raw_let_3098"(ptr null, ptr %cast_0, ptr %1)
  ret ptr %3
}

define internal i32 @"ToplevelVariable.#let_closure_3107"(ptr %0, i32 %1) {
  %p_addr_0 = getelementptr { i32 }, ptr %0, i32 0, i32 0
  %p_0 = load i32, ptr %p_addr_0, align 4
  %3 = call i32 @"Builtin.$addInt32#_curry_4032"(ptr null, i32 %p_0, i32 %1)
  ret i32 %3
...
"switch_branch_Builtin.String#_0":                ; preds = %switch_branch_Prelude.Nothing_0
  ...
  store ptr @"ToplevelVariable.#let_closure_3104", ptr %let_func_0, align 8
...
"switch_branch_Builtin.Int32#_1":                 ; preds = %"switch_branch_Builtin.Int32#_0"
  ...
  store ptr @"ToplevelVariable.#let_closure_3105", ptr %let_func_1, align 8
...
switch_branch_Prelude.Just_0:                     ; preds = %1
  ...
  store ptr @"ToplevelVariable.#let_closure_3106", ptr %let_func_2, align 8
...
"switch_branch_Builtin.Int32#_4":                 ; preds = %"switch_branch_Builtin.Int32#_3"
  ...
  store ptr @"ToplevelVariable.#let_closure_3107", ptr %let_func_3, align 8
...
define internal i32 @"ToplevelVariable.$raw_let_3095"(ptr %0, i32 %"ToplevelVariable.$p_2920_0", i32 %"ToplevelVariable.$y_2929_0") {
  %2 = call ptr @Builtin.malgo_add_int32_t(ptr null, i32 %"ToplevelVariable.$p_2920_0")
  %3 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 0
  %4 = load ptr, ptr %3, align 8
  %5 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  %6 = load ptr, ptr %5, align 8
  %7 = call i32 %6(ptr %4, i32 %"ToplevelVariable.$y_2929_0")
  ret i32 %7
}

define internal ptr @"ToplevelVariable.$raw_let_3093"(ptr %0, ptr %"Prelude.$a_956_0", ptr %"Prelude.$__957_0") {
  ret ptr %"Prelude.$a_956_0"
}

define internal i32 @"ToplevelVariable.#let_closure_3108"(ptr %0, i32 %1) {
  %p_addr_0 = getelementptr { i32 }, ptr %0, i32 0, i32 0
  %p_0 = load i32, ptr %p_addr_0, align 4
...
define internal ptr @Builtin.malgo_add_int32_t(ptr %0, i32 %"Builtin.$p_1808_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"ToplevelVariable.#let_closure_3108", ptr %let_func_0, align 8
  ret ptr %2
}
