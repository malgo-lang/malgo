...
define internal ptr @"test/testcases/malgo/TestPolySynonym.mlg.#let_closure_3469"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @str3466, ptr %6, align 8
  %7 = tail call ptr @malgo_hash_table_new()
  tail call void @malgo_hash_table_insert(ptr %7, ptr noundef nonnull @str3467, ptr noundef nonnull %5)
  tail call void @malgo_hash_table_insert(ptr %7, ptr noundef nonnull @str3468, ptr noundef nonnull %3)
  %8 = tail call ptr @malgo_hash_table_get(ptr %7, ptr noundef nonnull @str3467)
  %9 = tail call ptr @malgo_hash_table_get(ptr %7, ptr noundef nonnull @str3468)
  ...
  store ptr @"test/testcases/malgo/TestPolySynonym.mlg.#let_closure_3469", ptr %let_func_0.i, align 8
