...
define internal ptr @"test/testcases/malgo/TypeSynonym.mlg.#let_closure_2860"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define internal ptr @"test/testcases/malgo/TypeSynonym.mlg.#fun_closure_2861"(ptr nocapture nofree readnone %0, ptr nocapture nofree readonly align 8 %1) {
"switch_branch_Tuple#_0":
  %2 = getelementptr { i8, { ptr, ptr } }, ptr %1, i64 0, i32 1
  %3 = load ptr, ptr %2, align 8
  %4 = getelementptr { i8, { ptr, ptr } }, ptr %1, i64 0, i32 1, i32 1
  %5 = load ptr, ptr %4, align 8
  %6 = getelementptr { i8, { ptr } }, ptr %3, i64 0, i32 1
  %7 = load ptr, ptr %6, align 8
  %8 = tail call ptr @malgo_print_string(ptr %7)
  %9 = tail call ptr @malgo_malloc(i64 noundef 16)
  store i8 0, ptr %9, align 1
  %10 = getelementptr { i8, { ptr } }, ptr %9, i64 0, i32 1, i32 0
  store ptr @str2862, ptr %10, align 8
  %11 = tail call ptr @malgo_print_string(ptr noundef nonnull @str2862)
  %12 = getelementptr { i8, { ptr } }, ptr %5, i64 0, i32 1
  %13 = load ptr, ptr %12, align 8
  %14 = tail call ptr @malgo_print_string(ptr %13)
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @str2868, ptr %5, align 8
  ...
  store ptr @"test/testcases/malgo/TypeSynonym.mlg.#let_closure_2860", ptr %let_func_0.i, align 8
  ...
  store ptr @"test/testcases/malgo/TypeSynonym.mlg.#fun_closure_2861", ptr %fun_func_0.i, align 8
