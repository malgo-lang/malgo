...
define internal ptr @"test/testcases/malgo/Null.mlg.#let_closure_247"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define internal ptr @"test/testcases/malgo/Null.mlg.#fun_closure_248"(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %1) {
...
"switch_branch_test/testcases/malgo/Null.mlg.False_0.i": ; preds = %2
  ...
  br label %"test/testcases/malgo/Null.mlg.$raw_fun_236.exit"
...
"test/testcases/malgo/Null.mlg.$raw_fun_236.exit": ; preds = %"switch_branch_test/testcases/malgo/Null.mlg.False_0.i", %"switch_branch_test/testcases/malgo/Null.mlg.True_0.i"
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/Null.mlg.#let_closure_247", ptr %let_func_3.i, align 8
  ...
  store ptr @"test/testcases/malgo/Null.mlg.#fun_closure_248", ptr %fun_func_3.i, align 8
