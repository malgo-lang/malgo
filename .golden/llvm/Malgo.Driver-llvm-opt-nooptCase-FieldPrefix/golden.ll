; ModuleID = './test/tmp/malgo_test/noopt/FieldPrefix.ll'
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  tail call void @malgo_hash_table_insert(ptr %10, ptr noundef nonnull @str149, ptr noundef nonnull %4)
  tail call void @malgo_hash_table_insert(ptr %10, ptr noundef nonnull @str150, ptr noundef nonnull %6)
  ...
  tail call void @malgo_hash_table_insert(ptr %15, ptr noundef nonnull @str149, ptr noundef nonnull %11)
  tail call void @malgo_hash_table_insert(ptr %15, ptr noundef nonnull @str150, ptr noundef nonnull %13)
  store ptr %15, ptr @FieldPrefix.zero2D, align 8
  %16 = tail call ptr @malgo_malloc(i64 noundef 1)
  store i8 0, ptr %16, align 1
  %17 = load ptr, ptr @FieldPrefix.zero2D, align 8
  %18 = tail call ptr @malgo_hash_table_get(ptr %17, ptr noundef nonnull @str149)
  %19 = tail call ptr @malgo_hash_table_get(ptr %17, ptr noundef nonnull @str150)
  %20 = getelementptr i8, ptr %18, i64 4
  %.val.i.i = load i32, ptr %20, align 4
  %21 = tail call ptr @malgo_int32_t_to_string(i32 %.val.i.i)
  ...
  store ptr @str151, ptr %26, align 8
  %27 = tail call ptr @malgo_print_string(ptr noundef nonnull @str151)
  %28 = getelementptr i8, ptr %19, i64 4
  %.val1.i.i = load i32, ptr %28, align 4
  %29 = tail call ptr @malgo_int32_t_to_string(i32 %.val1.i.i)
