...
define internal ptr @"With.$raw_fun_2996"(ptr %0, ptr %"With.$tuple_116_0") {
...
"switch_branch_Tuple#_0":                         ; preds = %1
  ...
  store ptr @str3028, ptr %6, align 8
...
define internal ptr @"With.#fun_closure_3029"(ptr %0, ptr %1) {
  %3 = call ptr @"With.$raw_fun_3026"(ptr null, ptr %1)
  ret ptr %3
}

define internal ptr @"With.$raw_fun_3027"(ptr %0, ptr %"With.$$__125_0") {
  ...
  store ptr @"With.#fun_closure_3029", ptr %fun_func_0, align 8
...
define internal ptr @"With.#let_closure_3031"(ptr %0, ptr %1) {
  %d_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %d_0 = load ptr, ptr %d_addr_0, align 8
  %3 = call ptr @"With.$raw_let_3024"(ptr null, ptr %d_0, ptr %1)
  ret ptr %3
}

define internal ptr @"With.#fun_closure_3032"(ptr %0, ptr %1) {
  %3 = call ptr @"With.$raw_fun_3025"(ptr null, ptr %1)
  ret ptr %3
}

define internal ptr @"With.$raw_fun_3026"(ptr %0, ptr %"With.$$__126_0") {
  ...
  store ptr @"With.#let_closure_3031", ptr %let_func_0, align 8
  ...
  store ptr @"With.#fun_closure_3032", ptr %fun_func_0, align 8
...
define internal ptr @"With.$raw_let_3012"(ptr %0, ptr %"With.$cast_122_0", ptr %"With.$k_2938_0") {
  %2 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ i8, {} }, ptr null, i32 1) to i64))
  %3 = getelementptr { i8, {} }, ptr %2, i32 0, i32 0
  store i8 0, ptr %3, align 1
  %4 = getelementptr { ptr, ptr }, ptr %"With.$k_2938_0", i32 0, i32 0
  %5 = load ptr, ptr %4, align 8
  %6 = getelementptr { ptr, ptr }, ptr %"With.$k_2938_0", i32 0, i32 1
...
define internal ptr @"With.$raw_fun_3025"(ptr %0, ptr %"With.$x_131_0") {
...
define internal ptr @"With.#let_closure_3033"(ptr %0, ptr %1) {
  %str_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %str_0 = load ptr, ptr %str_addr_0, align 8
  %3 = call ptr @"With.$raw_let_2963"(ptr null, ptr %str_0, ptr %1)
  ret ptr %3
}
...
define internal ptr @With.printAndReturn(ptr %0, ptr %"With.$str_87_0") {
  ...
  store ptr @"With.#let_closure_3033", ptr %let_func_0, align 8
  ret ptr %2
}

define internal ptr @"With.#let_closure_3034"(ptr %0, ptr %1) {
  %finalizer_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %finalizer_0 = load ptr, ptr %finalizer_addr_0, align 8
  %3 = call ptr @"With.$raw_let_2964"(ptr null, ptr %finalizer_0, ptr %1)
  ret ptr %3
}
...
define internal ptr @With.finally(ptr %0, ptr %"With.$finalizer_99_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"With.#let_closure_3034", ptr %let_func_0, align 8
  ret ptr %2
}
...
define internal ptr @"With.$raw_let_3024"(ptr %0, ptr %"With.$d_127_0", ptr %"With.$k_2941_0") {
...
"switch_branch_Builtin.String#_0":                ; preds = %1
  ...
  %6 = load ptr, ptr %5, align 8
  %7 = call ptr @malgo_print_string(ptr %6)
  %8 = getelementptr { ptr, ptr }, ptr %"With.$k_2941_0", i32 0, i32 0
  %9 = load ptr, ptr %8, align 8
  %10 = getelementptr { ptr, ptr }, ptr %"With.$k_2941_0", i32 0, i32 1
  %11 = load ptr, ptr %10, align 8
...
define internal ptr @"With.$raw_let_2963"(ptr %0, ptr %"With.$str_87_0", ptr %"With.$k_88_0") {
...
define internal ptr @"With.$raw_let_2964"(ptr %0, ptr %"With.$finalizer_99_0", ptr %"With.$k_100_0") {
  %2 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ i8, {} }, ptr null, i32 1) to i64))
  %3 = getelementptr { i8, {} }, ptr %2, i32 0, i32 0
  store i8 0, ptr %3, align 1
...
define internal ptr @"With.#fun_closure_3035"(ptr %0, ptr %1) {
  %3 = call ptr @"With.$raw_fun_2996"(ptr null, ptr %1)
  ret ptr %3
}

define internal ptr @"With.#let_closure_3036"(ptr %0, ptr %1) {
  %cast_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %cast_0 = load ptr, ptr %cast_addr_0, align 8
  %3 = call ptr @"With.$raw_let_3012"(ptr null, ptr %cast_0, ptr %1)
  ret ptr %3
}

define internal ptr @"With.#fun_closure_3037"(ptr %0, ptr %1) {
  %3 = call ptr @"With.$raw_fun_3027"(ptr null, ptr %1)
  ret ptr %3
}
...
define internal ptr @With.main(ptr %0, ptr %"With.$$__115_0") {
  ...
  store ptr %fun_capture_0, ptr %fun_capture_1, align 8
  %fun_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"With.#fun_closure_3035", ptr %fun_func_0, align 8
  ...
  store ptr @"With.#let_closure_3036", ptr %let_func_0, align 8
  ...
  store ptr @"With.#fun_closure_3037", ptr %fun_func_1, align 8
