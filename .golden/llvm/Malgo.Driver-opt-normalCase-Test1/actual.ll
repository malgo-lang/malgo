...
define internal ptr @_M14let_x5Fclosure42test_x2Ftestcases_x2Fmalgo_x2FTest1_x2Emlg11Internal100(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
  ...
  %d_0.i = getelementptr { ptr, ptr }, ptr %let_capture_0.i, i64 0, i32 1
  store ptr %d_0, ptr %d_0.i, align 8
  store ptr %let_capture_0.i, ptr %3, align 8
  %let_func_0.i = getelementptr { ptr, ptr }, ptr %3, i64 0, i32 1
  store ptr @_M14let_x5Fclosure42test_x2Ftestcases_x2Fmalgo_x2FTest1_x2Emlg11Internal107, ptr %let_func_0.i, align 8
  ret ptr %3
}

define internal ptr @_M14fun_x5Fclosure42test_x2Ftestcases_x2Fmalgo_x2FTest1_x2Emlg11Internal101(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %1) {
  %3 = tail call ptr @malgo_print_string(ptr noundef nonnull @str102)
  ret ptr %3
}

define internal ptr @_M14fun_x5Fclosure42test_x2Ftestcases_x2Fmalgo_x2FTest1_x2Emlg11Internal103(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %1) {
  %3 = tail call ptr @malgo_print_string(ptr noundef nonnull @str104)
  ret ptr %3
}

define internal ptr @_M14let_x5Fclosure42test_x2Ftestcases_x2Fmalgo_x2FTest1_x2Emlg11Internal107(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %0, ptr nocapture nofree readonly %1) {
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @_M14let_x5Fclosure42test_x2Ftestcases_x2Fmalgo_x2FTest1_x2Emlg11Internal100, ptr %let_func_0.i, align 8
  ...
  store ptr @_M14fun_x5Fclosure42test_x2Ftestcases_x2Fmalgo_x2FTest1_x2Emlg11Internal101, ptr %fun_func_0.i, align 8
  ...
  store ptr @_M14fun_x5Fclosure42test_x2Ftestcases_x2Fmalgo_x2FTest1_x2Emlg11Internal103, ptr %fun_func_1.i, align 8
