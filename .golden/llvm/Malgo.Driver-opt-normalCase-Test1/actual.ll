...
define internal ptr @"test/testcases/malgo/Test1.mlg.#let_closure_100"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
...
define internal ptr @"test/testcases/malgo/Test1.mlg.#fun_closure_101"(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %1) {
  %3 = tail call ptr @malgo_print_string(ptr noundef nonnull @str102)
  ret ptr %3
}

define internal ptr @"test/testcases/malgo/Test1.mlg.#fun_closure_103"(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %1) {
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/Test1.mlg.#let_closure_100", ptr %let_func_0.i, align 8
  ...
  store ptr @"test/testcases/malgo/Test1.mlg.#fun_closure_101", ptr %fun_func_0.i, align 8
  ...
  store ptr @"test/testcases/malgo/Test1.mlg.#fun_closure_103", ptr %fun_func_1.i, align 8
