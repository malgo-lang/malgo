; ModuleID = './test/tmp/malgo_test/aggressive/EvenOdd.ll'
...
define internal noundef ptr @"EvenOdd.#let_closure_4774"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  ...
  store ptr @"EvenOdd.#let_closure_4784", ptr %let_func_0.i, align 8
...
define internal i32 @"EvenOdd.#let_closure_4781"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  %p_0 = load i32, ptr %0, align 4
  %3 = tail call i32 @malgo_sub_int32_t(i32 %p_0, i32 %1)
  ret i32 %3
}

define internal noundef ptr @"EvenOdd.#let_closure_4782"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  ...
  store ptr @"EvenOdd.#let_closure_4785", ptr %let_func_0.i.i, align 8
...
define internal noundef ptr @"EvenOdd.#let_closure_4783"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  %d_0 = load ptr, ptr %0, align 8
  %3 = getelementptr i8, ptr %d_0, i64 4
  %d_0.val = load i32, ptr %3, align 4
  %4 = getelementptr i8, ptr %1, i64 4
  ...
  store ptr %let_capture_0.i, ptr %5, align 8
  %let_func_0.i = getelementptr { ptr, ptr }, ptr %5, i64 0, i32 1
  store ptr @"EvenOdd.#let_closure_4791", ptr %let_func_0.i, align 8
...
define internal i32 @"EvenOdd.#let_closure_4784"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  %p_0 = load i32, ptr %0, align 4
  %3 = tail call i32 @malgo_sub_int32_t(i32 %p_0, i32 %1)
  ret i32 %3
}

define internal i32 @"EvenOdd.#let_closure_4785"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  %x_0 = load i32, ptr %0, align 4
  %3 = tail call i32 @malgo_sub_int32_t(i32 %x_0, i32 %1)
  ret i32 %3
}

define internal i32 @"EvenOdd.#let_closure_4786"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  %p_0 = load i32, ptr %0, align 4
  ...
  store ptr @"EvenOdd.#let_closure_4790", ptr %let_func_0.i.i, align 8
  %p_0.i.i = load i32, ptr %let_capture_0.i.i, align 4
  %4 = tail call i32 @malgo_sub_int32_t(i32 %p_0.i.i, i32 %1)
  ret i32 %4
}

define internal i32 @"EvenOdd.#let_closure_4787"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  %p_0 = load i32, ptr %0, align 4
  %3 = tail call i32 @malgo_sub_int32_t(i32 %p_0, i32 %1)
  ret i32 %3
}

define internal noundef ptr @"EvenOdd.#let_closure_4788"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  %d_0 = load ptr, ptr %0, align 8
  %3 = getelementptr i8, ptr %d_0, i64 4
  %d_0.val = load i32, ptr %3, align 4
  %4 = getelementptr i8, ptr %1, i64 4
...
define internal noundef ptr @"EvenOdd.#let_closure_4789"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  %d_0 = load ptr, ptr %0, align 8
  %3 = getelementptr i8, ptr %d_0, i64 4
  %d_0.val = load i32, ptr %3, align 4
  %4 = getelementptr i8, ptr %1, i64 4
...
define internal i32 @"EvenOdd.#let_closure_4790"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  %p_0 = load i32, ptr %0, align 4
  %3 = tail call i32 @malgo_sub_int32_t(i32 %p_0, i32 %1)
  ret i32 %3
}

define internal i32 @"EvenOdd.#let_closure_4791"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  %p_0 = load i32, ptr %0, align 4
  %3 = tail call i32 @malgo_sub_int32_t(i32 %p_0, i32 %1)
  ret i32 %3
}
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"EvenOdd.#let_closure_4781", ptr %let_func_0.i, align 8
  %p_0.i.i = load i32, ptr %let_capture_0.i, align 4
  ...
  br i1 %cond1.i, label %EvenOdd.main.exit, label %switch-unboxed_default_1.i
...
switch-unboxed_default_1.i:                       ; preds = %1
  ...
  br i1 %cond2.i, label %EvenOdd.main.exit, label %switch-unboxed_default_2.i
...
switch-unboxed_default_2.i:                       ; preds = %switch-unboxed_default_1.i
  ...
  store ptr @"EvenOdd.#let_closure_4782", ptr %let_func_1.i, align 8
  ...
  store ptr @"EvenOdd.#let_closure_4791", ptr %let_func_0.i4.i, align 8
  ...
  br i1 %cond3.i, label %EvenOdd.main.exit, label %switch-unboxed_default_3.i
...
switch-unboxed_default_3.i:                       ; preds = %switch-unboxed_default_2.i
  ...
  store ptr @"EvenOdd.#let_closure_4783", ptr %let_func_2.i, align 8
  ...
  br i1 %cond4.i, label %EvenOdd.main.exit, label %switch-unboxed_default_4.i
...
switch-unboxed_default_4.i:                       ; preds = %switch-unboxed_default_3.i
  ...
  store ptr @"EvenOdd.#let_closure_4774", ptr %let_func_0.i6.i, align 8
  ...
  br i1 %cond6.i.i, label %EvenOdd.main.exit, label %switch-unboxed_default_0.i.i
...
switch-unboxed_default_0.i.i:                     ; preds = %switch-unboxed_default_4.i, %switch-unboxed_default_5.i.i
  ...
  store ptr @"EvenOdd.#let_closure_4786", ptr %let_func_0.i8.i, align 8
  ...
  br i1 %cond1.i.i, label %EvenOdd.main.exit, label %switch-unboxed_default_1.i.i
...
switch-unboxed_default_1.i.i:                     ; preds = %switch-unboxed_default_0.i.i
  ...
  store ptr @"EvenOdd.#let_closure_4787", ptr %let_func_1.i.i, align 8
  ...
  br i1 %cond2.i.i, label %EvenOdd.main.exit, label %switch-unboxed_default_2.i.i
...
switch-unboxed_default_2.i.i:                     ; preds = %switch-unboxed_default_1.i.i
  ...
  store ptr @"EvenOdd.#let_closure_4785", ptr %let_func_0.i.i.i, align 8
  ...
  br i1 %cond3.i.i, label %EvenOdd.main.exit, label %switch-unboxed_default_3.i.i
...
switch-unboxed_default_3.i.i:                     ; preds = %switch-unboxed_default_2.i.i
  ...
  store ptr @"EvenOdd.#let_closure_4788", ptr %let_func_2.i.i, align 8
  ...
  store ptr @"EvenOdd.#let_closure_4791", ptr %let_func_0.i3.i.i, align 8
  ...
  br i1 %cond4.i.i, label %EvenOdd.main.exit, label %switch-unboxed_default_4.i.i
...
switch-unboxed_default_4.i.i:                     ; preds = %switch-unboxed_default_3.i.i
  ...
  store ptr @"EvenOdd.#let_closure_4789", ptr %let_func_3.i.i, align 8
  ...
  br i1 %cond5.i.i, label %EvenOdd.main.exit, label %switch-unboxed_default_5.i.i
...
switch-unboxed_default_5.i.i:                     ; preds = %switch-unboxed_default_4.i.i
  ...
  store ptr @"EvenOdd.#let_closure_4774", ptr %let_func_0.i5.i.i, align 8
...
EvenOdd.main.exit:                                ; preds = %switch-unboxed_default_0.i.i, %switch-unboxed_default_1.i.i, %switch-unboxed_default_2.i.i, %switch-unboxed_default_3.i.i, %switch-unboxed_default_4.i.i, %switch-unboxed_default_5.i.i, %1, %switch-unboxed_default_1.i, %switch-unboxed_default_2.i, %switch-unboxed_default_3.i, %switch-unboxed_default_4.i
  ...
  %str4780.sink14.i = phi ptr [ @str4779, %1 ], [ @str4780, %switch-unboxed_default_1.i ], [ @str4779, %switch-unboxed_default_2.i ], [ @str4780, %switch-unboxed_default_3.i ], [ @str4779, %switch-unboxed_default_4.i ], [ @str4779, %switch-unboxed_default_3.i.i ], [ @str4779, %switch-unboxed_default_1.i.i ], [ @str4779, %switch-unboxed_default_5.i.i ], [ @str4780, %switch-unboxed_default_4.i.i ], [ @str4780, %switch-unboxed_default_2.i.i ], [ @str4780, %switch-unboxed_default_0.i.i ]
  ...
  store ptr %str4780.sink14.i, ptr %89, align 8
  %90 = tail call ptr @malgo_print_string(ptr noundef nonnull %str4780.sink14.i)
