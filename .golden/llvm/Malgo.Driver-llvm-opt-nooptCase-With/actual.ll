...
define internal ptr @"test/testcases/malgo/With.mlg.#fun_closure_193"(ptr nocapture nofree readnone %0, ptr nocapture nofree readonly align 8 %1) {
...
define internal ptr @"test/testcases/malgo/With.mlg.#fun_closure_201"(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %1) {
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  store i8 0, ptr %3, align 1
  %4 = getelementptr { i8, { ptr } }, ptr %3, i64 0, i32 1, i32 0
  store ptr @str192, ptr %4, align 8
  ...
  store ptr @"test/testcases/malgo/With.mlg.#fun_closure_193", ptr %fun_func_0.i, align 8
...
define internal ptr @"test/testcases/malgo/With.mlg.#let_closure_341"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly %1) {
...
define internal ptr @"test/testcases/malgo/With.mlg.#fun_closure_375"(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %1) {
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  store i8 0, ptr %3, align 1
  %4 = getelementptr { i8, { ptr } }, ptr %3, i64 0, i32 1, i32 0
...
define internal ptr @"test/testcases/malgo/With.mlg.#fun_closure_376"(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %1) {
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  %fun_capture_0.i = tail call ptr @malgo_malloc(i64 noundef 0)
  store ptr %fun_capture_0.i, ptr %3, align 8
  %fun_func_0.i = getelementptr { ptr, ptr }, ptr %3, i64 0, i32 1
  store ptr @"test/testcases/malgo/With.mlg.#fun_closure_201", ptr %fun_func_0.i, align 8
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/With.mlg.#fun_closure_375", ptr %fun_func_0.i, align 8
  %6 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i.i = tail call ptr @malgo_malloc(i64 noundef 8)
  ...
  store ptr @"test/testcases/malgo/With.mlg.#let_closure_341", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/With.mlg.#fun_closure_376", ptr %fun_func_1.i, align 8
