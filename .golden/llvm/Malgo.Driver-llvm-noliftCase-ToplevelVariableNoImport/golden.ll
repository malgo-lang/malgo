...
define internal i32 @"ToplevelVariableNoImport.#let_closure_532"(ptr %0, i32 %1) {
...
define internal ptr @ToplevelVariableNoImport.malgo_add_int32_t(ptr %0, i32 %"ToplevelVariableNoImport.$p_174_0") {
  ...
  store ptr @"ToplevelVariableNoImport.#let_closure_532", ptr %let_func_0, align 8
  ret ptr %2
}
...
define internal ptr @"ToplevelVariableNoImport.#let_closure_533"(ptr %0, ptr %1) {
...
define internal ptr @"ToplevelVariableNoImport.#let_closure_534"(ptr %0, ptr %1) {
...
define internal ptr @ToplevelVariableNoImport.constId(ptr %0, ptr %"ToplevelVariableNoImport.$eta_210_0") {
  ...
  store ptr @"ToplevelVariableNoImport.#let_closure_534", ptr %let_func_0, align 8
...
define internal i32 @"ToplevelVariableNoImport.#let_closure_535"(ptr %0, i32 %1) {
...
define internal ptr @"ToplevelVariableNoImport.addInt32#"(ptr %0, i32 %"ToplevelVariableNoImport.$x_223_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"ToplevelVariableNoImport.#let_closure_535", ptr %let_func_0, align 8
  ret ptr %2
}

define internal i32 @"ToplevelVariableNoImport.#let_closure_537"(ptr %0, i32 %1) {
  %p_addr_0 = getelementptr { i32 }, ptr %0, i32 0, i32 0
  %p_0 = load i32, ptr %p_addr_0, align 4
...
define internal ptr @"ToplevelVariableNoImport.#let_closure_536"(ptr %0, ptr %1) {
...
"switch_branch_ToplevelVariableNoImport.Int32#_0": ; preds = %2
...
"switch_branch_ToplevelVariableNoImport.Int32#_1": ; preds = %"switch_branch_ToplevelVariableNoImport.Int32#_0"
  ...
  store ptr @"ToplevelVariableNoImport.#let_closure_537", ptr %let_func_0, align 8
...
define internal ptr @ToplevelVariableNoImport.addInt32(ptr %0, ptr %"ToplevelVariableNoImport.$int32#_235_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"ToplevelVariableNoImport.#let_closure_536", ptr %let_func_0, align 8
  ret ptr %2
}

define internal i32 @"ToplevelVariableNoImport.#let_closure_538"(ptr %0, i32 %1) {
...
"switch_branch_ToplevelVariableNoImport.Int32#_1": ; preds = %"switch_branch_ToplevelVariableNoImport.Int32#_0"
  ...
  store ptr @ToplevelVariableNoImport.malgo_add_int32_t, ptr %malgo_add_int32_t_func_0, align 8
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %13, i32 0, i32 1
  store ptr @"ToplevelVariableNoImport.#let_closure_538", ptr %let_func_0, align 8
  %15 = call i32 @"ToplevelVariableNoImport.$addInt32#_curry_228"(ptr null, i32 %7, i32 %12)
...
define internal i32 @"ToplevelVariableNoImport.#let_closure_541"(ptr %0, i32 %1) {
  %p_addr_0 = getelementptr { i32 }, ptr %0, i32 0, i32 0
  %p_0 = load i32, ptr %p_addr_0, align 4
...
"switch_branch_ToplevelVariableNoImport.Int32#_1": ; preds = %"switch_branch_ToplevelVariableNoImport.Int32#_0"
  ...
  store ptr @"ToplevelVariableNoImport.#let_closure_541", ptr %let_func_1, align 8
...
switch_branch_ToplevelVariableNoImport.Just_0:    ; preds = %1
  ...
  store ptr @"ToplevelVariableNoImport.#let_closure_542", ptr %let_func_2, align 8
...
"switch_branch_ToplevelVariableNoImport.Int32#_4": ; preds = %"switch_branch_ToplevelVariableNoImport.Int32#_3"
  ...
  store ptr @"ToplevelVariableNoImport.#let_closure_543", ptr %let_func_3, align 8
