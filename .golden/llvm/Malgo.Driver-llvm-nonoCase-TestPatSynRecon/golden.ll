...
define internal ptr @"test/testcases/malgo/TestPatSynRecon.mlg.#fun_closure_342"(ptr %0, ptr %1) {
  %"+#_addr_0" = getelementptr { ptr, i64, ptr }, ptr %0, i32 0, i32 0
  %"+#_0" = load ptr, ptr %"+#_addr_0", align 8
  %p_addr_0 = getelementptr { ptr, i64, ptr }, ptr %0, i32 0, i32 1
  %p_0 = load i64, ptr %p_addr_0, align 4
  %"Int64#_addr_0" = getelementptr { ptr, i64, ptr }, ptr %0, i32 0, i32 2
  %"Int64#_0" = load ptr, ptr %"Int64#_addr_0", align 8
  %3 = getelementptr { i8, <8 x i8> }, ptr %1, i32 0, i32 0
  %4 = load i8, ptr %3, align 1
  switch i8 %4, label %switch_default_0 [
...
"switch_branch_runtime/malgo/Builtin.mlg.Int64#_0": ; preds = %"switch_branch_runtime/malgo/Prelude.mlg.Cons_0"
  ...
  %33 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ ptr, ptr }, ptr null, i32 1) to i64))
  %fun_capture_0 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ ptr, i64, ptr }, ptr null, i32 1) to i64))
  %34 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ ptr, ptr }, ptr null, i32 1) to i64))
  ...
  %"+#_0" = getelementptr { ptr, i64, ptr }, ptr %fun_capture_0, i32 0, i32 0
  store ptr %34, ptr %"+#_0", align 8
  %p_0 = getelementptr { ptr, i64, ptr }, ptr %fun_capture_0, i32 0, i32 1
  ...
  %"Int64#_0" = getelementptr { ptr, i64, ptr }, ptr %fun_capture_0, i32 0, i32 2
