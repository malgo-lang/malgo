...
define internal i32 @_M14let_x5Fclosure47test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg12Internal2905(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
...
define internal i32 @_M14let_x5Fclosure47test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg12Internal2908(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  %p_0 = load i32, ptr %0, align 4
  ...
  store ptr @_M14let_x5Fclosure47test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg12Internal2905, ptr %let_func_0.i.i, align 8
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  tail call void @malgo_hash_table_insert(ptr %7, ptr noundef nonnull @str2906, ptr noundef nonnull %3)
  tail call void @malgo_hash_table_insert(ptr %7, ptr noundef nonnull @str2907, ptr noundef nonnull %5)
  %8 = tail call ptr @malgo_hash_table_get(ptr %7, ptr noundef nonnull @str2906)
  %9 = tail call ptr @malgo_hash_table_get(ptr %7, ptr noundef nonnull @str2907)
  %10 = tail call ptr @malgo_hash_table_get(ptr %7, ptr noundef nonnull @str2906)
  %11 = tail call ptr @malgo_hash_table_get(ptr %7, ptr noundef nonnull @str2907)
  ...
  store ptr @_M14let_x5Fclosure47test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg12Internal2908, ptr %let_func_0.i, align 8
