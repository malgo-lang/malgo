; ModuleID = './test/tmp/malgo_test/normal/TuplePattern.ll'
...
define internal ptr @"TuplePattern.#let_closure_2834"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define internal ptr @"TuplePattern.#fun_closure_2835"(ptr nocapture nofree readnone %0, ptr nocapture nofree readonly align 8 %1) {
...
switch_branch_TuplePattern.A_0.i:                 ; preds = %2
  ...
  br label %"TuplePattern.$raw_fun_2833.exit"
...
"TuplePattern.$raw_fun_2833.exit":                ; preds = %switch_branch_TuplePattern.A_0.i, %switch_branch_TuplePattern.B_0.i, %switch_branch_TuplePattern.C_0.i
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"TuplePattern.#let_closure_2834", ptr %let_func_0.i, align 8
  ...
  store ptr @"TuplePattern.#fun_closure_2835", ptr %fun_func_0.i, align 8
