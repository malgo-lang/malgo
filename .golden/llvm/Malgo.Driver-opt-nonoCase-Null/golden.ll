...
define internal noundef ptr @"test/testcases/malgo/Null.mlg.Just"(ptr nocapture nofree readnone %0, ptr nofree %"test/testcases/malgo/Null.mlg.$p_120_0") {
  %2 = tail call noundef ptr @malgo_malloc(i64 noundef 16)
  store i8 1, ptr %2, align 1
  %3 = getelementptr { i8, { ptr } }, ptr %2, i64 0, i32 1, i32 0
  store ptr %"test/testcases/malgo/Null.mlg.$p_120_0", ptr %3, align 8
  ret ptr %2
}

define internal noundef ptr @"test/testcases/malgo/Null.mlg.#let_closure_180"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
...
define internal ptr @"test/testcases/malgo/Null.mlg.Cons"(ptr nocapture nofree readnone %0, ptr nofree %"test/testcases/malgo/Null.mlg.$p_125_0") {
  %2 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0 = tail call ptr @malgo_malloc(i64 noundef 8)
  store ptr %"test/testcases/malgo/Null.mlg.$p_125_0", ptr %let_capture_0, align 8
  store ptr %let_capture_0, ptr %2, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i64 0, i32 1
  store ptr @"test/testcases/malgo/Null.mlg.#let_closure_180", ptr %let_func_0, align 8
  ret ptr %2
}

define internal ptr @"test/testcases/malgo/Null.mlg.malgo_print_string"(ptr nocapture nofree readnone %0, ptr %"test/testcases/malgo/Null.mlg.$p_133_0") {
  %2 = tail call ptr @malgo_print_string(ptr %"test/testcases/malgo/Null.mlg.$p_133_0")
  ret ptr %2
}

define internal ptr @"test/testcases/malgo/Null.mlg.malgo_exit_failure"(ptr nocapture nofree readnone %0, ptr %"test/testcases/malgo/Null.mlg.$p_134_0") {
  %2 = tail call ptr @malgo_exit_failure(ptr %"test/testcases/malgo/Null.mlg.$p_134_0")
  ret ptr %2
}
...
define internal ptr @"test/testcases/malgo/Null.mlg.|>"(ptr nocapture nofree readnone %0, ptr nofree %"test/testcases/malgo/Null.mlg.$x_135_0") {
  %2 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0 = tail call ptr @malgo_malloc(i64 noundef 8)
  store ptr %"test/testcases/malgo/Null.mlg.$x_135_0", ptr %let_capture_0, align 8
  store ptr %let_capture_0, ptr %2, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i64 0, i32 1
  store ptr @"test/testcases/malgo/Null.mlg.#let_closure_181", ptr %let_func_0, align 8
  ret ptr %2
}

define internal noundef ptr @"test/testcases/malgo/Null.mlg.mHead"(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %"test/testcases/malgo/Null.mlg.$nil_143_0") {
  %2 = load i8, ptr %"test/testcases/malgo/Null.mlg.$nil_143_0", align 1
  %switch = icmp eq i8 %2, 0
  br i1 %switch, label %"switch_branch_test/testcases/malgo/Null.mlg.Nil_0", label %"switch_branch_test/testcases/malgo/Null.mlg.Cons_0"

common.ret:                                       ; preds = %"switch_branch_test/testcases/malgo/Null.mlg.Cons_0", %"switch_branch_test/testcases/malgo/Null.mlg.Nil_0"
  %common.ret.op = phi ptr [ %3, %"switch_branch_test/testcases/malgo/Null.mlg.Nil_0" ], [ %7, %"switch_branch_test/testcases/malgo/Null.mlg.Cons_0" ]
...
"switch_branch_test/testcases/malgo/Null.mlg.Cons_0": ; preds = %1
  %4 = getelementptr { i8, { ptr, ptr } }, ptr %"test/testcases/malgo/Null.mlg.$nil_143_0", i64 0, i32 1
  %5 = load ptr, ptr %4, align 8
  %6 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %6, align 8
  %Just_func_0 = getelementptr { ptr, ptr }, ptr %6, i64 0, i32 1
  store ptr @"test/testcases/malgo/Null.mlg.Just", ptr %Just_func_0, align 8
...
define internal noundef ptr @"test/testcases/malgo/Null.mlg.isNothing"(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %"test/testcases/malgo/Null.mlg.$nothing_147_0") {
common.ret:
  %1 = load i8, ptr %"test/testcases/malgo/Null.mlg.$nothing_147_0", align 1
...
define internal noundef ptr @"test/testcases/malgo/Null.mlg.null"(ptr nocapture nofree readnone %0, ptr nocapture nofree readonly %"test/testcases/malgo/Null.mlg.$as_149_0") {
  %2 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %2, align 8
  %mHead_func_0 = getelementptr { ptr, ptr }, ptr %2, i64 0, i32 1
  store ptr @"test/testcases/malgo/Null.mlg.mHead", ptr %mHead_func_0, align 8
  %3 = load i8, ptr %"test/testcases/malgo/Null.mlg.$as_149_0", align 1
  %switch.i = icmp eq i8 %3, 0
  br i1 %switch.i, label %"switch_branch_test/testcases/malgo/Null.mlg.Nil_0.i", label %"switch_branch_test/testcases/malgo/Null.mlg.Cons_0.i"

"switch_branch_test/testcases/malgo/Null.mlg.Nil_0.i": ; preds = %1
  %4 = tail call ptr @malgo_malloc(i64 noundef 1)
  store i8 0, ptr %4, align 1
  br label %"test/testcases/malgo/Null.mlg.mHead.exit"

"switch_branch_test/testcases/malgo/Null.mlg.Cons_0.i": ; preds = %1
  %5 = getelementptr { i8, { ptr, ptr } }, ptr %"test/testcases/malgo/Null.mlg.$as_149_0", i64 0, i32 1
  %6 = load ptr, ptr %5, align 8
  %7 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %7, align 8
  %Just_func_0.i = getelementptr { ptr, ptr }, ptr %7, i64 0, i32 1
  store ptr @"test/testcases/malgo/Null.mlg.Just", ptr %Just_func_0.i, align 8
...
"test/testcases/malgo/Null.mlg.mHead.exit":       ; preds = %"switch_branch_test/testcases/malgo/Null.mlg.Nil_0.i", %"switch_branch_test/testcases/malgo/Null.mlg.Cons_0.i"
  %common.ret.op.i = phi ptr [ %4, %"switch_branch_test/testcases/malgo/Null.mlg.Nil_0.i" ], [ %8, %"switch_branch_test/testcases/malgo/Null.mlg.Cons_0.i" ]
  %10 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %10, align 8
  %isNothing_func_0 = getelementptr { ptr, ptr }, ptr %10, i64 0, i32 1
  store ptr @"test/testcases/malgo/Null.mlg.isNothing", ptr %isNothing_func_0, align 8
...
define internal ptr @"test/testcases/malgo/Null.mlg.#fun_closure_182"(ptr nocapture nofree readonly align 8 %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %1) {
...
common.ret:                                       ; preds = %"switch_branch_test/testcases/malgo/Null.mlg.True_0", %"switch_branch_test/testcases/malgo/Null.mlg.False_0"
  %malgo_exit_failure_0.sink4 = phi ptr [ %malgo_exit_failure_0, %"switch_branch_test/testcases/malgo/Null.mlg.True_0" ], [ %malgo_print_string_0, %"switch_branch_test/testcases/malgo/Null.mlg.False_0" ]
  %.sink1 = phi ptr [ %8, %"switch_branch_test/testcases/malgo/Null.mlg.True_0" ], [ @str183, %"switch_branch_test/testcases/malgo/Null.mlg.False_0" ]
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/Null.mlg.Cons", ptr %Cons_func_0.i, align 8
  ...
  store ptr @"test/testcases/malgo/Null.mlg.#let_closure_180", ptr %let_func_0.i.i, align 8
  %6 = tail call ptr @malgo_malloc(i64 noundef 1)
  store i8 1, ptr %6, align 1
  %7 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %7, align 8
  %Cons_func_1.i = getelementptr { ptr, ptr }, ptr %7, i64 0, i32 1
  store ptr @"test/testcases/malgo/Null.mlg.Cons", ptr %Cons_func_1.i, align 8
  %8 = tail call ptr @malgo_malloc(i64 noundef 16)
  ...
  store ptr @"test/testcases/malgo/Null.mlg.#let_closure_180", ptr %let_func_0.i2.i, align 8
  ...
  store ptr @"test/testcases/malgo/Null.mlg.null", ptr %null_func_0.i, align 8
  %17 = tail call ptr @"test/testcases/malgo/Null.mlg.null"(ptr poison, ptr nocapture nofree readonly %15)
  %18 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %18, align 8
  %"|>_func_0.i" = getelementptr { ptr, ptr }, ptr %18, i64 0, i32 1
  store ptr @"test/testcases/malgo/Null.mlg.|>", ptr %"|>_func_0.i", align 8
