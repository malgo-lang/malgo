; ModuleID = '.malgo-work/test/testcases/malgo/FuncOverUnboxed.ll'
...
define internal ptr @"test/testcases/malgo/FuncOverUnboxed.mlg.f"(ptr nocapture nofree readnone %0, i64 %"test/testcases/malgo/FuncOverUnboxed.mlg.$unboxed_22_0") {
common.ret:
  %switch = icmp ult i64 %"test/testcases/malgo/FuncOverUnboxed.mlg.$unboxed_22_0", 2
  ...
  store ptr @"runtime/malgo/Builtin.mlg.malgo_int64_t_to_string", ptr %malgo_int64_t_to_string_func_0.i3, align 8
  ...
  store ptr @"runtime/malgo/Builtin.mlg.malgo_print_string", ptr %malgo_print_string_func_0.i4, align 8
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/FuncOverUnboxed.mlg.f", ptr %f_func_0.i, align 8
  %7 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %7, align 8
  %"toStringInt64#_func_2.i.i" = getelementptr { ptr, ptr }, ptr %7, i64 0, i32 1
  store ptr @"runtime/malgo/Builtin.mlg.toStringInt64#", ptr %"toStringInt64#_func_2.i.i", align 8
  %8 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %8, align 8
  %malgo_int64_t_to_string_func_0.i3.i.i = getelementptr { ptr, ptr }, ptr %8, i64 0, i32 1
  store ptr @"runtime/malgo/Builtin.mlg.malgo_int64_t_to_string", ptr %malgo_int64_t_to_string_func_0.i3.i.i, align 8
  ...
  store ptr @"runtime/malgo/Builtin.mlg.printString#", ptr %"printString#_func_2.i.i", align 8
  %11 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %11, align 8
  %malgo_print_string_func_0.i4.i.i = getelementptr { ptr, ptr }, ptr %11, i64 0, i32 1
  store ptr @"runtime/malgo/Builtin.mlg.malgo_print_string", ptr %malgo_print_string_func_0.i4.i.i, align 8
