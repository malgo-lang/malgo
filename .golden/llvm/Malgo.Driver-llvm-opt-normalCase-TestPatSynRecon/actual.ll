...
define internal fastcc noundef ptr @"test/testcases/malgo/TestPatSynRecon.mlg.sum"(ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %"test/testcases/malgo/TestPatSynRecon.mlg.$cons_95_0") unnamed_addr {
...
common.ret1:                                      ; preds = %0, %"switch_branch_runtime/malgo/Prelude.mlg.Cons_0"
  %.sink = phi i64 [ %14, %"switch_branch_runtime/malgo/Prelude.mlg.Cons_0" ], [ 0, %0 ]
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  %14 = tail call fastcc ptr @"test/testcases/malgo/TestPatSynRecon.mlg.sum"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(1) %11)
