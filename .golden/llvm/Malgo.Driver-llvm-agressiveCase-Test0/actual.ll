...
define internal ptr @"test/testcases/malgo/Test0.mlg.$raw_fun_2398"(ptr %0, ptr %"test/testcases/malgo/Test0.mlg.$int64#_63_0") {
...
define internal i64 @"test/testcases/malgo/Test0.mlg.#let_closure_2400"(ptr %0, i64 %1) {
  %x_addr_0 = getelementptr { i64 }, ptr %0, i32 0, i32 0
  %x_0 = load i64, ptr %x_addr_0, align 4
  %3 = call i64 @"test/testcases/malgo/Test0.mlg.$raw_let_2399"(ptr null, i64 %x_0, i64 %1)
  ret i64 %3
}
...
define internal ptr @"test/testcases/malgo/Test0.mlg.+#"(ptr %0, i64 %"test/testcases/malgo/Test0.mlg.$x_71_0") {
  ...
  store ptr @"test/testcases/malgo/Test0.mlg.#let_closure_2400", ptr %let_func_0, align 8
  ret ptr %2
}

define internal ptr @"test/testcases/malgo/Test0.mlg.#let_closure_2401"(ptr %0, ptr %1) {
...
define internal ptr @"test/testcases/malgo/Test0.mlg.#fun_closure_2402"(ptr %0, ptr %1) {
  %3 = call ptr @"test/testcases/malgo/Test0.mlg.$raw_fun_2398"(ptr null, ptr %1)
  ret ptr %3
}
...
define internal ptr @"test/testcases/malgo/Test0.mlg.main"(ptr %0, ptr %"test/testcases/malgo/Test0.mlg.$$__58_0") {
  ...
  store ptr @"test/testcases/malgo/Test0.mlg.#let_closure_2401", ptr %let_func_0, align 8
  ...
  store ptr @"test/testcases/malgo/Test0.mlg.#fun_closure_2402", ptr %fun_func_0, align 8
...
define internal ptr @"test/testcases/malgo/Test0.mlg.#let_closure_2403"(ptr %0, ptr %1) {
...
define internal ptr @"test/testcases/malgo/Test0.mlg.|>"(ptr %0, ptr %"test/testcases/malgo/Test0.mlg.$x_50_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"test/testcases/malgo/Test0.mlg.#let_closure_2403", ptr %let_func_0, align 8
  ret ptr %2
}

define internal i64 @"test/testcases/malgo/Test0.mlg.#let_closure_2404"(ptr %0, i64 %1) {
  %x_addr_0 = getelementptr { i64 }, ptr %0, i32 0, i32 0
  %x_0 = load i64, ptr %x_addr_0, align 4
...
define internal i64 @"test/testcases/malgo/Test0.mlg.$raw_let_2399"(ptr %0, i64 %"test/testcases/malgo/Test0.mlg.$x_71_0", i64 %"test/testcases/malgo/Test0.mlg.$y_72_0") {
  %2 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ ptr, ptr }, ptr null, i32 1) to i64))
  %let_capture_0 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ i64 }, ptr null, i32 1) to i64))
  %x_0 = getelementptr { i64 }, ptr %let_capture_0, i32 0, i32 0
  store i64 %"test/testcases/malgo/Test0.mlg.$x_71_0", ptr %x_0, align 4
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"test/testcases/malgo/Test0.mlg.#let_closure_2404", ptr %let_func_0, align 8
  %3 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 0
  %4 = load ptr, ptr %3, align 8
  %5 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  %6 = load ptr, ptr %5, align 8
  %7 = call i64 %6(ptr %4, i64 %"test/testcases/malgo/Test0.mlg.$y_72_0")
  ret i64 %7
}
