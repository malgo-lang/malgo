...
define internal ptr @"Null.#let_closure_231"(ptr %0, ptr %1) {
...
define internal ptr @Null.Cons(ptr %0, ptr %"Null.$p_125_0") {
  ...
  store ptr @"Null.#let_closure_231", ptr %let_func_0, align 8
  ret ptr %2
}
...
define internal ptr @"Null.#let_closure_232"(ptr %0, ptr %1) {
...
define internal ptr @"Null.|>"(ptr %0, ptr %"Null.$x_135_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"Null.#let_closure_232", ptr %let_func_0, align 8
  ret ptr %2
}
...
define internal ptr @"Null.#let_closure_233"(ptr %0, ptr %1) {
...
define internal ptr @"Null.#fun_closure_234"(ptr %0, ptr %1) {
...
switch_branch_Null.False_0:                       ; preds = %2
  %5 = call ptr @malgo_print_string(ptr @str235)
  ret ptr %5
...
define internal ptr @"Null.#let_closure_236"(ptr %0, ptr %1) {
  %d_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %d_0 = load ptr, ptr %d_addr_0, align 8
  %3 = getelementptr { ptr, ptr }, ptr %1, i32 0, i32 0
  %4 = load ptr, ptr %3, align 8
...
define internal ptr @"Null.#fun_closure_237"(ptr %0, ptr %1) {
  %3 = getelementptr { i8, {} }, ptr %1, i32 0, i32 0
  %4 = load i8, ptr %3, align 1
  switch i8 %4, label %switch_default_0 [
    i8 0, label %switch_branch_Null.False_0
...
define internal ptr @"Null.#let_closure_238"(ptr %0, ptr %1) {
  %d_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %d_0 = load ptr, ptr %d_addr_0, align 8
  %3 = getelementptr { ptr, ptr }, ptr %1, i32 0, i32 0
  %4 = load ptr, ptr %3, align 8
...
define internal ptr @"Null.#fun_closure_239"(ptr %0, ptr %1) {
  %3 = getelementptr { i8, {} }, ptr %1, i32 0, i32 0
  %4 = load i8, ptr %3, align 1
  switch i8 %4, label %switch_default_0 [
    i8 0, label %switch_branch_Null.False_0
...
define internal ptr @"Null.#let_closure_240"(ptr %0, ptr %1) {
  %d_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %d_0 = load ptr, ptr %d_addr_0, align 8
  %3 = getelementptr { ptr, ptr }, ptr %1, i32 0, i32 0
  %4 = load ptr, ptr %3, align 8
...
define internal ptr @"Null.#fun_closure_241"(ptr %0, ptr %1) {
  %3 = getelementptr { i8, {} }, ptr %1, i32 0, i32 0
  %4 = load i8, ptr %3, align 1
  switch i8 %4, label %switch_default_0 [
    i8 0, label %switch_branch_Null.False_0
...
switch_branch_Null.Nothing_0:                     ; preds = %switch_branch_Null.Nil_0
  ...
  store ptr @"Null.#let_closure_233", ptr %let_func_0, align 8
  ...
  store ptr @"Null.#fun_closure_234", ptr %fun_func_0, align 8
...
switch_branch_Null.Just_0:                        ; preds = %switch_branch_Null.Nil_0
  ...
  store ptr @"Null.#let_closure_236", ptr %let_func_1, align 8
  ...
  store ptr @"Null.#fun_closure_237", ptr %fun_func_1, align 8
...
switch_branch_Null.Nothing_1:                     ; preds = %switch_branch_Null.Cons_0
  ...
  store ptr @"Null.#let_closure_238", ptr %let_func_2, align 8
  ...
  store ptr @"Null.#fun_closure_239", ptr %fun_func_2, align 8
...
switch_branch_Null.Just_1:                        ; preds = %switch_branch_Null.Cons_0
  ...
  store ptr @"Null.#let_closure_240", ptr %let_func_3, align 8
  ...
  store ptr @"Null.#fun_closure_241", ptr %fun_func_3, align 8
