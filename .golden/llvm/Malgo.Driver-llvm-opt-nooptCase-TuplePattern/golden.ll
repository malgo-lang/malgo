...
define internal ptr @"test/testcases/malgo/TuplePattern.mlg.#let_closure_168"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
"switch_branch_test/testcases/malgo/TuplePattern.mlg.A_0.i": ; preds = %2
  ...
  store ptr @str131, ptr %5, align 8
  %6 = tail call ptr @malgo_print_string(ptr noundef nonnull @str131)
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/TuplePattern.mlg.#let_closure_168", ptr %let_func_0.i.i, align 8
