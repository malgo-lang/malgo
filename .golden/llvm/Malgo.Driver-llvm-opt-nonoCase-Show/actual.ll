...
define internal ptr @"test/testcases/malgo/Show.mlg.#let_closure_296"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
...
define internal ptr @"test/testcases/malgo/Show.mlg.#let_closure_403"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_296", ptr %let_func_0.i.i, align 8
...
define internal noundef ptr @"test/testcases/malgo/Show.mlg.#let_closure_404"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 8 %1) {
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_403", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_296", ptr %let_func_0.i.i.i.i, align 8
...
"switch_branch_Tuple#_0":
  ...
  %showDictB_addr_0 = getelementptr { ptr, ptr, ptr, ptr, ptr }, ptr %0, i64 0, i32 4
...
define internal ptr @"test/testcases/malgo/Show.mlg.show"(ptr nocapture nofree readnone %0, ptr %"test/testcases/malgo/Show.mlg.$record_119_0") {
  %2 = tail call ptr @malgo_hash_table_get(ptr %"test/testcases/malgo/Show.mlg.$record_119_0", ptr noundef nonnull @str447)
  ret ptr %2
}

define internal ptr @"test/testcases/malgo/Show.mlg.#let_closure_448"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
...
define internal ptr @"test/testcases/malgo/Show.mlg.print"(ptr nocapture nofree readnone %0, ptr nofree %"test/testcases/malgo/Show.mlg.$showDict_121_0") {
  %2 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0 = tail call ptr @malgo_malloc(i64 noundef 8)
  store ptr %"test/testcases/malgo/Show.mlg.$showDict_121_0", ptr %let_capture_0, align 8
  store ptr %let_capture_0, ptr %2, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i64 0, i32 1
...
define internal noundef ptr @"test/testcases/malgo/Show.mlg.#let_closure_449"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly %1) {
  %x_0 = load ptr, ptr %0, align 8
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %3, align 8
  ...
  store ptr %let_capture_0.i.i, ptr %4, align 8
  %let_func_0.i.i = getelementptr { ptr, ptr }, ptr %4, i64 0, i32 1
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_404", ptr %let_func_0.i.i, align 8
  %5 = tail call noundef ptr @"test/testcases/malgo/Show.mlg.#let_closure_404"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %let_capture_0.i.i, ptr nocapture nofree readonly align 8 %1)
  ret ptr %5
}

define internal ptr @"test/testcases/malgo/Show.mlg.<>"(ptr nocapture nofree readnone %0, ptr nofree %"test/testcases/malgo/Show.mlg.$x_137_0") {
  %2 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0 = tail call ptr @malgo_malloc(i64 noundef 8)
  store ptr %"test/testcases/malgo/Show.mlg.$x_137_0", ptr %let_capture_0, align 8
  store ptr %let_capture_0, ptr %2, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i64 0, i32 1
...
define internal ptr @"test/testcases/malgo/Show.mlg.#let_closure_450"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
  ...
  %5 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %5, align 8
  %show_func_0.i = getelementptr { ptr, ptr }, ptr %5, i64 0, i32 1
  store ptr @"test/testcases/malgo/Show.mlg.show", ptr %show_func_0.i, align 8
  %show_0.i = getelementptr { ptr, ptr, ptr, ptr, ptr }, ptr %fun_capture_0.i, i64 0, i32 1
  store ptr %5, ptr %show_0.i, align 8
  %6 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %6, align 8
  ...
  %showDictB_0.i = getelementptr { ptr, ptr, ptr, ptr, ptr }, ptr %fun_capture_0.i, i64 0, i32 4
...
define internal ptr @"test/testcases/malgo/Show.mlg.showTuple2"(ptr nocapture nofree readnone %0, ptr nofree %"test/testcases/malgo/Show.mlg.$showDictA_149_0") {
  %2 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0 = tail call ptr @malgo_malloc(i64 noundef 8)
  store ptr %"test/testcases/malgo/Show.mlg.$showDictA_149_0", ptr %let_capture_0, align 8
  store ptr %let_capture_0, ptr %2, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i64 0, i32 1
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#fun_closure_455", ptr %fun_func_0.i, align 8
  %7 = tail call ptr @malgo_hash_table_new()
  tail call void @malgo_hash_table_insert(ptr %7, ptr noundef nonnull @str447, ptr noundef nonnull %5)
  store ptr %7, ptr @"test/testcases/malgo/Show.mlg.showInt32", align 8
  %8 = tail call ptr @malgo_malloc(i64 noundef 1)
  store i8 0, ptr %8, align 1
  %9 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %9, align 8
  %showTuple2_func_0.i = getelementptr { ptr, ptr }, ptr %9, i64 0, i32 1
  store ptr @"test/testcases/malgo/Show.mlg.showTuple2", ptr %showTuple2_func_0.i, align 8
  %10 = load ptr, ptr @"test/testcases/malgo/Show.mlg.showInt32", align 8
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_450", ptr %let_func_0.i.i, align 8
  %12 = load ptr, ptr @"test/testcases/malgo/Show.mlg.showInt32", align 8
  ...
  %show_func_0.i.i.i = getelementptr { ptr, ptr }, ptr %15, i64 0, i32 1
  ...
  store ptr %15, ptr %show_0.i.i.i, align 8
  %16 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %16, align 8
  %"<>_func_0.i.i.i" = getelementptr { ptr, ptr }, ptr %16, i64 0, i32 1
  store ptr @"test/testcases/malgo/Show.mlg.<>", ptr %"<>_func_0.i.i.i", align 8
  %"<>_0.i.i.i" = getelementptr { ptr, ptr, ptr, ptr, ptr }, ptr %fun_capture_0.i.i.i, i64 0, i32 2
  store ptr %16, ptr %"<>_0.i.i.i", align 8
  ...
  %showDictB_0.i.i.i = getelementptr { ptr, ptr, ptr, ptr, ptr }, ptr %fun_capture_0.i.i.i, i64 0, i32 4
  ...
  store ptr @"test/testcases/malgo/Show.mlg.print", ptr %print_func_0.i, align 8
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_448", ptr %let_func_0.i2.i, align 8
...
define internal ptr @"test/testcases/malgo/Show.mlg.#fun_closure_455"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
