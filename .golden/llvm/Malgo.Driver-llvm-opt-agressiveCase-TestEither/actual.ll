...
define internal ptr @"TestEither.#let_closure_5003"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define internal ptr @"TestEither.#let_closure_5019"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
  %d_0 = load ptr, ptr %0, align 8
  %3 = load ptr, ptr %1, align 8
  %4 = getelementptr { ptr, ptr }, ptr %1, i64 0, i32 1
  %5 = load ptr, ptr %4, align 8
...
define internal i32 @"TestEither.#let_closure_5033"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  %x_0 = load i32, ptr %0, align 4
  %3 = tail call i32 @malgo_add_int32_t(i32 %x_0, i32 %1)
  ret i32 %3
}

define internal ptr @"TestEither.#let_closure_5091"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
  %d_0 = load ptr, ptr %0, align 8
  %3 = load ptr, ptr %1, align 8
  %4 = getelementptr { ptr, ptr }, ptr %1, i64 0, i32 1
  %5 = load ptr, ptr %4, align 8
...
define internal ptr @"TestEither.#fun_closure_5092"(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %1) {
...
switch_branch_TestEither.Left_0.i:                ; preds = %2
  ...
  store ptr @str5040, ptr %5, align 8
  %6 = tail call ptr @malgo_print_string(ptr noundef nonnull @str5040)
  ...
  br label %"TestEither.$raw_fun_4672.exit"
...
"TestEither.$raw_fun_4672.exit":                  ; preds = %switch_branch_TestEither.Left_0.i, %switch_branch_TestEither.Right_0.i
  %common.ret.op.i = phi ptr [ %9, %switch_branch_TestEither.Left_0.i ], [ %17, %switch_branch_TestEither.Right_0.i ]
  ret ptr %common.ret.op.i
}

define internal ptr @"TestEither.#let_closure_5120"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
  %d_0 = load ptr, ptr %0, align 8
  %3 = load ptr, ptr %1, align 8
  %4 = getelementptr { ptr, ptr }, ptr %1, i64 0, i32 1
  %5 = load ptr, ptr %4, align 8
...
define internal ptr @"TestEither.#let_closure_5121"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define internal ptr @"TestEither.#let_closure_5122"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
  %d_0 = load ptr, ptr %0, align 8
  %3 = load ptr, ptr %1, align 8
  %4 = getelementptr { ptr, ptr }, ptr %1, i64 0, i32 1
  %5 = load ptr, ptr %4, align 8
...
define internal ptr @"TestEither.#fun_closure_5123"(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(1) %1) {
  %.val = load i8, ptr %1, align 8
  %3 = getelementptr i8, ptr %1, i64 8
  %.val1 = load ptr, ptr %3, align 8
  %switch.i = icmp eq i8 %.val, 0
  br i1 %switch.i, label %"TestEither.$raw_fun_4733.exit", label %switch_branch_TestEither.Right_0.i
...
switch_branch_TestEither.Right_0.i:               ; preds = %2
  ...
  store ptr @"TestEither.#let_closure_5003", ptr %let_func_0.i, align 8
  ...
  br label %"TestEither.$raw_fun_4733.exit"

"TestEither.$raw_fun_4733.exit":                  ; preds = %2, %switch_branch_TestEither.Right_0.i
...
define internal ptr @"TestEither.#let_closure_5126"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
  %d_0 = load ptr, ptr %0, align 8
  %3 = load ptr, ptr %1, align 8
  %4 = getelementptr { ptr, ptr }, ptr %1, i64 0, i32 1
  %5 = load ptr, ptr %4, align 8
...
define internal ptr @"TestEither.#fun_closure_5127"(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(1) %1) {
  %.val = load i8, ptr %1, align 8
  %3 = getelementptr i8, ptr %1, i64 8
  %.val1 = load ptr, ptr %3, align 8
  %switch.i = icmp eq i8 %.val, 0
  br i1 %switch.i, label %"TestEither.$raw_fun_4738.exit", label %switch_branch_TestEither.Right_0.i
...
switch_branch_TestEither.Right_0.i:               ; preds = %2
  ...
  store ptr %let_capture_0.i, ptr %9, align 8
  %let_func_0.i = getelementptr { ptr, ptr }, ptr %9, i64 0, i32 1
  store ptr @"TestEither.#let_closure_5019", ptr %let_func_0.i, align 8
  %10 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %10, align 8
  %putStrLn_func_0.i = getelementptr { ptr, ptr }, ptr %10, i64 0, i32 1
  store ptr @Prelude.putStrLn, ptr %putStrLn_func_0.i, align 8
  %d_0.i.i = load ptr, ptr %let_capture_0.i, align 8
  br label %"TestEither.$raw_fun_4738.exit"

"TestEither.$raw_fun_4738.exit":                  ; preds = %2, %switch_branch_TestEither.Right_0.i
  %d_0.i.sink.i = phi ptr [ %d_0.i.i, %switch_branch_TestEither.Right_0.i ], [ %.val1, %2 ]
  %11 = getelementptr { i8, { ptr } }, ptr %d_0.i.sink.i, i64 0, i32 1
  %12 = load ptr, ptr %11, align 8
  %13 = tail call ptr @malgo_print_string(ptr %12)
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"TestEither.#let_closure_5091", ptr %let_func_0.i, align 8
  ...
  store ptr @"TestEither.#fun_closure_5092", ptr %fun_func_0.i, align 8
  ...
  store ptr @"TestEither.#let_closure_5033", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"TestEither.#let_closure_5120", ptr %let_func_15.i, align 8
  ...
  store ptr @"TestEither.#let_closure_5121", ptr %let_func_16.i, align 8
  ...
  br i1 %switch.i, label %switch_branch_TestEither.Left_12.i, label %switch_branch_TestEither.Right_13.i

switch_branch_TestEither.Left_12.i:               ; preds = %1
  ...
  store ptr @"TestEither.#let_closure_5122", ptr %let_func_17.i, align 8
  br label %TestEither.main.exit

switch_branch_TestEither.Right_13.i:              ; preds = %1
  %45 = tail call ptr @malgo_malloc(i64 noundef 16)
  store i8 0, ptr %45, align 1
  %46 = getelementptr { i8, { ptr } }, ptr %45, i64 0, i32 1, i32 0
  store ptr @str5097, ptr %46, align 8
  ...
  store ptr @"TestEither.#let_closure_5126", ptr %let_func_19.i, align 8
  br label %TestEither.main.exit

TestEither.main.exit:                             ; preds = %switch_branch_TestEither.Left_12.i, %switch_branch_TestEither.Right_13.i
  %"TestEither.#fun_closure_5127.sink.i" = phi ptr [ @"TestEither.#fun_closure_5127", %switch_branch_TestEither.Right_13.i ], [ @"TestEither.#fun_closure_5123", %switch_branch_TestEither.Left_12.i ]
  %.sink3.i = phi ptr [ %51, %switch_branch_TestEither.Right_13.i ], [ %44, %switch_branch_TestEither.Left_12.i ]
  %let_func_19.sink.i = phi ptr [ %let_func_19.i, %switch_branch_TestEither.Right_13.i ], [ %let_func_17.i, %switch_branch_TestEither.Left_12.i ]
  ...
  store ptr %"TestEither.#fun_closure_5127.sink.i", ptr %fun_func_15.i, align 8
