...
@str4906 = unnamed_addr constant [6 x i8] c"error\00"
@str4939 = unnamed_addr constant [12 x i8] c"unreachable\00"
...
define internal i32 @"test/testcases/malgo/TestEither.mlg.#let_closure_4899"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  %x_0 = load i32, ptr %0, align 4
  %3 = tail call i32 @malgo_add_int32_t(i32 %x_0, i32 %1)
  ret i32 %3
}

define internal ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_4900"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define internal ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_4901"(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %1) {
...
"switch_branch_test/testcases/malgo/TestEither.mlg.Left_0.i": ; preds = %2
  ...
  store ptr @str4939, ptr %5, align 8
  %6 = tail call ptr @malgo_print_string(ptr noundef nonnull @str4939)
...
define internal ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_4929"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
  %d_0 = load ptr, ptr %0, align 8
  %3 = load ptr, ptr %1, align 8
  %4 = getelementptr { ptr, ptr }, ptr %1, i64 0, i32 1
  %5 = load ptr, ptr %4, align 8
...
define internal ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_4930"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define internal ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_4931"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
  %d_0 = load ptr, ptr %0, align 8
  %3 = load ptr, ptr %1, align 8
  %4 = getelementptr { ptr, ptr }, ptr %1, i64 0, i32 1
  %5 = load ptr, ptr %4, align 8
...
define internal ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_4932"(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(1) %1) {
...
"switch_branch_test/testcases/malgo/TestEither.mlg.Right_0.i": ; preds = %2
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_5000", ptr %let_func_0.i, align 8
...
define internal ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_4935"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
  %d_0 = load ptr, ptr %0, align 8
  %3 = load ptr, ptr %1, align 8
  %4 = getelementptr { ptr, ptr }, ptr %1, i64 0, i32 1
  %5 = load ptr, ptr %4, align 8
...
define internal ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_4936"(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(1) %1) {
  %.val = load i8, ptr %1, align 8
  %3 = getelementptr i8, ptr %1, i64 8
  %.val1 = load ptr, ptr %3, align 8
  %switch.i = icmp eq i8 %.val, 0
...
"switch_branch_test/testcases/malgo/TestEither.mlg.Right_0.i": ; preds = %2
  ...
  store ptr %let_capture_0.i, ptr %9, align 8
  %let_func_0.i = getelementptr { ptr, ptr }, ptr %9, i64 0, i32 1
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_5005", ptr %let_func_0.i, align 8
  %10 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %10, align 8
  %putStrLn_func_0.i = getelementptr { ptr, ptr }, ptr %10, i64 0, i32 1
  store ptr @"runtime/malgo/Prelude.mlg.putStrLn", ptr %putStrLn_func_0.i, align 8
...
define internal ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_5000"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
  %d_0 = load ptr, ptr %0, align 8
  %3 = load ptr, ptr %1, align 8
  %4 = getelementptr { ptr, ptr }, ptr %1, i64 0, i32 1
  %5 = load ptr, ptr %4, align 8
...
define internal ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_5005"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
  %d_0 = load ptr, ptr %0, align 8
  %3 = load ptr, ptr %1, align 8
  %4 = getelementptr { ptr, ptr }, ptr %1, i64 0, i32 1
  %5 = load ptr, ptr %4, align 8
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_4900", ptr %let_func_0.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_4901", ptr %fun_func_0.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_4899", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_4929", ptr %let_func_15.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_4930", ptr %let_func_16.i, align 8
...
"switch_branch_test/testcases/malgo/TestEither.mlg.Left_12.i": ; preds = %1
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_4931", ptr %let_func_17.i, align 8
...
"switch_branch_test/testcases/malgo/TestEither.mlg.Right_13.i": ; preds = %1
  ...
  store ptr @str4906, ptr %46, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_4935", ptr %let_func_19.i, align 8
  br label %"test/testcases/malgo/TestEither.mlg.main.exit"
...
"test/testcases/malgo/TestEither.mlg.main.exit":  ; preds = %"switch_branch_test/testcases/malgo/TestEither.mlg.Left_12.i", %"switch_branch_test/testcases/malgo/TestEither.mlg.Right_13.i"
  %"test/testcases/malgo/TestEither.mlg.#fun_closure_4936.sink.i" = phi ptr [ @"test/testcases/malgo/TestEither.mlg.#fun_closure_4936", %"switch_branch_test/testcases/malgo/TestEither.mlg.Right_13.i" ], [ @"test/testcases/malgo/TestEither.mlg.#fun_closure_4932", %"switch_branch_test/testcases/malgo/TestEither.mlg.Left_12.i" ]
  ...
  store ptr %"test/testcases/malgo/TestEither.mlg.#fun_closure_4936.sink.i", ptr %fun_func_15.i, align 8
