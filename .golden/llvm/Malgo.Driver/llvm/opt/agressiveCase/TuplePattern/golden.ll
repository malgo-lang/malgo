...
@str3465 = unnamed_addr constant [2 x i8] c"A\00"
...
define internal ptr @"test/testcases/malgo/TuplePattern.mlg.#let_closure_3463"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define internal ptr @"test/testcases/malgo/TuplePattern.mlg.#fun_closure_3464"(ptr nocapture nofree readnone %0, ptr nocapture nofree readonly align 8 %1) {
...
"switch_branch_test/testcases/malgo/TuplePattern.mlg.A_0.i": ; preds = %2
  ...
  store ptr @str3465, ptr %5, align 8
  %6 = tail call ptr @malgo_print_string(ptr noundef nonnull @str3465)
  br label %"test/testcases/malgo/TuplePattern.mlg.$raw_fun_3462.exit"
...
"test/testcases/malgo/TuplePattern.mlg.$raw_fun_3462.exit": ; preds = %"switch_branch_test/testcases/malgo/TuplePattern.mlg.A_0.i", %"switch_branch_test/testcases/malgo/TuplePattern.mlg.B_0.i", %"switch_branch_test/testcases/malgo/TuplePattern.mlg.C_0.i"
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/TuplePattern.mlg.#let_closure_3463", ptr %let_func_0.i, align 8
  ...
  store ptr @"test/testcases/malgo/TuplePattern.mlg.#fun_closure_3464", ptr %fun_func_0.i, align 8
