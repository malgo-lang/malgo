...
define internal ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_3102"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readnone %1) #0 {
  %cast_0 = load ptr, ptr %0, align 8
  ret ptr %cast_0
}

define internal i32 @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_3103"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
...
; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind readonly willreturn
define internal ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_3104"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readnone %1) #0 {
  %cast_0 = load ptr, ptr %0, align 8
  ret ptr %cast_0
}

define internal i32 @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_3105"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  %p_0 = load i32, ptr %0, align 4
  %3 = tail call i32 @malgo_add_int32_t(i32 %p_0, i32 %1)
  ret i32 %3
}
...
; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind readonly willreturn
define internal ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_3106"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readnone %1) #0 {
...
define internal ptr @"runtime/malgo/Prelude.mlg.const"(ptr nocapture nofree readnone %0, ptr nofree %"runtime/malgo/Prelude.mlg.$a_956_0") {
  ...
  store ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_3106", ptr %let_func_0, align 8
  ret ptr %2
}
...
"switch_branch_runtime/malgo/Prelude.mlg.Nothing_0.i": ; preds = %1
  ...
  store ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_3102", ptr %let_func_0.i, align 8
...
"switch_branch_runtime/malgo/Prelude.mlg.Just_0.i": ; preds = %1
  ...
  store ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_3104", ptr %let_func_2.i, align 8
...
"test/testcases/malgo/ToplevelVariable.mlg.main.exit": ; preds = %"switch_branch_runtime/malgo/Prelude.mlg.Nothing_0.i", %"switch_branch_runtime/malgo/Prelude.mlg.Just_0.i"
  ...
  %"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_3105.sink.i" = phi ptr [ @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_3105", %"switch_branch_runtime/malgo/Prelude.mlg.Just_0.i" ], [ @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_3103", %"switch_branch_runtime/malgo/Prelude.mlg.Nothing_0.i" ]
  ...
  store ptr %"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_3105.sink.i", ptr %let_func_3.i, align 8
