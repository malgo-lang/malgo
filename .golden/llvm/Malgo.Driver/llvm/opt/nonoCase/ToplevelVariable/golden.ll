...
define internal i32 @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_125"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
...
define internal i32 @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_290"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  ...
  store ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_125", ptr %let_func_0.i.i, align 8
...
define internal noundef ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_291"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  ...
  store ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_290", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_125", ptr %let_func_0.i.i.i.i, align 8
...
define internal ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_319"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readnone %1) #1 {
...
define internal ptr @"test/testcases/malgo/ToplevelVariable.mlg.constId"(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %"test/testcases/malgo/ToplevelVariable.mlg.$eta_87_0") {
  ...
  store ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_319", ptr %let_func_0.i, align 8
...
define internal noundef ptr @"test/testcases/malgo/ToplevelVariable.mlg.addOne"(ptr nocapture nofree readnone %0, ptr nocapture nofree readonly %"test/testcases/malgo/ToplevelVariable.mlg.$eta_102_0") {
  ...
  store ptr %let_capture_0.i, ptr %4, align 8
  %let_func_0.i = getelementptr { ptr, ptr }, ptr %4, i64 0, i32 1
  store ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_291", ptr %let_func_0.i, align 8
  %5 = tail call noundef ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_291"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %let_capture_0.i, ptr nocapture nofree readonly align 4 %"test/testcases/malgo/ToplevelVariable.mlg.$eta_102_0")
  ret ptr %5
}
...
"test/testcases/malgo/ToplevelVariable.mlg.main.exit": ; preds = %"switch_branch_runtime/malgo/Prelude.mlg.Nothing_0.i.i", %"switch_branch_runtime/malgo/Prelude.mlg.Just_0.i.i"
  ...
  store ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_319", ptr %let_func_0.i.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_291", ptr %let_func_0.i.i2.i, align 8
  %41 = tail call ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_291"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %let_capture_0.i.i1.i, ptr nocapture nofree readonly align 4 %37)
