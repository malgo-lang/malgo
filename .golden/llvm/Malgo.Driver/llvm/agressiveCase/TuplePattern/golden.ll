...
define internal ptr @"test/testcases/malgo/TuplePattern.mlg.#let_closure_3463"(ptr %0, ptr %1) {
...
define internal ptr @"test/testcases/malgo/TuplePattern.mlg.#fun_closure_3464"(ptr %0, ptr %1) {
  %3 = call ptr @"test/testcases/malgo/TuplePattern.mlg.$raw_fun_3462"(ptr null, ptr %1)
  ret ptr %3
}
...
define internal ptr @"test/testcases/malgo/TuplePattern.mlg.main"(ptr %0, ptr %"test/testcases/malgo/TuplePattern.mlg.$$__29_0") {
  ...
  store ptr @"test/testcases/malgo/TuplePattern.mlg.#let_closure_3463", ptr %let_func_0, align 8
  ...
  store ptr @"test/testcases/malgo/TuplePattern.mlg.#fun_closure_3464", ptr %fun_func_0, align 8
...
define internal ptr @"test/testcases/malgo/TuplePattern.mlg.$raw_fun_3462"(ptr %0, ptr %"test/testcases/malgo/TuplePattern.mlg.$tuple_37_0") {
...
"switch_branch_test/testcases/malgo/TuplePattern.mlg.A_0": ; preds = %"switch_branch_Tuple#_0"
  ...
  store ptr @str3465, ptr %13, align 8
