...
define internal ptr @"test/testcases/malgo/Null.mlg.#let_closure_183"(ptr %0, ptr %1) {
...
define internal ptr @"test/testcases/malgo/Null.mlg.Cons"(ptr %0, ptr %"test/testcases/malgo/Null.mlg.$p_125_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"test/testcases/malgo/Null.mlg.#let_closure_183", ptr %let_func_0, align 8
  ret ptr %2
}
