...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr %3, ptr @_M9undefined34runtime_x2Fmalgo_x2FBuiltin_x2Emlg8External, align 8
  %4 = tail call ptr @malgo_malloc(i64 noundef 1)
  store i8 0, ptr %4, align 1
  %5 = tail call ptr @malgo_malloc(i64 noundef 16)
  store i8 0, ptr %5, align 1
  %6 = getelementptr { i8, { ptr } }, ptr %5, i64 0, i32 1, i32 0
  store ptr @str3592, ptr %6, align 8
  %7 = tail call ptr @malgo_print_string(ptr noundef nonnull @str3592)
  ret i32 0
}
