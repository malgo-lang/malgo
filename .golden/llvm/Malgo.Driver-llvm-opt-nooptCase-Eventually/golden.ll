; ModuleID = './test/tmp/malgo_test/noopt/Eventually.ll'
...
define internal ptr @"Eventually.#let_closure_468"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define internal ptr @"Eventually.#let_closure_503"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
...
switch_branch_Eventually.NotYetDone_0.i:          ; preds = %2
  ...
  store ptr @"Eventually.#fun_closure_598", ptr %fun_func_0.i, align 8
...
define internal ptr @"Eventually.#fun_closure_535"(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %1) {
...
switch_branch_Eventually.Done_0.i:                ; preds = %2
  ...
  br label %"Eventually.$raw_fun_418.exit"

switch_branch_Eventually.NotYetDone_0.i:          ; preds = %2
  %11 = tail call ptr @malgo_malloc(i64 noundef 16)
  store i8 0, ptr %11, align 1
  %12 = getelementptr { i8, { ptr } }, ptr %11, i64 0, i32 1, i32 0
  store ptr @str612, ptr %12, align 8
  %13 = tail call ptr @malgo_print_string(ptr noundef nonnull @str612)
  br label %"Eventually.$raw_fun_418.exit"

"Eventually.$raw_fun_418.exit":                   ; preds = %switch_branch_Eventually.Done_0.i, %switch_branch_Eventually.NotYetDone_0.i
  %common.ret.op.i = phi ptr [ %10, %switch_branch_Eventually.Done_0.i ], [ %13, %switch_branch_Eventually.NotYetDone_0.i ]
  ret ptr %common.ret.op.i
}
...
common.ret:                                       ; preds = %switch_branch_Eventually.NotYetDone_0, %switch_branch_Eventually.Done_0
  %common.ret.op = phi ptr [ %5, %switch_branch_Eventually.Done_0 ], [ %11, %switch_branch_Eventually.NotYetDone_0 ]
...
define internal ptr @"Eventually.#fun_closure_598"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %0, ptr nocapture nofree readnone %1) {
  ...
  store ptr @"Eventually.#let_closure_503", ptr %let_func_0.i.i, align 8
...
switch_branch_Eventually.Done_0.i.i.i:            ; preds = %2
  ...
  br label %"Eventually.$raw_fun_417.exit"
...
switch_branch_Eventually.NotYetDone_0.i.i.i:      ; preds = %2
  ...
  store ptr @"Eventually.#fun_closure_598", ptr %fun_func_0.i.i.i, align 8
...
"Eventually.$raw_fun_417.exit":                   ; preds = %switch_branch_Eventually.Done_0.i.i.i, %switch_branch_Eventually.NotYetDone_0.i.i.i
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  tail call void @malgo_hash_table_insert(ptr %4, ptr noundef nonnull @str438, ptr noundef nonnull %5)
  ...
  tail call void @malgo_hash_table_insert(ptr %4, ptr noundef nonnull @str439, ptr noundef nonnull %6)
  store ptr %4, ptr @Eventually.eventually, align 8
  %7 = tail call ptr @malgo_hash_table_get(ptr %4, ptr noundef nonnull @str438)
  %8 = tail call ptr @malgo_hash_table_get(ptr %4, ptr noundef nonnull @str439)
  ...
  store ptr @"Eventually.#fun_closure_630", ptr %fun_func_0.i, align 8
  %10 = tail call ptr @malgo_malloc(i64 noundef 16)
  ...
  store ptr @"Eventually.#let_closure_468", ptr %let_func_0.i.i, align 8
...
Eventually.step.exit.i:                           ; preds = %switch_branch_Eventually.NotYetDone_0.i.i, %switch_branch_Eventually.Done_0.i.i
  %35 = load ptr, ptr @Eventually.comp, align 8
  ...
  store ptr @"Eventually.#let_closure_468", ptr %let_func_0.i2.i, align 8
  ...
  br i1 %switch.i18.i, label %switch_branch_Eventually.Done_0.i20.i, label %switch_branch_Eventually.NotYetDone_0.i21.i

switch_branch_Eventually.Done_0.i20.i:            ; preds = %Eventually.step.exit.i
  %41 = tail call ptr @malgo_malloc(i64 noundef 16)
  store i8 0, ptr %41, align 1
  %42 = getelementptr { i8, { ptr } }, ptr %41, i64 0, i32 1, i32 0
  store ptr %40, ptr %42, align 8
  br label %Eventually.step.exit22.i

switch_branch_Eventually.NotYetDone_0.i21.i:      ; preds = %Eventually.step.exit.i
...
Eventually.step.exit22.i:                         ; preds = %switch_branch_Eventually.NotYetDone_0.i21.i, %switch_branch_Eventually.Done_0.i20.i
  %common.ret.op.i19.i = phi ptr [ %41, %switch_branch_Eventually.Done_0.i20.i ], [ %47, %switch_branch_Eventually.NotYetDone_0.i21.i ]
  ...
  store ptr @"Eventually.#let_closure_468", ptr %let_func_0.i4.i, align 8
  ...
  br i1 %switch.i23.i, label %switch_branch_Eventually.Done_0.i25.i, label %switch_branch_Eventually.NotYetDone_0.i26.i

switch_branch_Eventually.Done_0.i25.i:            ; preds = %Eventually.step.exit22.i
  %53 = tail call ptr @malgo_malloc(i64 noundef 16)
  store i8 0, ptr %53, align 1
  %54 = getelementptr { i8, { ptr } }, ptr %53, i64 0, i32 1, i32 0
  store ptr %52, ptr %54, align 8
  br label %Eventually.step.exit27.i

switch_branch_Eventually.NotYetDone_0.i26.i:      ; preds = %Eventually.step.exit22.i
...
Eventually.step.exit27.i:                         ; preds = %switch_branch_Eventually.NotYetDone_0.i26.i, %switch_branch_Eventually.Done_0.i25.i
  %common.ret.op.i24.i = phi ptr [ %53, %switch_branch_Eventually.Done_0.i25.i ], [ %59, %switch_branch_Eventually.NotYetDone_0.i26.i ]
  ...
  store ptr @"Eventually.#let_closure_468", ptr %let_func_0.i6.i, align 8
  ...
  br i1 %switch.i28.i, label %switch_branch_Eventually.Done_0.i30.i, label %switch_branch_Eventually.NotYetDone_0.i31.i

switch_branch_Eventually.Done_0.i30.i:            ; preds = %Eventually.step.exit27.i
...
switch_branch_Eventually.NotYetDone_0.i31.i:      ; preds = %Eventually.step.exit27.i
...
Eventually.main.exit:                             ; preds = %switch_branch_Eventually.Done_0.i30.i, %switch_branch_Eventually.NotYetDone_0.i31.i
  %common.ret.op.i29.i = phi ptr [ %65, %switch_branch_Eventually.Done_0.i30.i ], [ %71, %switch_branch_Eventually.NotYetDone_0.i31.i ]
  ...
  store ptr @"Eventually.#let_closure_468", ptr %let_func_0.i8.i, align 8
  ...
  store ptr @"Eventually.#fun_closure_535", ptr %fun_func_0.i2, align 8
...
define internal noundef ptr @"Eventually.#fun_closure_630"(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %1) {
...
define internal noundef ptr @"Eventually.#fun_closure_633"(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %1) {
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  store i8 0, ptr %3, align 1
  %4 = getelementptr { i8, { ptr } }, ptr %3, i64 0, i32 1, i32 0
...
define internal ptr @"Eventually.#fun_closure_635"(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %1) {
  %3 = load ptr, ptr @Eventually.eventually, align 8
  %4 = tail call ptr @malgo_hash_table_get(ptr %3, ptr noundef nonnull @str438)
  %5 = tail call ptr @malgo_hash_table_get(ptr %3, ptr noundef nonnull @str439)
...
define internal ptr @"Eventually.#fun_closure_632"(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %1) {
  %3 = load ptr, ptr @Eventually.eventually, align 8
  %4 = tail call ptr @malgo_hash_table_get(ptr %3, ptr noundef nonnull @str438)
  %5 = tail call ptr @malgo_hash_table_get(ptr %3, ptr noundef nonnull @str439)
  %6 = tail call ptr @malgo_malloc(i64 noundef 16)
