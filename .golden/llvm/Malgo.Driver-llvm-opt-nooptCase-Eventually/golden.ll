...
define internal ptr @"test/testcases/malgo/Eventually.mlg.#fun_closure_547"(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %1) {
...
"switch_branch_test/testcases/malgo/Eventually.mlg.NotYetDone_0.i": ; preds = %2
  ...
  store ptr @str615, ptr %12, align 8
  %13 = tail call ptr @malgo_print_string(ptr noundef nonnull @str615)
  br label %"test/testcases/malgo/Eventually.mlg.$raw_fun_418.exit"
...
define internal ptr @"test/testcases/malgo/Eventually.mlg.#let_closure_553"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
...
"switch_branch_test/testcases/malgo/Eventually.mlg.NotYetDone_0.i": ; preds = %2
  ...
  store ptr @"test/testcases/malgo/Eventually.mlg.#fun_closure_622", ptr %fun_func_0.i, align 8
...
define internal ptr @"test/testcases/malgo/Eventually.mlg.#let_closure_554"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define internal ptr @"test/testcases/malgo/Eventually.mlg.#fun_closure_622"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %0, ptr nocapture nofree readnone %1) {
  ...
  store ptr @"test/testcases/malgo/Eventually.mlg.#let_closure_553", ptr %let_func_0.i.i, align 8
...
"switch_branch_test/testcases/malgo/Eventually.mlg.NotYetDone_0.i.i.i": ; preds = %2
  ...
  store ptr @"test/testcases/malgo/Eventually.mlg.#fun_closure_622", ptr %fun_func_0.i.i.i, align 8
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  %eventuallyBind_func_0.i = getelementptr { ptr, ptr }, ptr %5, i64 0, i32 1
  store ptr @"test/testcases/malgo/Eventually.mlg.eventuallyBind", ptr %eventuallyBind_func_0.i, align 8
  tail call void @malgo_hash_table_insert(ptr %4, ptr noundef nonnull @str549, ptr noundef nonnull %5)
  ...
  tail call void @malgo_hash_table_insert(ptr %4, ptr noundef nonnull @str550, ptr noundef nonnull %6)
  store ptr %4, ptr @"test/testcases/malgo/Eventually.mlg.eventually", align 8
  %7 = tail call ptr @malgo_hash_table_get(ptr %4, ptr noundef nonnull @str549)
  %8 = tail call ptr @malgo_hash_table_get(ptr %4, ptr noundef nonnull @str550)
  ...
  store ptr @"test/testcases/malgo/Eventually.mlg.#let_closure_554", ptr %let_func_0.i.i, align 8
...
"test/testcases/malgo/Eventually.mlg.step.exit.i": ; preds = %"switch_branch_test/testcases/malgo/Eventually.mlg.NotYetDone_0.i.i", %"switch_branch_test/testcases/malgo/Eventually.mlg.Done_0.i.i"
  ...
  store ptr @"test/testcases/malgo/Eventually.mlg.#let_closure_554", ptr %let_func_0.i2.i, align 8
...
"test/testcases/malgo/Eventually.mlg.step.exit22.i": ; preds = %"switch_branch_test/testcases/malgo/Eventually.mlg.NotYetDone_0.i21.i", %"switch_branch_test/testcases/malgo/Eventually.mlg.Done_0.i20.i"
  ...
  store ptr @"test/testcases/malgo/Eventually.mlg.#let_closure_554", ptr %let_func_0.i4.i, align 8
...
"test/testcases/malgo/Eventually.mlg.step.exit27.i": ; preds = %"switch_branch_test/testcases/malgo/Eventually.mlg.NotYetDone_0.i26.i", %"switch_branch_test/testcases/malgo/Eventually.mlg.Done_0.i25.i"
  ...
  store ptr @"test/testcases/malgo/Eventually.mlg.#let_closure_554", ptr %let_func_0.i6.i, align 8
...
"test/testcases/malgo/Eventually.mlg.main.exit":  ; preds = %"switch_branch_test/testcases/malgo/Eventually.mlg.Done_0.i30.i", %"switch_branch_test/testcases/malgo/Eventually.mlg.NotYetDone_0.i31.i"
  ...
  store ptr @"test/testcases/malgo/Eventually.mlg.#let_closure_554", ptr %let_func_0.i8.i, align 8
  ...
  store ptr @"test/testcases/malgo/Eventually.mlg.#fun_closure_547", ptr %fun_func_0.i2, align 8
...
define internal ptr @"test/testcases/malgo/Eventually.mlg.#fun_closure_635"(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %1) {
  ...
  %4 = tail call ptr @malgo_hash_table_get(ptr %3, ptr noundef nonnull @str549)
  %5 = tail call ptr @malgo_hash_table_get(ptr %3, ptr noundef nonnull @str550)
