...
define internal double @"TestArithDouble.#let_closure_3128"(ptr %0, double %1) {
...
define internal ptr @Builtin.malgo_add_double(ptr %0, double %"Builtin.$p_1880_0") {
  ...
  store ptr @"TestArithDouble.#let_closure_3128", ptr %let_func_0, align 8
  ret ptr %2
}

define internal double @"TestArithDouble.#let_closure_3129"(ptr %0, double %1) {
  %p_addr_0 = getelementptr { double }, ptr %0, i32 0, i32 0
  %p_0 = load double, ptr %p_addr_0, align 8
...
define internal ptr @Builtin.malgo_mul_double(ptr %0, double %"Builtin.$p_1892_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"TestArithDouble.#let_closure_3129", ptr %let_func_0, align 8
  ret ptr %2
}
...
define internal double @"TestArithDouble.#let_closure_3130"(ptr %0, double %1) {
...
define internal double @TestArithDouble.neg(ptr %0, double %"TestArithDouble.$x_100_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"TestArithDouble.#let_closure_3130", ptr %let_func_0, align 8
  %3 = call double @"Builtin.$malgo_sub_double_curry_1888"(ptr null, double 0.000000e+00, double %"TestArithDouble.$x_100_0")
  ret double %3
}

define internal double @"TestArithDouble.#let_closure_3132"(ptr %0, double %1) {
...
define internal double @"TestArithDouble.#let_closure_3131"(ptr %0, double %1) {
  %x_addr_0 = getelementptr { double }, ptr %0, i32 0, i32 0
  %x_0 = load double, ptr %x_addr_0, align 8
  ...
  store ptr @"TestArithDouble.#let_closure_3132", ptr %let_func_0, align 8
...
define internal ptr @TestArithDouble.mul(ptr %0, double %"TestArithDouble.$x_104_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"TestArithDouble.#let_closure_3131", ptr %let_func_0, align 8
  ret ptr %2
}

define internal double @"TestArithDouble.#let_closure_3134"(ptr %0, double %1) {
  %x_addr_0 = getelementptr { double }, ptr %0, i32 0, i32 0
  %x_0 = load double, ptr %x_addr_0, align 8
...
define internal double @"TestArithDouble.#let_closure_3133"(ptr %0, double %1) {
  %x_addr_0 = getelementptr { double }, ptr %0, i32 0, i32 0
  %x_0 = load double, ptr %x_addr_0, align 8
  %3 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ ptr, ptr }, ptr null, i32 1) to i64))
  %let_capture_0 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ double }, ptr null, i32 1) to i64))
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %3, i32 0, i32 1
  store ptr @"TestArithDouble.#let_closure_3134", ptr %let_func_0, align 8
  %4 = getelementptr { ptr, ptr }, ptr %3, i32 0, i32 0
  %5 = load ptr, ptr %4, align 8
  %6 = getelementptr { ptr, ptr }, ptr %3, i32 0, i32 1
  %7 = load ptr, ptr %6, align 8
...
define internal ptr @TestArithDouble.add(ptr %0, double %"TestArithDouble.$x_116_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"TestArithDouble.#let_closure_3133", ptr %let_func_0, align 8
  ret ptr %2
}
...
define internal ptr @"TestArithDouble.*"(ptr %0, double %"TestArithDouble.$x_140_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"TestArithDouble.#let_closure_3137", ptr %let_func_0, align 8
  ret ptr %2
}

define internal double @"TestArithDouble.#let_closure_3139"(ptr %0, double %1) {
  %malgo_add_double_addr_0 = getelementptr { ptr, double }, ptr %0, i32 0, i32 0
  %malgo_add_double_0 = load ptr, ptr %malgo_add_double_addr_0, align 8
  %x_addr_0 = getelementptr { ptr, double }, ptr %0, i32 0, i32 1
  %x_0 = load double, ptr %x_addr_0, align 8
...
define internal double @TestArithDouble.f(ptr %0, double %"TestArithDouble.$x_152_0") {
  %2 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ ptr, ptr }, ptr null, i32 1) to i64))
  %let_capture_0 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ ptr, double }, ptr null, i32 1) to i64))
  %3 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ ptr, ptr }, ptr null, i32 1) to i64))
  ...
  %malgo_add_double_0 = getelementptr { ptr, double }, ptr %let_capture_0, i32 0, i32 0
  store ptr %3, ptr %malgo_add_double_0, align 8
  %x_0 = getelementptr { ptr, double }, ptr %let_capture_0, i32 0, i32 1
  store double %"TestArithDouble.$x_152_0", ptr %x_0, align 8
  %let_capture_1 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 0
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"TestArithDouble.#let_closure_3139", ptr %let_func_0, align 8
  %4 = call double @"Builtin.$addDouble#_curry_4096"(ptr null, double %"TestArithDouble.$x_152_0", double 0.000000e+00)
  ...
  store ptr @"TestArithDouble.#let_closure_3140", ptr %let_func_1, align 8
  %7 = call double @"Builtin.$mulDouble#_curry_2597"(ptr null, double %4, double %"TestArithDouble.$x_152_0")
  ret double %7
}
...
define internal ptr @TestArithDouble.main(ptr %0, ptr %"TestArithDouble.$$__160_0") {
  ...
  store ptr @"TestArithDouble.#let_closure_3142", ptr %let_func_1, align 8
