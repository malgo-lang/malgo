...
define internal i32 @"test/testcases/malgo/Seq.mlg.#let_closure_3649"(ptr %0, i32 %1) {
...
define internal ptr @"runtime/malgo/Builtin.mlg.malgo_add_int32_t"(ptr %0, i32 %"runtime/malgo/Builtin.mlg.$p_1808_0") {
  ...
  store ptr @"test/testcases/malgo/Seq.mlg.#let_closure_3649", ptr %let_func_0, align 8
  ret ptr %2
}
...
define internal i32 @"test/testcases/malgo/Seq.mlg.#let_closure_3654"(ptr %0, i32 %1) {
  %p_addr_0 = getelementptr { i32 }, ptr %0, i32 0, i32 0
  %p_0 = load i32, ptr %p_addr_0, align 4
  %3 = call ptr @"runtime/malgo/Builtin.mlg.malgo_add_int32_t"(ptr null, i32 %p_0)
...
define internal i32 @"test/testcases/malgo/Seq.mlg.#let_closure_3655"(ptr %0, i32 %1) {
  %p_addr_0 = getelementptr { i32 }, ptr %0, i32 0, i32 0
  %p_0 = load i32, ptr %p_addr_0, align 4
  %3 = call ptr @"runtime/malgo/Builtin.mlg.malgo_add_int32_t"(ptr null, i32 %p_0)
  %4 = getelementptr { ptr, ptr }, ptr %3, i32 0, i32 0
...
"switch_branch_runtime/malgo/Builtin.mlg.Int32#_1": ; preds = %"switch_branch_runtime/malgo/Builtin.mlg.Int32#_0"
  ...
  store ptr @"test/testcases/malgo/Seq.mlg.#let_closure_3654", ptr %let_func_0, align 8
  %18 = call i32 @"runtime/malgo/Builtin.mlg.$addInt32#_curry_4032"(ptr null, i32 %11, i32 %16)
...
"switch_branch_runtime/malgo/Builtin.mlg.Int32#_4": ; preds = %"switch_branch_runtime/malgo/Builtin.mlg.Int32#_3"
  ...
  store ptr @"test/testcases/malgo/Seq.mlg.#let_closure_3655", ptr %let_func_1, align 8
  %48 = call i32 @"runtime/malgo/Builtin.mlg.$addInt32#_curry_4032"(ptr null, i32 %41, i32 %46)
  ...
  store ptr %49, ptr @"test/testcases/malgo/Seq.mlg.executeWhenLoaded", align 8
  ret void
