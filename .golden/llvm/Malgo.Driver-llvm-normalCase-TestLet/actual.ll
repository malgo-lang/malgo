...
define internal i32 @"TestLet.#let_closure_2366"(ptr %0, i32 %1) {
...
define internal ptr @TestLet.main(ptr %0, ptr %"TestLet.$$__57_0") {
  ...
  store ptr @"TestLet.#let_closure_2367", ptr %let_func_1, align 8
...
define internal ptr @"TestLet.#let_closure_2368"(ptr %0, ptr %1) {
...
define internal ptr @"TestLet.|>"(ptr %0, ptr %"TestLet.$x_49_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"TestLet.#let_closure_2368", ptr %let_func_0, align 8
  ret ptr %2
}
