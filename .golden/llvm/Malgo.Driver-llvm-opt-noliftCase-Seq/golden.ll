...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr %8, ptr %malgo_add_int32_t_0.i, align 8
  ...
  store ptr @Builtin.malgo_add_int32_t, ptr %malgo_add_int32_t_func_1.i, align 8
  ...
  store ptr %21, ptr @Seq.executeWhenLoaded, align 8
  %23 = tail call ptr @malgo_malloc(i64 noundef 1)
  store i8 0, ptr %23, align 1
  %24 = load ptr, ptr @Seq.executeWhenLoaded, align 8
...
define internal i32 @"Seq.#let_closure_3025"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(4) %0, i32 %1) {
...
define internal i32 @"Seq.#let_closure_3026"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(4) %0, i32 %1) {
  %p_0 = load i32, ptr %0, align 8
  %malgo_add_int32_t_addr_0 = getelementptr { i32, ptr }, ptr %0, i64 0, i32 1
  %malgo_add_int32_t_0 = load ptr, ptr %malgo_add_int32_t_addr_0, align 8
  %3 = load ptr, ptr %malgo_add_int32_t_0, align 8
