...
@str3466 = unnamed_addr constant [5 x i8] c"hoge\00"
@str3467 = unnamed_addr constant [4 x i8] c"snd\00"
@str3468 = unnamed_addr constant [4 x i8] c"fst\00"
...
define internal ptr @"test/testcases/malgo/TestPolySynonym.mlg.#let_closure_3469"(ptr %0, ptr %1) {
...
define internal ptr @"test/testcases/malgo/TestPolySynonym.mlg.main"(ptr %0, ptr %"test/testcases/malgo/TestPolySynonym.mlg.$$__43_0") {
  ...
  store ptr @str3466, ptr %7, align 8
  %8 = call ptr @malgo_hash_table_new()
  call void @malgo_hash_table_insert(ptr %8, ptr @str3467, ptr %5)
  call void @malgo_hash_table_insert(ptr %8, ptr @str3468, ptr %2)
  %9 = call ptr @malgo_hash_table_get(ptr %8, ptr @str3467)
  %10 = call ptr @malgo_hash_table_get(ptr %8, ptr @str3468)
  ...
  store ptr @"test/testcases/malgo/TestPolySynonym.mlg.#let_closure_3469", ptr %let_func_0, align 8
...
define internal ptr @"test/testcases/malgo/TestPolySynonym.mlg.first"(ptr %0, ptr %"test/testcases/malgo/TestPolySynonym.mlg.$record_40_0") {
  %2 = call ptr @malgo_hash_table_get(ptr %"test/testcases/malgo/TestPolySynonym.mlg.$record_40_0", ptr @str3467)
  %3 = call ptr @malgo_hash_table_get(ptr %"test/testcases/malgo/TestPolySynonym.mlg.$record_40_0", ptr @str3468)
  ret ptr %3
}
