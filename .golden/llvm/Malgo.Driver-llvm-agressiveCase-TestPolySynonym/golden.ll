...
@str3466 = unnamed_addr constant [4 x i8] c"snd\00"
@str3467 = unnamed_addr constant [4 x i8] c"fst\00"
@str3468 = unnamed_addr constant [5 x i8] c"hoge\00"
...
define internal ptr @TestPolySynonym.first(ptr %0, ptr %"TestPolySynonym.$record_40_0") {
  %2 = call ptr @malgo_hash_table_get(ptr %"TestPolySynonym.$record_40_0", ptr @str3466)
  %3 = call ptr @malgo_hash_table_get(ptr %"TestPolySynonym.$record_40_0", ptr @str3467)
  ret ptr %3
}
...
define internal ptr @"TestPolySynonym.#let_closure_3469"(ptr %0, ptr %1) {
...
define internal ptr @TestPolySynonym.main(ptr %0, ptr %"TestPolySynonym.$$__43_0") {
  ...
  store ptr @str3468, ptr %7, align 8
  %8 = call ptr @malgo_hash_table_new()
  call void @malgo_hash_table_insert(ptr %8, ptr @str3466, ptr %5)
  call void @malgo_hash_table_insert(ptr %8, ptr @str3467, ptr %2)
  %9 = call ptr @malgo_hash_table_get(ptr %8, ptr @str3466)
  %10 = call ptr @malgo_hash_table_get(ptr %8, ptr @str3467)
