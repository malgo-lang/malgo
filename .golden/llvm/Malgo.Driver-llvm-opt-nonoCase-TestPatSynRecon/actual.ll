; ModuleID = './test/tmp/malgo_test/nono/TestPatSynRecon.ll'
...
define internal noundef ptr @"TestPatSynRecon.#let_closure_149"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
...
define internal ptr @"TestPatSynRecon.#let_closure_150"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define internal i64 @"TestPatSynRecon.#let_closure_174"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
...
define internal i64 @"TestPatSynRecon.#let_closure_333"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  ...
  store ptr @"TestPatSynRecon.#let_closure_174", ptr %let_func_0.i.i, align 8
...
define internal i64 @"TestPatSynRecon.#let_closure_341"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  %x_0 = load i64, ptr %0, align 4
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %3, align 8
  ...
  store ptr %let_capture_0.i.i, ptr %4, align 8
  %let_func_0.i.i = getelementptr { ptr, ptr }, ptr %4, i64 0, i32 1
  store ptr @"TestPatSynRecon.#let_closure_333", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"TestPatSynRecon.#let_closure_174", ptr %let_func_0.i.i.i.i, align 8
  %p_0.i.i.i.i = load i64, ptr %let_capture_0.i.i.i.i, align 4
  %7 = tail call i64 @malgo_add_int64_t(i64 %p_0.i.i.i.i, i64 %1)
  ret i64 %7
}

define internal ptr @"TestPatSynRecon.+#"(ptr nocapture nofree readnone %0, i64 %"TestPatSynRecon.$x_83_0") {
  %2 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0 = tail call ptr @malgo_malloc(i64 noundef 8)
  store i64 %"TestPatSynRecon.$x_83_0", ptr %let_capture_0, align 4
  store ptr %let_capture_0, ptr %2, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i64 0, i32 1
...
define internal ptr @"TestPatSynRecon.#fun_closure_342"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(24) %0, ptr nocapture nofree readonly align 4 %1) {
"switch_branch_Builtin.Int64#_0":
  %"+#_0" = load ptr, ptr %0, align 8
  %"Int64#_addr_0" = getelementptr { ptr, ptr, i64 }, ptr %0, i64 0, i32 1
...
define internal ptr @TestPatSynRecon.sum(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %"TestPatSynRecon.$cons_95_0") {
...
common.ret:                                       ; preds = %switch_branch_Prelude.Cons_0, %switch_branch_Prelude.Nil_0
  %common.ret.op = phi ptr [ %4, %switch_branch_Prelude.Nil_0 ], [ %21, %switch_branch_Prelude.Cons_0 ]
...
switch_branch_Prelude.Cons_0:                     ; preds = %1
  %6 = getelementptr { i8, { ptr, ptr } }, ptr %"TestPatSynRecon.$cons_95_0", i64 0, i32 1
  %7 = load ptr, ptr %6, align 8
  %8 = getelementptr { i8, { ptr, ptr } }, ptr %"TestPatSynRecon.$cons_95_0", i64 0, i32 1, i32 1
  ...
  %13 = tail call ptr @TestPatSynRecon.sum(ptr poison, ptr nocapture nofree readonly %9)
  %14 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %14, align 8
  ...
  store ptr @"TestPatSynRecon.#let_closure_150", ptr %let_func_0.i, align 8
  %16 = tail call ptr @malgo_malloc(i64 noundef 16)
  %fun_capture_0 = tail call ptr @malgo_malloc(i64 noundef 24)
  %17 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %17, align 8
  %"+#_func_0" = getelementptr { ptr, ptr }, ptr %17, i64 0, i32 1
  ...
  %"Int64#_func_1" = getelementptr { ptr, ptr }, ptr %18, i64 0, i32 1
  store ptr @"Builtin.Int64#", ptr %"Int64#_func_1", align 8
  %"Int64#_0" = getelementptr { ptr, ptr, i64 }, ptr %fun_capture_0, i64 0, i32 1
  store ptr %18, ptr %"Int64#_0", align 8
...
define internal ptr @"TestPatSynRecon.#fun_closure_343"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"TestPatSynRecon.#let_closure_149", ptr %let_func_0.i.i, align 8
  %11 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %11, align 8
  ...
  store ptr @"TestPatSynRecon.#let_closure_149", ptr %let_func_0.i2.i, align 8
  ...
  %24 = tail call ptr @TestPatSynRecon.sum(ptr poison, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %22)
  ...
  store ptr @"TestPatSynRecon.#let_closure_150", ptr %let_func_0.i4.i, align 8
  ...
  store ptr @"TestPatSynRecon.#fun_closure_343", ptr %fun_func_0.i, align 8
