...
define internal double @"test/testcases/malgo/TestArithDouble.mlg.#let_closure_3136"(ptr nocapture nofree readnone %0, double %1) {
  %3 = tail call double @malgo_add_double(double noundef 5.000000e-01, double %1)
  ret double %3
}

define internal double @"test/testcases/malgo/TestArithDouble.mlg.#let_closure_3137"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, double %1) {
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/TestArithDouble.mlg.#let_closure_3136", ptr %let_func_0.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestArithDouble.mlg.#let_closure_3137", ptr %let_func_1.i, align 8
