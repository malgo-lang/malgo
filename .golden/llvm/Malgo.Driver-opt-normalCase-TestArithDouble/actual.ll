...
define internal double @_M36let_x24a59_x24fe9_x5Fclosure_x24101652test_x2Ftestcases_x2Fmalgo_x2FTestArithDouble_x2Emlg8Internal(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, double %1) {
  %"d$9b$f9e_0" = load double, ptr %0, align 8
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  %"let$a59$fe9_capture_0.i" = tail call ptr @malgo_malloc(i64 noundef 8)
  store double %4, ptr %"let$a59$fe9_capture_0.i", align 8
  store ptr %"let$a59$fe9_capture_0.i", ptr %5, align 8
  %"let$a59$fe9_func_0.i" = getelementptr { ptr, ptr }, ptr %5, i64 0, i32 1
  store ptr @_M36let_x24a59_x24fe9_x5Fclosure_x24101652test_x2Ftestcases_x2Fmalgo_x2FTestArithDouble_x2Emlg8Internal, ptr %"let$a59$fe9_func_0.i", align 8
