...
define internal ptr @_M36let_x242c2_x24f67_x5Fclosure_x2411af47test_x2Ftestcases_x2Fmalgo_x2FTestEither_x2Emlg8Internal(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
  %"d$111_0" = load ptr, ptr %0, align 8
  %3 = load ptr, ptr %1, align 8
  %4 = getelementptr { ptr, ptr }, ptr %1, i64 0, i32 1
  %5 = load ptr, ptr %4, align 8
  %6 = tail call ptr %5(ptr %3, ptr %"d$111_0")
  ret ptr %6
}

define internal ptr @_M29fun_x2411f_x5Fclosure_x2411b047test_x2Ftestcases_x2Fmalgo_x2FTestEither_x2Emlg8Internal(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %1) {
...
switch_branch_Left_0.i:                           ; preds = %2
  ...
  br label %_M25raw_x5Ffun_x2411f_x24115c47test_x2Ftestcases_x2Fmalgo_x2FTestEither_x2Emlg8Temporal.exit
...
_M25raw_x5Ffun_x2411f_x24115c47test_x2Ftestcases_x2Fmalgo_x2FTestEither_x2Emlg8Temporal.exit: ; preds = %switch_branch_Left_0.i, %switch_branch_Right_0.i
...
define internal ptr @_M36let_x242c2_x24fd3_x5Fclosure_x2411ca47test_x2Ftestcases_x2Fmalgo_x2FTestEither_x2Emlg8Internal(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
  %"d$167_0" = load ptr, ptr %0, align 8
  %3 = load ptr, ptr %1, align 8
  %4 = getelementptr { ptr, ptr }, ptr %1, i64 0, i32 1
  %5 = load ptr, ptr %4, align 8
  %6 = tail call ptr %5(ptr %3, ptr %"d$167_0")
  ret ptr %6
}

define internal ptr @_M29fun_x24177_x5Fclosure_x2411cb47test_x2Ftestcases_x2Fmalgo_x2FTestEither_x2Emlg8Internal(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(1) %1) {
  %.val = load i8, ptr %1, align 8
  %3 = getelementptr i8, ptr %1, i64 8
  %.val1 = load ptr, ptr %3, align 8
  %switch.i = icmp eq i8 %.val, 0
  br i1 %switch.i, label %_M25raw_x5Ffun_x24177_x24118147test_x2Ftestcases_x2Fmalgo_x2FTestEither_x2Emlg8Temporal.exit, label %switch_branch_Right_0.i
...
switch_branch_Right_0.i:                          ; preds = %2
  ...
  %"d$88a$1060_0.i.i" = load ptr, ptr %"let$2c2$fe4_capture_0.i", align 8
  br label %_M25raw_x5Ffun_x24177_x24118147test_x2Ftestcases_x2Fmalgo_x2FTestEither_x2Emlg8Temporal.exit

_M25raw_x5Ffun_x24177_x24118147test_x2Ftestcases_x2Fmalgo_x2FTestEither_x2Emlg8Temporal.exit: ; preds = %2, %switch_branch_Right_0.i
  %"d$88a$1060_0.i.sink.i" = phi ptr [ %"d$88a$1060_0.i.i", %switch_branch_Right_0.i ], [ %.val1, %2 ]
  %11 = getelementptr { i8, { ptr } }, ptr %"d$88a$1060_0.i.sink.i", i64 0, i32 1
...
define internal ptr @_M29fun_x24177_x5Fclosure_x2411cf47test_x2Ftestcases_x2Fmalgo_x2FTestEither_x2Emlg8Internal(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(1) %1) {
  %.val = load i8, ptr %1, align 8
  %3 = getelementptr i8, ptr %1, i64 8
  %.val1 = load ptr, ptr %3, align 8
  %switch.i = icmp eq i8 %.val, 0
  br i1 %switch.i, label %_M25raw_x5Ffun_x24177_x24118447test_x2Ftestcases_x2Fmalgo_x2FTestEither_x2Emlg8Temporal.exit, label %switch_branch_Right_0.i
...
switch_branch_Right_0.i:                          ; preds = %2
  ...
  store ptr @_M8putStrLn34runtime_x2Fmalgo_x2FPrelude_x2Emlg8External, ptr %putStrLn_func_0.i, align 8
  %"d$88a$1060_0.i.i" = load ptr, ptr %"let$2c2$fe4_capture_0.i", align 8
  br label %_M25raw_x5Ffun_x24177_x24118447test_x2Ftestcases_x2Fmalgo_x2FTestEither_x2Emlg8Temporal.exit

_M25raw_x5Ffun_x24177_x24118447test_x2Ftestcases_x2Fmalgo_x2FTestEither_x2Emlg8Temporal.exit: ; preds = %2, %switch_branch_Right_0.i
  %"d$88a$1060_0.i.sink.i" = phi ptr [ %"d$88a$1060_0.i.i", %switch_branch_Right_0.i ], [ %.val1, %2 ]
  %11 = getelementptr { i8, { ptr } }, ptr %"d$88a$1060_0.i.sink.i", i64 0, i32 1
  %12 = load ptr, ptr %11, align 8
  %13 = tail call ptr @malgo_print_string(ptr %12)
...
define internal noundef ptr @_M30let_x2410c5_x5Fclosure_x2411d247test_x2Ftestcases_x2Fmalgo_x2FTestEither_x2Emlg8Internal(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  ...
  store i32 %"int32#$10ae_0.val", ptr %"let$715$dcf_capture_0.i", align 4
...
define internal ptr @_M6putStr34runtime_x2Fmalgo_x2FPrelude_x2Emlg8External(ptr nocapture nofree readnone %0, ptr nocapture nofree readonly align 8 %_M16str_x245a_x242d434runtime_x2Fmalgo_x2FPrelude_x2Emlg8Temporal_0) {
"switch_branch_String#_0":
  %1 = getelementptr { i8, { ptr } }, ptr %_M16str_x245a_x242d434runtime_x2Fmalgo_x2FPrelude_x2Emlg8Temporal_0, i64 0, i32 1
...
define internal ptr @_M36let_x242c2_x24fe4_x5Fclosure_x2411f847test_x2Ftestcases_x2Fmalgo_x2FTestEither_x2Emlg8Internal(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
  %"d$88a$1060_0" = load ptr, ptr %0, align 8
  %3 = load ptr, ptr %1, align 8
  %4 = getelementptr { ptr, ptr }, ptr %1, i64 0, i32 1
  %5 = load ptr, ptr %4, align 8
  %6 = tail call ptr %5(ptr %3, ptr %"d$88a$1060_0")
  ret ptr %6
}
...
define internal ptr @_M36let_x242c2_x24f99_x5Fclosure_x24122547test_x2Ftestcases_x2Fmalgo_x2FTestEither_x2Emlg8Internal(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
  %"d$88a$103c_0" = load ptr, ptr %0, align 8
  %3 = load ptr, ptr %1, align 8
  %4 = getelementptr { ptr, ptr }, ptr %1, i64 0, i32 1
  %5 = load ptr, ptr %4, align 8
  %6 = tail call ptr %5(ptr %3, ptr %"d$88a$103c_0")
  ret ptr %6
}
...
define internal ptr @_M36let_x242c2_x24f9f_x5Fclosure_x24122647test_x2Ftestcases_x2Fmalgo_x2FTestEither_x2Emlg8Internal(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
  %"cast$142_0" = load ptr, ptr %0, align 8
  %3 = load ptr, ptr %1, align 8
  %4 = getelementptr { ptr, ptr }, ptr %1, i64 0, i32 1
  %5 = load ptr, ptr %4, align 8
  %6 = tail call ptr %5(ptr %3, ptr %"cast$142_0")
  ret ptr %6
}
...
define internal i32 @_M36let_x24715_x24dcf_x5Fclosure_x24122747test_x2Ftestcases_x2Fmalgo_x2FTestEither_x2Emlg8Internal(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  %"p$10b0$10bd$db2_0" = load i32, ptr %0, align 4
  %3 = tail call i32 @malgo_add_int32_t(i32 %"p$10b0$10bd$db2_0", i32 %1)
  ret i32 %3
}
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  %"fun$11f_capture_0.i" = tail call ptr @malgo_malloc(i64 noundef 0)
  store ptr %"fun$11f_capture_0.i", ptr %8, align 8
  %"fun$11f_func_0.i" = getelementptr { ptr, ptr }, ptr %8, i64 0, i32 1
  store ptr @_M29fun_x2411f_x5Fclosure_x2411b047test_x2Ftestcases_x2Fmalgo_x2FTestEither_x2Emlg8Internal, ptr %"fun$11f_func_0.i", align 8
  ...
  store ptr %12, ptr %"let$10c5_capture_0.i.i", align 8
  store ptr %"let$10c5_capture_0.i.i", ptr %16, align 8
  %"let$10c5_func_0.i.i" = getelementptr { ptr, ptr }, ptr %16, i64 0, i32 1
  store ptr @_M30let_x2410c5_x5Fclosure_x2411d247test_x2Ftestcases_x2Fmalgo_x2FTestEither_x2Emlg8Internal, ptr %"let$10c5_func_0.i.i", align 8
  %17 = tail call ptr @malgo_malloc(i64 noundef 8)
  store i8 0, ptr %17, align 1
  %18 = getelementptr { i8, { i32 } }, ptr %17, i64 0, i32 1, i32 0
  store i32 1, ptr %18, align 4
  %19 = load ptr, ptr %16, align 8
  %20 = load ptr, ptr %"let$10c5_func_0.i.i", align 8
  ...
  %"d$88a$103c_0.i.i.i" = load ptr, ptr %"let$2c2$f99_capture_0.i.i", align 8
  %30 = getelementptr { i8, { ptr } }, ptr %"d$88a$103c_0.i.i.i", i64 0, i32 1
...
_M4main47test_x2Ftestcases_x2Fmalgo_x2FTestEither_x2Emlg8External.exit: ; preds = %switch_branch_Left_12.i, %switch_branch_Right_13.i
  %_M29fun_x24177_x5Fclosure_x2411cf47test_x2Ftestcases_x2Fmalgo_x2FTestEither_x2Emlg8Internal.sink.i = phi ptr [ @_M29fun_x24177_x5Fclosure_x2411cf47test_x2Ftestcases_x2Fmalgo_x2FTestEither_x2Emlg8Internal, %switch_branch_Right_13.i ], [ @_M29fun_x24177_x5Fclosure_x2411cb47test_x2Ftestcases_x2Fmalgo_x2FTestEither_x2Emlg8Internal, %switch_branch_Left_12.i ]
  ...
  %"fun$177_capture_28.i" = tail call ptr @malgo_malloc(i64 noundef 0)
  store ptr %"fun$177_capture_28.i", ptr %52, align 8
  %"fun$177_func_14.i" = getelementptr { ptr, ptr }, ptr %52, i64 0, i32 1
  store ptr %_M29fun_x24177_x5Fclosure_x2411cf47test_x2Ftestcases_x2Fmalgo_x2FTestEither_x2Emlg8Internal.sink.i, ptr %"fun$177_func_14.i", align 8
