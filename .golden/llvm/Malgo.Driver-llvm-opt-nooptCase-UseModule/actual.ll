; ModuleID = '/workspaces/malgo/.malgo-work/UseModule.ll'
...
define internal ptr @"UseModule.#let_closure_123"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
...
define internal ptr @Prelude.printInt32(ptr nocapture nofree readnone %0, ptr nocapture nofree readonly align 4 %"Prelude.$i_773_0") {
  %2 = getelementptr i8, ptr %"Prelude.$i_773_0", i64 4
  %"Prelude.$i_773_0.val" = load i32, ptr %2, align 4
  %3 = tail call ptr @malgo_int32_t_to_string(i32 %"Prelude.$i_773_0.val")
...
define internal noundef ptr @"UseModule.#let_closure_182"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  ...
  store ptr @"UseModule.#let_closure_203", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"UseModule.#let_closure_277", ptr %let_func_0.i.i.i.i, align 8
...
define internal i32 @"UseModule.#let_closure_203"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  ...
  store ptr @"UseModule.#let_closure_277", ptr %let_func_0.i.i, align 8
  %p_0.i.i = load i32, ptr %let_capture_0.i.i, align 4
  %4 = tail call i32 @malgo_add_int32_t(i32 %p_0.i.i, i32 %1)
  ret i32 %4
}

define internal ptr @"UseModule.#let_closure_247"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
  %f_0 = load ptr, ptr %0, align 8
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  ...
  store ptr @"UseModule.#fun_closure_264", ptr %fun_func_0.i, align 8
  ret ptr %3
}

define internal ptr @"UseModule.#fun_closure_264"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %0, ptr %1) {
...
define internal ptr @UseModule.succ(ptr nocapture nofree readnone %0, ptr nofree %"UseModule.$x_36_0") {
  ...
  store ptr @"UseModule.#let_closure_182", ptr %let_func_0.i, align 8
...
define internal i32 @"UseModule.#let_closure_277"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @str286, ptr %6, align 8
  %7 = tail call ptr @malgo_print_string(ptr noundef nonnull @str286)
  ...
  store ptr @"UseModule.#let_closure_123", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"UseModule.#let_closure_247", ptr %let_func_0.i2.i, align 8
  ...
  store ptr %15, ptr %fun_capture_0.i.i.i, align 8
  ...
  store ptr @"UseModule.#fun_closure_264", ptr %fun_func_0.i.i.i, align 8
