...
define internal ptr @"test/testcases/malgo/UseModule.mlg.#let_closure_172"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
...
define internal ptr @"test/testcases/malgo/UseModule.mlg.succ"(ptr nocapture nofree readnone %0, ptr nofree %"test/testcases/malgo/UseModule.mlg.$x_36_0") {
  ...
  store ptr @"test/testcases/malgo/UseModule.mlg.#let_closure_202", ptr %let_func_0.i, align 8
...
define internal noundef ptr @"test/testcases/malgo/UseModule.mlg.#let_closure_202"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  ...
  store ptr @"test/testcases/malgo/UseModule.mlg.#let_closure_209", ptr %let_func_0.i.i.i.i, align 8
...
define internal i32 @"test/testcases/malgo/UseModule.mlg.#let_closure_209"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
...
define internal i32 @"test/testcases/malgo/UseModule.mlg.#let_closure_221"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  ...
  store ptr @"test/testcases/malgo/UseModule.mlg.#let_closure_209", ptr %let_func_0.i.i, align 8
  %p_0.i.i = load i32, ptr %let_capture_0.i.i, align 4
  %4 = tail call i32 @malgo_add_int32_t(i32 %p_0.i.i, i32 %1)
  ret i32 %4
}

define internal ptr @"test/testcases/malgo/UseModule.mlg.#fun_closure_238"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %0, ptr %1) {
  %f_0 = load ptr, ptr %0, align 8
...
define internal ptr @"test/testcases/malgo/UseModule.mlg.#let_closure_255"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
  %f_0 = load ptr, ptr %0, align 8
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  ...
  store ptr @"test/testcases/malgo/UseModule.mlg.#fun_closure_238", ptr %fun_func_0.i, align 8
  ret ptr %3
}
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @str135, ptr %6, align 8
  %7 = tail call ptr @malgo_print_string(ptr noundef nonnull @str135)
  ...
  store ptr @"test/testcases/malgo/UseModule.mlg.#let_closure_172", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/UseModule.mlg.#let_closure_255", ptr %let_func_0.i2.i, align 8
  ...
  store ptr @"test/testcases/malgo/UseModule.mlg.#fun_closure_238", ptr %fun_func_0.i.i.i, align 8
