...
define internal ptr @"test/testcases/malgo/With.mlg.#fun_closure_3031"(ptr nocapture nofree readnone %0, ptr nocapture nofree readonly align 8 %1) {
...
define internal ptr @"test/testcases/malgo/With.mlg.#fun_closure_3032"(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %1) {
  ...
  store ptr @"test/testcases/malgo/With.mlg.#fun_closure_3031", ptr %fun_func_0.i, align 8
...
define internal ptr @"test/testcases/malgo/With.mlg.#fun_closure_3035"(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %1) {
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  store i8 0, ptr %3, align 1
  %4 = getelementptr { i8, { ptr } }, ptr %3, i64 0, i32 1, i32 0
  store ptr @str3033, ptr %4, align 8
  %5 = tail call ptr @malgo_print_string(ptr noundef nonnull @str3033)
  ret ptr %5
}

define internal ptr @"test/testcases/malgo/With.mlg.#let_closure_3036"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly %1) {
...
define internal ptr @"test/testcases/malgo/With.mlg.#fun_closure_3037"(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %1) {
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  %fun_capture_0.i = tail call ptr @malgo_malloc(i64 noundef 0)
  store ptr %fun_capture_0.i, ptr %3, align 8
  %fun_func_0.i = getelementptr { ptr, ptr }, ptr %3, i64 0, i32 1
  store ptr @"test/testcases/malgo/With.mlg.#fun_closure_3032", ptr %fun_func_0.i, align 8
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/With.mlg.#let_closure_3036", ptr %let_func_0.i, align 8
  %5 = tail call ptr @malgo_malloc(i64 noundef 16)
  ...
  store ptr @"test/testcases/malgo/With.mlg.#fun_closure_3037", ptr %fun_func_1.i, align 8
