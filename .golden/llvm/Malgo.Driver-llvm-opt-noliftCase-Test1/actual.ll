; ModuleID = './test/tmp/malgo_test/nolift/Test1.ll'
...
define internal ptr @"Test1.#let_closure_97"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly %1) {
  %d_0 = load ptr, ptr %0, align 8
  %3 = load i8, ptr %d_0, align 1
  %switch = icmp eq i8 %3, 0
  br i1 %switch, label %switch_branch_Test1.True_0, label %common.ret

common.ret:                                       ; preds = %2, %switch_branch_Test1.True_0
  %.sink5 = phi ptr [ %t_0, %switch_branch_Test1.True_0 ], [ %1, %2 ]
...
define internal ptr @"Test1.#let_closure_96"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
  %d_0 = load ptr, ptr %0, align 8
...
define internal ptr @"Test1.#fun_closure_98"(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %1) {
  %3 = tail call ptr @malgo_print_string(ptr noundef nonnull @str99)
  ret ptr %3
}

define internal ptr @"Test1.#fun_closure_100"(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %1) {
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"Test1.#let_closure_96", ptr %let_func_0.i, align 8
  ...
  store ptr @"Test1.#fun_closure_98", ptr %fun_func_0.i, align 8
  ...
  store ptr @"Test1.#fun_closure_100", ptr %fun_func_1.i, align 8
