...
@str83 = unnamed_addr constant [6 x i8] c"False\00"
@str84 = unnamed_addr constant [5 x i8] c"True\00"
...
define internal ptr @"test/testcases/malgo/Test1.mlg.$raw_fun_82"(ptr %0, ptr %"test/testcases/malgo/Test1.mlg.$$__73_0") {
  %2 = call ptr @"test/testcases/malgo/Test1.mlg.malgo_print_string"(ptr null, ptr @str83)
  ret ptr %2
}

define internal ptr @"test/testcases/malgo/Test1.mlg.$raw_fun_81"(ptr %0, ptr %"test/testcases/malgo/Test1.mlg.$$__67_0") {
  %2 = call ptr @"test/testcases/malgo/Test1.mlg.malgo_print_string"(ptr null, ptr @str84)
  ret ptr %2
}

define internal ptr @"test/testcases/malgo/Test1.mlg.#let_closure_85"(ptr %0, ptr %1) {
  %true_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %true_0 = load ptr, ptr %true_addr_0, align 8
  %3 = call ptr @"test/testcases/malgo/Test1.mlg.$raw_let_79"(ptr null, ptr %true_0, ptr %1)
  ret ptr %3
}
...
define internal ptr @"test/testcases/malgo/Test1.mlg.if"(ptr %0, ptr %"test/testcases/malgo/Test1.mlg.$true_42_0") {
  ...
  store ptr @"test/testcases/malgo/Test1.mlg.#let_closure_85", ptr %let_func_0, align 8
  ret ptr %2
}

define internal ptr @"test/testcases/malgo/Test1.mlg.#let_closure_86"(ptr %0, ptr %1) {
...
define internal ptr @"test/testcases/malgo/Test1.mlg.$raw_let_79"(ptr %0, ptr %"test/testcases/malgo/Test1.mlg.$true_42_0", ptr %"test/testcases/malgo/Test1.mlg.$t_43_0") {
  %2 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ ptr, ptr }, ptr null, i32 1) to i64))
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"test/testcases/malgo/Test1.mlg.#let_closure_86", ptr %let_func_0, align 8
  ret ptr %2
}
...
define internal ptr @"test/testcases/malgo/Test1.mlg.#fun_closure_87"(ptr %0, ptr %1) {
  %3 = call ptr @"test/testcases/malgo/Test1.mlg.$raw_fun_81"(ptr null, ptr %1)
  ret ptr %3
}

define internal ptr @"test/testcases/malgo/Test1.mlg.#fun_closure_88"(ptr %0, ptr %1) {
  %3 = call ptr @"test/testcases/malgo/Test1.mlg.$raw_fun_82"(ptr null, ptr %1)
  ret ptr %3
}
...
define internal ptr @"test/testcases/malgo/Test1.mlg.main"(ptr %0, ptr %"test/testcases/malgo/Test1.mlg.$$__63_0") {
  ...
  %3 = call ptr @"test/testcases/malgo/Test1.mlg.if"(ptr null, ptr %2)
  ...
  store ptr @"test/testcases/malgo/Test1.mlg.#fun_closure_87", ptr %fun_func_0, align 8
  ...
  store ptr @"test/testcases/malgo/Test1.mlg.#fun_closure_88", ptr %fun_func_1, align 8
