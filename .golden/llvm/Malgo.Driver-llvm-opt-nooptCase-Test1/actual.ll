; ModuleID = './test/tmp/malgo_test/noopt/Test1.ll'
...
define internal ptr @"Test1.#fun_closure_83"(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %1) {
  %3 = tail call ptr @malgo_print_string(ptr noundef nonnull @str87)
  ret ptr %3
}

define internal ptr @"Test1.#fun_closure_84"(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %1) {
  %3 = tail call ptr @malgo_print_string(ptr noundef nonnull @str86)
  ret ptr %3
}

define internal ptr @"Test1.#let_closure_85"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
  ...
  store ptr @"Test1.#let_closure_88", ptr %let_func_0.i, align 8
  ret ptr %3
}

define internal ptr @"Test1.#let_closure_88"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %0, ptr nocapture nofree readonly %1) {
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"Test1.#let_closure_85", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"Test1.#fun_closure_83", ptr %fun_func_0.i, align 8
  ...
  store ptr @"Test1.#fun_closure_84", ptr %fun_func_1.i, align 8
