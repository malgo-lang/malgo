...
define internal ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_471"(ptr nocapture nofree readonly %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(1) %1) {
...
"test/testcases/malgo/TestEither.mlg.$andThen_curry_260.exit": ; preds = %"switch_branch_test/testcases/malgo/TestEither.mlg.Left_0.i", %"switch_branch_test/testcases/malgo/TestEither.mlg.Right_0.i"
  %common.ret.op.i = phi ptr [ %6, %"switch_branch_test/testcases/malgo/TestEither.mlg.Left_0.i" ], [ %11, %"switch_branch_test/testcases/malgo/TestEither.mlg.Right_0.i" ]
  ret ptr %common.ret.op.i
}

define internal i32 @"test/testcases/malgo/TestEither.mlg.#let_closure_482"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_489", ptr %let_func_0.i.i, align 8
  %p_0.i.i = load i32, ptr %let_capture_0.i.i, align 4
  %4 = tail call i32 @malgo_add_int32_t(i32 %p_0.i.i, i32 %1)
  ret i32 %4
}

define internal i32 @"test/testcases/malgo/TestEither.mlg.#let_closure_489"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  %p_0 = load i32, ptr %0, align 4
  %3 = tail call i32 @malgo_add_int32_t(i32 %p_0, i32 %1)
  ret i32 %3
}

define internal ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_596"(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %1) {
...
"switch_branch_test/testcases/malgo/TestEither.mlg.Left_0.i": ; preds = %2
  ...
  store ptr @str666, ptr %5, align 8
  %6 = tail call ptr @malgo_print_string(ptr noundef nonnull @str666)
  ...
  br label %"test/testcases/malgo/TestEither.mlg.$raw_fun_435.exit"
...
"test/testcases/malgo/TestEither.mlg.$raw_fun_435.exit": ; preds = %"switch_branch_test/testcases/malgo/TestEither.mlg.Left_0.i", %"switch_branch_test/testcases/malgo/TestEither.mlg.Right_0.i"
...
define internal noundef ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_597"(ptr nocapture nofree readnone %0, ptr nofree %1) {
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i.i = tail call ptr @malgo_malloc(i64 noundef 8)
  store ptr %1, ptr %let_capture_0.i.i, align 8
  store ptr %let_capture_0.i.i, ptr %3, align 8
  %let_func_0.i.i = getelementptr { ptr, ptr }, ptr %3, i64 0, i32 1
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_611", ptr %let_func_0.i.i, align 8
...
define internal ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_598"(ptr nocapture nofree readnone %0, ptr nofree %1) {
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i.i = tail call ptr @malgo_malloc(i64 noundef 8)
  store ptr %1, ptr %let_capture_0.i.i, align 8
  store ptr %let_capture_0.i.i, ptr %3, align 8
  %let_func_0.i.i = getelementptr { ptr, ptr }, ptr %3, i64 0, i32 1
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_605", ptr %let_func_0.i.i, align 8
  %4 = tail call ptr @malgo_malloc(i64 noundef 16)
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_605", ptr %let_func_0.i2.i, align 8
  ...
  %"runtime/malgo/Prelude.mlg.$str_723_0.val.i.i" = load ptr, ptr %12, align 8
  %13 = tail call ptr @malgo_print_string(ptr %"runtime/malgo/Prelude.mlg.$str_723_0.val.i.i")
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_605", ptr %let_func_0.i4.i, align 8
  %15 = tail call ptr @malgo_malloc(i64 noundef 16)
...
define internal noundef ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_599"(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %1) {
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  store i8 0, ptr %3, align 1
  %4 = getelementptr { i8, { ptr } }, ptr %3, i64 0, i32 1, i32 0
  store ptr @str670, ptr %4, align 8
...
define internal noundef ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_600"(ptr nocapture nofree readnone %0, ptr nofree %1) {
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i.i = tail call ptr @malgo_malloc(i64 noundef 8)
  store ptr %1, ptr %let_capture_0.i.i, align 8
  store ptr %let_capture_0.i.i, ptr %3, align 8
...
define internal ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_601"(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(1) %1) {
  %.val = load i8, ptr %1, align 8
  %3 = getelementptr i8, ptr %1, i64 8
  %.val1 = load ptr, ptr %3, align 8
  %switch.i = icmp eq i8 %.val, 0
  br i1 %switch.i, label %"test/testcases/malgo/TestEither.mlg.$raw_fun_466.exit", label %"switch_branch_test/testcases/malgo/TestEither.mlg.Right_0.i"
...
"switch_branch_test/testcases/malgo/TestEither.mlg.Right_0.i": ; preds = %2
  ...
  br label %"test/testcases/malgo/TestEither.mlg.$raw_fun_466.exit"

"test/testcases/malgo/TestEither.mlg.$raw_fun_466.exit": ; preds = %2, %"switch_branch_test/testcases/malgo/TestEither.mlg.Right_0.i"
  %x_0.i3.sink.i = phi ptr [ %x_0.i3.i, %"switch_branch_test/testcases/malgo/TestEither.mlg.Right_0.i" ], [ %.val1, %2 ]
  %13 = getelementptr i8, ptr %x_0.i3.sink.i, i64 8
  %"runtime/malgo/Prelude.mlg.$str_716_0.val.i1.i" = load ptr, ptr %13, align 8
  %14 = tail call ptr @malgo_print_string(ptr %"runtime/malgo/Prelude.mlg.$str_716_0.val.i1.i")
...
define internal ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_605"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define internal noundef ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_611"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_482", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_489", ptr %let_func_0.i.i.i.i, align 8
...
define internal ptr @"runtime/malgo/Prelude.mlg.putStr"(ptr nocapture nofree readnone %0, ptr nocapture nofree readonly align 8 %"runtime/malgo/Prelude.mlg.$str_723_0") {
  %2 = getelementptr i8, ptr %"runtime/malgo/Prelude.mlg.$str_723_0", i64 8
  %"runtime/malgo/Prelude.mlg.$str_723_0.val" = load ptr, ptr %2, align 8
  %3 = tail call ptr @malgo_print_string(ptr %"runtime/malgo/Prelude.mlg.$str_723_0.val")
  ret ptr %3
}
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_596", ptr %fun_func_0.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_597", ptr %fun_func_1.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_471", ptr %let_func_0.i4.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_605", ptr %let_func_0.i6.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_598", ptr %fun_func_2.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_471", ptr %let_func_0.i8.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_605", ptr %let_func_0.i10.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_599", ptr %fun_func_3.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_471", ptr %let_func_0.i12.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_605", ptr %let_func_0.i14.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_600", ptr %fun_func_4.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_471", ptr %let_func_0.i16.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_605", ptr %let_func_0.i18.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_601", ptr %fun_func_5.i, align 8
