...
define internal ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_475"(ptr nocapture nofree readonly %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(1) %1) {
...
define internal ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_519"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define internal i32 @"test/testcases/malgo/TestEither.mlg.#let_closure_530"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_624", ptr %let_func_0.i.i, align 8
...
define internal ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_590"(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %1) {
...
"switch_branch_test/testcases/malgo/TestEither.mlg.Left_0.i": ; preds = %2
  ...
  store ptr @str477, ptr %5, align 8
  %6 = tail call ptr @malgo_print_string(ptr noundef nonnull @str477)
...
define internal noundef ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_591"(ptr nocapture nofree readnone %0, ptr nofree %1) {
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i.i = tail call ptr @malgo_malloc(i64 noundef 8)
  store ptr %1, ptr %let_capture_0.i.i, align 8
  store ptr %let_capture_0.i.i, ptr %3, align 8
  %let_func_0.i.i = getelementptr { ptr, ptr }, ptr %3, i64 0, i32 1
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_619", ptr %let_func_0.i.i, align 8
...
define internal ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_592"(ptr nocapture nofree readnone %0, ptr nofree %1) {
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i.i = tail call ptr @malgo_malloc(i64 noundef 8)
  store ptr %1, ptr %let_capture_0.i.i, align 8
  store ptr %let_capture_0.i.i, ptr %3, align 8
  %let_func_0.i.i = getelementptr { ptr, ptr }, ptr %3, i64 0, i32 1
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_519", ptr %let_func_0.i.i, align 8
  %4 = tail call ptr @malgo_malloc(i64 noundef 16)
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_519", ptr %let_func_0.i2.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_519", ptr %let_func_0.i4.i, align 8
  %15 = tail call ptr @malgo_malloc(i64 noundef 16)
...
define internal noundef ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_593"(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %1) {
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  store i8 0, ptr %3, align 1
  %4 = getelementptr { i8, { ptr } }, ptr %3, i64 0, i32 1, i32 0
  store ptr @str507, ptr %4, align 8
...
define internal noundef ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_594"(ptr nocapture nofree readnone %0, ptr nofree %1) {
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i.i = tail call ptr @malgo_malloc(i64 noundef 8)
  store ptr %1, ptr %let_capture_0.i.i, align 8
  store ptr %let_capture_0.i.i, ptr %3, align 8
...
define internal ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_595"(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(1) %1) {
...
define internal noundef ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_619"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_530", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_624", ptr %let_func_0.i.i.i.i, align 8
...
define internal i32 @"test/testcases/malgo/TestEither.mlg.#let_closure_624"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_590", ptr %fun_func_0.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_591", ptr %fun_func_1.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_475", ptr %let_func_0.i4.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_519", ptr %let_func_0.i6.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_592", ptr %fun_func_2.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_475", ptr %let_func_0.i8.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_519", ptr %let_func_0.i10.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_593", ptr %fun_func_3.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_475", ptr %let_func_0.i12.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_519", ptr %let_func_0.i14.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_594", ptr %fun_func_4.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_475", ptr %let_func_0.i16.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#let_closure_519", ptr %let_func_0.i18.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestEither.mlg.#fun_closure_595", ptr %fun_func_5.i, align 8
