...
define internal ptr @"HelloImport.$raw_fun_2817"(ptr %0, ptr %"HelloImport.$f_26_0") {
...
define internal ptr @"HelloImport.$raw_fun_2816"(ptr %0, ptr %"HelloImport.$f_26_0") {
  %2 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ i8, { ptr } }, ptr null, i32 1) to i64))
  %3 = getelementptr { i8, { ptr } }, ptr %2, i32 0, i32 0
  store i8 0, ptr %3, align 1
  %4 = getelementptr { i8, { ptr } }, ptr %2, i32 0, i32 1, i32 0
...
define internal ptr @"HelloImport.#let_closure_2820"(ptr %0, ptr %1) {
...
define internal ptr @"HelloImport.#fun_closure_2821"(ptr %0, ptr %1) {
  %3 = call ptr @"HelloImport.$raw_fun_2816"(ptr null, ptr %1)
  ret ptr %3
}
...
"switch_branch_Builtin.String#_0":                ; preds = %1
  ...
  store ptr @"HelloImport.#let_closure_2820", ptr %let_func_0, align 8
  ...
  store ptr @"HelloImport.#fun_closure_2821", ptr %fun_func_0, align 8
