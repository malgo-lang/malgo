...
define internal i32 @"test/testcases/malgo/Factorial.mlg.#let_closure_3297"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  %x_0 = load i64, ptr %0, align 4
  %3 = tail call i32 @malgo_eq_int64_t(i64 %x_0, i64 %1)
  ret i32 %3
}

define internal i64 @"test/testcases/malgo/Factorial.mlg.#let_closure_3298"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  %x_0 = load i64, ptr %0, align 4
  %3 = tail call i64 @malgo_mul_int64_t(i64 %x_0, i64 %1)
  ret i64 %3
}

define internal i64 @"test/testcases/malgo/Factorial.mlg.#let_closure_3299"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  %x_0 = load i64, ptr %0, align 4
  %3 = tail call i64 @malgo_sub_int64_t(i64 %x_0, i64 %1)
  ret i64 %3
}

define internal ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_3300"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define internal i32 @"test/testcases/malgo/Factorial.mlg.#let_closure_3305"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  %p_0 = load i64, ptr %0, align 4
  %3 = tail call i32 @malgo_eq_int64_t(i64 %p_0, i64 %1)
  ret i32 %3
}

define internal noundef ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_3306"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
...
define internal ptr @"test/testcases/malgo/Factorial.mlg.#fun_closure_3307"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readnone %1) #0 {
  %acc_0 = load ptr, ptr %0, align 8
  ret ptr %acc_0
}

define internal noundef ptr @"test/testcases/malgo/Factorial.mlg.#fun_closure_3308"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %0, ptr nocapture nofree readnone %1) {
  %acc_0 = load ptr, ptr %0, align 8
  ...
  store ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_3315", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_3311", ptr %let_func_0.i3.i, align 8
...
define internal noundef ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_3309"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  %n_0 = load ptr, ptr %0, align 8
  %3 = getelementptr i8, ptr %n_0, i64 4
  %n_0.val = load i64, ptr %3, align 4
  %4 = getelementptr i8, ptr %1, i64 4
...
define internal noundef ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_3310"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  %n_0 = load ptr, ptr %0, align 8
  %3 = getelementptr i8, ptr %n_0, i64 4
  %n_0.val = load i64, ptr %3, align 4
  %4 = getelementptr i8, ptr %1, i64 4
  ...
  store ptr %let_capture_0.i, ptr %5, align 8
  %let_func_0.i = getelementptr { ptr, ptr }, ptr %5, i64 0, i32 1
  store ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_3311", ptr %let_func_0.i, align 8
...
tailrecurse:                                      ; preds = %"switch_branch_runtime/malgo/Builtin.mlg.False_0", %0
  ...
  store ptr %let_capture_0.i, ptr %5, align 8
  %let_func_0.i = getelementptr { ptr, ptr }, ptr %5, i64 0, i32 1
  store ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_3305", ptr %let_func_0.i, align 8
...
"switch_branch_runtime/malgo/Builtin.mlg.False_0": ; preds = %tailrecurse
  ...
  store ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_3311", ptr %let_func_0.i.i5, align 8
...
define internal i64 @"test/testcases/malgo/Factorial.mlg.#let_closure_3311"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  %p_0 = load i64, ptr %0, align 4
  %3 = tail call i64 @malgo_mul_int64_t(i64 %p_0, i64 %1)
  ret i64 %3
}

define internal i64 @"test/testcases/malgo/Factorial.mlg.#let_closure_3315"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  %p_0 = load i64, ptr %0, align 4
...
define internal noundef ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_3316"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  ...
  store ptr %let_capture_0.i.i, ptr %5, align 8
  %let_func_0.i.i = getelementptr { ptr, ptr }, ptr %5, i64 0, i32 1
  store ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_3299", ptr %let_func_0.i.i, align 8
  %x_0.i.i = load i64, ptr %let_capture_0.i.i, align 4
...
define internal noundef ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_3317"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  ...
  store ptr %let_capture_0.i.i, ptr %5, align 8
  %let_func_0.i.i = getelementptr { ptr, ptr }, ptr %5, i64 0, i32 1
  store ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_3298", ptr %let_func_0.i.i, align 8
  %x_0.i.i = load i64, ptr %let_capture_0.i.i, align 4
