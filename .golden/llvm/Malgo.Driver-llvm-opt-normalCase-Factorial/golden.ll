...
define internal noundef ptr @"Factorial.#let_closure_3297"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  ...
  store ptr @"Factorial.#let_closure_3308", ptr %let_func_0.i.i, align 8
...
define internal ptr @"Factorial.#fun_closure_3298"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readnone %1) #0 {
  %acc_0 = load ptr, ptr %0, align 8
  ret ptr %acc_0
}

define internal noundef ptr @"Factorial.#fun_closure_3299"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %0, ptr nocapture nofree readnone %1) {
  %acc_0 = load ptr, ptr %0, align 8
  ...
  store ptr @"Factorial.#let_closure_3305", ptr %let_func_0.i, align 8
  %6 = getelementptr i8, ptr %n_0, i64 4
  %"Factorial.$n_167_0.val.i" = load i64, ptr %6, align 4
  %.val.i = load i64, ptr %4, align 4
  %7 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i.i = tail call ptr @malgo_malloc(i64 noundef 8)
  store i64 %"Factorial.$n_167_0.val.i", ptr %let_capture_0.i.i, align 4
  store ptr %let_capture_0.i.i, ptr %7, align 8
  %let_func_0.i.i = getelementptr { ptr, ptr }, ptr %7, i64 0, i32 1
  store ptr @"Factorial.#let_closure_3314", ptr %let_func_0.i.i, align 8
  %8 = tail call i64 @malgo_sub_int64_t(i64 %"Factorial.$n_167_0.val.i", i64 %.val.i)
  ...
  store ptr @"Factorial.#let_closure_3306", ptr %let_func_1.i, align 8
  %"Factorial.$n_167_0.val1.i" = load i64, ptr %6, align 4
  %12 = getelementptr i8, ptr %acc_0, i64 4
  %"Factorial.$acc_168_0.val.i" = load i64, ptr %12, align 4
  %13 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i2.i = tail call ptr @malgo_malloc(i64 noundef 8)
  store i64 %"Factorial.$n_167_0.val1.i", ptr %let_capture_0.i2.i, align 4
  store ptr %let_capture_0.i2.i, ptr %13, align 8
  %let_func_0.i3.i = getelementptr { ptr, ptr }, ptr %13, i64 0, i32 1
  store ptr @"Factorial.#let_closure_3307", ptr %let_func_0.i3.i, align 8
  %14 = tail call i64 @malgo_mul_int64_t(i64 %"Factorial.$n_167_0.val1.i", i64 %"Factorial.$acc_168_0.val.i")
...
define internal noundef ptr @"Factorial.#let_closure_3300"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  %n_0 = load ptr, ptr %0, align 8
  %3 = getelementptr i8, ptr %n_0, i64 4
  %n_0.val = load i64, ptr %3, align 4
  %4 = getelementptr i8, ptr %1, i64 4
  ...
  store ptr %let_capture_0.i, ptr %5, align 8
  %let_func_0.i = getelementptr { ptr, ptr }, ptr %5, i64 0, i32 1
  store ptr @"Factorial.#let_closure_3314", ptr %let_func_0.i, align 8
...
define internal noundef ptr @"Factorial.#let_closure_3301"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  %n_0 = load ptr, ptr %0, align 8
  %3 = getelementptr i8, ptr %n_0, i64 4
  %n_0.val = load i64, ptr %3, align 4
  %4 = getelementptr i8, ptr %1, i64 4
  ...
  store ptr %let_capture_0.i, ptr %5, align 8
  %let_func_0.i = getelementptr { ptr, ptr }, ptr %5, i64 0, i32 1
  store ptr @"Factorial.#let_closure_3307", ptr %let_func_0.i, align 8
...
tailrecurse:                                      ; preds = %switch_branch_Builtin.False_0, %0
  %"Factorial.$n_167_0.tr" = phi ptr [ %"Factorial.$n_167_0", %0 ], [ %18, %switch_branch_Builtin.False_0 ]
  %"Factorial.$acc_168_0.tr" = phi ptr [ %"Factorial.$acc_168_0", %0 ], [ %25, %switch_branch_Builtin.False_0 ]
  ...
  store ptr %"Factorial.$n_167_0.tr", ptr %let_capture_0, align 8
  store ptr %let_capture_0, ptr %3, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %3, i64 0, i32 1
  store ptr @"Factorial.#let_closure_3297", ptr %let_func_0, align 8
  %4 = getelementptr i8, ptr %"Factorial.$n_167_0.tr", i64 4
  %"Factorial.$n_167_0.val" = load i64, ptr %4, align 4
  ...
  store ptr %let_capture_0.i, ptr %5, align 8
  %let_func_0.i = getelementptr { ptr, ptr }, ptr %5, i64 0, i32 1
  store ptr @"Factorial.#let_closure_3304", ptr %let_func_0.i, align 8
  %6 = tail call i32 @malgo_eq_int64_t(i64 %"Factorial.$n_167_0.val", i64 %.val)
  ...
  store ptr @"Factorial.#fun_closure_3298", ptr %fun_func_0, align 8
  ...
  store ptr @"Factorial.#fun_closure_3299", ptr %fun_func_1, align 8
...
switch_branch_Builtin.False_0:                    ; preds = %tailrecurse
  ...
  store ptr @"Factorial.#let_closure_3300", ptr %let_func_1, align 8
  ...
  store ptr @"Factorial.#let_closure_3301", ptr %let_func_2, align 8
  %n_0.i1 = load ptr, ptr %let_capture_4, align 8
  %21 = getelementptr i8, ptr %n_0.i1, i64 4
  %n_0.val.i2 = load i64, ptr %21, align 4
  %22 = getelementptr i8, ptr %"Factorial.$acc_168_0.tr", i64 4
  ...
  store ptr @"Factorial.#let_closure_3307", ptr %let_func_0.i.i5, align 8
...
define internal i64 @"Factorial.#let_closure_3303"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
...
define internal i32 @"Factorial.#let_closure_3304"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  %p_0 = load i64, ptr %0, align 4
  %3 = tail call i32 @malgo_eq_int64_t(i64 %p_0, i64 %1)
  ret i32 %3
}

define internal noundef ptr @"Factorial.#let_closure_3305"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  %n_0 = load ptr, ptr %0, align 8
  %3 = getelementptr i8, ptr %n_0, i64 4
  %n_0.val = load i64, ptr %3, align 4
  %4 = getelementptr i8, ptr %1, i64 4
  ...
  store ptr %let_capture_0.i.i, ptr %5, align 8
  %let_func_0.i.i = getelementptr { ptr, ptr }, ptr %5, i64 0, i32 1
  store ptr @"Factorial.#let_closure_3303", ptr %let_func_0.i.i, align 8
  %x_0.i.i = load i64, ptr %let_capture_0.i.i, align 4
...
define internal noundef ptr @"Factorial.#let_closure_3306"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  %n_0 = load ptr, ptr %0, align 8
  %3 = getelementptr i8, ptr %n_0, i64 4
  %n_0.val = load i64, ptr %3, align 4
  %4 = getelementptr i8, ptr %1, i64 4
  ...
  store ptr %let_capture_0.i.i, ptr %5, align 8
  %let_func_0.i.i = getelementptr { ptr, ptr }, ptr %5, i64 0, i32 1
  store ptr @"Factorial.#let_closure_3317", ptr %let_func_0.i.i, align 8
  %x_0.i.i = load i64, ptr %let_capture_0.i.i, align 4
...
define internal i64 @"Factorial.#let_closure_3307"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  %p_0 = load i64, ptr %0, align 4
  %3 = tail call i64 @malgo_mul_int64_t(i64 %p_0, i64 %1)
  ret i64 %3
}

define internal i32 @"Factorial.#let_closure_3308"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  %x_0 = load i64, ptr %0, align 4
  %3 = tail call i32 @malgo_eq_int64_t(i64 %x_0, i64 %1)
  ret i32 %3
}

define internal ptr @"Factorial.#let_closure_3311"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define internal i64 @"Factorial.#let_closure_3314"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  %p_0 = load i64, ptr %0, align 4
  %3 = tail call i64 @malgo_sub_int64_t(i64 %p_0, i64 %1)
  ret i64 %3
}

define internal i64 @"Factorial.#let_closure_3317"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  %x_0 = load i64, ptr %0, align 4
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"Factorial.#let_closure_3311", ptr %let_func_0.i, align 8
  %14 = tail call ptr @malgo_malloc(i64 noundef 16)
