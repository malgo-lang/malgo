; ModuleID = '/workspaces/malgo/.malgo-work/Primitive.ll'
...
define internal i64 @"Primitive.#let_closure_142"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  %p_0 = load i64, ptr %0, align 4
  %3 = tail call i64 @malgo_add_int64_t(i64 %p_0, i64 %1)
  ret i64 %3
}

define internal i64 @"Primitive.#let_closure_167"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  ...
  store ptr @"Primitive.#let_closure_142", ptr %let_func_0.i.i, align 8
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"Primitive.#let_closure_167", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"Primitive.#let_closure_142", ptr %let_func_0.i.i.i.i, align 8
