...
define internal i64 @"test/testcases/malgo/Primitive.mlg.#let_closure_54"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  ...
  store ptr @"test/testcases/malgo/Primitive.mlg.#let_closure_56", ptr %let_func_0.i.i, align 8
  %p_0.i.i = load i64, ptr %let_capture_0.i.i, align 4
  %4 = tail call i64 @malgo_add_int64_t(i64 %p_0.i.i, i64 %1)
  ret i64 %4
}

define internal i64 @"test/testcases/malgo/Primitive.mlg.#let_closure_56"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/Primitive.mlg.#let_closure_54", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/Primitive.mlg.#let_closure_56", ptr %let_func_0.i.i.i.i, align 8
