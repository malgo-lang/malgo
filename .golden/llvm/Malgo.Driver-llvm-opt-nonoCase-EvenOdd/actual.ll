...
define internal i32 @"EvenOdd.#let_closure_122"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
...
define internal i32 @"EvenOdd.#let_closure_184"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  ...
  store ptr @"EvenOdd.#let_closure_122", ptr %let_func_0.i.i, align 8
...
define internal noundef ptr @"EvenOdd.#let_closure_185"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  ...
  store ptr @"EvenOdd.#let_closure_184", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"EvenOdd.#let_closure_122", ptr %let_func_0.i.i.i.i, align 8
...
define internal noundef ptr @EvenOdd.even(ptr nocapture nofree readnone %0, ptr nofree align 4 %"EvenOdd.$int32#_51_0") {
...
switch-unboxed_default_0:                         ; preds = %"switch_branch_Builtin.Int32#_0"
  ...
  store ptr %"EvenOdd.$int32#_51_0", ptr %let_capture_0.i, align 8
  store ptr %let_capture_0.i, ptr %5, align 8
  %let_func_0.i = getelementptr { ptr, ptr }, ptr %5, i64 0, i32 1
  store ptr @"EvenOdd.#let_closure_185", ptr %let_func_0.i, align 8
  %6 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %6, align 8
  ...
  %13 = tail call noundef ptr @EvenOdd.odd(ptr poison, ptr nofree align 4 %11)
  br label %common.ret
}

define internal noundef ptr @EvenOdd.odd(ptr nocapture nofree readnone %0, ptr nofree align 4 %"EvenOdd.$int32#_61_0") {
"switch_branch_Builtin.Int32#_0":
...
switch-unboxed_default_0:                         ; preds = %"switch_branch_Builtin.Int32#_0"
  ...
  %5 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i = tail call ptr @malgo_malloc(i64 noundef 8)
  store ptr %"EvenOdd.$int32#_61_0", ptr %let_capture_0.i, align 8
  store ptr %let_capture_0.i, ptr %5, align 8
  %let_func_0.i = getelementptr { ptr, ptr }, ptr %5, i64 0, i32 1
  store ptr @"EvenOdd.#let_closure_185", ptr %let_func_0.i, align 8
  %6 = tail call ptr @malgo_malloc(i64 noundef 16)
  ...
  %13 = tail call noundef ptr @EvenOdd.even(ptr poison, ptr nofree align 4 %11)
  br label %common.ret
}

define internal ptr @"EvenOdd.#fun_closure_292"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %1) {
common.ret:
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"EvenOdd.#fun_closure_292", ptr %fun_func_0.i, align 8
  %9 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %9, align 8
  ...
  %13 = tail call ptr @EvenOdd.even(ptr poison, ptr nofree noundef nonnull align 4 dereferenceable(1) %10)
