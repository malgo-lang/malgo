...
define internal ptr @"Test3.#fun_closure_136"(ptr %0, ptr %1) {
  %3 = call ptr @"Test3.$raw_fun_134"(ptr null, ptr %1)
  ret ptr %3
}
...
define internal ptr @"Test3.#let_closure_137"(ptr %0, ptr %1) {
  %p_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %p_0 = load ptr, ptr %p_addr_0, align 8
  %3 = call ptr @"Test3.$raw_let_133"(ptr null, ptr %p_0, ptr %1)
  ret ptr %3
}
...
define internal ptr @Test3.Cons(ptr %0, ptr %"Test3.$p_69_0") {
  ...
  store ptr @"Test3.#let_closure_137", ptr %let_func_0, align 8
  ret ptr %2
}
...
define internal ptr @"Test3.$raw_let_133"(ptr %0, ptr %"Test3.$p_69_0", ptr %"Test3.$p_70_0") {
  ...
  store ptr %"Test3.$p_69_0", ptr %4, align 8
  %5 = getelementptr { i8, { ptr, ptr } }, ptr %2, i32 0, i32 1, i32 1
  store ptr %"Test3.$p_70_0", ptr %5, align 8
  ret ptr %2
}

define internal ptr @"Test3.#let_closure_138"(ptr %0, ptr %1) {
...
define internal ptr @"Test3.|>"(ptr %0, ptr %"Test3.$x_78_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"Test3.#let_closure_138", ptr %let_func_0, align 8
  ret ptr %2
}

define internal ptr @"Test3.$raw_fun_134"(ptr %0, ptr %"Test3.$cons_100_0") {
...
switch_branch_Test3.Cons_0:                       ; preds = %1
  %5 = getelementptr { i8, { ptr, ptr } }, ptr %"Test3.$cons_100_0", i32 0, i32 1
