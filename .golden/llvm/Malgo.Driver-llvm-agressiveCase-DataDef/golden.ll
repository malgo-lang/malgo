...
define internal ptr @"test/testcases/malgo/DataDef.mlg.#let_closure_51"(ptr %0, ptr %1) {
  %p_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %p_0 = load ptr, ptr %p_addr_0, align 8
  %3 = call ptr @"test/testcases/malgo/DataDef.mlg.$raw_let_50"(ptr null, ptr %p_0, ptr %1)
  ret ptr %3
}
...
define internal ptr @"test/testcases/malgo/DataDef.mlg.$raw_let_50"(ptr %0, ptr %"test/testcases/malgo/DataDef.mlg.$p_21_0", ptr %"test/testcases/malgo/DataDef.mlg.$p_22_0") {
  ...
  store ptr %"test/testcases/malgo/DataDef.mlg.$p_21_0", ptr %4, align 8
  %5 = getelementptr { i8, { ptr, ptr } }, ptr %2, i32 0, i32 1, i32 1
  store ptr %"test/testcases/malgo/DataDef.mlg.$p_22_0", ptr %5, align 8
  ret ptr %2
}
