...
define internal ptr @"DataDef.#let_closure_51"(ptr %0, ptr %1) {
  %p_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %p_0 = load ptr, ptr %p_addr_0, align 8
  %3 = call ptr @"DataDef.$raw_let_50"(ptr null, ptr %p_0, ptr %1)
  ret ptr %3
}
...
define internal ptr @DataDef.Cons(ptr %0, ptr %"DataDef.$p_21_0") {
  ...
  store ptr @"DataDef.#let_closure_51", ptr %let_func_0, align 8
  ret ptr %2
}
...
define internal ptr @"DataDef.$raw_let_50"(ptr %0, ptr %"DataDef.$p_21_0", ptr %"DataDef.$p_22_0") {
  ...
  store ptr %"DataDef.$p_21_0", ptr %4, align 8
  %5 = getelementptr { i8, { ptr, ptr } }, ptr %2, i32 0, i32 1, i32 1
  store ptr %"DataDef.$p_22_0", ptr %5, align 8
  ret ptr %2
}
...
define internal void @malgo_load_DataDef() {
  ret void
}
