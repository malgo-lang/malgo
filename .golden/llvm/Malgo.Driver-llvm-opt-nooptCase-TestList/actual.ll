; ModuleID = '/workspaces/malgo/.malgo-work/test/testcases/malgo/TestList.ll'
...
define internal noundef ptr @"test/testcases/malgo/TestList.mlg.#let_closure_256"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/TestList.mlg.#let_closure_256", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestList.mlg.#let_closure_256", ptr %let_func_0.i3.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestList.mlg.#let_closure_256", ptr %let_func_0.i5.i, align 8
...
"test/testcases/malgo/TestList.mlg.main.exit":    ; preds = %"switch_branch_runtime/malgo/Prelude.mlg.Nil_0.i.i", %"switch_branch_runtime/malgo/Prelude.mlg.Cons_0.i.i"
  %common.ret.op.i.i = phi ptr [ %28, %"switch_branch_runtime/malgo/Prelude.mlg.Nil_0.i.i" ], [ %30, %"switch_branch_runtime/malgo/Prelude.mlg.Cons_0.i.i" ]
