...
define internal ptr @"Show.#let_closure_3220"(ptr %0, ptr %1) {
...
define internal ptr @Show.showTuple2(ptr %0, ptr %"Show.$showDictA_149_0") {
  ...
  store ptr @"Show.#let_closure_3220", ptr %let_func_0, align 8
  ret ptr %2
}

define internal ptr @"Show.$raw_let_3208"(ptr %0, ptr %"Show.$d_209_0", ptr %"Show.$string#_3060_0") {
...
"switch_branch_Builtin.String#_0":                ; preds = %1
  ...
  %7 = getelementptr { i8, <8 x i8> }, ptr %"Show.$string#_3060_0", i32 0, i32 0
...
"switch_branch_Builtin.String#_1":                ; preds = %"switch_branch_Builtin.String#_0"
  %9 = getelementptr { i8, { ptr } }, ptr %"Show.$string#_3060_0", i32 0, i32 1
...
define internal ptr @"Show.#let_closure_3221"(ptr %0, ptr %1) {
  %x_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %x_0 = load ptr, ptr %x_addr_0, align 8
  %3 = call ptr @"Show.$raw_let_3218"(ptr null, ptr %x_0, ptr %1)
  ret ptr %3
}
...
define internal ptr @"Show.<>"(ptr %0, ptr %"Show.$x_137_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"Show.#let_closure_3221", ptr %let_func_0, align 8
  ret ptr %2
}

define internal ptr @"Show.$raw_let_3212"(ptr %0, ptr %"Show.$d_203_0", ptr %"Show.$string#_3062_0") {
...
"switch_branch_Builtin.String#_0":                ; preds = %1
  ...
  %5 = getelementptr { ptr }, ptr %4, i32 0, i32 0
  %6 = load ptr, ptr %5, align 8
  %7 = getelementptr { i8, <8 x i8> }, ptr %"Show.$string#_3062_0", i32 0, i32 0
  %8 = load i8, ptr %7, align 1
  switch i8 %8, label %switch_default_0 [
    i8 0, label %"switch_branch_Builtin.String#_1"
  ]
...
"switch_branch_Builtin.String#_1":                ; preds = %"switch_branch_Builtin.String#_0"
  %9 = getelementptr { i8, { ptr } }, ptr %"Show.$string#_3062_0", i32 0, i32 1
  %10 = getelementptr { ptr }, ptr %9, i32 0, i32 0
  %11 = load ptr, ptr %10, align 8
  %12 = call ptr @"Builtin.appendString#"(ptr null, ptr %6)
  %13 = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 0
...
define internal ptr @"Show.$raw_let_3217"(ptr %0, ptr %"Show.$showDict_121_0", ptr %"Show.$x_122_0") {
  %2 = call ptr @malgo_hash_table_get(ptr %"Show.$showDict_121_0", ptr @str3222)
...
define internal ptr @"Show.#let_closure_3223"(ptr %0, ptr %1) {
...
"switch_branch_Builtin.String#_1":                ; preds = %"switch_branch_Builtin.String#_0"
  ...
  store ptr @"Show.#let_closure_3223", ptr %let_func_0, align 8
...
define internal ptr @"Show.$raw_let_3214"(ptr %0, ptr %"Show.$d_199_0", ptr %"Show.$string#_3064_0") {
...
"switch_branch_Builtin.String#_0":                ; preds = %1
  ...
  %5 = getelementptr { ptr }, ptr %4, i32 0, i32 0
  %6 = load ptr, ptr %5, align 8
  %7 = getelementptr { i8, <8 x i8> }, ptr %"Show.$string#_3064_0", i32 0, i32 0
  %8 = load i8, ptr %7, align 1
  switch i8 %8, label %switch_default_0 [
    i8 0, label %"switch_branch_Builtin.String#_1"
  ]
...
"switch_branch_Builtin.String#_1":                ; preds = %"switch_branch_Builtin.String#_0"
  %9 = getelementptr { i8, { ptr } }, ptr %"Show.$string#_3064_0", i32 0, i32 1
  %10 = getelementptr { ptr }, ptr %9, i32 0, i32 0
  %11 = load ptr, ptr %10, align 8
  %12 = call ptr @"Builtin.appendString#"(ptr null, ptr %6)
  %13 = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 0
...
define internal ptr @"Show.$raw_let_3219"(ptr %0, ptr %"Show.$cast_230_0", ptr %"Show.$x_3173_0") {
  %2 = call ptr @malgo_hash_table_get(ptr %"Show.$cast_230_0", ptr @str3222)
  %3 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 0
  %4 = load ptr, ptr %3, align 8
  %5 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  %6 = load ptr, ptr %5, align 8
  %7 = call ptr %6(ptr %4, ptr %"Show.$x_3173_0")
  %8 = getelementptr { i8, <8 x i8> }, ptr %7, i32 0, i32 0
  %9 = load i8, ptr %8, align 1
  switch i8 %9, label %switch_default_0 [
    i8 0, label %"switch_branch_Builtin.String#_0"
...
define internal ptr @"Show.#let_closure_3224"(ptr %0, ptr %1) {
  %showDict_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %showDict_0 = load ptr, ptr %showDict_addr_0, align 8
  %3 = call ptr @"Show.$raw_let_3217"(ptr null, ptr %showDict_0, ptr %1)
  ret ptr %3
}
...
define internal ptr @Show.print(ptr %0, ptr %"Show.$showDict_121_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"Show.#let_closure_3224", ptr %let_func_0, align 8
  ret ptr %2
}

define internal ptr @"Show.$raw_let_3215"(ptr %0, ptr %"Show.$d_193_0", ptr %"Show.$string#_3066_0") {
...
"switch_branch_Builtin.String#_0":                ; preds = %1
  ...
  %5 = getelementptr { ptr }, ptr %4, i32 0, i32 0
  %6 = load ptr, ptr %5, align 8
  %7 = getelementptr { i8, <8 x i8> }, ptr %"Show.$string#_3066_0", i32 0, i32 0
  %8 = load i8, ptr %7, align 1
  switch i8 %8, label %switch_default_0 [
    i8 0, label %"switch_branch_Builtin.String#_1"
  ]
...
"switch_branch_Builtin.String#_1":                ; preds = %"switch_branch_Builtin.String#_0"
  %9 = getelementptr { i8, { ptr } }, ptr %"Show.$string#_3066_0", i32 0, i32 1
  %10 = getelementptr { ptr }, ptr %9, i32 0, i32 0
  %11 = load ptr, ptr %10, align 8
  %12 = call ptr @"Builtin.appendString#"(ptr null, ptr %6)
  %13 = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 0
...
define internal ptr @"Show.#let_closure_3225"(ptr %0, ptr %1) {
  %p_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %p_0 = load ptr, ptr %p_addr_0, align 8
...
define internal ptr @"Show.$raw_let_3218"(ptr %0, ptr %"Show.$x_137_0", ptr %"Show.$y_138_0") {
...
"switch_branch_Builtin.String#_1":                ; preds = %"switch_branch_Builtin.String#_0"
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 1
  store ptr @"Show.#let_closure_3225", ptr %let_func_0, align 8
  %13 = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 0
  %14 = load ptr, ptr %13, align 8
  %15 = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 1
  %16 = load ptr, ptr %15, align 8
...
define internal ptr @"Show.#let_closure_3229"(ptr %0, ptr %1) {
  %d_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %d_0 = load ptr, ptr %d_addr_0, align 8
  %3 = call ptr @"Show.$raw_let_3208"(ptr null, ptr %d_0, ptr %1)
  ret ptr %3
}

define internal ptr @"Show.#let_closure_3230"(ptr %0, ptr %1) {
  %d_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %d_0 = load ptr, ptr %d_addr_0, align 8
  %3 = call ptr @"Show.$raw_let_3212"(ptr null, ptr %d_0, ptr %1)
  ret ptr %3
}

define internal ptr @"Show.#let_closure_3231"(ptr %0, ptr %1) {
  %d_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %d_0 = load ptr, ptr %d_addr_0, align 8
  %3 = call ptr @"Show.$raw_let_3214"(ptr null, ptr %d_0, ptr %1)
  ret ptr %3
}

define internal ptr @"Show.#let_closure_3232"(ptr %0, ptr %1) {
  %d_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %d_0 = load ptr, ptr %d_addr_0, align 8
  %3 = call ptr @"Show.$raw_let_3215"(ptr null, ptr %d_0, ptr %1)
  ret ptr %3
}

define internal ptr @"Show.$raw_fun_3216"(ptr %0, ptr %"Show.$showDictB_188_0", ptr %"Show.$showDictA_187_0", ptr %"Show.$tuple_190_0") {
...
"switch_branch_Tuple#_0":                         ; preds = %1
  ...
  %12 = call ptr @malgo_hash_table_get(ptr %"Show.$showDictA_187_0", ptr @str3222)
  %13 = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 0
  %14 = load ptr, ptr %13, align 8
  %15 = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 1
  %16 = load ptr, ptr %15, align 8
  ...
  %21 = call ptr @malgo_hash_table_get(ptr %"Show.$showDictB_188_0", ptr @str3222)
  ...
  store ptr @"Show.#let_closure_3229", ptr %let_func_0, align 8
  ...
  store ptr @"Show.#let_closure_3230", ptr %let_func_1, align 8
  ...
  store ptr @"Show.#let_closure_3231", ptr %let_func_2, align 8
  ...
  store ptr @"Show.#let_closure_3232", ptr %let_func_3, align 8
...
define internal ptr @"Show.#let_closure_3233"(ptr %0, ptr %1) {
  %cast_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %cast_0 = load ptr, ptr %cast_addr_0, align 8
  %3 = call ptr @"Show.$raw_let_3219"(ptr null, ptr %cast_0, ptr %1)
  ret ptr %3
}
...
define internal ptr @Show.main(ptr %0, ptr %"Show.$$__225_0") {
  ...
  store ptr @"Show.#let_closure_3233", ptr %let_func_0, align 8
...
define internal ptr @"Show.#fun_closure_3234"(ptr %0, ptr %1) {
  ...
  %showDictA_0 = load ptr, ptr %showDictA_addr_0, align 8
  %3 = call ptr @"Show.$raw_fun_3216"(ptr null, ptr %showDictB_0, ptr %showDictA_0, ptr %1)
  ret ptr %3
}
...
define internal ptr @"Show.$showTuple2_curry_186"(ptr %0, ptr %"Show.$showDictA_187_0", ptr %"Show.$showDictB_188_0") {
  ...
  store ptr @"Show.#fun_closure_3234", ptr %fun_func_0, align 8
  %3 = call ptr @malgo_hash_table_new()
  call void @malgo_hash_table_insert(ptr %3, ptr @str3222, ptr %2)
  ret ptr %3
}

define internal ptr @Show.show(ptr %0, ptr %"Show.$record_119_0") {
  %2 = call ptr @malgo_hash_table_get(ptr %"Show.$record_119_0", ptr @str3222)
  ret ptr %2
}

define internal ptr @"Show.#let_closure_3235"(ptr %0, ptr %1) {
  %x_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %x_0 = load ptr, ptr %x_addr_0, align 8
...
define internal ptr @"Builtin.appendString#"(ptr %0, ptr %"Builtin.$x_3963_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"Show.#let_closure_3235", ptr %let_func_0, align 8
  ret ptr %2
}
...
define internal ptr @"Show.#fun_closure_3240"(ptr %0, ptr %1) {
...
define internal void @malgo_load_Show() {
  ...
  store ptr @"Show.#fun_closure_3240", ptr %fun_func_0, align 8
  %2 = call ptr @malgo_hash_table_new()
  call void @malgo_hash_table_insert(ptr %2, ptr @str3222, ptr %1)
