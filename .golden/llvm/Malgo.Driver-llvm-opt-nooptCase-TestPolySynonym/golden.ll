; ModuleID = '/workspaces/malgo/.malgo-work/test/testcases/malgo/TestPolySynonym.ll'
...
define internal ptr @"TestPolySynonym.#let_closure_127"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @str275, ptr %8, align 8
  %9 = tail call ptr @malgo_hash_table_new()
  tail call void @malgo_hash_table_insert(ptr %9, ptr noundef nonnull @str223, ptr noundef nonnull %7)
  tail call void @malgo_hash_table_insert(ptr %9, ptr noundef nonnull @str224, ptr noundef nonnull %5)
  %10 = tail call ptr @malgo_hash_table_get(ptr %9, ptr noundef nonnull @str223)
  %11 = tail call ptr @malgo_hash_table_get(ptr %9, ptr noundef nonnull @str224)
  ...
  store ptr @"TestPolySynonym.#let_closure_127", ptr %let_func_0.i.i, align 8
  ...
  %"Prelude.$i_773_0.val.i.i" = load i32, ptr %14, align 4
  %15 = tail call ptr @malgo_int32_t_to_string(i32 %"Prelude.$i_773_0.val.i.i")
