...
define internal ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3486"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
  ...
  store ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3494", ptr %let_func_0.i, align 8
...
define internal ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3487"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
  %f_0 = load ptr, ptr %0, align 8
  ...
  store ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3499", ptr %let_func_0.i, align 8
  ...
  store ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3503", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/InlineFunction.mlg.#fun_closure_3500", ptr %fun_func_0.i, align 8
...
define internal ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3488"(ptr nocapture nofree readnone %0, ptr nofree %1) {
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  ...
  store ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3487", ptr %let_func_0.i2.i, align 8
  %6 = tail call ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3487"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %let_capture_0.i1.i, ptr nofree %1)
  ret ptr %6
}

define internal ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3489"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define internal i32 @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3490"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  %p_0 = load i32, ptr %0, align 4
  %3 = tail call i32 @malgo_add_int32_t(i32 %p_0, i32 %1)
  ret i32 %3
}

define internal i32 @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3491"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  %x_0 = load i32, ptr %0, align 4
  %3 = tail call i32 @malgo_sub_int32_t(i32 %x_0, i32 %1)
  ret i32 %3
}

define internal i32 @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3492"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  %x_0 = load i32, ptr %0, align 4
...
define internal i32 @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3493"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  %p_0 = load i32, ptr %0, align 4
  %3 = tail call i32 @malgo_sub_int32_t(i32 %p_0, i32 %1)
  ret i32 %3
}

define internal ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3494"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
  %f_0 = load ptr, ptr %0, align 8
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i = tail call ptr @malgo_malloc(i64 noundef 8)
  store ptr %f_0, ptr %let_capture_0.i, align 8
  store ptr %let_capture_0.i, ptr %3, align 8
  %let_func_0.i = getelementptr { ptr, ptr }, ptr %3, i64 0, i32 1
  store ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3495", ptr %let_func_0.i, align 8
  %4 = load ptr, ptr %f_0, align 8
  %5 = getelementptr { ptr, ptr }, ptr %f_0, i64 0, i32 1
  %6 = load ptr, ptr %5, align 8
  %7 = tail call ptr %6(ptr %4, ptr nonnull %3)
...
define internal ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3495"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
  %f_0 = load ptr, ptr %0, align 8
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i.i = tail call ptr @malgo_malloc(i64 noundef 8)
...
define internal noundef ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3496"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  ...
  store ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3491", ptr %let_func_0.i.i, align 8
...
define internal noundef ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3497"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  %n_0 = load ptr, ptr %0, align 8
  %3 = getelementptr i8, ptr %n_0, i64 4
  %n_0.val = load i32, ptr %3, align 4
  %4 = getelementptr i8, ptr %1, i64 4
...
define internal noundef ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3498"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  %d_0 = load ptr, ptr %0, align 8
  ...
  store ptr %let_capture_0.i.i, ptr %5, align 8
  %let_func_0.i.i = getelementptr { ptr, ptr }, ptr %5, i64 0, i32 1
  store ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3492", ptr %let_func_0.i.i, align 8
  %x_0.i.i = load i32, ptr %let_capture_0.i.i, align 4
...
define internal noundef ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3499"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  %n_0 = load ptr, ptr %0, align 8
  %3 = getelementptr i8, ptr %n_0, i64 4
  %n_0.val = load i32, ptr %3, align 4
  %4 = getelementptr i8, ptr %1, i64 4
  ...
  store ptr %let_capture_0.i.i, ptr %5, align 8
  %let_func_0.i.i = getelementptr { ptr, ptr }, ptr %5, i64 0, i32 1
  store ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3506", ptr %let_func_0.i.i, align 8
  %x_0.i.i = load i32, ptr %let_capture_0.i.i, align 4
...
define internal noundef ptr @"test/testcases/malgo/InlineFunction.mlg.#fun_closure_3500"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %0, ptr nocapture nofree readnone %1) {
  %f_0 = load ptr, ptr %0, align 8
  ...
  store ptr %let_capture_0.i, ptr %5, align 8
  %let_func_0.i = getelementptr { ptr, ptr }, ptr %5, i64 0, i32 1
  store ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3496", ptr %let_func_0.i, align 8
  ...
  store ptr %let_capture_0.i.i, ptr %7, align 8
  %let_func_0.i.i = getelementptr { ptr, ptr }, ptr %7, i64 0, i32 1
  store ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3493", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3497", ptr %let_func_1.i, align 8
  ...
  store ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3493", ptr %let_func_0.i6.i, align 8
  ...
  store ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3498", ptr %let_func_2.i, align 8
  ...
  store ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3490", ptr %let_func_0.i8.i, align 8
...
define internal i32 @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3506"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  %x_0 = load i32, ptr %0, align 4
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3487", ptr %let_func_0.i.i, align 8
  %7 = tail call ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3487"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %let_capture_0.i.i, ptr nofree noundef nonnull align 4 dereferenceable(1) %3)
  ...
  store ptr @"test/testcases/malgo/InlineFunction.mlg.#let_closure_3489", ptr %let_func_1.i, align 8
