...
@str3659 = unnamed_addr constant [4 x i8] c"foo\00"
@str3665 = unnamed_addr constant [4 x i8] c"end\00"
...
define internal ptr @"With.$raw_let_3653"(ptr %0, ptr %"With.$d_127_0", ptr %"With.$k_3570_0") {
  %2 = getelementptr { i8, <8 x i8> }, ptr %"With.$d_127_0", i32 0, i32 0
...
"switch_branch_Builtin.String#_0":                ; preds = %1
  %4 = getelementptr { i8, { ptr } }, ptr %"With.$d_127_0", i32 0, i32 1
  %5 = getelementptr { ptr }, ptr %4, i32 0, i32 0
  %6 = load ptr, ptr %5, align 8
  %7 = call ptr @malgo_print_string(ptr %6)
  %8 = getelementptr { ptr, ptr }, ptr %"With.$k_3570_0", i32 0, i32 0
  %9 = load ptr, ptr %8, align 8
  %10 = getelementptr { ptr, ptr }, ptr %"With.$k_3570_0", i32 0, i32 1
  %11 = load ptr, ptr %10, align 8
  %12 = call ptr %11(ptr %9, ptr %"With.$d_127_0")
  ret ptr %12
...
define internal ptr @"With.#let_closure_3657"(ptr %0, ptr %1) {
  %str_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %str_0 = load ptr, ptr %str_addr_0, align 8
  %3 = call ptr @"With.$raw_let_3592"(ptr null, ptr %str_0, ptr %1)
  ret ptr %3
}
...
define internal ptr @With.printAndReturn(ptr %0, ptr %"With.$str_87_0") {
  ...
  store ptr @"With.#let_closure_3657", ptr %let_func_0, align 8
  ret ptr %2
}

define internal ptr @"With.$raw_let_3592"(ptr %0, ptr %"With.$str_87_0", ptr %"With.$k_88_0") {
  %2 = getelementptr { i8, <8 x i8> }, ptr %"With.$str_87_0", i32 0, i32 0
  %3 = load i8, ptr %2, align 1
  switch i8 %3, label %switch_default_0 [
    i8 0, label %"switch_branch_Builtin.String#_0"
  ]
...
"switch_branch_Builtin.String#_0":                ; preds = %1
  %4 = getelementptr { i8, { ptr } }, ptr %"With.$str_87_0", i32 0, i32 1
  %5 = getelementptr { ptr }, ptr %4, i32 0, i32 0
  %6 = load ptr, ptr %5, align 8
  %7 = call ptr @malgo_print_string(ptr %6)
  %8 = getelementptr { ptr, ptr }, ptr %"With.$k_88_0", i32 0, i32 0
  %9 = load ptr, ptr %8, align 8
  %10 = getelementptr { ptr, ptr }, ptr %"With.$k_88_0", i32 0, i32 1
  %11 = load ptr, ptr %10, align 8
  %12 = call ptr %11(ptr %9, ptr %"With.$str_87_0")
  ret ptr %12
...
define internal ptr @"With.#let_closure_3658"(ptr %0, ptr %1) {
  %finalizer_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %finalizer_0 = load ptr, ptr %finalizer_addr_0, align 8
  %3 = call ptr @"With.$raw_let_3593"(ptr null, ptr %finalizer_0, ptr %1)
  ret ptr %3
}
...
define internal ptr @With.finally(ptr %0, ptr %"With.$finalizer_99_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"With.#let_closure_3658", ptr %let_func_0, align 8
  ret ptr %2
}

define internal ptr @"With.$raw_let_3593"(ptr %0, ptr %"With.$finalizer_99_0", ptr %"With.$k_100_0") {
  %2 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ i8, {} }, ptr null, i32 1) to i64))
  %3 = getelementptr { i8, {} }, ptr %2, i32 0, i32 0
  store i8 0, ptr %3, align 1
  %4 = getelementptr { ptr, ptr }, ptr %"With.$k_100_0", i32 0, i32 0
  %5 = load ptr, ptr %4, align 8
  %6 = getelementptr { ptr, ptr }, ptr %"With.$k_100_0", i32 0, i32 1
  %7 = load ptr, ptr %6, align 8
  %8 = call ptr %7(ptr %5, ptr %2)
  %9 = getelementptr { ptr, ptr }, ptr %"With.$finalizer_99_0", i32 0, i32 0
  %10 = load ptr, ptr %9, align 8
  %11 = getelementptr { ptr, ptr }, ptr %"With.$finalizer_99_0", i32 0, i32 1
  %12 = load ptr, ptr %11, align 8
  %13 = call ptr %12(ptr %10, ptr %8)
  ret ptr %13
}

define internal ptr @"With.$raw_fun_3654"(ptr %0, ptr %"With.$x_131_0") {
  %2 = getelementptr { i8, <8 x i8> }, ptr %"With.$x_131_0", i32 0, i32 0
  %3 = load i8, ptr %2, align 1
  switch i8 %3, label %switch_default_0 [
    i8 0, label %"switch_branch_Builtin.String#_0"
  ]
...
"switch_branch_Builtin.String#_0":                ; preds = %1
  %4 = getelementptr { i8, { ptr } }, ptr %"With.$x_131_0", i32 0, i32 1
  %5 = getelementptr { ptr }, ptr %4, i32 0, i32 0
  %6 = load ptr, ptr %5, align 8
  %7 = call ptr @malgo_print_string(ptr %6)
  ret ptr %7
...
define internal ptr @"With.#let_closure_3660"(ptr %0, ptr %1) {
  %d_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %d_0 = load ptr, ptr %d_addr_0, align 8
  %3 = call ptr @"With.$raw_let_3653"(ptr null, ptr %d_0, ptr %1)
  ret ptr %3
}

define internal ptr @"With.#fun_closure_3661"(ptr %0, ptr %1) {
  %3 = call ptr @"With.$raw_fun_3654"(ptr null, ptr %1)
  ret ptr %3
}

define internal ptr @"With.$raw_fun_3655"(ptr %0, ptr %"With.$$__126_0") {
  ...
  store ptr @str3659, ptr %4, align 8
  ...
  store ptr @"With.#let_closure_3660", ptr %let_func_0, align 8
  ...
  store ptr @"With.#fun_closure_3661", ptr %fun_func_0, align 8
...
define internal ptr @"With.#fun_closure_3662"(ptr %0, ptr %1) {
  %3 = call ptr @"With.$raw_fun_3625"(ptr null, ptr %1)
  ret ptr %3
}

define internal ptr @"With.#let_closure_3663"(ptr %0, ptr %1) {
  %cast_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %cast_0 = load ptr, ptr %cast_addr_0, align 8
  %3 = call ptr @"With.$raw_let_3641"(ptr null, ptr %cast_0, ptr %1)
  ret ptr %3
}

define internal ptr @"With.#fun_closure_3664"(ptr %0, ptr %1) {
  %3 = call ptr @"With.$raw_fun_3656"(ptr null, ptr %1)
  ret ptr %3
}
...
define internal ptr @With.main(ptr %0, ptr %"With.$$__115_0") {
  ...
  store ptr @"With.#fun_closure_3662", ptr %fun_func_0, align 8
  ...
  store ptr @"With.#let_closure_3663", ptr %let_func_0, align 8
  ...
  store ptr @"With.#fun_closure_3664", ptr %fun_func_1, align 8
...
define internal ptr @"With.$raw_let_3641"(ptr %0, ptr %"With.$cast_122_0", ptr %"With.$k_3567_0") {
  %2 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ i8, {} }, ptr null, i32 1) to i64))
  %3 = getelementptr { i8, {} }, ptr %2, i32 0, i32 0
  store i8 0, ptr %3, align 1
  %4 = getelementptr { ptr, ptr }, ptr %"With.$k_3567_0", i32 0, i32 0
  %5 = load ptr, ptr %4, align 8
  %6 = getelementptr { ptr, ptr }, ptr %"With.$k_3567_0", i32 0, i32 1
  %7 = load ptr, ptr %6, align 8
  %8 = call ptr %7(ptr %5, ptr %2)
  %9 = getelementptr { ptr, ptr }, ptr %"With.$cast_122_0", i32 0, i32 0
  %10 = load ptr, ptr %9, align 8
  %11 = getelementptr { ptr, ptr }, ptr %"With.$cast_122_0", i32 0, i32 1
  %12 = load ptr, ptr %11, align 8
  %13 = call ptr %12(ptr %10, ptr %8)
  ret ptr %13
}

define internal ptr @"With.$raw_fun_3625"(ptr %0, ptr %"With.$tuple_116_0") {
...
"switch_branch_Tuple#_0":                         ; preds = %1
  ...
  store ptr @str3665, ptr %6, align 8
...
define internal ptr @"With.#fun_closure_3666"(ptr %0, ptr %1) {
  %3 = call ptr @"With.$raw_fun_3655"(ptr null, ptr %1)
  ret ptr %3
}

define internal ptr @"With.$raw_fun_3656"(ptr %0, ptr %"With.$$__125_0") {
  %2 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ ptr, ptr }, ptr null, i32 1) to i64))
  %fun_capture_0 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({}, ptr null, i32 1) to i64))
  %fun_capture_1 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 0
  store ptr %fun_capture_0, ptr %fun_capture_1, align 8
  %fun_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"With.#fun_closure_3666", ptr %fun_func_0, align 8
