...
define internal i32 @"UseModule.#let_closure_2936"(ptr %0, i32 %1) {
...
define internal ptr @"UseModule.$raw_let_2934"(ptr %0, ptr %"Builtin.$int32#_4039_0", ptr %"Builtin.$int32#_4040_0") {
...
"switch_branch_Builtin.Int32#_1":                 ; preds = %"switch_branch_Builtin.Int32#_0"
  ...
  store ptr @"UseModule.#let_closure_2936", ptr %let_func_0, align 8
...
define internal ptr @"UseModule.#let_closure_2937"(ptr %0, ptr %1) {
  %"int32#_addr_0" = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %"int32#_0" = load ptr, ptr %"int32#_addr_0", align 8
  %3 = call ptr @"UseModule.$raw_let_2934"(ptr null, ptr %"int32#_0", ptr %1)
  ret ptr %3
}
...
define internal ptr @Builtin.addInt32(ptr %0, ptr %"Builtin.$int32#_4039_0") {
  ...
  store ptr @"UseModule.#let_closure_2937", ptr %let_func_0, align 8
  ret ptr %2
}
...
define internal i32 @"UseModule.#let_closure_2938"(ptr %0, i32 %1) {
  %p_addr_0 = getelementptr { i32 }, ptr %0, i32 0, i32 0
  %p_0 = load i32, ptr %p_addr_0, align 4
  %3 = call i32 @"UseModule.$raw_let_2935"(ptr null, i32 %p_0, i32 %1)
  ret i32 %3
}
...
"switch_branch_Builtin.Int32#_1":                 ; preds = %"switch_branch_Builtin.Int32#_0"
  ...
  store ptr @"UseModule.#let_closure_2938", ptr %let_func_0, align 8
...
define internal i32 @"UseModule.#let_closure_2939"(ptr %0, i32 %1) {
  %p_addr_0 = getelementptr { i32 }, ptr %0, i32 0, i32 0
  %p_0 = load i32, ptr %p_addr_0, align 4
...
define internal ptr @Builtin.malgo_add_int32_t(ptr %0, i32 %"Builtin.$p_1808_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"UseModule.#let_closure_2939", ptr %let_func_0, align 8
  ret ptr %2
}

define internal i32 @"UseModule.$raw_let_2935"(ptr %0, i32 %"UseModule.$p_2845_0", i32 %"UseModule.$y_2854_0") {
  %2 = call ptr @Builtin.malgo_add_int32_t(ptr null, i32 %"UseModule.$p_2845_0")
  %3 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 0
  %4 = load ptr, ptr %3, align 8
  %5 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  %6 = load ptr, ptr %5, align 8
  %7 = call i32 %6(ptr %4, i32 %"UseModule.$y_2854_0")
  ret i32 %7
}

define internal ptr @"UseModule.#let_closure_2941"(ptr %0, ptr %1) {
...
"switch_branch_Builtin.String#_0":                ; preds = %1
  ...
  store ptr @"UseModule.#let_closure_2941", ptr %let_func_0, align 8
  %18 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ i8, { i32 } }, ptr null, i32 1) to i64))
  %19 = getelementptr { i8, { i32 } }, ptr %18, i32 0, i32 0
  store i8 0, ptr %19, align 1
  %20 = getelementptr { i8, { i32 } }, ptr %18, i32 0, i32 1, i32 0
