; ModuleID = './test/tmp/malgo_test/nono/Eventually.ll'
...
define internal ptr @"Eventually.#let_closure_401"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define internal ptr @"Eventually.#fun_closure_592"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(24) %0, ptr nocapture nofree readnone %1) {
...
define internal noundef ptr @Eventually.NotYetDone(ptr nocapture nofree readnone %0, ptr nofree %"Eventually.$p_260_0") {
  %2 = tail call noundef ptr @malgo_malloc(i64 noundef 16)
  store i8 1, ptr %2, align 1
  %3 = getelementptr { i8, { ptr } }, ptr %2, i64 0, i32 1, i32 0
  store ptr %"Eventually.$p_260_0", ptr %3, align 8
  ret ptr %2
}

define internal ptr @Eventually.step(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(1) %"Eventually.$done_262_0") {
  %2 = load i8, ptr %"Eventually.$done_262_0", align 8
  %switch = icmp eq i8 %2, 0
  %3 = getelementptr { i8, { ptr } }, ptr %"Eventually.$done_262_0", i64 0, i32 1
  %4 = load ptr, ptr %3, align 8
  br i1 %switch, label %switch_branch_Eventually.Done_0, label %switch_branch_Eventually.NotYetDone_0

common.ret:                                       ; preds = %switch_branch_Eventually.NotYetDone_0, %switch_branch_Eventually.Done_0
  %common.ret.op = phi ptr [ %6, %switch_branch_Eventually.Done_0 ], [ %12, %switch_branch_Eventually.NotYetDone_0 ]
...
define internal ptr @Eventually.return(ptr nocapture nofree readnone %0, ptr %"Eventually.$record_269_0") {
  %2 = tail call ptr @malgo_hash_table_get(ptr %"Eventually.$record_269_0", ptr noundef nonnull @str593)
  %3 = tail call ptr @malgo_hash_table_get(ptr %"Eventually.$record_269_0", ptr noundef nonnull @str594)
  ret ptr %2
}

define internal ptr @"Eventually.#let_closure_595"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
...
switch_branch_Eventually.NotYetDone_0.i:          ; preds = %2
  ...
  store ptr @"Eventually.#fun_closure_592", ptr %fun_func_0.i, align 8
  %12 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %12, align 8
  %NotYetDone_func_0.i = getelementptr { ptr, ptr }, ptr %12, i64 0, i32 1
  store ptr @Eventually.NotYetDone, ptr %NotYetDone_func_0.i, align 8
...
"Eventually.$eventuallyBind_curry_288.exit":      ; preds = %switch_branch_Eventually.Done_0.i, %switch_branch_Eventually.NotYetDone_0.i
  %common.ret.op.i = phi ptr [ %9, %switch_branch_Eventually.Done_0.i ], [ %13, %switch_branch_Eventually.NotYetDone_0.i ]
...
define internal ptr @Eventually.bind(ptr nocapture nofree readnone %0, ptr %"Eventually.$record_308_0") {
  %2 = tail call ptr @malgo_hash_table_get(ptr %"Eventually.$record_308_0", ptr noundef nonnull @str593)
  %3 = tail call ptr @malgo_hash_table_get(ptr %"Eventually.$record_308_0", ptr noundef nonnull @str594)
  ret ptr %3
}

define internal ptr @"Eventually.#fun_closure_596"(ptr nocapture nofree readonly align 8 %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %1) {
...
common.ret:                                       ; preds = %switch_branch_Eventually.NotYetDone_0, %switch_branch_Eventually.Done_0
  %.sink1 = phi ptr [ %17, %switch_branch_Eventually.NotYetDone_0 ], [ %13, %switch_branch_Eventually.Done_0 ]
...
switch_branch_Eventually.Done_0:                  ; preds = %2
  %toStringInt32_addr_0 = getelementptr { ptr, ptr, ptr }, ptr %0, i64 0, i32 1
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr %5, ptr @Eventually.eventually, align 8
  %8 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %8, align 8
  %bind_func_0.i = getelementptr { ptr, ptr }, ptr %8, i64 0, i32 1
  store ptr @Eventually.bind, ptr %bind_func_0.i, align 8
  %9 = load ptr, ptr @Eventually.eventually, align 8
  ...
  %"String#_func_0.i" = getelementptr { ptr, ptr }, ptr %13, i64 0, i32 1
  store ptr @"Builtin.String#", ptr %"String#_func_0.i", align 8
  store ptr %13, ptr %fun_capture_0.i, align 8
  %14 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %14, align 8
  %Done_func_1.i = getelementptr { ptr, ptr }, ptr %14, i64 0, i32 1
  store ptr @Eventually.Done, ptr %Done_func_1.i, align 8
  %Done_0.i = getelementptr { ptr, ptr, ptr }, ptr %fun_capture_0.i, i64 0, i32 1
  store ptr %14, ptr %Done_0.i, align 8
  ...
  %printString_0.i = getelementptr { ptr, ptr, ptr }, ptr %fun_capture_0.i, i64 0, i32 2
  ...
  store ptr @"Eventually.#fun_closure_602", ptr %fun_func_0.i, align 8
  ...
  %"String#_func_1.i" = getelementptr { ptr, ptr }, ptr %24, i64 0, i32 1
  ...
  store ptr @Eventually.bind, ptr %bind_func_1.i, align 8
  ...
  %Done_func_2.i = getelementptr { ptr, ptr }, ptr %26, i64 0, i32 1
  store ptr @Eventually.Done, ptr %Done_func_2.i, align 8
  %Done_1.i = getelementptr { ptr, ptr, ptr, ptr, ptr, ptr, ptr }, ptr %fun_capture_2.i, i64 0, i32 2
  store ptr %26, ptr %Done_1.i, align 8
  %27 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %27, align 8
  %printString_func_1.i = getelementptr { ptr, ptr }, ptr %27, i64 0, i32 1
  store ptr @Builtin.printString, ptr %printString_func_1.i, align 8
  %printString_1.i = getelementptr { ptr, ptr, ptr, ptr, ptr, ptr, ptr }, ptr %fun_capture_2.i, i64 0, i32 3
  store ptr %27, ptr %printString_1.i, align 8
  ...
  %NotYetDone_func_1.i = getelementptr { ptr, ptr }, ptr %29, i64 0, i32 1
  store ptr @Eventually.NotYetDone, ptr %NotYetDone_func_1.i, align 8
  %NotYetDone_0.i = getelementptr { ptr, ptr, ptr, ptr, ptr, ptr, ptr }, ptr %fun_capture_2.i, i64 0, i32 5
  store ptr %29, ptr %NotYetDone_0.i, align 8
  %30 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %30, align 8
  %return_func_0.i = getelementptr { ptr, ptr }, ptr %30, i64 0, i32 1
  store ptr @Eventually.return, ptr %return_func_0.i, align 8
  %return_0.i = getelementptr { ptr, ptr, ptr, ptr, ptr, ptr, ptr }, ptr %fun_capture_2.i, i64 0, i32 6
  store ptr %30, ptr %return_0.i, align 8
  store ptr %fun_capture_2.i, ptr %23, align 8
  %fun_func_1.i = getelementptr { ptr, ptr }, ptr %23, i64 0, i32 1
  store ptr @"Eventually.#fun_closure_604", ptr %fun_func_1.i, align 8
  %31 = load ptr, ptr %22, align 8
  %32 = getelementptr { ptr, ptr }, ptr %22, i64 0, i32 1
  %33 = load ptr, ptr %32, align 8
  %34 = tail call ptr %33(ptr %31, ptr nonnull %23)
  store ptr %34, ptr @Eventually.comp, align 8
  ...
  %37 = load ptr, ptr @Eventually.comp, align 8
  ...
  store ptr @"Eventually.#let_closure_401", ptr %let_func_0.i.i, align 8
  %39 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %39, align 8
  %step_func_0.i = getelementptr { ptr, ptr }, ptr %39, i64 0, i32 1
  store ptr @Eventually.step, ptr %step_func_0.i, align 8
...
Eventually.step.exit.i:                           ; preds = %switch_branch_Eventually.NotYetDone_0.i.i, %switch_branch_Eventually.Done_0.i.i
  ...
  %52 = load ptr, ptr @Eventually.comp, align 8
  ...
  store ptr @"Eventually.#let_closure_401", ptr %let_func_0.i2.i, align 8
  %54 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %54, align 8
  %step_func_1.i = getelementptr { ptr, ptr }, ptr %54, i64 0, i32 1
  store ptr @Eventually.step, ptr %step_func_1.i, align 8
  ...
  br i1 %switch.i18.i, label %switch_branch_Eventually.Done_0.i21.i, label %switch_branch_Eventually.NotYetDone_0.i22.i

switch_branch_Eventually.Done_0.i21.i:            ; preds = %Eventually.step.exit.i
  %58 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %58, align 8
  %Done_func_0.i20.i = getelementptr { ptr, ptr }, ptr %58, i64 0, i32 1
  store ptr @Eventually.Done, ptr %Done_func_0.i20.i, align 8
  %59 = tail call ptr @malgo_malloc(i64 noundef 16)
  store i8 0, ptr %59, align 1
  %60 = getelementptr { i8, { ptr } }, ptr %59, i64 0, i32 1, i32 0
  store ptr %57, ptr %60, align 8
  br label %Eventually.step.exit23.i

switch_branch_Eventually.NotYetDone_0.i22.i:      ; preds = %Eventually.step.exit.i
...
Eventually.step.exit23.i:                         ; preds = %switch_branch_Eventually.NotYetDone_0.i22.i, %switch_branch_Eventually.Done_0.i21.i
  %common.ret.op.i19.i = phi ptr [ %59, %switch_branch_Eventually.Done_0.i21.i ], [ %65, %switch_branch_Eventually.NotYetDone_0.i22.i ]
  %66 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %66, align 8
  %"|>_func_2.i" = getelementptr { ptr, ptr }, ptr %66, i64 0, i32 1
  store ptr @"Prelude.|>", ptr %"|>_func_2.i", align 8
  ...
  store ptr @"Eventually.#let_closure_401", ptr %let_func_0.i4.i, align 8
  %68 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %68, align 8
  %step_func_2.i = getelementptr { ptr, ptr }, ptr %68, i64 0, i32 1
  store ptr @Eventually.step, ptr %step_func_2.i, align 8
  ...
  br i1 %switch.i24.i, label %switch_branch_Eventually.Done_0.i27.i, label %switch_branch_Eventually.NotYetDone_0.i28.i

switch_branch_Eventually.Done_0.i27.i:            ; preds = %Eventually.step.exit23.i
  %72 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %72, align 8
  %Done_func_0.i26.i = getelementptr { ptr, ptr }, ptr %72, i64 0, i32 1
  store ptr @Eventually.Done, ptr %Done_func_0.i26.i, align 8
  %73 = tail call ptr @malgo_malloc(i64 noundef 16)
  store i8 0, ptr %73, align 1
  %74 = getelementptr { i8, { ptr } }, ptr %73, i64 0, i32 1, i32 0
  store ptr %71, ptr %74, align 8
  br label %Eventually.step.exit29.i

switch_branch_Eventually.NotYetDone_0.i28.i:      ; preds = %Eventually.step.exit23.i
...
Eventually.step.exit29.i:                         ; preds = %switch_branch_Eventually.NotYetDone_0.i28.i, %switch_branch_Eventually.Done_0.i27.i
  %common.ret.op.i25.i = phi ptr [ %73, %switch_branch_Eventually.Done_0.i27.i ], [ %79, %switch_branch_Eventually.NotYetDone_0.i28.i ]
  %80 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %80, align 8
  %"|>_func_3.i" = getelementptr { ptr, ptr }, ptr %80, i64 0, i32 1
  store ptr @"Prelude.|>", ptr %"|>_func_3.i", align 8
  ...
  store ptr @"Eventually.#let_closure_401", ptr %let_func_0.i6.i, align 8
  %82 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %82, align 8
  %step_func_3.i = getelementptr { ptr, ptr }, ptr %82, i64 0, i32 1
  store ptr @Eventually.step, ptr %step_func_3.i, align 8
  ...
  br i1 %switch.i30.i, label %switch_branch_Eventually.Done_0.i33.i, label %switch_branch_Eventually.NotYetDone_0.i34.i

switch_branch_Eventually.Done_0.i33.i:            ; preds = %Eventually.step.exit29.i
  %86 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %86, align 8
  %Done_func_0.i32.i = getelementptr { ptr, ptr }, ptr %86, i64 0, i32 1
  store ptr @Eventually.Done, ptr %Done_func_0.i32.i, align 8
...
switch_branch_Eventually.NotYetDone_0.i34.i:      ; preds = %Eventually.step.exit29.i
...
Eventually.main.exit:                             ; preds = %switch_branch_Eventually.Done_0.i33.i, %switch_branch_Eventually.NotYetDone_0.i34.i
  %common.ret.op.i31.i = phi ptr [ %87, %switch_branch_Eventually.Done_0.i33.i ], [ %93, %switch_branch_Eventually.NotYetDone_0.i34.i ]
  %94 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %94, align 8
  %"|>_func_4.i" = getelementptr { ptr, ptr }, ptr %94, i64 0, i32 1
  store ptr @"Prelude.|>", ptr %"|>_func_4.i", align 8
  ...
  store ptr @"Eventually.#let_closure_401", ptr %let_func_0.i8.i, align 8
  ...
  %"String#_func_0.i2" = getelementptr { ptr, ptr }, ptr %97, i64 0, i32 1
  store ptr @"Builtin.String#", ptr %"String#_func_0.i2", align 8
  store ptr %97, ptr %fun_capture_0.i1, align 8
  %98 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %98, align 8
  %toStringInt32_func_0.i = getelementptr { ptr, ptr }, ptr %98, i64 0, i32 1
  store ptr @Builtin.toStringInt32, ptr %toStringInt32_func_0.i, align 8
  %toStringInt32_0.i = getelementptr { ptr, ptr, ptr }, ptr %fun_capture_0.i1, i64 0, i32 1
  store ptr %98, ptr %toStringInt32_0.i, align 8
  %99 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %99, align 8
  %printString_func_0.i3 = getelementptr { ptr, ptr }, ptr %99, i64 0, i32 1
  store ptr @Builtin.printString, ptr %printString_func_0.i3, align 8
  %printString_0.i4 = getelementptr { ptr, ptr, ptr }, ptr %fun_capture_0.i1, i64 0, i32 2
  store ptr %99, ptr %printString_0.i4, align 8
  store ptr %fun_capture_0.i1, ptr %96, align 8
  %fun_func_0.i5 = getelementptr { ptr, ptr }, ptr %96, i64 0, i32 1
  store ptr @"Eventually.#fun_closure_596", ptr %fun_func_0.i5, align 8
...
define internal ptr @"Eventually.#fun_closure_602"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(24) %0, ptr nocapture nofree readnone %1) {
  %"String#_0" = load ptr, ptr %0, align 8
  %Done_addr_0 = getelementptr { ptr, ptr, ptr }, ptr %0, i64 0, i32 1
...
define internal ptr @"Eventually.#fun_closure_605"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(24) %0, ptr nocapture nofree readnone %1) {
  %"String#_0" = load ptr, ptr %0, align 8
  %Done_addr_0 = getelementptr { ptr, ptr, ptr }, ptr %0, i64 0, i32 1
  %Done_0 = load ptr, ptr %Done_addr_0, align 8
  %printString_addr_0 = getelementptr { ptr, ptr, ptr }, ptr %0, i64 0, i32 2
...
define internal ptr @"Eventually.#fun_closure_607"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %0, ptr nocapture nofree readnone %1) {
  ...
  %5 = load ptr, ptr %4, align 8
  %6 = load ptr, ptr @Eventually.eventually, align 8
...
define internal ptr @"Eventually.#fun_closure_604"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(56) %0, ptr nocapture nofree readnone %1) {
  %"String#_0" = load ptr, ptr %0, align 8
  %bind_addr_0 = getelementptr { ptr, ptr, ptr, ptr, ptr, ptr, ptr }, ptr %0, i64 0, i32 1
  %bind_0 = load ptr, ptr %bind_addr_0, align 8
  %Done_addr_0 = getelementptr { ptr, ptr, ptr, ptr, ptr, ptr, ptr }, ptr %0, i64 0, i32 2
  %Done_0 = load ptr, ptr %Done_addr_0, align 8
  %printString_addr_0 = getelementptr { ptr, ptr, ptr, ptr, ptr, ptr, ptr }, ptr %0, i64 0, i32 3
  %printString_0 = load ptr, ptr %printString_addr_0, align 8
  %"Int32#_addr_0" = getelementptr { ptr, ptr, ptr, ptr, ptr, ptr, ptr }, ptr %0, i64 0, i32 4
  %"Int32#_0" = load ptr, ptr %"Int32#_addr_0", align 8
  %NotYetDone_addr_0 = getelementptr { ptr, ptr, ptr, ptr, ptr, ptr, ptr }, ptr %0, i64 0, i32 5
  %NotYetDone_0 = load ptr, ptr %NotYetDone_addr_0, align 8
  %return_addr_0 = getelementptr { ptr, ptr, ptr, ptr, ptr, ptr, ptr }, ptr %0, i64 0, i32 6
  %return_0 = load ptr, ptr %return_addr_0, align 8
  ...
  %Done_1 = getelementptr { ptr, ptr, ptr }, ptr %fun_capture_0, i64 0, i32 1
