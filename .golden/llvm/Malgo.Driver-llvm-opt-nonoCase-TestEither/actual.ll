; ModuleID = './test/tmp/malgo_test/nono/TestEither.ll'
...
define internal ptr @"TestEither.#let_closure_388"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define internal i32 @"TestEither.#let_closure_408"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
...
define internal i32 @"TestEither.#let_closure_573"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  ...
  store ptr @"TestEither.#let_closure_408", ptr %let_func_0.i.i, align 8
...
define internal noundef ptr @"TestEither.#let_closure_574"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  ...
  store ptr @"TestEither.#let_closure_573", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"TestEither.#let_closure_408", ptr %let_func_0.i.i.i.i, align 8
...
define internal noundef ptr @TestEither.Left(ptr nocapture nofree readnone %0, ptr nofree %"TestEither.$p_249_0") {
  %2 = tail call noundef ptr @malgo_malloc(i64 noundef 16)
  store i8 0, ptr %2, align 1
  %3 = getelementptr { i8, { ptr } }, ptr %2, i64 0, i32 1, i32 0
  store ptr %"TestEither.$p_249_0", ptr %3, align 8
  ret ptr %2
}
...
define internal ptr @"TestEither.#let_closure_579"(ptr nocapture nofree readonly %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(1) %1) {
...
switch_branch_TestEither.Left_0.i:                ; preds = %2
  ...
  store ptr @TestEither.Left, ptr %Left_func_0.i, align 8
  %7 = tail call ptr @malgo_malloc(i64 noundef 16)
  store i8 0, ptr %7, align 1
  %8 = getelementptr { i8, { ptr } }, ptr %7, i64 0, i32 1, i32 0
  store ptr %5, ptr %8, align 8
...
"TestEither.$andThen_curry_260.exit":             ; preds = %switch_branch_TestEither.Left_0.i, %switch_branch_TestEither.Right_0.i
  %common.ret.op.i = phi ptr [ %7, %switch_branch_TestEither.Left_0.i ], [ %12, %switch_branch_TestEither.Right_0.i ]
  ret ptr %common.ret.op.i
}

define internal ptr @TestEither.andThen(ptr nocapture nofree readnone %0, ptr nofree %"TestEither.$__254_0") {
  %2 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0 = tail call ptr @malgo_malloc(i64 noundef 8)
  store ptr %"TestEither.$__254_0", ptr %let_capture_0, align 8
  store ptr %let_capture_0, ptr %2, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i64 0, i32 1
...
define internal ptr @"TestEither.#fun_closure_580"(ptr nocapture nofree readonly align 8 %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %1) {
  %3 = load i8, ptr %1, align 1
  %switch = icmp eq i8 %3, 0
  br i1 %switch, label %switch_branch_TestEither.Left_0, label %switch_branch_TestEither.Right_0

common.ret:                                       ; preds = %switch_branch_TestEither.Right_0, %switch_branch_TestEither.Left_0
  %putStr_0.sink4 = phi ptr [ %putStr_0, %switch_branch_TestEither.Right_0 ], [ %putStrLn_0, %switch_branch_TestEither.Left_0 ]
  %.sink1 = phi ptr [ %17, %switch_branch_TestEither.Right_0 ], [ %11, %switch_branch_TestEither.Left_0 ]
...
switch_branch_TestEither.Left_0:                  ; preds = %2
  %putStrLn_addr_0 = getelementptr { ptr, ptr, ptr, ptr }, ptr %0, i64 0, i32 3
...
switch_branch_TestEither.Right_0:                 ; preds = %2
  ...
  %toStringInt32_addr_0 = getelementptr { ptr, ptr, ptr, ptr }, ptr %0, i64 0, i32 1
...
define internal ptr @"TestEither.#fun_closure_582"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(24) %0, ptr %1) {
  %addInt32_0 = load ptr, ptr %0, align 8
  %"Int32#_addr_0" = getelementptr { ptr, ptr, ptr }, ptr %0, i64 0, i32 1
  %"Int32#_0" = load ptr, ptr %"Int32#_addr_0", align 8
  %Right_addr_0 = getelementptr { ptr, ptr, ptr }, ptr %0, i64 0, i32 2
...
define internal ptr @"TestEither.#fun_closure_583"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(32) %0, ptr %1) {
  %toStringInt32_0 = load ptr, ptr %0, align 8
  %putStr_addr_0 = getelementptr { ptr, ptr, ptr, ptr }, ptr %0, i64 0, i32 1
  %putStr_0 = load ptr, ptr %putStr_addr_0, align 8
  %"|>_addr_0" = getelementptr { ptr, ptr, ptr, ptr }, ptr %0, i64 0, i32 2
  %"|>_0" = load ptr, ptr %"|>_addr_0", align 8
  %Right_addr_0 = getelementptr { ptr, ptr, ptr, ptr }, ptr %0, i64 0, i32 3
  %Right_0 = load ptr, ptr %Right_addr_0, align 8
...
define internal ptr @"TestEither.#fun_closure_584"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %0, ptr nocapture nofree readnone %1) {
  %"String#_0" = load ptr, ptr %0, align 8
  %Left_addr_0 = getelementptr { ptr, ptr }, ptr %0, i64 0, i32 1
...
define internal ptr @"TestEither.#fun_closure_586"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(24) %0, ptr %1) {
  %addInt32_0 = load ptr, ptr %0, align 8
  %"Int32#_addr_0" = getelementptr { ptr, ptr, ptr }, ptr %0, i64 0, i32 1
  %"Int32#_0" = load ptr, ptr %"Int32#_addr_0", align 8
  %Right_addr_0 = getelementptr { ptr, ptr, ptr }, ptr %0, i64 0, i32 2
...
define internal ptr @"TestEither.#fun_closure_587"(ptr nocapture nofree readonly align 8 %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(1) %1) {
...
common.ret:                                       ; preds = %switch_branch_TestEither.Right_0, %switch_branch_TestEither.Left_0
  %.sink4 = phi ptr [ %22, %switch_branch_TestEither.Right_0 ], [ %putStrLn_0, %switch_branch_TestEither.Left_0 ]
  %putStrLn_0.sink = phi ptr [ %putStrLn_0, %switch_branch_TestEither.Right_0 ], [ %9, %switch_branch_TestEither.Left_0 ]
...
switch_branch_TestEither.Right_0:                 ; preds = %2
  %"|>_addr_0" = getelementptr { ptr, ptr, ptr }, ptr %0, i64 0, i32 1
  %"|>_0" = load ptr, ptr %"|>_addr_0", align 8
  %toStringInt32_0 = load ptr, ptr %0, align 8
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"TestEither.#let_closure_388", ptr %let_func_0.i.i, align 8
  ...
  %toStringInt32_func_0.i = getelementptr { ptr, ptr }, ptr %16, i64 0, i32 1
  store ptr @Builtin.toStringInt32, ptr %toStringInt32_func_0.i, align 8
  %toStringInt32_0.i = getelementptr { ptr, ptr, ptr, ptr }, ptr %fun_capture_0.i, i64 0, i32 1
  store ptr %16, ptr %toStringInt32_0.i, align 8
  ...
  %putStr_0.i = getelementptr { ptr, ptr, ptr, ptr }, ptr %fun_capture_0.i, i64 0, i32 2
  store ptr %17, ptr %putStr_0.i, align 8
  %18 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %18, align 8
  %putStrLn_func_0.i = getelementptr { ptr, ptr }, ptr %18, i64 0, i32 1
  store ptr @Prelude.putStrLn, ptr %putStrLn_func_0.i, align 8
  %putStrLn_0.i = getelementptr { ptr, ptr, ptr, ptr }, ptr %fun_capture_0.i, i64 0, i32 3
  store ptr %18, ptr %putStrLn_0.i, align 8
  store ptr %fun_capture_0.i, ptr %14, align 8
  %fun_func_0.i = getelementptr { ptr, ptr }, ptr %14, i64 0, i32 1
  store ptr @"TestEither.#fun_closure_580", ptr %fun_func_0.i, align 8
  ...
  store ptr @TestEither.Right, ptr %Right_func_1.i, align 8
  ...
  store ptr @"TestEither.#let_closure_388", ptr %let_func_0.i2.i, align 8
  ...
  %addInt32_func_0.i = getelementptr { ptr, ptr }, ptr %31, i64 0, i32 1
  ...
  %Right_func_2.i = getelementptr { ptr, ptr }, ptr %33, i64 0, i32 1
  store ptr @TestEither.Right, ptr %Right_func_2.i, align 8
  %Right_0.i = getelementptr { ptr, ptr, ptr }, ptr %fun_capture_2.i, i64 0, i32 2
  store ptr %33, ptr %Right_0.i, align 8
  store ptr %fun_capture_2.i, ptr %30, align 8
  %fun_func_1.i = getelementptr { ptr, ptr }, ptr %30, i64 0, i32 1
  store ptr @"TestEither.#fun_closure_582", ptr %fun_func_1.i, align 8
  %34 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %34, align 8
  %andThen_func_0.i = getelementptr { ptr, ptr }, ptr %34, i64 0, i32 1
  store ptr @TestEither.andThen, ptr %andThen_func_0.i, align 8
  ...
  store ptr @"TestEither.#let_closure_579", ptr %let_func_0.i4.i, align 8
  ...
  store ptr @"TestEither.#let_closure_388", ptr %let_func_0.i6.i, align 8
  ...
  %toStringInt32_func_1.i = getelementptr { ptr, ptr }, ptr %42, i64 0, i32 1
  store ptr @Builtin.toStringInt32, ptr %toStringInt32_func_1.i, align 8
  store ptr %42, ptr %fun_capture_4.i, align 8
  %43 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %43, align 8
  %putStr_func_1.i = getelementptr { ptr, ptr }, ptr %43, i64 0, i32 1
  store ptr @Prelude.putStr, ptr %putStr_func_1.i, align 8
  %putStr_1.i = getelementptr { ptr, ptr, ptr, ptr }, ptr %fun_capture_4.i, i64 0, i32 1
  store ptr %43, ptr %putStr_1.i, align 8
  %44 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %44, align 8
  %"|>_func_3.i" = getelementptr { ptr, ptr }, ptr %44, i64 0, i32 1
  store ptr @"Prelude.|>", ptr %"|>_func_3.i", align 8
  %"|>_0.i" = getelementptr { ptr, ptr, ptr, ptr }, ptr %fun_capture_4.i, i64 0, i32 2
  store ptr %44, ptr %"|>_0.i", align 8
  %45 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %45, align 8
  %Right_func_3.i = getelementptr { ptr, ptr }, ptr %45, i64 0, i32 1
  store ptr @TestEither.Right, ptr %Right_func_3.i, align 8
  %Right_1.i = getelementptr { ptr, ptr, ptr, ptr }, ptr %fun_capture_4.i, i64 0, i32 3
  store ptr %45, ptr %Right_1.i, align 8
  store ptr %fun_capture_4.i, ptr %41, align 8
  %fun_func_2.i = getelementptr { ptr, ptr }, ptr %41, i64 0, i32 1
  store ptr @"TestEither.#fun_closure_583", ptr %fun_func_2.i, align 8
  %46 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %46, align 8
  %andThen_func_1.i = getelementptr { ptr, ptr }, ptr %46, i64 0, i32 1
  store ptr @TestEither.andThen, ptr %andThen_func_1.i, align 8
  ...
  store ptr @"TestEither.#let_closure_579", ptr %let_func_0.i8.i, align 8
  ...
  store ptr @"TestEither.#let_closure_388", ptr %let_func_0.i10.i, align 8
  ...
  %"String#_func_1.i" = getelementptr { ptr, ptr }, ptr %54, i64 0, i32 1
  ...
  %Left_func_0.i = getelementptr { ptr, ptr }, ptr %55, i64 0, i32 1
  store ptr @TestEither.Left, ptr %Left_func_0.i, align 8
  %Left_0.i = getelementptr { ptr, ptr }, ptr %fun_capture_6.i, i64 0, i32 1
  store ptr %55, ptr %Left_0.i, align 8
  store ptr %fun_capture_6.i, ptr %53, align 8
  %fun_func_3.i = getelementptr { ptr, ptr }, ptr %53, i64 0, i32 1
  store ptr @"TestEither.#fun_closure_584", ptr %fun_func_3.i, align 8
  %56 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %56, align 8
  %andThen_func_2.i = getelementptr { ptr, ptr }, ptr %56, i64 0, i32 1
  store ptr @TestEither.andThen, ptr %andThen_func_2.i, align 8
  ...
  store ptr @"TestEither.#let_closure_579", ptr %let_func_0.i12.i, align 8
  ...
  store ptr @"Prelude.|>", ptr %"|>_func_5.i", align 8
  ...
  store ptr @"TestEither.#let_closure_388", ptr %let_func_0.i14.i, align 8
  ...
  %addInt32_func_1.i = getelementptr { ptr, ptr }, ptr %64, i64 0, i32 1
  store ptr @Builtin.addInt32, ptr %addInt32_func_1.i, align 8
  ...
  store ptr @"Builtin.Int32#", ptr %"Int32#_func_3.i", align 8
  ...
  %Right_func_4.i = getelementptr { ptr, ptr }, ptr %66, i64 0, i32 1
  store ptr @TestEither.Right, ptr %Right_func_4.i, align 8
  %Right_2.i = getelementptr { ptr, ptr, ptr }, ptr %fun_capture_8.i, i64 0, i32 2
  store ptr %66, ptr %Right_2.i, align 8
  store ptr %fun_capture_8.i, ptr %63, align 8
  %fun_func_4.i = getelementptr { ptr, ptr }, ptr %63, i64 0, i32 1
  store ptr @"TestEither.#fun_closure_586", ptr %fun_func_4.i, align 8
  %67 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %67, align 8
  %andThen_func_3.i = getelementptr { ptr, ptr }, ptr %67, i64 0, i32 1
  store ptr @TestEither.andThen, ptr %andThen_func_3.i, align 8
  ...
  store ptr @"TestEither.#let_closure_579", ptr %let_func_0.i16.i, align 8
  ...
  store ptr @"Prelude.|>", ptr %"|>_func_6.i", align 8
  ...
  store ptr @"TestEither.#let_closure_388", ptr %let_func_0.i18.i, align 8
  ...
  %toStringInt32_func_2.i = getelementptr { ptr, ptr }, ptr %75, i64 0, i32 1
  store ptr @Builtin.toStringInt32, ptr %toStringInt32_func_2.i, align 8
  store ptr %75, ptr %fun_capture_10.i, align 8
  %76 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %76, align 8
  %"|>_func_7.i" = getelementptr { ptr, ptr }, ptr %76, i64 0, i32 1
  store ptr @"Prelude.|>", ptr %"|>_func_7.i", align 8
  %"|>_1.i" = getelementptr { ptr, ptr, ptr }, ptr %fun_capture_10.i, i64 0, i32 1
  store ptr %76, ptr %"|>_1.i", align 8
  %77 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %77, align 8
  %putStrLn_func_1.i = getelementptr { ptr, ptr }, ptr %77, i64 0, i32 1
  store ptr @Prelude.putStrLn, ptr %putStrLn_func_1.i, align 8
  %putStrLn_1.i = getelementptr { ptr, ptr, ptr }, ptr %fun_capture_10.i, i64 0, i32 2
  store ptr %77, ptr %putStrLn_1.i, align 8
  store ptr %fun_capture_10.i, ptr %74, align 8
  %fun_func_5.i = getelementptr { ptr, ptr }, ptr %74, i64 0, i32 1
  store ptr @"TestEither.#fun_closure_587", ptr %fun_func_5.i, align 8
