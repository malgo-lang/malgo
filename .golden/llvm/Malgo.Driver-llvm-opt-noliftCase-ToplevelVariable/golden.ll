; ModuleID = './test/tmp/malgo_test/nolift/ToplevelVariable.ll'
...
define internal ptr @"ToplevelVariable.#let_closure_3093"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readnone %1) #1 {
...
; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind readonly willreturn
define internal ptr @"ToplevelVariable.#let_closure_3098"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readnone %1) #1 {
  %cast_0 = load ptr, ptr %0, align 8
  ret ptr %cast_0
}

define internal i32 @"ToplevelVariable.#let_closure_3099"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
...
; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind readonly willreturn
define internal ptr @"ToplevelVariable.#let_closure_3100"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readnone %1) #1 {
  %cast_0 = load ptr, ptr %0, align 8
  ret ptr %cast_0
}

define internal i32 @"ToplevelVariable.#let_closure_3101"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  %p_0 = load i32, ptr %0, align 4
  %3 = tail call i32 @malgo_add_int32_t(i32 %p_0, i32 %1)
  ret i32 %3
}
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr %2, ptr @ToplevelVariable.one, align 8
  ...
  store ptr %7, ptr @ToplevelVariable.comp, align 8
  ...
  br i1 %switch.i, label %switch_branch_Prelude.Nothing_0.i, label %switch_branch_Prelude.Just_0.i

switch_branch_Prelude.Nothing_0.i:                ; preds = %1
  store i8 0, ptr %11, align 1
  %12 = getelementptr { i8, { ptr } }, ptr %11, i64 0, i32 1, i32 0
  store ptr @str3097, ptr %12, align 8
  %13 = tail call ptr @malgo_print_string(ptr noundef nonnull @str3097)
  ...
  store ptr @Prelude.identity, ptr %identity_func_0.i, align 8
  ...
  store ptr @"ToplevelVariable.#let_closure_3098", ptr %let_func_0.i, align 8
  %cast_0.i.i = load ptr, ptr %let_capture_0.i, align 8
  %17 = load ptr, ptr @ToplevelVariable.one, align 8
...
switch_branch_Prelude.Just_0.i:                   ; preds = %1
  ...
  store ptr @"ToplevelVariable.#let_closure_3100", ptr %let_func_2.i, align 8
...
ToplevelVariable.main.exit:                       ; preds = %switch_branch_Prelude.Nothing_0.i, %switch_branch_Prelude.Just_0.i
  %.sink.i = phi ptr [ %26, %switch_branch_Prelude.Just_0.i ], [ %20, %switch_branch_Prelude.Nothing_0.i ]
  %"ToplevelVariable.#let_closure_3101.sink.i" = phi ptr [ @"ToplevelVariable.#let_closure_3101", %switch_branch_Prelude.Just_0.i ], [ @"ToplevelVariable.#let_closure_3099", %switch_branch_Prelude.Nothing_0.i ]
  %let_capture_6.sink.i = phi ptr [ %let_capture_6.i, %switch_branch_Prelude.Just_0.i ], [ %let_capture_2.i, %switch_branch_Prelude.Nothing_0.i ]
  %.sink15.i = phi i32 [ %25, %switch_branch_Prelude.Just_0.i ], [ %19, %switch_branch_Prelude.Nothing_0.i ]
  %cast_0.i1.sink11.i = phi ptr [ %cast_0.i1.i, %switch_branch_Prelude.Just_0.i ], [ %cast_0.i.i, %switch_branch_Prelude.Nothing_0.i ]
  %let_func_3.i = getelementptr { ptr, ptr }, ptr %.sink.i, i64 0, i32 1
  store ptr %"ToplevelVariable.#let_closure_3101.sink.i", ptr %let_func_3.i, align 8
