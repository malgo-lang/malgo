...
@str103 = unnamed_addr constant [5 x i8] c"True\00"
@str105 = unnamed_addr constant [6 x i8] c"False\00"
...
define internal ptr @"test/testcases/malgo/Test1.mlg.$raw_let_95"(ptr %0, ptr %"test/testcases/malgo/Test1.mlg.$t_43_0", ptr %"test/testcases/malgo/Test1.mlg.$true_42_0", ptr %"test/testcases/malgo/Test1.mlg.$__44_0") {
...
define internal ptr @"test/testcases/malgo/Test1.mlg.#fun_closure_102"(ptr %0, ptr %1) {
  %3 = call ptr @malgo_print_string(ptr @str103)
  ret ptr %3
}
...
define internal ptr @"test/testcases/malgo/Test1.mlg.main"(ptr %0, ptr %"test/testcases/malgo/Test1.mlg.$$__63_0") {
  ...
  store ptr @"test/testcases/malgo/Test1.mlg.#fun_closure_102", ptr %fun_func_0, align 8
  ...
  store ptr @"test/testcases/malgo/Test1.mlg.#fun_closure_104", ptr %fun_func_1, align 8
...
define internal ptr @"test/testcases/malgo/Test1.mlg.#let_closure_106"(ptr %0, ptr %1) {
  ...
  %true_0 = load ptr, ptr %true_addr_0, align 8
  %3 = call ptr @"test/testcases/malgo/Test1.mlg.$raw_let_95"(ptr null, ptr %t_0, ptr %true_0, ptr %1)
  ret ptr %3
}
...
define internal ptr @"test/testcases/malgo/Test1.mlg.$raw_let_96"(ptr %0, ptr %"test/testcases/malgo/Test1.mlg.$true_42_0", ptr %"test/testcases/malgo/Test1.mlg.$t_43_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"test/testcases/malgo/Test1.mlg.#let_closure_106", ptr %let_func_0, align 8
  ret ptr %2
}
...
define internal ptr @"test/testcases/malgo/Test1.mlg.$raw_let_98"(ptr %0, ptr %"test/testcases/malgo/Test1.mlg.$d_64_0", ptr %"test/testcases/malgo/Test1.mlg.$t_86_0", ptr %"test/testcases/malgo/Test1.mlg.$__88_0") {
...
define internal ptr @"test/testcases/malgo/Test1.mlg.#let_closure_107"(ptr %0, ptr %1) {
  %d_addr_0 = getelementptr { ptr, ptr }, ptr %0, i32 0, i32 0
  %d_0 = load ptr, ptr %d_addr_0, align 8
  %t_addr_0 = getelementptr { ptr, ptr }, ptr %0, i32 0, i32 1
  %t_0 = load ptr, ptr %t_addr_0, align 8
  %3 = call ptr @"test/testcases/malgo/Test1.mlg.$raw_let_98"(ptr null, ptr %d_0, ptr %t_0, ptr %1)
  ret ptr %3
}
...
define internal ptr @"test/testcases/malgo/Test1.mlg.$raw_let_99"(ptr %0, ptr %"test/testcases/malgo/Test1.mlg.$d_64_0", ptr %"test/testcases/malgo/Test1.mlg.$t_86_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"test/testcases/malgo/Test1.mlg.#let_closure_107", ptr %let_func_0, align 8
  ret ptr %2
}
