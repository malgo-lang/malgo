...
define internal i32 @"test/testcases/malgo/TestLet.mlg.#let_closure_87"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  ...
  store ptr @"test/testcases/malgo/TestLet.mlg.#let_closure_94", ptr %let_func_0.i.i, align 8
  %p_0.i.i = load i32, ptr %let_capture_0.i.i, align 4
  %4 = tail call i32 @malgo_add_int32_t(i32 %p_0.i.i, i32 %1)
  ret i32 %4
}

define internal i32 @"test/testcases/malgo/TestLet.mlg.#let_closure_94"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/TestLet.mlg.#let_closure_87", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestLet.mlg.#let_closure_94", ptr %let_func_0.i.i.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestLet.mlg.#let_closure_87", ptr %let_func_0.i2.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestLet.mlg.#let_closure_94", ptr %let_func_0.i.i.i5.i, align 8
