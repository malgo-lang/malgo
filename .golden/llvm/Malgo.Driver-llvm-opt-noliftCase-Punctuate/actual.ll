...
define internal ptr @"test/testcases/malgo/Punctuate.mlg.#let_closure_3168"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
...
define internal ptr @"test/testcases/malgo/Punctuate.mlg.#let_closure_3170"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %0, ptr %1) {
...
define internal noundef ptr @"runtime/malgo/Prelude.mlg.concatString"(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %"runtime/malgo/Prelude.mlg.$nil_974_0") {
...
common.ret1:                                      ; preds = %1, %"switch_branch_runtime/malgo/Prelude.mlg.Cons_0"
  %.sink = phi ptr [ %17, %"switch_branch_runtime/malgo/Prelude.mlg.Cons_0" ], [ @str3169, %1 ]
...
"switch_branch_runtime/malgo/Prelude.mlg.Cons_0": ; preds = %1
  %5 = getelementptr { i8, { ptr, ptr } }, ptr %"runtime/malgo/Prelude.mlg.$nil_974_0", i64 0, i32 1
  %6 = load ptr, ptr %5, align 8
  %7 = getelementptr { i8, { ptr, ptr } }, ptr %"runtime/malgo/Prelude.mlg.$nil_974_0", i64 0, i32 1, i32 1
  ...
  %10 = tail call ptr @"runtime/malgo/Prelude.mlg.concatString"(ptr poison, ptr nocapture nofree readonly %8)
...
define internal ptr @"test/testcases/malgo/Punctuate.mlg.#let_closure_3173"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
  %p_0 = load ptr, ptr %0, align 8
  %3 = tail call ptr @malgo_string_append(ptr %p_0, ptr %1)
  ret ptr %3
}

define internal ptr @"test/testcases/malgo/Punctuate.mlg.#let_closure_3175"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
  %p_0 = load ptr, ptr %0, align 8
  %3 = tail call ptr @malgo_string_append(ptr %p_0, ptr %1)
  ret ptr %3
}

define internal ptr @"test/testcases/malgo/Punctuate.mlg.#let_closure_3179"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
  %p_0 = load ptr, ptr %0, align 8
  %3 = tail call ptr @malgo_string_append(ptr %p_0, ptr %1)
  ret ptr %3
}
...
common.ret:                                       ; preds = %"switch_branch_test/testcases/malgo/Punctuate.mlg.SList_0", %"switch_branch_test/testcases/malgo/Punctuate.mlg.SInt_0", %"switch_branch_test/testcases/malgo/Punctuate.mlg.Symbol_0"
  %.sink = phi ptr [ %44, %"switch_branch_test/testcases/malgo/Punctuate.mlg.SList_0" ], [ %23, %"switch_branch_test/testcases/malgo/Punctuate.mlg.SInt_0" ], [ %9, %"switch_branch_test/testcases/malgo/Punctuate.mlg.Symbol_0" ]
  %"test/testcases/malgo/Punctuate.mlg.#let_closure_3180.sink" = phi ptr [ @"test/testcases/malgo/Punctuate.mlg.#let_closure_3180", %"switch_branch_test/testcases/malgo/Punctuate.mlg.SList_0" ], [ @"test/testcases/malgo/Punctuate.mlg.#let_closure_3175", %"switch_branch_test/testcases/malgo/Punctuate.mlg.SInt_0" ], [ @"test/testcases/malgo/Punctuate.mlg.#let_closure_3173", %"switch_branch_test/testcases/malgo/Punctuate.mlg.Symbol_0" ]
  ...
  %.sink7 = phi ptr [ %40, %"switch_branch_test/testcases/malgo/Punctuate.mlg.SList_0" ], [ %19, %"switch_branch_test/testcases/malgo/Punctuate.mlg.SInt_0" ], [ %8, %"switch_branch_test/testcases/malgo/Punctuate.mlg.Symbol_0" ]
  %let_func_3 = getelementptr { ptr, ptr }, ptr %.sink, i64 0, i32 1
  store ptr %"test/testcases/malgo/Punctuate.mlg.#let_closure_3180.sink", ptr %let_func_3, align 8
...
"switch_branch_test/testcases/malgo/Punctuate.mlg.SList_0": ; preds = %1
  ...
  store ptr @"runtime/malgo/Prelude.mlg.concatString", ptr %concatString_func_0, align 8
  %34 = tail call ptr @"runtime/malgo/Prelude.mlg.concatString"(ptr poison, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %32)
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  %40 = tail call ptr @"test/testcases/malgo/Punctuate.mlg.show"(ptr poison, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(1) %37)
