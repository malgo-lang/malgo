...
define internal i32 @"test/testcases/malgo/RecordTest.mlg.#let_closure_127"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  ...
  store ptr @"test/testcases/malgo/RecordTest.mlg.#let_closure_134", ptr %let_func_0.i.i, align 8
  %p_0.i.i = load i32, ptr %let_capture_0.i.i, align 4
  %4 = tail call i32 @malgo_add_int32_t(i32 %p_0.i.i, i32 %1)
  ret i32 %4
}

define internal i32 @"test/testcases/malgo/RecordTest.mlg.#let_closure_134"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
...
define internal noundef ptr @"test/testcases/malgo/RecordTest.mlg.#let_closure_252"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  ...
  store ptr @"test/testcases/malgo/RecordTest.mlg.#let_closure_127", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/RecordTest.mlg.#let_closure_134", ptr %let_func_0.i.i.i.i, align 8
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  tail call void @malgo_hash_table_insert(ptr %9, ptr noundef nonnull @str241, ptr noundef nonnull %5)
  tail call void @malgo_hash_table_insert(ptr %9, ptr noundef nonnull @str242, ptr noundef nonnull %7)
  %10 = tail call ptr @malgo_hash_table_get(ptr %9, ptr noundef nonnull @str241)
  %11 = tail call ptr @malgo_hash_table_get(ptr %9, ptr noundef nonnull @str242)
  ...
  %13 = tail call ptr @malgo_hash_table_get(ptr %9, ptr noundef nonnull @str241)
  %14 = tail call ptr @malgo_hash_table_get(ptr %9, ptr noundef nonnull @str242)
