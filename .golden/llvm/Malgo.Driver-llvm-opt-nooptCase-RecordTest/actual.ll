...
define internal noundef ptr @"test/testcases/malgo/RecordTest.mlg.#let_closure_231"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  ...
  store ptr @"test/testcases/malgo/RecordTest.mlg.#let_closure_250", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/RecordTest.mlg.#let_closure_238", ptr %let_func_0.i.i.i.i, align 8
...
define internal i32 @"test/testcases/malgo/RecordTest.mlg.#let_closure_238"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  %p_0 = load i32, ptr %0, align 4
  %3 = tail call i32 @malgo_add_int32_t(i32 %p_0, i32 %1)
  ret i32 %3
}

define internal i32 @"test/testcases/malgo/RecordTest.mlg.#let_closure_250"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  ...
  store ptr @"test/testcases/malgo/RecordTest.mlg.#let_closure_238", ptr %let_func_0.i.i, align 8
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/RecordTest.mlg.#let_closure_231", ptr %let_func_0.i.i, align 8
