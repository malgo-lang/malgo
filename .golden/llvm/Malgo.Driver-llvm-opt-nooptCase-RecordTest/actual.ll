; ModuleID = '/workspaces/malgo/.malgo-work/RecordTest.ll'
...
define internal noundef ptr @"RecordTest.#let_closure_210"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  ...
  store ptr @"RecordTest.#let_closure_234", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"RecordTest.#let_closure_307", ptr %let_func_0.i.i.i.i, align 8
...
define internal i32 @"RecordTest.#let_closure_234"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  ...
  store ptr @"RecordTest.#let_closure_307", ptr %let_func_0.i.i, align 8
...
define internal i32 @"RecordTest.#let_closure_307"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  tail call void @malgo_hash_table_insert(ptr %9, ptr noundef nonnull @str179, ptr noundef nonnull %5)
  tail call void @malgo_hash_table_insert(ptr %9, ptr noundef nonnull @str180, ptr noundef nonnull %7)
  %10 = tail call ptr @malgo_hash_table_get(ptr %9, ptr noundef nonnull @str179)
  %11 = tail call ptr @malgo_hash_table_get(ptr %9, ptr noundef nonnull @str180)
  ...
  store ptr @"RecordTest.#let_closure_210", ptr %let_func_0.i.i, align 8
  %13 = tail call ptr @malgo_hash_table_get(ptr %9, ptr noundef nonnull @str179)
  %14 = tail call ptr @malgo_hash_table_get(ptr %9, ptr noundef nonnull @str180)
