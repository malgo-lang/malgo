...
define internal ptr @"test/testcases/malgo/HelloImport.mlg.#fun_closure_190"(ptr nocapture nofree readnone %0, ptr nocapture nofree readonly %1) {
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  store i8 0, ptr %3, align 1
  %4 = getelementptr { i8, { ptr } }, ptr %3, i64 0, i32 1, i32 0
  store ptr @str62, ptr %4, align 8
...
define internal ptr @"test/testcases/malgo/HelloImport.mlg.#let_closure_194"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @str189, ptr %6, align 8
  %7 = tail call ptr @malgo_print_string(ptr noundef nonnull @str189)
  ...
  store ptr @"test/testcases/malgo/HelloImport.mlg.#let_closure_194", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/HelloImport.mlg.#fun_closure_190", ptr %fun_func_0.i, align 8
