; ModuleID = './test/tmp/malgo_test/noopt/HelloImport.ll'
...
define internal ptr @"HelloImport.#let_closure_104"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define internal ptr @"HelloImport.#fun_closure_129"(ptr nocapture nofree readnone %0, ptr nocapture nofree readonly %1) {
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  store i8 0, ptr %3, align 1
  %4 = getelementptr { i8, { ptr } }, ptr %3, i64 0, i32 1, i32 0
  store ptr @str174, ptr %4, align 8
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @str128, ptr %6, align 8
  %7 = tail call ptr @malgo_print_string(ptr noundef nonnull @str128)
  ...
  store ptr @"HelloImport.#let_closure_104", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"HelloImport.#fun_closure_129", ptr %fun_func_0.i, align 8
