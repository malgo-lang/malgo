; ModuleID = './test/tmp/malgo_test/aggressive/ToplevelVariableNoImport.ll'
...
define internal ptr @"ToplevelVariableNoImport.#let_closure_542"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readnone %1) #0 {
...
; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind readonly willreturn
define internal ptr @"ToplevelVariableNoImport.#let_closure_545"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readnone %1) #0 {
  %cast_0 = load ptr, ptr %0, align 8
  ret ptr %cast_0
}

define internal i32 @"ToplevelVariableNoImport.#let_closure_546"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
...
; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind readonly willreturn
define internal ptr @"ToplevelVariableNoImport.#let_closure_547"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readnone %1) #0 {
  %cast_0 = load ptr, ptr %0, align 8
  ret ptr %cast_0
}

define internal i32 @"ToplevelVariableNoImport.#let_closure_548"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  %p_0 = load i32, ptr %0, align 4
  %3 = tail call i32 @malgo_add_int32_t(i32 %p_0, i32 %1)
  ret i32 %3
}
...
switch_branch_ToplevelVariableNoImport.Nothing_0.i: ; preds = %1
  ...
  store ptr @"ToplevelVariableNoImport.#let_closure_545", ptr %let_func_0.i, align 8
...
switch_branch_ToplevelVariableNoImport.Just_0.i:  ; preds = %1
  ...
  store ptr @"ToplevelVariableNoImport.#let_closure_547", ptr %let_func_2.i, align 8
...
ToplevelVariableNoImport.main.exit:               ; preds = %switch_branch_ToplevelVariableNoImport.Nothing_0.i, %switch_branch_ToplevelVariableNoImport.Just_0.i
  ...
  %"ToplevelVariableNoImport.#let_closure_548.sink.i" = phi ptr [ @"ToplevelVariableNoImport.#let_closure_548", %switch_branch_ToplevelVariableNoImport.Just_0.i ], [ @"ToplevelVariableNoImport.#let_closure_546", %switch_branch_ToplevelVariableNoImport.Nothing_0.i ]
  ...
  store ptr %"ToplevelVariableNoImport.#let_closure_548.sink.i", ptr %let_func_3.i, align 8
