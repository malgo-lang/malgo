...
"switch_branch_ToplevelVariableNoImport.Int32#_1": ; preds = %"switch_branch_ToplevelVariableNoImport.Int32#_0"
  ...
  store ptr @"ToplevelVariableNoImport.addInt32#", ptr %"addInt32#_func_0", align 8
  ...
  store ptr @"ToplevelVariableNoImport.Int32#", ptr %"Int32#_func_0", align 8
...
define internal i32 @"ToplevelVariableNoImport.$addInt32#_curry_228"(ptr %0, i32 %"ToplevelVariableNoImport.$x_229_0", i32 %"ToplevelVariableNoImport.$y_230_0") {
  ...
  %7 = call ptr %6(ptr %4, i32 %"ToplevelVariableNoImport.$x_229_0")
  %8 = getelementptr { ptr, ptr }, ptr %7, i32 0, i32 0
  %9 = load ptr, ptr %8, align 8
  %10 = getelementptr { ptr, ptr }, ptr %7, i32 0, i32 1
  %11 = load ptr, ptr %10, align 8
  %12 = call i32 %11(ptr %9, i32 %"ToplevelVariableNoImport.$y_230_0")
  ret i32 %12
}
...
define internal i32 @"ToplevelVariableNoImport.#let_closure_284"(ptr %0, i32 %1) {
...
define internal ptr @"ToplevelVariableNoImport.toStringInt32#"(ptr %0, i32 %"ToplevelVariableNoImport.$x_182_0") {
  ...
  %5 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  %6 = load ptr, ptr %5, align 8
  %7 = call ptr %6(ptr %4, i32 %"ToplevelVariableNoImport.$x_182_0")
  ret ptr %7
}
...
define internal ptr @"ToplevelVariableNoImport.printString#"(ptr %0, ptr %"ToplevelVariableNoImport.$x_189_0") {
  ...
  %5 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  %6 = load ptr, ptr %5, align 8
  %7 = call ptr %6(ptr %4, ptr %"ToplevelVariableNoImport.$x_189_0")
  ret ptr %7
}
...
define internal ptr @ToplevelVariableNoImport.printInt32(ptr %0, ptr %"ToplevelVariableNoImport.$i_194_0") {
  ...
  %5 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  %6 = load ptr, ptr %5, align 8
  %7 = call ptr %6(ptr %4, ptr %"ToplevelVariableNoImport.$i_194_0")
...
define internal ptr @ToplevelVariableNoImport.constId(ptr %0, ptr %"ToplevelVariableNoImport.$eta_210_0") {
  ...
  %11 = getelementptr { ptr, ptr }, ptr %8, i32 0, i32 1
  %12 = load ptr, ptr %11, align 8
  %13 = call ptr %12(ptr %10, ptr %"ToplevelVariableNoImport.$eta_210_0")
  ret ptr %13
}

define internal i32 @"ToplevelVariableNoImport.#let_closure_286"(ptr %0, i32 %1) {
...
define internal ptr @"ToplevelVariableNoImport.#let_closure_287"(ptr %0, ptr %1) {
...
define internal ptr @ToplevelVariableNoImport.addOne(ptr %0, ptr %"ToplevelVariableNoImport.$eta_257_0") {
  ...
  %5 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  %6 = load ptr, ptr %5, align 8
  %7 = load ptr, ptr @ToplevelVariableNoImport.one, align 8
  %8 = call ptr %6(ptr %4, ptr %7)
  %9 = getelementptr { ptr, ptr }, ptr %8, i32 0, i32 0
  %10 = load ptr, ptr %9, align 8
  %11 = getelementptr { ptr, ptr }, ptr %8, i32 0, i32 1
  %12 = load ptr, ptr %11, align 8
  %13 = call ptr %12(ptr %10, ptr %"ToplevelVariableNoImport.$eta_257_0")
  ret ptr %13
}

define internal ptr @"ToplevelVariableNoImport.#fun_closure_288"(ptr %0, ptr %1) {
...
define internal ptr @ToplevelVariableNoImport.main(ptr %0, ptr %"ToplevelVariableNoImport.$$__259_0") {
  ...
  store ptr @"ToplevelVariableNoImport.#fun_closure_288", ptr %fun_func_0, align 8
  ...
  store ptr @ToplevelVariableNoImport.constId, ptr %constId_func_0, align 8
  %13 = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 0
  %14 = load ptr, ptr %13, align 8
  %15 = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 1
  %16 = load ptr, ptr %15, align 8
  ...
  store ptr @ToplevelVariableNoImport.addOne, ptr %addOne_func_0, align 8
  ...
  store ptr @ToplevelVariableNoImport.printInt32, ptr %printInt32_func_0, align 8
...
define internal ptr @"ToplevelVariableNoImport.#fun_closure_294"(ptr %0, ptr %1) {
  %3 = getelementptr { i8, <8 x i8> }, ptr %1, i32 0, i32 0
  %4 = load i8, ptr %3, align 1
  switch i8 %4, label %switch_default_0 [
    i8 0, label %switch_branch_ToplevelVariableNoImport.Nothing_0
...
define internal void @malgo_load_ToplevelVariableNoImport() {
  ...
  store ptr %6, ptr @ToplevelVariableNoImport.one, align 8
  %7 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ ptr, ptr }, ptr null, i32 1) to i64))
  ...
  store ptr @"ToplevelVariableNoImport.#fun_closure_294", ptr %fun_func_0, align 8
  ...
  store ptr @ToplevelVariableNoImport.Just, ptr %Just_func_0, align 8
  ...
  store ptr %20, ptr @ToplevelVariableNoImport.comp, align 8
  ret void
}
