; ModuleID = './test/tmp/malgo_test/nolift/TuplePattern.ll'
...
define internal ptr @"TuplePattern.#let_closure_2833"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define internal ptr @"TuplePattern.#fun_closure_2834"(ptr nocapture nofree readnone %0, ptr nocapture nofree readonly align 8 %1) {
...
common.ret:                                       ; preds = %switch_branch_TuplePattern.C_0, %switch_branch_TuplePattern.B_0, %switch_branch_TuplePattern.A_0
  %common.ret.op = phi ptr [ %7, %switch_branch_TuplePattern.A_0 ], [ %8, %switch_branch_TuplePattern.B_0 ], [ %9, %switch_branch_TuplePattern.C_0 ]
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"TuplePattern.#let_closure_2833", ptr %let_func_0.i, align 8
  ...
  store ptr @"TuplePattern.#fun_closure_2834", ptr %fun_func_0.i, align 8
