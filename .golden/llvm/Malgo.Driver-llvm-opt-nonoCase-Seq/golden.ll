; ModuleID = './test/tmp/malgo_test/nono/Seq.ll'
...
define internal i32 @"Seq.#let_closure_79"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
...
define internal i32 @"Seq.#let_closure_244"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  ...
  store ptr @"Seq.#let_closure_79", ptr %let_func_0.i.i, align 8
...
define internal noundef ptr @"Seq.#let_closure_245"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  ...
  store ptr @"Seq.#let_closure_244", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"Seq.#let_closure_79", ptr %let_func_0.i.i.i.i, align 8
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"Seq.#let_closure_245", ptr %let_func_0.i.i, align 8
  %13 = tail call ptr @"Seq.#let_closure_245"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %let_capture_0.i.i, ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(1) %9)
  ...
  store ptr @"Seq.#let_closure_245", ptr %let_func_0.i2.i, align 8
  %30 = tail call ptr @"Seq.#let_closure_245"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %let_capture_0.i1.i, ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(1) %9)
  store ptr %30, ptr @Seq.executeWhenLoaded, align 8
  ...
  store ptr @Builtin.toStringInt32, ptr %toStringInt32_func_0.i1, align 8
  %33 = load ptr, ptr @Seq.executeWhenLoaded, align 8
  ...
  store ptr @"Builtin.toStringInt32#", ptr %"toStringInt32#_func_0.i.i2", align 8
  ...
  store ptr @Builtin.malgo_int32_t_to_string, ptr %malgo_int32_t_to_string_func_0.i.i.i3, align 8
  ...
  store ptr @"Builtin.String#", ptr %"String#_func_0.i.i4", align 8
  ...
  store ptr @Builtin.printString, ptr %printString_func_0.i5, align 8
  %43 = load ptr, ptr %41, align 8
  %44 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %44, align 8
  %"printString#_func_0.i.i6" = getelementptr { ptr, ptr }, ptr %44, i64 0, i32 1
  store ptr @"Builtin.printString#", ptr %"printString#_func_0.i.i6", align 8
  ...
  store ptr @Builtin.malgo_print_string, ptr %malgo_print_string_func_0.i.i.i7, align 8
