...
define internal ptr @_M26fun_x246d_x5Fclosure_x249442test_x2Ftestcases_x2Fmalgo_x2FTest3_x2Emlg8Internal(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %1) {
  %3 = load i8, ptr %1, align 1
  %switch.i = icmp eq i8 %3, 0
  br i1 %switch.i, label %_M22raw_x5Ffun_x246d_x249242test_x2Ftestcases_x2Fmalgo_x2FTest3_x2Emlg8Temporal.exit, label %switch_branch_Cons_0.i
...
switch_branch_Cons_0.i:                           ; preds = %2
  ...
  br i1 %switch1.i, label %switch_branch_A_0.i, label %_M22raw_x5Ffun_x246d_x249242test_x2Ftestcases_x2Fmalgo_x2FTest3_x2Emlg8Temporal.exit

switch_branch_A_0.i:                              ; preds = %switch_branch_Cons_0.i
  %9 = load i8, ptr %7, align 1
  %switch2.i = icmp eq i8 %9, 0
  br i1 %switch2.i, label %_M22raw_x5Ffun_x246d_x249242test_x2Ftestcases_x2Fmalgo_x2FTest3_x2Emlg8Temporal.exit, label %switch_branch_Cons_1.i
...
switch_branch_Cons_1.i:                           ; preds = %switch_branch_A_0.i
  ...
  br i1 %switch3.i, label %_M22raw_x5Ffun_x246d_x249242test_x2Ftestcases_x2Fmalgo_x2FTest3_x2Emlg8Temporal.exit, label %switch_branch_B_0.i
...
switch_branch_B_0.i:                              ; preds = %switch_branch_Cons_1.i
  ...
  br label %_M22raw_x5Ffun_x246d_x249242test_x2Ftestcases_x2Fmalgo_x2FTest3_x2Emlg8Temporal.exit

_M22raw_x5Ffun_x246d_x249242test_x2Ftestcases_x2Fmalgo_x2FTest3_x2Emlg8Temporal.exit: ; preds = %2, %switch_branch_Cons_0.i, %switch_branch_A_0.i, %switch_branch_Cons_1.i, %switch_branch_B_0.i
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  %"fun$6d_capture_0.i" = tail call ptr @malgo_malloc(i64 noundef 0)
  store ptr %"fun$6d_capture_0.i", ptr %13, align 8
  %"fun$6d_func_0.i" = getelementptr { ptr, ptr }, ptr %13, i64 0, i32 1
  store ptr @_M26fun_x246d_x5Fclosure_x249442test_x2Ftestcases_x2Fmalgo_x2FTest3_x2Emlg8Internal, ptr %"fun$6d_func_0.i", align 8
