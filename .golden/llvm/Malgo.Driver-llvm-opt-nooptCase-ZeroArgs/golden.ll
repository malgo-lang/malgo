; ModuleID = './test/tmp/malgo_test/noopt/ZeroArgs.ll'
...
define internal ptr @"ZeroArgs.#fun_closure_199"(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %1) {
  %3 = load ptr, ptr @ZeroArgs.one, align 8
  ...
  store ptr @"ZeroArgs.#fun_closure_249", ptr %fun_func_0.i.i, align 8
...
define internal ptr @"ZeroArgs.#fun_closure_249"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readnone %1) #0 {
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"ZeroArgs.#fun_closure_294", ptr %fun_func_0.i, align 8
  %5 = tail call ptr @malgo_malloc(i64 noundef 1)
  store i8 0, ptr %5, align 1
  %6 = load ptr, ptr %4, align 8
  %7 = load ptr, ptr %fun_func_0.i, align 8
  %8 = tail call ptr %7(ptr %6, ptr nonnull %5)
  store ptr %8, ptr @ZeroArgs.one, align 8
  ...
  store ptr @"ZeroArgs.#fun_closure_199", ptr %fun_func_0.i.i, align 8
  %12 = load ptr, ptr @ZeroArgs.one, align 8
  ...
  store ptr @"ZeroArgs.#fun_closure_249", ptr %fun_func_0.i.i.i.i, align 8
...
define internal noundef ptr @"ZeroArgs.#fun_closure_294"(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %1) {
