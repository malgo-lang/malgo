...
define internal ptr @"test/testcases/malgo/TestDot.mlg.#let_closure_76"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
  ...
  store ptr @"test/testcases/malgo/TestDot.mlg.#fun_closure_81", ptr %fun_func_0.i, align 8
  ret ptr %3
}

define internal ptr @"test/testcases/malgo/TestDot.mlg.#fun_closure_81"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %0, ptr %1) {
  %f_0 = load ptr, ptr %0, align 8
...
define internal i64 @"test/testcases/malgo/TestDot.mlg.#let_closure_120"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  ...
  store ptr @"test/testcases/malgo/TestDot.mlg.#let_closure_122", ptr %let_func_0.i.i, align 8
  %p_0.i.i = load i64, ptr %let_capture_0.i.i, align 4
  %4 = tail call i64 @malgo_add_int64_t(i64 %p_0.i.i, i64 %1)
  ret i64 %4
}

define internal i64 @"test/testcases/malgo/TestDot.mlg.#let_closure_122"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
...
"switch_branch_runtime/malgo/Builtin.mlg.Int64#_0":
  ...
  store ptr @"test/testcases/malgo/TestDot.mlg.#let_closure_120", ptr %let_func_0.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestDot.mlg.#let_closure_122", ptr %let_func_0.i.i.i, align 8
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/TestDot.mlg.#let_closure_76", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestDot.mlg.#fun_closure_81", ptr %fun_func_0.i.i.i, align 8
