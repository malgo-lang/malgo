...
define internal i64 @"test/testcases/malgo/TestDot.mlg.#let_closure_176"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  %p_0 = load i64, ptr %0, align 4
  %3 = tail call i64 @malgo_add_int64_t(i64 %p_0, i64 %1)
  ret i64 %3
}

define internal i64 @"test/testcases/malgo/TestDot.mlg.#let_closure_204"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  ...
  store ptr @"test/testcases/malgo/TestDot.mlg.#let_closure_176", ptr %let_func_0.i.i, align 8
  %p_0.i.i = load i64, ptr %let_capture_0.i.i, align 4
  %4 = tail call i64 @malgo_add_int64_t(i64 %p_0.i.i, i64 %1)
  ret i64 %4
}

define internal ptr @"test/testcases/malgo/TestDot.mlg.#fun_closure_230"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %0, ptr %1) {
...
"switch_branch_runtime/malgo/Builtin.mlg.Int64#_0":
  ...
  store ptr @"test/testcases/malgo/TestDot.mlg.#let_closure_204", ptr %let_func_0.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestDot.mlg.#let_closure_176", ptr %let_func_0.i.i.i, align 8
...
define internal ptr @"test/testcases/malgo/TestDot.mlg.#let_closure_245"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
  %f_0 = load ptr, ptr %0, align 8
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  ...
  store ptr @"test/testcases/malgo/TestDot.mlg.#fun_closure_230", ptr %fun_func_0.i, align 8
  ret ptr %3
}
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/TestDot.mlg.#let_closure_245", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/TestDot.mlg.#fun_closure_230", ptr %fun_func_0.i.i.i, align 8
