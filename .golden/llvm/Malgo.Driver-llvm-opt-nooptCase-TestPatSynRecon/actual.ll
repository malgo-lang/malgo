; ModuleID = './test/tmp/malgo_test/noopt/TestPatSynRecon.ll'
...
define internal ptr @"TestPatSynRecon.#fun_closure_171"(ptr nocapture nofree readnone %0, ptr nocapture nofree readonly align 4 %1) {
...
define internal i64 @"TestPatSynRecon.#let_closure_175"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  ...
  store ptr @"TestPatSynRecon.#let_closure_339", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"TestPatSynRecon.#let_closure_311", ptr %let_func_0.i.i.i.i, align 8
  %p_0.i.i.i.i = load i64, ptr %let_capture_0.i.i.i.i, align 4
  %5 = tail call i64 @malgo_add_int64_t(i64 %p_0.i.i.i.i, i64 %1)
  ret i64 %5
}

define internal ptr @"TestPatSynRecon.#let_closure_216"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define internal noundef ptr @"TestPatSynRecon.#fun_closure_308"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  ...
  store ptr @"TestPatSynRecon.#let_closure_175", ptr %let_func_0.i.i, align 8
  %x_0.i.i = load i64, ptr %let_capture_0.i.i, align 4
  %5 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i.i.i.i = tail call ptr @malgo_malloc(i64 noundef 8)
  store i64 %x_0.i.i, ptr %let_capture_0.i.i.i.i, align 4
  ...
  store ptr @"TestPatSynRecon.#let_closure_339", ptr %let_func_0.i.i.i.i, align 8
  ...
  store ptr @"TestPatSynRecon.#let_closure_311", ptr %let_func_0.i.i.i.i.i.i, align 8
...
define internal fastcc ptr @TestPatSynRecon.sum(ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %"TestPatSynRecon.$cons_95_0") unnamed_addr {
...
common.ret:                                       ; preds = %switch_branch_Prelude.Cons_0, %switch_branch_Prelude.Nil_0
  %common.ret.op = phi ptr [ %2, %switch_branch_Prelude.Nil_0 ], [ %15, %switch_branch_Prelude.Cons_0 ]
...
switch_branch_Prelude.Cons_0:                     ; preds = %0
  ...
  store ptr @"TestPatSynRecon.#let_closure_216", ptr %let_func_0.i, align 8
...
define internal i64 @"TestPatSynRecon.#let_closure_311"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  %p_0 = load i64, ptr %0, align 4
  %3 = tail call i64 @malgo_add_int64_t(i64 %p_0, i64 %1)
  ret i64 %3
}

define internal noundef ptr @"TestPatSynRecon.#let_closure_334"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
...
define internal i64 @"TestPatSynRecon.#let_closure_339"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  %x_0 = load i64, ptr %0, align 4
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i.i = tail call ptr @malgo_malloc(i64 noundef 8)
  store i64 %x_0, ptr %let_capture_0.i.i, align 4
  store ptr %let_capture_0.i.i, ptr %3, align 8
  %let_func_0.i.i = getelementptr { ptr, ptr }, ptr %3, i64 0, i32 1
  store ptr @"TestPatSynRecon.#let_closure_311", ptr %let_func_0.i.i, align 8
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"TestPatSynRecon.#let_closure_334", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"TestPatSynRecon.#let_closure_334", ptr %let_func_0.i2.i, align 8
  ...
  %18 = tail call fastcc ptr @TestPatSynRecon.sum(ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %17)
  ...
  store ptr @"TestPatSynRecon.#let_closure_216", ptr %let_func_0.i4.i, align 8
  ...
  store ptr @"TestPatSynRecon.#fun_closure_171", ptr %fun_func_0.i, align 8
