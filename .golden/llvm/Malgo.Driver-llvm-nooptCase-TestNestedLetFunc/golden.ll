...
define internal ptr @TestNestedLetFunc.main(ptr %0, ptr %"TestNestedLetFunc.$$__14_0") {
  %2 = call ptr @TestNestedLetFunc.malgo_print_string(ptr null, ptr @str27)
  ret ptr %2
}

declare ptr @malgo_malloc(i64)

define internal ptr @"TestNestedLetFunc.$fun_23"(ptr %0, ptr %"TestNestedLetFunc.$$__15_0") {
  %2 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ i8, {} }, ptr null, i32 1) to i64))
  %3 = getelementptr { i8, {} }, ptr %2, i32 0, i32 0
  store i8 0, ptr %3, align 1
  %4 = call ptr @"TestNestedLetFunc.$fun_18"(ptr null, ptr %2)
  ret ptr %4
}

define internal ptr @"TestNestedLetFunc.$fun_18"(ptr %0, ptr %"TestNestedLetFunc.$a_16_0") {
  %2 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ i8, {} }, ptr null, i32 1) to i64))
  %3 = getelementptr { i8, {} }, ptr %2, i32 0, i32 0
  store i8 0, ptr %3, align 1
  ret ptr %2
