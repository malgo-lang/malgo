; ModuleID = './test/tmp/malgo_test/normal/ToplevelVariable.ll'
...
define internal ptr @"ToplevelVariable.#let_closure_3102"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readnone %1) #1 {
...
; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind readonly willreturn
define internal ptr @"ToplevelVariable.#let_closure_3104"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readnone %1) #1 {
  %cast_0 = load ptr, ptr %0, align 8
  ret ptr %cast_0
}

define internal i32 @"ToplevelVariable.#let_closure_3105"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
...
; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind readonly willreturn
define internal ptr @"ToplevelVariable.#let_closure_3106"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readnone %1) #1 {
  %cast_0 = load ptr, ptr %0, align 8
  ret ptr %cast_0
}

define internal i32 @"ToplevelVariable.#let_closure_3107"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  %p_0 = load i32, ptr %0, align 4
  %3 = tail call i32 @malgo_add_int32_t(i32 %p_0, i32 %1)
  ret i32 %3
}
...
switch_branch_Prelude.Nothing_0.i:                ; preds = %1
  ...
  store ptr @str3103, ptr %12, align 8
  %13 = tail call ptr @malgo_print_string(ptr noundef nonnull @str3103)
  ...
  store ptr @"ToplevelVariable.#let_closure_3104", ptr %let_func_0.i, align 8
...
switch_branch_Prelude.Just_0.i:                   ; preds = %1
  ...
  store ptr @"ToplevelVariable.#let_closure_3106", ptr %let_func_2.i, align 8
...
ToplevelVariable.main.exit:                       ; preds = %switch_branch_Prelude.Nothing_0.i, %switch_branch_Prelude.Just_0.i
  ...
  %"ToplevelVariable.#let_closure_3107.sink.i" = phi ptr [ @"ToplevelVariable.#let_closure_3107", %switch_branch_Prelude.Just_0.i ], [ @"ToplevelVariable.#let_closure_3105", %switch_branch_Prelude.Nothing_0.i ]
  ...
  store ptr %"ToplevelVariable.#let_closure_3107.sink.i", ptr %let_func_3.i, align 8
