...
define internal noundef ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_249"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly %1) {
  ...
  store ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_287", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_293", ptr %let_func_0.i.i.i.i.i.i, align 8
...
define internal noundef ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_256"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly %1) {
  %x_0 = load ptr, ptr %0, align 8
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i.i = tail call ptr @malgo_malloc(i64 noundef 8)
  store ptr %x_0, ptr %let_capture_0.i.i, align 8
  store ptr %let_capture_0.i.i, ptr %3, align 8
  %let_func_0.i.i = getelementptr { ptr, ptr }, ptr %3, i64 0, i32 1
  store ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_371", ptr %let_func_0.i.i, align 8
  %"int64#_0.i.i" = load ptr, ptr %let_capture_0.i.i, align 8
  %4 = getelementptr i8, ptr %"int64#_0.i.i", i64 4
  %"int64#_0.val.i.i" = load i64, ptr %4, align 4
  %5 = getelementptr i8, ptr %1, i64 4
  ...
  store ptr %let_capture_0.i.i.i.i, ptr %6, align 8
  %let_func_0.i.i.i.i = getelementptr { ptr, ptr }, ptr %6, i64 0, i32 1
  store ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_336", ptr %let_func_0.i.i.i.i, align 8
  %x_0.i.i.i.i = load i64, ptr %let_capture_0.i.i.i.i, align 4
  %7 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i.i.i.i.i.i = tail call ptr @malgo_malloc(i64 noundef 8)
  store i64 %x_0.i.i.i.i, ptr %let_capture_0.i.i.i.i.i.i, align 4
...
define internal noundef ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_287"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  ...
  store ptr %let_capture_0.i.i.i.i, ptr %6, align 8
  %let_func_0.i.i.i.i = getelementptr { ptr, ptr }, ptr %6, i64 0, i32 1
  store ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_293", ptr %let_func_0.i.i.i.i, align 8
...
define internal noundef ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_305"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  %"int64#_0" = load ptr, ptr %0, align 8
  %3 = getelementptr i8, ptr %"int64#_0", i64 4
  %"int64#_0.val" = load i64, ptr %3, align 4
  %4 = getelementptr i8, ptr %1, i64 4
  ...
  store ptr %let_capture_0.i.i, ptr %5, align 8
  %let_func_0.i.i = getelementptr { ptr, ptr }, ptr %5, i64 0, i32 1
  store ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_369", ptr %let_func_0.i.i, align 8
  %x_0.i.i = load i64, ptr %let_capture_0.i.i, align 4
  %6 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i.i.i.i = tail call ptr @malgo_malloc(i64 noundef 8)
  store i64 %x_0.i.i, ptr %let_capture_0.i.i.i.i, align 4
...
define internal ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_325"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %0, ptr nocapture nofree readonly %1) {
...
define internal i32 @"test/testcases/malgo/Factorial.mlg.#let_closure_336"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
...
define internal ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_342"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
  %x_0 = load ptr, ptr %0, align 8
...
define internal ptr @"test/testcases/malgo/Factorial.mlg.#fun_closure_358"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readnone %1) #0 {
  %acc_0 = load ptr, ptr %0, align 8
  ret ptr %acc_0
}

define internal ptr @"test/testcases/malgo/Factorial.mlg.#fun_closure_359"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %0, ptr nocapture nofree readnone %1) {
  ...
  store ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_287", ptr %let_func_0.i.i.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_293", ptr %let_func_0.i.i.i.i.i.i.i.i, align 8
...
define internal i64 @"test/testcases/malgo/Factorial.mlg.#let_closure_369"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  %x_0 = load i64, ptr %0, align 4
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i.i = tail call ptr @malgo_malloc(i64 noundef 8)
  store i64 %x_0, ptr %let_capture_0.i.i, align 4
...
define internal noundef ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_371"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  %"int64#_0" = load ptr, ptr %0, align 8
  %3 = getelementptr i8, ptr %"int64#_0", i64 4
  %"int64#_0.val" = load i64, ptr %3, align 4
  %4 = getelementptr i8, ptr %1, i64 4
  ...
  store ptr %let_capture_0.i.i, ptr %5, align 8
  %let_func_0.i.i = getelementptr { ptr, ptr }, ptr %5, i64 0, i32 1
  store ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_336", ptr %let_func_0.i.i, align 8
  %x_0.i.i = load i64, ptr %let_capture_0.i.i, align 4
  %6 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i.i.i.i = tail call ptr @malgo_malloc(i64 noundef 8)
  store i64 %x_0.i.i, ptr %let_capture_0.i.i.i.i, align 4
...
define internal noundef ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_400"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly %1) {
  ...
  store ptr %let_capture_0.i.i, ptr %3, align 8
  %let_func_0.i.i = getelementptr { ptr, ptr }, ptr %3, i64 0, i32 1
  store ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_305", ptr %let_func_0.i.i, align 8
  %"int64#_0.i.i" = load ptr, ptr %let_capture_0.i.i, align 8
  %4 = getelementptr i8, ptr %"int64#_0.i.i", i64 4
  %"int64#_0.val.i.i" = load i64, ptr %4, align 4
  %5 = getelementptr i8, ptr %1, i64 4
  ...
  store ptr %let_capture_0.i.i.i.i, ptr %6, align 8
  %let_func_0.i.i.i.i = getelementptr { ptr, ptr }, ptr %6, i64 0, i32 1
  store ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_369", ptr %let_func_0.i.i.i.i, align 8
  %x_0.i.i.i.i = load i64, ptr %let_capture_0.i.i.i.i, align 4
  %7 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i.i.i.i.i.i = tail call ptr @malgo_malloc(i64 noundef 8)
  store i64 %x_0.i.i.i.i, ptr %let_capture_0.i.i.i.i.i.i, align 4
...
define internal ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_411"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
  ...
  store ptr %let_capture_0.i.i, ptr %3, align 8
  %let_func_0.i.i = getelementptr { ptr, ptr }, ptr %3, i64 0, i32 1
  store ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_256", ptr %let_func_0.i.i, align 8
  %4 = tail call ptr @malgo_malloc(i64 noundef 12)
  store i8 0, ptr %4, align 1
  %5 = getelementptr { i8, { i64 } }, ptr %4, i64 0, i32 1, i32 0
  ...
  store ptr @"test/testcases/malgo/Factorial.mlg.#fun_closure_358", ptr %fun_func_0.i, align 8
  ...
  store ptr @"test/testcases/malgo/Factorial.mlg.#fun_closure_359", ptr %fun_func_1.i, align 8
...
define internal ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_438"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
  ...
  store ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_325", ptr %let_func_0.i, align 8
  ret ptr %3
}
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_411", ptr %let_func_0.i.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_342", ptr %let_func_0.i.i, align 8
  %14 = tail call ptr @malgo_malloc(i64 noundef 16)
  ...
  store ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_342", ptr %let_func_0.i2.i, align 8
