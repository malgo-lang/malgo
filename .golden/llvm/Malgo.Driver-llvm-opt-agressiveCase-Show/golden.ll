...
define internal noundef ptr @"test/testcases/malgo/Show.mlg.#fun_closure_3850"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %0, ptr nocapture nofree readonly align 8 %1) {
  ...
  store ptr @str3854, ptr %6, align 8
  %7 = tail call ptr @malgo_hash_table_get(ptr %showDictA_0, ptr noundef nonnull @str3849)
  ...
  store ptr @str3855, ptr %13, align 8
  %14 = tail call ptr @malgo_hash_table_get(ptr %showDictB_0, ptr noundef nonnull @str3849)
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_3857", ptr %let_func_0.i, align 8
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_3858", ptr %let_func_1.i, align 8
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_3859", ptr %let_func_2.i, align 8
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_3860", ptr %let_func_3.i, align 8
...
define internal ptr @"test/testcases/malgo/Show.mlg.#let_closure_3852"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
...
define internal noundef ptr @"test/testcases/malgo/Show.mlg.#let_closure_3857"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 8 %1) {
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_3852", ptr %let_func_0.i.i, align 8
...
define internal ptr @"test/testcases/malgo/Show.mlg.#let_closure_3864"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
  ...
  %3 = tail call ptr @malgo_hash_table_get(ptr %cast_0, ptr noundef nonnull @str3849)
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  tail call void @malgo_hash_table_insert(ptr %3, ptr noundef nonnull @str3849, ptr noundef nonnull %2)
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#fun_closure_3850", ptr %fun_func_0.i.i, align 8
  %7 = tail call ptr @malgo_hash_table_new()
  tail call void @malgo_hash_table_insert(ptr %7, ptr noundef nonnull @str3849, ptr noundef nonnull %6)
