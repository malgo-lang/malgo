; ModuleID = './test/tmp/malgo_test/aggressive/RecordTest.ll'
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  tail call void @malgo_hash_table_insert(ptr %7, ptr noundef nonnull @str3534, ptr noundef nonnull %3)
  tail call void @malgo_hash_table_insert(ptr %7, ptr noundef nonnull @str3535, ptr noundef nonnull %5)
  %8 = tail call ptr @malgo_hash_table_get(ptr %7, ptr noundef nonnull @str3534)
  %9 = tail call ptr @malgo_hash_table_get(ptr %7, ptr noundef nonnull @str3535)
  %10 = tail call ptr @malgo_hash_table_get(ptr %7, ptr noundef nonnull @str3534)
  %11 = tail call ptr @malgo_hash_table_get(ptr %7, ptr noundef nonnull @str3535)
