...
define internal ptr @_M28let_x24350_x5Fclosure_x24f4846test_x2Ftestcases_x2Fmalgo_x2FFactorial_x2Emlg8Internal(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
  ...
  store ptr @_M28let_x2434f_x5Fclosure_x24f5046test_x2Ftestcases_x2Fmalgo_x2FFactorial_x2Emlg8Internal, ptr %"let$34f_func_0.i", align 8
  ret ptr %3
}

define internal noundef ptr @_M28let_x24eed_x5Fclosure_x24f4c46test_x2Ftestcases_x2Fmalgo_x2FFactorial_x2Emlg8Internal(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  %"int64#$ed6_0" = load ptr, ptr %0, align 8
  %3 = getelementptr i8, ptr %"int64#$ed6_0", i64 4
  %"int64#$ed6_0.val" = load i64, ptr %3, align 4
  %4 = getelementptr i8, ptr %1, i64 4
  %.val = load i64, ptr %4, align 4
  %5 = tail call ptr @malgo_malloc(i64 noundef 16)
  %"let$79b$a48_capture_0.i" = tail call ptr @malgo_malloc(i64 noundef 8)
  store i64 %"int64#$ed6_0.val", ptr %"let$79b$a48_capture_0.i", align 4
  ...
  %6 = tail call i32 @malgo_eq_int64_t(i64 %"int64#$ed6_0.val", i64 %.val)
...
define internal ptr @_M27let_x24c7_x5Fclosure_x24f4d46test_x2Ftestcases_x2Fmalgo_x2FFactorial_x2Emlg8Internal(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
  ...
  %5 = tail call ptr @malgo_malloc(i64 noundef 16)
  %"let$eed_capture_0.i.i" = tail call ptr @malgo_malloc(i64 noundef 8)
  store ptr %"n$7$86_0", ptr %"let$eed_capture_0.i.i", align 8
  store ptr %"let$eed_capture_0.i.i", ptr %5, align 8
  %"let$eed_func_0.i.i" = getelementptr { ptr, ptr }, ptr %5, i64 0, i32 1
  store ptr @_M28let_x24eed_x5Fclosure_x24f4c46test_x2Ftestcases_x2Fmalgo_x2FFactorial_x2Emlg8Internal, ptr %"let$eed_func_0.i.i", align 8
  %"int64#$ed6_0.i.i" = load ptr, ptr %"let$eed_capture_0.i.i", align 8
  %6 = getelementptr i8, ptr %"int64#$ed6_0.i.i", i64 4
  %"int64#$ed6_0.val.i.i" = load i64, ptr %6, align 4
  %.val.i.i = load i64, ptr %4, align 4
  %7 = tail call ptr @malgo_malloc(i64 noundef 16)
  %"let$79b$a48_capture_0.i.i.i" = tail call ptr @malgo_malloc(i64 noundef 8)
  store i64 %"int64#$ed6_0.val.i.i", ptr %"let$79b$a48_capture_0.i.i.i", align 4
  ...
  %8 = tail call i32 @malgo_eq_int64_t(i64 %"int64#$ed6_0.val.i.i", i64 %.val.i.i)
  ...
  store ptr @_M28let_x24350_x5Fclosure_x24f4846test_x2Ftestcases_x2Fmalgo_x2FFactorial_x2Emlg8Internal, ptr %"let$350_func_0.i.i", align 8
...
define internal noundef ptr @_M28let_x24a05_x5Fclosure_x24f4e46test_x2Ftestcases_x2Fmalgo_x2FFactorial_x2Emlg8Internal(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  %"int64#$9ee_0" = load ptr, ptr %0, align 8
  %3 = getelementptr i8, ptr %"int64#$9ee_0", i64 4
  %"int64#$9ee_0.val" = load i64, ptr %3, align 4
  %4 = getelementptr i8, ptr %1, i64 4
  %.val = load i64, ptr %4, align 4
  %5 = tail call ptr @malgo_malloc(i64 noundef 16)
  %"let$739$2b6_capture_0.i" = tail call ptr @malgo_malloc(i64 noundef 8)
  store i64 %"int64#$9ee_0.val", ptr %"let$739$2b6_capture_0.i", align 4
  ...
  %6 = tail call i64 @malgo_mul_int64_t(i64 %"int64#$9ee_0.val", i64 %.val)
...
define internal noundef ptr @_M28let_x248fd_x5Fclosure_x24f4f46test_x2Ftestcases_x2Fmalgo_x2FFactorial_x2Emlg8Internal(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  %"int64#$8e6_0" = load ptr, ptr %0, align 8
  %3 = getelementptr i8, ptr %"int64#$8e6_0", i64 4
  %"int64#$8e6_0.val" = load i64, ptr %3, align 4
  %4 = getelementptr i8, ptr %1, i64 4
  %.val = load i64, ptr %4, align 4
  %5 = tail call ptr @malgo_malloc(i64 noundef 16)
  %"let$733$179_capture_0.i" = tail call ptr @malgo_malloc(i64 noundef 8)
  store i64 %"int64#$8e6_0.val", ptr %"let$733$179_capture_0.i", align 4
  ...
  %6 = tail call i64 @malgo_sub_int64_t(i64 %"int64#$8e6_0.val", i64 %.val)
  %7 = tail call noundef ptr @malgo_malloc(i64 noundef 12)
  store i8 0, ptr %7, align 1
  %8 = getelementptr { i8, { i64 } }, ptr %7, i64 0, i32 1, i32 0
  store i64 %6, ptr %8, align 4
...
define internal ptr @_M28let_x2434f_x5Fclosure_x24f5046test_x2Ftestcases_x2Fmalgo_x2FFactorial_x2Emlg8Internal(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %0, ptr nocapture nofree readonly %1) {
...
define internal i64 @_M35let_x24733_x24179_x5Fclosure_x24f5146test_x2Ftestcases_x2Fmalgo_x2FFactorial_x2Emlg8Internal(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  %"p$8e8$8f5$15c_0" = load i64, ptr %0, align 4
  %3 = tail call i64 @malgo_sub_int64_t(i64 %"p$8e8$8f5$15c_0", i64 %1)
  ret i64 %3
}
...
define internal i64 @_M35let_x24739_x242b6_x5Fclosure_x24f5246test_x2Ftestcases_x2Fmalgo_x2FFactorial_x2Emlg8Internal(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  %"p$9f0$9fd$299_0" = load i64, ptr %0, align 4
  %3 = tail call i64 @malgo_mul_int64_t(i64 %"p$9f0$9fd$299_0", i64 %1)
  ret i64 %3
}
...
define internal ptr @_M40fun_x24a3_x24b6_x24efc_x5Fclosure_x24f5446test_x2Ftestcases_x2Fmalgo_x2FFactorial_x2Emlg8Internal(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %0, ptr nocapture nofree readnone %1) {
  ...
  %5 = tail call ptr @malgo_malloc(i64 noundef 16)
  %"let$8fd_capture_0.i.i" = tail call ptr @malgo_malloc(i64 noundef 8)
  store ptr %"n$7$86_0", ptr %"let$8fd_capture_0.i.i", align 8
  store ptr %"let$8fd_capture_0.i.i", ptr %5, align 8
  %"let$8fd_func_0.i.i" = getelementptr { ptr, ptr }, ptr %5, i64 0, i32 1
  store ptr @_M28let_x248fd_x5Fclosure_x24f4f46test_x2Ftestcases_x2Fmalgo_x2FFactorial_x2Emlg8Internal, ptr %"let$8fd_func_0.i.i", align 8
  %"int64#$8e6_0.i.i" = load ptr, ptr %"let$8fd_capture_0.i.i", align 8
  %6 = getelementptr i8, ptr %"int64#$8e6_0.i.i", i64 4
  %"int64#$8e6_0.val.i.i" = load i64, ptr %6, align 4
  %.val.i.i = load i64, ptr %4, align 4
  %7 = tail call ptr @malgo_malloc(i64 noundef 16)
  %"let$733$179_capture_0.i.i.i" = tail call ptr @malgo_malloc(i64 noundef 8)
  store i64 %"int64#$8e6_0.val.i.i", ptr %"let$733$179_capture_0.i.i.i", align 4
  ...
  %8 = tail call i64 @malgo_sub_int64_t(i64 %"int64#$8e6_0.val.i.i", i64 %.val.i.i)
  ...
  %"let$a05_capture_0.i.i" = tail call ptr @malgo_malloc(i64 noundef 8)
  store ptr %"n$7$86_0", ptr %"let$a05_capture_0.i.i", align 8
  store ptr %"let$a05_capture_0.i.i", ptr %12, align 8
  %"let$a05_func_0.i.i" = getelementptr { ptr, ptr }, ptr %12, i64 0, i32 1
  store ptr @_M28let_x24a05_x5Fclosure_x24f4e46test_x2Ftestcases_x2Fmalgo_x2FFactorial_x2Emlg8Internal, ptr %"let$a05_func_0.i.i", align 8
  %"int64#$9ee_0.i.i" = load ptr, ptr %"let$a05_capture_0.i.i", align 8
  %13 = getelementptr i8, ptr %"int64#$9ee_0.i.i", i64 4
  %"int64#$9ee_0.val.i.i" = load i64, ptr %13, align 4
  ...
  store i64 %"int64#$9ee_0.val.i.i", ptr %"let$739$2b6_capture_0.i.i.i", align 4
  ...
  %16 = tail call i64 @malgo_mul_int64_t(i64 %"int64#$9ee_0.val.i.i", i64 %.val.i1.i)
...
define internal i32 @_M35let_x2479b_x24a48_x5Fclosure_x24f5546test_x2Ftestcases_x2Fmalgo_x2FFactorial_x2Emlg8Internal(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  %"p$ed8$ee5$a2a_0" = load i64, ptr %0, align 4
  %3 = tail call i32 @malgo_eq_int64_t(i64 %"p$ed8$ee5$a2a_0", i64 %1)
  ret i32 %3
}
