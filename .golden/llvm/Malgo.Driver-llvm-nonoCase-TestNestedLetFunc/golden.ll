...
define internal ptr @"test/testcases/malgo/TestNestedLetFunc.mlg.#fun_closure_28"(ptr %0, ptr %1) {
...
define internal ptr @"test/testcases/malgo/TestNestedLetFunc.mlg.#fun_closure_27"(ptr %0, ptr %1) {
...
define internal ptr @"test/testcases/malgo/TestNestedLetFunc.mlg.main"(ptr %0, ptr %"test/testcases/malgo/TestNestedLetFunc.mlg.$$__14_0") {
  ...
  store ptr @"test/testcases/malgo/TestNestedLetFunc.mlg.#fun_closure_27", ptr %fun_func_0, align 8
  %3 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ ptr, ptr }, ptr null, i32 1) to i64))
  ...
  store ptr @"test/testcases/malgo/TestNestedLetFunc.mlg.malgo_print_string", ptr %malgo_print_string_func_0, align 8
