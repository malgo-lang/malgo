...
define internal ptr @"test/testcases/malgo/TypeSynonym.mlg.#let_closure_131"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define internal ptr @"test/testcases/malgo/TypeSynonym.mlg.#fun_closure_250"(ptr nocapture nofree readnone %0, ptr nocapture nofree readonly align 8 %1) {
  %3 = getelementptr i8, ptr %1, i64 8
  ...
  store ptr @str210, ptr %8, align 8
  %9 = tail call ptr @malgo_print_string(ptr noundef nonnull @str210)
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/TypeSynonym.mlg.#let_closure_131", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/TypeSynonym.mlg.#fun_closure_250", ptr %fun_func_0.i, align 8
