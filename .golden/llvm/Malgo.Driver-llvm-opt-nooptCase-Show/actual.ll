...
define internal ptr @"test/testcases/malgo/Show.mlg.#let_closure_288"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
...
define internal noundef ptr @"test/testcases/malgo/Show.mlg.#let_closure_303"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 8 %1) {
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_344", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_288", ptr %let_func_0.i.i.i.i, align 8
...
define internal ptr @"test/testcases/malgo/Show.mlg.#fun_closure_318"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %0, ptr nocapture nofree readonly align 8 %1) {
  ...
  store ptr @str292, ptr %6, align 8
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_324", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_324", ptr %let_func_0.i2.i, align 8
  %14 = tail call ptr @malgo_malloc(i64 noundef 16)
  store i8 0, ptr %14, align 1
  %15 = getelementptr { i8, { ptr } }, ptr %14, i64 0, i32 1, i32 0
  store ptr @str293, ptr %15, align 8
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_324", ptr %let_func_0.i4.i, align 8
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_324", ptr %let_func_0.i6.i, align 8
  %23 = tail call ptr @malgo_malloc(i64 noundef 16)
  store i8 0, ptr %23, align 1
  %24 = getelementptr { i8, { ptr } }, ptr %23, i64 0, i32 1, i32 0
  store ptr @str294, ptr %24, align 8
...
define internal noundef ptr @"test/testcases/malgo/Show.mlg.#let_closure_324"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly %1) {
  ...
  store ptr %let_capture_0.i.i.i.i, ptr %6, align 8
  %let_func_0.i.i.i.i = getelementptr { ptr, ptr }, ptr %6, i64 0, i32 1
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_344", ptr %let_func_0.i.i.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_288", ptr %let_func_0.i.i.i.i.i.i, align 8
...
define internal ptr @"test/testcases/malgo/Show.mlg.#let_closure_344"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
  %x_0 = load ptr, ptr %0, align 8
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i.i = tail call ptr @malgo_malloc(i64 noundef 8)
  store ptr %x_0, ptr %let_capture_0.i.i, align 8
  store ptr %let_capture_0.i.i, ptr %3, align 8
  %let_func_0.i.i = getelementptr { ptr, ptr }, ptr %3, i64 0, i32 1
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_288", ptr %let_func_0.i.i, align 8
  %p_0.i.i = load ptr, ptr %let_capture_0.i.i, align 8
  %4 = tail call ptr @malgo_string_append(ptr %p_0.i.i, ptr %1)
  ret ptr %4
}

define internal ptr @"test/testcases/malgo/Show.mlg.#let_closure_360"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#fun_closure_318", ptr %fun_func_0.i, align 8
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_360", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#fun_closure_318", ptr %fun_func_0.i.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/Show.mlg.#let_closure_393", ptr %let_func_0.i2.i, align 8
