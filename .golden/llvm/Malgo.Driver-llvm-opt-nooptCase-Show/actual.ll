; ModuleID = './test/tmp/malgo_test/noopt/Show.ll'
...
define internal ptr @"Show.#let_closure_312"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
  ...
  store ptr @"Show.#fun_closure_439", ptr %fun_func_0.i, align 8
  %4 = tail call ptr @malgo_hash_table_new()
  tail call void @malgo_hash_table_insert(ptr %4, ptr noundef nonnull @str440, ptr noundef nonnull %3)
  ret ptr %4
}

define internal noundef ptr @"Show.#let_closure_326"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly %1) {
  ...
  store ptr @"Show.#let_closure_477", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"Show.#let_closure_458", ptr %let_func_0.i.i.i.i, align 8
  ...
  store ptr @"Show.#let_closure_327", ptr %let_func_0.i.i.i.i.i.i, align 8
...
define internal ptr @"Show.#let_closure_327"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
  %p_0 = load ptr, ptr %0, align 8
  %3 = tail call ptr @malgo_string_append(ptr %p_0, ptr %1)
  ret ptr %3
}

define internal ptr @"Show.#let_closure_360"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
  %showDict_0 = load ptr, ptr %0, align 8
  %3 = tail call ptr @malgo_hash_table_get(ptr %showDict_0, ptr noundef nonnull @str440)
...
define internal ptr @"Show.#fun_closure_439"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %0, ptr nocapture nofree readonly align 8 %1) {
  ...
  store ptr @str333, ptr %6, align 8
  %7 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i.i = tail call ptr @malgo_malloc(i64 noundef 8)
  ...
  %8 = tail call ptr @malgo_hash_table_get(ptr %showDictA_0, ptr noundef nonnull @str440)
  ...
  store ptr @"Show.#let_closure_326", ptr %let_func_0.i2.i, align 8
  %14 = tail call ptr @malgo_malloc(i64 noundef 16)
  store i8 0, ptr %14, align 1
  %15 = getelementptr { i8, { ptr } }, ptr %14, i64 0, i32 1, i32 0
  store ptr @str334, ptr %15, align 8
  ...
  store ptr @"Show.#let_closure_326", ptr %let_func_0.i4.i, align 8
  %17 = tail call ptr @malgo_hash_table_get(ptr %showDictB_0, ptr noundef nonnull @str440)
...
define internal ptr @"Show.#let_closure_458"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
  %x_0 = load ptr, ptr %0, align 8
  %3 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i.i = tail call ptr @malgo_malloc(i64 noundef 8)
  store ptr %x_0, ptr %let_capture_0.i.i, align 8
  store ptr %let_capture_0.i.i, ptr %3, align 8
  %let_func_0.i.i = getelementptr { ptr, ptr }, ptr %3, i64 0, i32 1
  store ptr @"Show.#let_closure_327", ptr %let_func_0.i.i, align 8
  %p_0.i.i = load ptr, ptr %let_capture_0.i.i, align 8
  %4 = tail call ptr @malgo_string_append(ptr %p_0.i.i, ptr %1)
  ret ptr %4
}

define internal noundef ptr @"Show.#let_closure_477"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 8 %1) {
  ...
  store ptr @"Show.#let_closure_458", ptr %let_func_0.i.i, align 8
  ...
  store ptr %let_capture_0.i.i.i.i, ptr %6, align 8
  %let_func_0.i.i.i.i = getelementptr { ptr, ptr }, ptr %6, i64 0, i32 1
  store ptr @"Show.#let_closure_327", ptr %let_func_0.i.i.i.i, align 8
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"Show.#fun_closure_482", ptr %fun_func_0.i, align 8
  %5 = tail call ptr @malgo_hash_table_new()
  tail call void @malgo_hash_table_insert(ptr %5, ptr noundef nonnull @str440, ptr noundef nonnull %4)
  ...
  store ptr @"Show.#let_closure_312", ptr %let_func_0.i.i, align 8
  %9 = load ptr, ptr @Show.showInt32, align 8
  ...
  store ptr @"Show.#fun_closure_439", ptr %fun_func_0.i.i.i, align 8
  %11 = tail call ptr @malgo_hash_table_new()
  tail call void @malgo_hash_table_insert(ptr %11, ptr noundef nonnull @str440, ptr noundef nonnull %10)
  ...
  store ptr @"Show.#let_closure_360", ptr %let_func_0.i2.i, align 8
...
define internal noundef ptr @"Show.#fun_closure_482"(ptr nocapture nofree readnone %0, ptr nocapture nofree readonly align 4 %1) {
