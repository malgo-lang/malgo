; ModuleID = './test/tmp/malgo_test/nolift/Show.ll'
...
define internal ptr @"Show.#let_closure_3186"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
...
define internal ptr @"Show.#let_closure_3187"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
...
define internal ptr @"Builtin.appendString#"(ptr nocapture nofree readnone %0, ptr nofree %"Builtin.$x_3963_0") {
  ...
  store ptr @"Show.#let_closure_3187", ptr %let_func_0, align 8
  ret ptr %2
}

declare ptr @malgo_hash_table_get(ptr, ptr) local_unnamed_addr

define internal ptr @"Show.#let_closure_3193"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(24) %0, ptr nocapture nofree readonly align 8 %1) {
"switch_branch_Builtin.String#_0":
  %"String#_0" = load ptr, ptr %0, align 8
  %d_addr_0 = getelementptr { ptr, ptr, ptr }, ptr %0, i64 0, i32 1
  %d_0 = load ptr, ptr %d_addr_0, align 8
  %"appendString#_addr_0" = getelementptr { ptr, ptr, ptr }, ptr %0, i64 0, i32 2
...
define internal ptr @"Show.#let_closure_3194"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(24) %0, ptr nocapture nofree readonly align 8 %1) {
"switch_branch_Builtin.String#_0":
  %"String#_0" = load ptr, ptr %0, align 8
  %d_addr_0 = getelementptr { ptr, ptr, ptr }, ptr %0, i64 0, i32 1
  %d_0 = load ptr, ptr %d_addr_0, align 8
...
define internal ptr @"Show.#let_closure_3195"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(24) %0, ptr nocapture nofree readonly align 8 %1) {
"switch_branch_Builtin.String#_0":
  %"String#_0" = load ptr, ptr %0, align 8
  %d_addr_0 = getelementptr { ptr, ptr, ptr }, ptr %0, i64 0, i32 1
  %d_0 = load ptr, ptr %d_addr_0, align 8
...
define internal ptr @"Show.#let_closure_3196"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(24) %0, ptr nocapture nofree readonly align 8 %1) {
"switch_branch_Builtin.String#_0":
  %"String#_0" = load ptr, ptr %0, align 8
  %"appendString#_addr_0" = getelementptr { ptr, ptr, ptr }, ptr %0, i64 0, i32 1
  %"appendString#_0" = load ptr, ptr %"appendString#_addr_0", align 8
...
define internal noundef ptr @"Show.#fun_closure_3188"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(32) %0, ptr nocapture nofree readonly align 8 %1) {
"switch_branch_Tuple#_0":
  %"String#_0" = load ptr, ptr %0, align 8
  %showDictB_addr_0 = getelementptr { ptr, ptr, ptr, ptr }, ptr %0, i64 0, i32 1
  ...
  %"appendString#_addr_0" = getelementptr { ptr, ptr, ptr, ptr }, ptr %0, i64 0, i32 3
  %"appendString#_0" = load ptr, ptr %"appendString#_addr_0", align 8
  ...
  store ptr %"String#_0", ptr %let_capture_0, align 8
  %d_0 = getelementptr { ptr, ptr, ptr }, ptr %let_capture_0, i64 0, i32 1
  store ptr %19, ptr %d_0, align 8
  %"appendString#_1" = getelementptr { ptr, ptr, ptr }, ptr %let_capture_0, i64 0, i32 2
  ...
  store ptr @"Show.#let_closure_3193", ptr %let_func_0, align 8
  ...
  store ptr @"Show.#let_closure_3186", ptr %let_func_0.i, align 8
  ...
  store ptr %"String#_0", ptr %let_capture_2, align 8
  %d_1 = getelementptr { ptr, ptr, ptr }, ptr %let_capture_2, i64 0, i32 1
  store ptr %13, ptr %d_1, align 8
  %"appendString#_2" = getelementptr { ptr, ptr, ptr }, ptr %let_capture_2, i64 0, i32 2
  ...
  store ptr @"Show.#let_closure_3194", ptr %let_func_1, align 8
  ...
  store ptr @"Show.#let_closure_3186", ptr %let_func_0.i9, align 8
  ...
  store ptr %"String#_0", ptr %let_capture_4, align 8
  %d_2 = getelementptr { ptr, ptr, ptr }, ptr %let_capture_4, i64 0, i32 1
  store ptr %12, ptr %d_2, align 8
  %"appendString#_3" = getelementptr { ptr, ptr, ptr }, ptr %let_capture_4, i64 0, i32 2
  ...
  store ptr @"Show.#let_closure_3195", ptr %let_func_2, align 8
  ...
  store ptr @"Show.#let_closure_3186", ptr %let_func_0.i11, align 8
  ...
  store ptr %"String#_0", ptr %let_capture_6, align 8
  %"appendString#_4" = getelementptr { ptr, ptr, ptr }, ptr %let_capture_6, i64 0, i32 1
  ...
  store ptr @"Show.#let_closure_3196", ptr %let_func_3, align 8
  ...
  store ptr @"Show.#let_closure_3186", ptr %let_func_0.i13, align 8
...
define internal ptr @"Show.#let_closure_3201"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
"switch_branch_Builtin.String#_0":
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"Show.#fun_closure_3206", ptr %fun_func_0.i, align 8
  ...
  %"String#_func_0.i.i" = getelementptr { ptr, ptr }, ptr %7, i64 0, i32 1
  store ptr @"Builtin.String#", ptr %"String#_func_0.i.i", align 8
  store ptr %7, ptr %fun_capture_0.i.i, align 8
  %showDictB_0.i.i = getelementptr { ptr, ptr, ptr, ptr }, ptr %fun_capture_0.i.i, i64 0, i32 1
  ...
  %"appendString#_func_0.i.i" = getelementptr { ptr, ptr }, ptr %8, i64 0, i32 1
  store ptr @"Builtin.appendString#", ptr %"appendString#_func_0.i.i", align 8
  %"appendString#_0.i.i" = getelementptr { ptr, ptr, ptr, ptr }, ptr %fun_capture_0.i.i, i64 0, i32 3
  store ptr %8, ptr %"appendString#_0.i.i", align 8
  store ptr %fun_capture_0.i.i, ptr %6, align 8
  %fun_func_0.i.i = getelementptr { ptr, ptr }, ptr %6, i64 0, i32 1
  store ptr @"Show.#fun_closure_3188", ptr %fun_func_0.i.i, align 8
  ...
  store ptr @"Show.#let_closure_3201", ptr %let_func_0.i, align 8
...
define internal noundef ptr @"Show.#fun_closure_3206"(ptr nocapture nofree readnone %0, ptr nocapture nofree readonly align 4 %1) {
