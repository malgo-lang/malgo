...
@str3704 = unnamed_addr constant [2 x i8] c"x\00"
@str3705 = unnamed_addr constant [2 x i8] c"y\00"
@str3706 = unnamed_addr constant [3 x i8] c", \00"
@str3711 = unnamed_addr constant [2 x i8] c"z\00"
...
define internal ptr @_M7print2D48test_x2Ftestcases_x2Fmalgo_x2FFieldPrefix_x2Emlg8External(ptr %0, ptr %_M12record_x244348test_x2Ftestcases_x2Fmalgo_x2FFieldPrefix_x2Emlg8Temporal_0) {
  %2 = call ptr @malgo_hash_table_get(ptr %_M12record_x244348test_x2Ftestcases_x2Fmalgo_x2FFieldPrefix_x2Emlg8Temporal_0, ptr @str3704)
  %3 = call ptr @malgo_hash_table_get(ptr %_M12record_x244348test_x2Ftestcases_x2Fmalgo_x2FFieldPrefix_x2Emlg8Temporal_0, ptr @str3705)
...
"switch_branch_String#_0":                        ; preds = %"switch_branch_Int32#_0"
  ...
  store ptr @str3706, ptr %21, align 8
...
"switch_branch_Int32#_1":                         ; preds = %"switch_branch_String#_1"
...
switch_default_1:                                 ; preds = %"switch_branch_String#_1"
  unreachable

switch_default_2:                                 ; preds = %"switch_branch_String#_0"
  unreachable
...
define internal ptr @_M3x2D48test_x2Ftestcases_x2Fmalgo_x2FFieldPrefix_x2Emlg8External(ptr %0, ptr %_M12record_x244048test_x2Ftestcases_x2Fmalgo_x2FFieldPrefix_x2Emlg8Temporal_0) {
  %2 = call ptr @malgo_hash_table_get(ptr %_M12record_x244048test_x2Ftestcases_x2Fmalgo_x2FFieldPrefix_x2Emlg8Temporal_0, ptr @str3704)
  %3 = call ptr @malgo_hash_table_get(ptr %_M12record_x244048test_x2Ftestcases_x2Fmalgo_x2FFieldPrefix_x2Emlg8Temporal_0, ptr @str3705)
  ret ptr %2
}
...
define internal ptr @_M3y2D48test_x2Ftestcases_x2Fmalgo_x2FFieldPrefix_x2Emlg8External(ptr %0, ptr %_M12record_x243d48test_x2Ftestcases_x2Fmalgo_x2FFieldPrefix_x2Emlg8Temporal_0) {
  %2 = call ptr @malgo_hash_table_get(ptr %_M12record_x243d48test_x2Ftestcases_x2Fmalgo_x2FFieldPrefix_x2Emlg8Temporal_0, ptr @str3704)
  %3 = call ptr @malgo_hash_table_get(ptr %_M12record_x243d48test_x2Ftestcases_x2Fmalgo_x2FFieldPrefix_x2Emlg8Temporal_0, ptr @str3705)
  ret ptr %3
}
...
define i32 @main(ptr %0) {
  ...
  %4 = call ptr @_M4main48test_x2Ftestcases_x2Fmalgo_x2FFieldPrefix_x2Emlg8External(ptr null, ptr %2)
  ret i32 0
}
...
define internal void @"malgo_load_test/testcases/malgo/FieldPrefix.mlg"() {
  ...
  call void @malgo_hash_table_insert(ptr %10, ptr @str3704, ptr %1)
  call void @malgo_hash_table_insert(ptr %10, ptr @str3705, ptr %4)
  call void @malgo_hash_table_insert(ptr %10, ptr @str3711, ptr %7)
  ...
  call void @malgo_hash_table_insert(ptr %17, ptr @str3704, ptr %11)
  call void @malgo_hash_table_insert(ptr %17, ptr @str3705, ptr %14)
