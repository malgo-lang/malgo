...
define internal ptr @"RightAssoc.#fun_closure_3285"(ptr %0, ptr %1) {
  %3 = call ptr @"RightAssoc.$raw_fun_3157"(ptr null, ptr %1)
  ret ptr %3
}

define internal ptr @"RightAssoc.#fun_closure_3286"(ptr %0, ptr %1) {
  %3 = call ptr @"RightAssoc.$raw_fun_3221"(ptr null, ptr %1)
  ret ptr %3
}

define internal ptr @"RightAssoc.#fun_closure_3287"(ptr %0, ptr %1) {
  %3 = call ptr @"RightAssoc.$raw_fun_3253"(ptr null, ptr %1)
  ret ptr %3
}

define internal ptr @"RightAssoc.#fun_closure_3288"(ptr %0, ptr %1) {
  %3 = call ptr @"RightAssoc.$raw_fun_3269"(ptr null, ptr %1)
  ret ptr %3
}

define internal ptr @"RightAssoc.#fun_closure_3289"(ptr %0, ptr %1) {
  %3 = call ptr @"RightAssoc.$raw_fun_3277"(ptr null, ptr %1)
  ret ptr %3
}

define internal ptr @"RightAssoc.#fun_closure_3290"(ptr %0, ptr %1) {
  %3 = call ptr @"RightAssoc.$raw_fun_3281"(ptr null, ptr %1)
  ret ptr %3
}

define internal ptr @"RightAssoc.#fun_closure_3291"(ptr %0, ptr %1) {
  %3 = call ptr @"RightAssoc.$raw_fun_3283"(ptr null, ptr %1)
  ret ptr %3
}

define internal ptr @"RightAssoc.#fun_closure_3292"(ptr %0, ptr %1) {
  %3 = call ptr @"RightAssoc.$raw_fun_3284"(ptr null, ptr %1)
  ret ptr %3
}
...
define internal ptr @RightAssoc.f(ptr %0, ptr %"RightAssoc.$n_87_0") {
  ...
  store ptr @"RightAssoc.#fun_closure_3285", ptr %fun_func_0, align 8
  ...
  store ptr @"RightAssoc.#fun_closure_3286", ptr %fun_func_1, align 8
  ...
  store ptr @"RightAssoc.#fun_closure_3287", ptr %fun_func_2, align 8
  ...
  store ptr @"RightAssoc.#fun_closure_3288", ptr %fun_func_3, align 8
  ...
  store ptr @"RightAssoc.#fun_closure_3289", ptr %fun_func_4, align 8
  ...
  store ptr @"RightAssoc.#fun_closure_3290", ptr %fun_func_5, align 8
  ...
  store ptr @"RightAssoc.#fun_closure_3291", ptr %fun_func_6, align 8
  ...
  store ptr @"RightAssoc.#fun_closure_3292", ptr %fun_func_7, align 8
...
define internal ptr @"RightAssoc.$raw_fun_3221"(ptr %0, ptr %"RightAssoc.$$__99_0") {
...
define internal ptr @"RightAssoc.$raw_fun_3253"(ptr %0, ptr %"RightAssoc.$$__109_0") {
  %2 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ i8, { i32 } }, ptr null, i32 1) to i64))
  %3 = getelementptr { i8, { i32 } }, ptr %2, i32 0, i32 0
  store i8 0, ptr %3, align 1
  %4 = getelementptr { i8, { i32 } }, ptr %2, i32 0, i32 1, i32 0
...
define internal ptr @"RightAssoc.$raw_fun_3157"(ptr %0, ptr %"RightAssoc.$$__89_0") {
  %2 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ i8, { i32 } }, ptr null, i32 1) to i64))
  %3 = getelementptr { i8, { i32 } }, ptr %2, i32 0, i32 0
  store i8 0, ptr %3, align 1
  %4 = getelementptr { i8, { i32 } }, ptr %2, i32 0, i32 1, i32 0
...
define internal ptr @"RightAssoc.$raw_fun_3284"(ptr %0, ptr %"RightAssoc.$$__168_0") {
  %2 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ i8, { i32 } }, ptr null, i32 1) to i64))
  %3 = getelementptr { i8, { i32 } }, ptr %2, i32 0, i32 0
  store i8 0, ptr %3, align 1
  %4 = getelementptr { i8, { i32 } }, ptr %2, i32 0, i32 1, i32 0
...
define internal ptr @"RightAssoc.$raw_fun_3283"(ptr %0, ptr %"RightAssoc.$$__158_0") {
  %2 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ i8, { i32 } }, ptr null, i32 1) to i64))
  %3 = getelementptr { i8, { i32 } }, ptr %2, i32 0, i32 0
  store i8 0, ptr %3, align 1
  %4 = getelementptr { i8, { i32 } }, ptr %2, i32 0, i32 1, i32 0
...
define internal ptr @"RightAssoc.$raw_fun_3281"(ptr %0, ptr %"RightAssoc.$$__148_0") {
  %2 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ i8, { i32 } }, ptr null, i32 1) to i64))
  %3 = getelementptr { i8, { i32 } }, ptr %2, i32 0, i32 0
  store i8 0, ptr %3, align 1
  %4 = getelementptr { i8, { i32 } }, ptr %2, i32 0, i32 1, i32 0
...
define internal ptr @RightAssoc.main(ptr %0, ptr %"RightAssoc.$$__186_0") {
  ...
  %4 = getelementptr { i8, { i32 } }, ptr %2, i32 0, i32 1, i32 0
  store i32 4, ptr %4, align 4
  %5 = call ptr @RightAssoc.f(ptr null, ptr %2)
  ...
  store ptr @str3293, ptr %8, align 8
...
define internal ptr @"RightAssoc.#let_closure_3294"(ptr %0, ptr %1) {
  %eta_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %eta_0 = load ptr, ptr %eta_addr_0, align 8
  %3 = call ptr @"RightAssoc.$raw_let_3029"(ptr null, ptr %eta_0, ptr %1)
  ret ptr %3
}
...
define internal ptr @"RightAssoc.<|>"(ptr %0, ptr %"RightAssoc.$eta_86_0") {
  ...
  store ptr %"RightAssoc.$eta_86_0", ptr %eta_0, align 8
  %let_capture_1 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 0
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"RightAssoc.#let_closure_3294", ptr %let_func_0, align 8
  ret ptr %2
}

define internal ptr @"RightAssoc.$raw_fun_3269"(ptr %0, ptr %"RightAssoc.$$__119_0") {
  %2 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ i8, { i32 } }, ptr null, i32 1) to i64))
  %3 = getelementptr { i8, { i32 } }, ptr %2, i32 0, i32 0
  store i8 0, ptr %3, align 1
  %4 = getelementptr { i8, { i32 } }, ptr %2, i32 0, i32 1, i32 0
...
define internal ptr @"RightAssoc.$raw_let_3029"(ptr %0, ptr %"RightAssoc.$eta_86_0", ptr %"RightAssoc.$p_2971_0") {
  ...
  store ptr %"RightAssoc.$eta_86_0", ptr %4, align 8
  %5 = getelementptr { i8, { ptr, ptr } }, ptr %2, i32 0, i32 1, i32 1
  store ptr %"RightAssoc.$p_2971_0", ptr %5, align 8
  ret ptr %2
}

define internal ptr @"RightAssoc.$raw_fun_3277"(ptr %0, ptr %"RightAssoc.$$__138_0") {
  %2 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ i8, { i32 } }, ptr null, i32 1) to i64))
  %3 = getelementptr { i8, { i32 } }, ptr %2, i32 0, i32 0
  store i8 0, ptr %3, align 1
  %4 = getelementptr { i8, { i32 } }, ptr %2, i32 0, i32 1, i32 0
