; ModuleID = './test/tmp/malgo_test/noopt/Null.ll'
...
define internal ptr @"Null.#fun_closure_181"(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %1) {
...
switch_branch_Null.False_0.i:                     ; preds = %2
  %3 = tail call ptr @malgo_print_string(ptr noundef nonnull @str183)
  br label %"Null.$raw_fun_180.exit"
...
"Null.$raw_fun_180.exit":                         ; preds = %switch_branch_Null.False_0.i, %switch_branch_Null.True_0.i
  %common.ret.op.i = phi ptr [ %3, %switch_branch_Null.False_0.i ], [ %5, %switch_branch_Null.True_0.i ]
  ret ptr %common.ret.op.i
}

define internal noundef ptr @"Null.#let_closure_182"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
...
define internal ptr @"Null.#let_closure_184"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"Null.#let_closure_182", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"Null.#let_closure_182", ptr %let_func_0.i2.i, align 8
  ...
  br i1 %switch.i.i.i, label %switch_branch_Null.Nil_0.i.i.i, label %switch_branch_Null.Cons_0.i.i.i

switch_branch_Null.Nil_0.i.i.i:                   ; preds = %1
  %15 = tail call ptr @malgo_malloc(i64 noundef 1)
  store i8 0, ptr %15, align 1
  br label %Null.main.exit

switch_branch_Null.Cons_0.i.i.i:                  ; preds = %1
...
Null.main.exit:                                   ; preds = %switch_branch_Null.Nil_0.i.i.i, %switch_branch_Null.Cons_0.i.i.i
  ...
  store ptr @"Null.#let_closure_184", ptr %let_func_0.i4.i, align 8
  ...
  store ptr @"Null.#fun_closure_181", ptr %fun_func_0.i, align 8
