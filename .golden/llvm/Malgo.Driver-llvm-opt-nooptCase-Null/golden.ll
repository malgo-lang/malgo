...
define internal ptr @"test/testcases/malgo/Null.mlg.#fun_closure_181"(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %1) {
...
define internal ptr @"test/testcases/malgo/Null.mlg.#let_closure_182"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define internal noundef ptr @"test/testcases/malgo/Null.mlg.#let_closure_183"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @"test/testcases/malgo/Null.mlg.#let_closure_183", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/Null.mlg.#let_closure_183", ptr %let_func_0.i2.i, align 8
...
"test/testcases/malgo/Null.mlg.main.exit":        ; preds = %"switch_branch_test/testcases/malgo/Null.mlg.Nil_0.i.i.i", %"switch_branch_test/testcases/malgo/Null.mlg.Cons_0.i.i.i"
  ...
  store ptr @"test/testcases/malgo/Null.mlg.#let_closure_182", ptr %let_func_0.i4.i, align 8
  ...
  store ptr @"test/testcases/malgo/Null.mlg.#fun_closure_181", ptr %fun_func_0.i, align 8
