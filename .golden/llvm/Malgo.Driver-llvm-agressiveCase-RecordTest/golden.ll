...
define internal i32 @"test/testcases/malgo/RecordTest.mlg.#let_closure_3534"(ptr %0, i32 %1) {
...
define internal ptr @"runtime/malgo/Builtin.mlg.malgo_add_int32_t"(ptr %0, i32 %"runtime/malgo/Builtin.mlg.$p_1808_0") {
  ...
  store ptr @"test/testcases/malgo/RecordTest.mlg.#let_closure_3534", ptr %let_func_0, align 8
  ret ptr %2
}
...
define internal i32 @"test/testcases/malgo/RecordTest.mlg.$raw_let_3533"(ptr %0, i32 %"test/testcases/malgo/RecordTest.mlg.$p_3519_0", i32 %"test/testcases/malgo/RecordTest.mlg.$y_3528_0") {
  %2 = call ptr @"runtime/malgo/Builtin.mlg.malgo_add_int32_t"(ptr null, i32 %"test/testcases/malgo/RecordTest.mlg.$p_3519_0")
  %3 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 0
  %4 = load ptr, ptr %3, align 8
  %5 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  %6 = load ptr, ptr %5, align 8
  %7 = call i32 %6(ptr %4, i32 %"test/testcases/malgo/RecordTest.mlg.$y_3528_0")
  ret i32 %7
}
...
define internal i32 @"test/testcases/malgo/RecordTest.mlg.#let_closure_3537"(ptr %0, i32 %1) {
  %p_addr_0 = getelementptr { i32 }, ptr %0, i32 0, i32 0
  %p_0 = load i32, ptr %p_addr_0, align 4
  %3 = call i32 @"test/testcases/malgo/RecordTest.mlg.$raw_let_3533"(ptr null, i32 %p_0, i32 %1)
  ret i32 %3
}
...
define internal ptr @"test/testcases/malgo/RecordTest.mlg.main"(ptr %0, ptr %"test/testcases/malgo/RecordTest.mlg.$$__59_0") {
  ...
  call void @malgo_hash_table_insert(ptr %8, ptr @str3535, ptr %2)
  call void @malgo_hash_table_insert(ptr %8, ptr @str3536, ptr %5)
  %9 = call ptr @malgo_hash_table_get(ptr %8, ptr @str3535)
  %10 = call ptr @malgo_hash_table_get(ptr %8, ptr @str3536)
  %11 = call ptr @malgo_hash_table_get(ptr %8, ptr @str3535)
  %12 = call ptr @malgo_hash_table_get(ptr %8, ptr @str3536)
...
"switch_branch_runtime/malgo/Builtin.mlg.Int32#_1": ; preds = %"switch_branch_runtime/malgo/Builtin.mlg.Int32#_0"
  ...
  store ptr @"test/testcases/malgo/RecordTest.mlg.#let_closure_3537", ptr %let_func_0, align 8
  %24 = call i32 @"runtime/malgo/Builtin.mlg.$addInt32#_curry_4032"(ptr null, i32 %17, i32 %22)
...
"switch_branch_runtime/malgo/Builtin.mlg.String#_0": ; preds = %"switch_branch_runtime/malgo/Builtin.mlg.Int32#_2"
...
define internal ptr @"test/testcases/malgo/RecordTest.mlg.f"(ptr %0, ptr %"test/testcases/malgo/RecordTest.mlg.$record_56_0") {
  %2 = call ptr @malgo_hash_table_get(ptr %"test/testcases/malgo/RecordTest.mlg.$record_56_0", ptr @str3535)
  %3 = call ptr @malgo_hash_table_get(ptr %"test/testcases/malgo/RecordTest.mlg.$record_56_0", ptr @str3536)
  ret ptr %2
}
...
"switch_branch_test/testcases/malgo/RecordTest.mlg.B_0": ; preds = %1
  ...
  %6 = load ptr, ptr %5, align 8
  %7 = call ptr @malgo_hash_table_get(ptr %6, ptr @str3535)
  %8 = call ptr @malgo_hash_table_get(ptr %6, ptr @str3536)
  ret ptr %7
