...
define internal ptr @"test/testcases/malgo/RecordTest.mlg.f"(ptr %0, ptr %"test/testcases/malgo/RecordTest.mlg.$record_56_0") {
  %2 = call ptr @malgo_hash_table_get(ptr %"test/testcases/malgo/RecordTest.mlg.$record_56_0", ptr @str3534)
  %3 = call ptr @malgo_hash_table_get(ptr %"test/testcases/malgo/RecordTest.mlg.$record_56_0", ptr @str3535)
  ret ptr %2
}
...
define internal i32 @"test/testcases/malgo/RecordTest.mlg.#let_closure_3536"(ptr %0, i32 %1) {
...
define internal ptr @"runtime/malgo/Builtin.mlg.malgo_add_int32_t"(ptr %0, i32 %"runtime/malgo/Builtin.mlg.$p_1808_0") {
  ...
  store ptr @"test/testcases/malgo/RecordTest.mlg.#let_closure_3536", ptr %let_func_0, align 8
  ret ptr %2
}
