; ModuleID = '/workspaces/malgo/.malgo-work/test/testcases/malgo/Test6.ll'
...
define internal ptr @Test6.malgo_exit_failure(ptr nocapture nofree readnone %0, ptr %"Test6.$p_33_0") {
  %2 = tail call ptr @malgo_exit_failure(ptr %"Test6.$p_33_0")
  ret ptr %2
}

define internal ptr @Test6.malgo_print_string(ptr nocapture nofree readnone %0, ptr %"Test6.$p_34_0") {
  %2 = tail call ptr @malgo_print_string(ptr %"Test6.$p_34_0")
  ret ptr %2
}

define internal ptr @Test6.rtob(ptr nocapture nofree readnone %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %"Test6.$r_35_0") {
  %2 = load i8, ptr %"Test6.$r_35_0", align 1
...
common.ret:                                       ; preds = %switch_branch_Test6.B_0, %switch_branch_Test6.G_0, %switch_branch_Test6.R_0
  %common.ret.op = phi ptr [ %3, %switch_branch_Test6.R_0 ], [ %6, %switch_branch_Test6.G_0 ], [ %9, %switch_branch_Test6.B_0 ]
...
define internal ptr @"Test6.#fun_closure_51"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %1) {
common.ret:
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr @Test6.malgo_print_string, ptr %malgo_print_string_func_0.i, align 8
  ...
  store ptr @"Test6.#fun_closure_51", ptr %fun_func_0.i, align 8
  %5 = tail call ptr @malgo_malloc(i64 noundef 1)
  store i8 0, ptr %5, align 1
  %6 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %6, align 8
  %rtob_func_0.i = getelementptr { ptr, ptr }, ptr %6, i64 0, i32 1
  store ptr @Test6.rtob, ptr %rtob_func_0.i, align 8
  %7 = tail call ptr @Test6.rtob(ptr poison, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %5)
