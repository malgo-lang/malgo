; ModuleID = './test/tmp/malgo_test/nono/ToplevelVariable.ll'
...
define internal noundef ptr @Prelude.Just(ptr nocapture nofree readnone %0, ptr nofree %"Prelude.$p_688_0") {
  %2 = tail call noundef ptr @malgo_malloc(i64 noundef 16)
  store i8 1, ptr %2, align 1
  %3 = getelementptr { i8, { ptr } }, ptr %2, i64 0, i32 1, i32 0
  store ptr %"Prelude.$p_688_0", ptr %3, align 8
  ret ptr %2
}
...
define internal ptr @"ToplevelVariable.#let_closure_148"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readnone %1) #1 {
...
define internal i32 @"ToplevelVariable.#let_closure_155"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
...
define internal i32 @"ToplevelVariable.#let_closure_320"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  ...
  store ptr @"ToplevelVariable.#let_closure_155", ptr %let_func_0.i.i, align 8
...
define internal noundef ptr @"ToplevelVariable.#let_closure_321"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  ...
  store ptr @"ToplevelVariable.#let_closure_320", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"ToplevelVariable.#let_closure_155", ptr %let_func_0.i.i.i.i, align 8
...
define internal ptr @ToplevelVariable.constId(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %"ToplevelVariable.$eta_87_0") {
  %2 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %2, align 8
  ...
  store ptr @"ToplevelVariable.#let_closure_148", ptr %let_func_0.i, align 8
  %a_0.i = load ptr, ptr %let_capture_0.i, align 8
  ret ptr %a_0.i
}

define internal noundef ptr @ToplevelVariable.addOne(ptr nocapture nofree readnone %0, ptr nocapture nofree readonly %"ToplevelVariable.$eta_102_0") {
  %2 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %2, align 8
  %addInt32_func_0 = getelementptr { ptr, ptr }, ptr %2, i64 0, i32 1
  store ptr @Builtin.addInt32, ptr %addInt32_func_0, align 8
  %3 = load ptr, ptr @ToplevelVariable.one, align 8
  %4 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i = tail call ptr @malgo_malloc(i64 noundef 8)
  store ptr %3, ptr %let_capture_0.i, align 8
  store ptr %let_capture_0.i, ptr %4, align 8
  %let_func_0.i = getelementptr { ptr, ptr }, ptr %4, i64 0, i32 1
  store ptr @"ToplevelVariable.#let_closure_321", ptr %let_func_0.i, align 8
  %5 = tail call noundef ptr @"ToplevelVariable.#let_closure_321"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %let_capture_0.i, ptr nocapture nofree readonly align 4 %"ToplevelVariable.$eta_102_0")
  ret ptr %5
}

define internal ptr @"ToplevelVariable.#fun_closure_326"(ptr nocapture nofree readonly %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %1) {
  %3 = load i8, ptr %1, align 1
  %switch = icmp eq i8 %3, 0
  br i1 %switch, label %switch_branch_Prelude.Nothing_0, label %switch_branch_Prelude.Just_0

common.ret:                                       ; preds = %switch_branch_Prelude.Just_0, %switch_branch_Prelude.Nothing_0
  %common.ret.op = phi ptr [ %11, %switch_branch_Prelude.Nothing_0 ], [ %12, %switch_branch_Prelude.Just_0 ]
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store ptr %6, ptr @ToplevelVariable.one, align 8
  %8 = tail call ptr @malgo_malloc(i64 noundef 16)
  ...
  store ptr @"ToplevelVariable.#fun_closure_332", ptr %fun_func_0.i, align 8
  %9 = tail call ptr @malgo_malloc(i64 noundef 1)
  store i8 0, ptr %9, align 1
  %10 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %10, align 8
  %Just_func_0.i = getelementptr { ptr, ptr }, ptr %10, i64 0, i32 1
  store ptr @Prelude.Just, ptr %Just_func_0.i, align 8
  %11 = tail call ptr @malgo_malloc(i64 noundef 16)
  ...
  store ptr %15, ptr @ToplevelVariable.comp, align 8
  ...
  %printString_func_0.i = getelementptr { ptr, ptr }, ptr %19, i64 0, i32 1
  ...
  store ptr %19, ptr %printString_0.i, align 8
  store ptr %fun_capture_0.i1, ptr %17, align 8
  %fun_func_0.i2 = getelementptr { ptr, ptr }, ptr %17, i64 0, i32 1
  store ptr @"ToplevelVariable.#fun_closure_326", ptr %fun_func_0.i2, align 8
  %20 = load ptr, ptr @ToplevelVariable.comp, align 8
...
ToplevelVariable.main.exit:                       ; preds = %switch_branch_Prelude.Nothing_0.i.i, %switch_branch_Prelude.Just_0.i.i
  ...
  store ptr @ToplevelVariable.constId, ptr %constId_func_0.i, align 8
  ...
  store ptr @Prelude.const, ptr %const_func_0.i.i, align 8
  ...
  store ptr @"ToplevelVariable.#let_closure_148", ptr %let_func_0.i.i.i, align 8
  ...
  store ptr @ToplevelVariable.addOne, ptr %addOne_func_0.i, align 8
  %37 = load ptr, ptr @ToplevelVariable.one, align 8
  %38 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %38, align 8
  %addInt32_func_0.i.i = getelementptr { ptr, ptr }, ptr %38, i64 0, i32 1
  store ptr @Builtin.addInt32, ptr %addInt32_func_0.i.i, align 8
  %39 = load ptr, ptr @ToplevelVariable.one, align 8
  ...
  store ptr @"ToplevelVariable.#let_closure_321", ptr %let_func_0.i.i2.i, align 8
  %41 = tail call ptr @"ToplevelVariable.#let_closure_321"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %let_capture_0.i.i1.i, ptr nocapture nofree readonly align 4 %37)
  ...
  %47 = tail call ptr @Prelude.printInt32(ptr poison, ptr nocapture nofree readonly %45)
  ret i32 0
}

define internal noundef ptr @"ToplevelVariable.#fun_closure_332"(ptr nocapture nofree readnone %0, ptr nocapture nofree readnone %1) {
common.ret:
