...
define internal ptr @"test/testcases/malgo/Null.mlg.#fun_closure_243"(ptr %0, ptr %1) {
...
"switch_branch_test/testcases/malgo/Null.mlg.Nothing_0": ; preds = %"switch_branch_test/testcases/malgo/Null.mlg.Nil_0"
  ...
  store ptr @"test/testcases/malgo/Null.mlg.#fun_closure_243", ptr %fun_func_0, align 8
...
"switch_branch_test/testcases/malgo/Null.mlg.Just_0": ; preds = %"switch_branch_test/testcases/malgo/Null.mlg.Nil_0"
  ...
  store ptr @"test/testcases/malgo/Null.mlg.#let_closure_244", ptr %let_func_1, align 8
  ...
  store ptr @"test/testcases/malgo/Null.mlg.#fun_closure_245", ptr %fun_func_1, align 8
...
"switch_branch_test/testcases/malgo/Null.mlg.Nothing_1": ; preds = %"switch_branch_test/testcases/malgo/Null.mlg.Cons_0"
  ...
  store ptr @"test/testcases/malgo/Null.mlg.#let_closure_246", ptr %let_func_2, align 8
  ...
  store ptr @"test/testcases/malgo/Null.mlg.#fun_closure_247", ptr %fun_func_2, align 8
...
"switch_branch_test/testcases/malgo/Null.mlg.Just_1": ; preds = %"switch_branch_test/testcases/malgo/Null.mlg.Cons_0"
  ...
  store ptr @"test/testcases/malgo/Null.mlg.#let_closure_248", ptr %let_func_3, align 8
  ...
  store ptr @"test/testcases/malgo/Null.mlg.#fun_closure_249", ptr %fun_func_3, align 8
...
define internal ptr @"test/testcases/malgo/Null.mlg.#let_closure_251"(ptr %0, ptr %1) {
...
define internal ptr @"test/testcases/malgo/Null.mlg.|>"(ptr %0, ptr %"test/testcases/malgo/Null.mlg.$x_135_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"test/testcases/malgo/Null.mlg.#let_closure_251", ptr %let_func_0, align 8
  ret ptr %2
}
