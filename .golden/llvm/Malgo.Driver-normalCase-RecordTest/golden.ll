...
define internal ptr @_M4main47test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8External(ptr %0, ptr %_M20_x24_x5F_x2431_x243b47test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8Temporal_0) {
...
define internal ptr @_M1f47test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8External(ptr %0, ptr %_M12record_x243847test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8Temporal_0) {
  %2 = call ptr @malgo_hash_table_get(ptr %_M12record_x243847test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8Temporal_0, ptr @str3662)
  %3 = call ptr @malgo_hash_table_get(ptr %_M12record_x243847test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8Temporal_0, ptr @str3663)
  ret ptr %2
}

define internal ptr @_M28let_x24fda_x5Fclosure_x24e5047test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8Internal(ptr %0, ptr %1) {
  %"int32#$fc7_addr_0" = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %"int32#$fc7_0" = load ptr, ptr %"int32#$fc7_addr_0", align 8
  %3 = call ptr @_M24raw_x5Flet_x24fda_x24e4d47test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8Temporal(ptr null, ptr %"int32#$fc7_0", ptr %1)
  ret ptr %3
}
...
define internal ptr @_M8addInt3234runtime_x2Fmalgo_x2FBuiltin_x2Emlg8External(ptr %0, ptr %_M16int32_x23_x24fc734runtime_x2Fmalgo_x2FBuiltin_x2Emlg8Temporal_0) {
  ...
  store ptr @_M28let_x24fda_x5Fclosure_x24e5047test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8Internal, ptr %"let$fda_func_0", align 8
  ret ptr %2
}
...
define internal i32 @_M35let_x24715_x24cac_x5Fclosure_x24e5147test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8Internal(ptr %0, i32 %1) {
  %"p$fc9$fd3$c8f_addr_0" = getelementptr { i32 }, ptr %0, i32 0, i32 0
  %"p$fc9$fd3$c8f_0" = load i32, ptr %"p$fc9$fd3$c8f_addr_0", align 4
  %3 = call i32 @malgo_add_int32_t(i32 %"p$fc9$fd3$c8f_0", i32 %1)
  ret i32 %3
}

define internal ptr @_M24raw_x5Flet_x24fda_x24e4d47test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8Temporal(ptr %0, ptr %_M16int32_x23_x24fc734runtime_x2Fmalgo_x2FBuiltin_x2Emlg8Temporal_0, ptr %_M16int32_x23_x24fc834runtime_x2Fmalgo_x2FBuiltin_x2Emlg8Temporal_0) {
...
"switch_branch_Int32#_1":                         ; preds = %"switch_branch_Int32#_0"
  ...
  %"let$715$cac_capture_0" = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ i32 }, ptr null, i32 1) to i64))
  %"p$fc9$fd3$c8f_0" = getelementptr { i32 }, ptr %"let$715$cac_capture_0", i32 0, i32 0
  store i32 %6, ptr %"p$fc9$fd3$c8f_0", align 4
  %"let$715$cac_capture_1" = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 0
  store ptr %"let$715$cac_capture_0", ptr %"let$715$cac_capture_1", align 8
  %"let$715$cac_func_0" = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 1
  store ptr @_M35let_x24715_x24cac_x5Fclosure_x24e5147test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8Internal, ptr %"let$715$cac_func_0", align 8
