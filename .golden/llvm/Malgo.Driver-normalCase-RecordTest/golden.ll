...
@str3658 = unnamed_addr constant [2 x i8] c"a\00"
@str3659 = unnamed_addr constant [2 x i8] c"b\00"
...
define internal ptr @_M4main47test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8External(ptr %0, ptr %_M20_x24_x5F_x2431_x243c47test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8Temporal_0) {
  ...
  call void @malgo_hash_table_insert(ptr %8, ptr @str3658, ptr %2)
  call void @malgo_hash_table_insert(ptr %8, ptr @str3659, ptr %5)
  %9 = call ptr @malgo_hash_table_get(ptr %8, ptr @str3658)
  %10 = call ptr @malgo_hash_table_get(ptr %8, ptr @str3659)
  %11 = call ptr @_M8addInt3234runtime_x2Fmalgo_x2FBuiltin_x2Emlg8External(ptr null, ptr %9)
  %12 = call ptr @malgo_hash_table_get(ptr %8, ptr @str3658)
  %13 = call ptr @malgo_hash_table_get(ptr %8, ptr @str3659)
...
define internal ptr @_M1B47test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8External(ptr %0, ptr %_M7p_x243247test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8Temporal_0) {
  ...
  store ptr %_M7p_x243247test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8Temporal_0, ptr %4, align 8
  ret ptr %2
}

define internal ptr @_M1f47test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8External(ptr %0, ptr %_M12record_x243947test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8Temporal_0) {
  %2 = call ptr @malgo_hash_table_get(ptr %_M12record_x243947test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8Temporal_0, ptr @str3658)
  %3 = call ptr @malgo_hash_table_get(ptr %_M12record_x243947test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8Temporal_0, ptr @str3659)
  ret ptr %2
}

define internal ptr @_M29let_x2410c5_x5Fclosure_x24e4c47test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8Internal(ptr %0, ptr %1) {
  %"int32#$10ae_addr_0" = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %"int32#$10ae_0" = load ptr, ptr %"int32#$10ae_addr_0", align 8
  %3 = call ptr @_M25raw_x5Flet_x2410c5_x24e4947test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8Temporal(ptr null, ptr %"int32#$10ae_0", ptr %1)
  ret ptr %3
}
...
define internal ptr @_M8addInt3234runtime_x2Fmalgo_x2FBuiltin_x2Emlg8External(ptr %0, ptr %_M17int32_x23_x2410ae34runtime_x2Fmalgo_x2FBuiltin_x2Emlg8Temporal_0) {
  ...
  store ptr @_M29let_x2410c5_x5Fclosure_x24e4c47test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8Internal, ptr %"let$10c5_func_0", align 8
  ret ptr %2
}

define internal ptr @_M1g47test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8External(ptr %0, ptr %_M7b_x243447test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8Temporal_0) {
  %2 = getelementptr { i8, <8 x i8> }, ptr %_M7b_x243447test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8Temporal_0, i32 0, i32 0
...
switch_branch_B_0:                                ; preds = %1
  %4 = getelementptr { i8, { ptr } }, ptr %_M7b_x243447test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8Temporal_0, i32 0, i32 1
  %5 = getelementptr { ptr }, ptr %4, i32 0, i32 0
  %6 = load ptr, ptr %5, align 8
  %7 = call ptr @malgo_hash_table_get(ptr %6, ptr @str3658)
  %8 = call ptr @malgo_hash_table_get(ptr %6, ptr @str3659)
  ret ptr %7
...
define internal i32 @_M35let_x24715_x24ca8_x5Fclosure_x24e4d47test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8Internal(ptr %0, i32 %1) {
  %"p$10b0$10bd$c8b_addr_0" = getelementptr { i32 }, ptr %0, i32 0, i32 0
  %"p$10b0$10bd$c8b_0" = load i32, ptr %"p$10b0$10bd$c8b_addr_0", align 4
  %3 = call i32 @malgo_add_int32_t(i32 %"p$10b0$10bd$c8b_0", i32 %1)
  ret i32 %3
}

define internal ptr @_M25raw_x5Flet_x2410c5_x24e4947test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8Temporal(ptr %0, ptr %_M17int32_x23_x2410ae34runtime_x2Fmalgo_x2FBuiltin_x2Emlg8Temporal_0, ptr %_M17int32_x23_x2410af34runtime_x2Fmalgo_x2FBuiltin_x2Emlg8Temporal_0) {
...
"switch_branch_Int32#_1":                         ; preds = %"switch_branch_Int32#_0"
  ...
  %"let$715$ca8_capture_0" = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ i32 }, ptr null, i32 1) to i64))
  %"p$10b0$10bd$c8b_0" = getelementptr { i32 }, ptr %"let$715$ca8_capture_0", i32 0, i32 0
  store i32 %6, ptr %"p$10b0$10bd$c8b_0", align 4
  %"let$715$ca8_capture_1" = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 0
  store ptr %"let$715$ca8_capture_0", ptr %"let$715$ca8_capture_1", align 8
  %"let$715$ca8_func_0" = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 1
  store ptr @_M35let_x24715_x24ca8_x5Fclosure_x24e4d47test_x2Ftestcases_x2Fmalgo_x2FRecordTest_x2Emlg8Internal, ptr %"let$715$ca8_func_0", align 8
