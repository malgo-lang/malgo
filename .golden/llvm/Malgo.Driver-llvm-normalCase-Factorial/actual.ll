...
define internal i64 @"test/testcases/malgo/Factorial.mlg.#let_closure_3297"(ptr %0, i64 %1) {
...
define internal i32 @"test/testcases/malgo/Factorial.mlg.#let_closure_3298"(ptr %0, i64 %1) {
  %p_addr_0 = getelementptr { i64 }, ptr %0, i32 0, i32 0
  %p_0 = load i64, ptr %p_addr_0, align 4
...
define internal i64 @"test/testcases/malgo/Factorial.mlg.#let_closure_3300"(ptr %0, i64 %1) {
  %p_addr_0 = getelementptr { i64 }, ptr %0, i32 0, i32 0
  %p_0 = load i64, ptr %p_addr_0, align 4
...
define internal i64 @"test/testcases/malgo/Factorial.mlg.#let_closure_3303"(ptr %0, i64 %1) {
  %x_addr_0 = getelementptr { i64 }, ptr %0, i32 0, i32 0
  %x_0 = load i64, ptr %x_addr_0, align 4
...
define internal ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_3304"(ptr %0, ptr %1) {
...
define internal ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_3305"(ptr %0, ptr %1) {
  %x_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %x_0 = load ptr, ptr %x_addr_0, align 8
...
define internal ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_3307"(ptr %0, ptr %1) {
...
"switch_branch_runtime/malgo/Builtin.mlg.Int64#_0": ; preds = %1
  ...
  store ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_3307", ptr %let_func_0, align 8
...
define internal ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_3308"(ptr %0, ptr %1) {
  %n_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %n_0 = load ptr, ptr %n_addr_0, align 8
...
define internal ptr @"test/testcases/malgo/Factorial.mlg.#fun_closure_3309"(ptr %0, ptr %1) {
...
define internal ptr @"test/testcases/malgo/Factorial.mlg.#fun_closure_3310"(ptr %0, ptr %1) {
  %acc_addr_0 = getelementptr { ptr, ptr }, ptr %0, i32 0, i32 0
  %acc_0 = load ptr, ptr %acc_addr_0, align 8
  %n_addr_0 = getelementptr { ptr, ptr }, ptr %0, i32 0, i32 1
  %n_0 = load ptr, ptr %n_addr_0, align 8
  %3 = call ptr @"test/testcases/malgo/Factorial.mlg.$raw_fun_3293"(ptr null, ptr %acc_0, ptr %n_0, ptr %1)
  ret ptr %3
}

define internal ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_3311"(ptr %0, ptr %1) {
  %n_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %n_0 = load ptr, ptr %n_addr_0, align 8
...
define internal ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_3312"(ptr %0, ptr %1) {
  %n_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %n_0 = load ptr, ptr %n_addr_0, align 8
...
define internal ptr @"test/testcases/malgo/Factorial.mlg.#let_closure_3313"(ptr %0, ptr %1) {
  %x_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %x_0 = load ptr, ptr %x_addr_0, align 8
...
define internal i64 @"test/testcases/malgo/Factorial.mlg.#let_closure_3314"(ptr %0, i64 %1) {
  %p_addr_0 = getelementptr { i64 }, ptr %0, i32 0, i32 0
  %p_0 = load i64, ptr %p_addr_0, align 4
...
define internal i32 @"test/testcases/malgo/Factorial.mlg.#let_closure_3315"(ptr %0, i64 %1) {
  %p_addr_0 = getelementptr { i64 }, ptr %0, i32 0, i32 0
  %p_0 = load i64, ptr %p_addr_0, align 4
...
define internal ptr @"test/testcases/malgo/Factorial.mlg.$raw_fun_3293"(ptr %0, ptr %"test/testcases/malgo/Factorial.mlg.$acc_168_0", ptr %"test/testcases/malgo/Factorial.mlg.$n_167_0", ptr %"test/testcases/malgo/Factorial.mlg.$$__183_0") {
  %2 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ i8, { i64 } }, ptr null, i32 1) to i64))
  %3 = getelementptr { i8, { i64 } }, ptr %2, i32 0, i32 0
  store i8 0, ptr %3, align 1
  %4 = getelementptr { i8, { i64 } }, ptr %2, i32 0, i32 1, i32 0
