...
define internal ptr @"Factorial.#let_closure_3297"(ptr %0, ptr %1) {
  %n_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %n_0 = load ptr, ptr %n_addr_0, align 8
  %3 = call ptr @"Factorial.$raw_let_3278"(ptr null, ptr %n_0, ptr %1)
  ret ptr %3
}

define internal ptr @"Factorial.#fun_closure_3298"(ptr %0, ptr %1) {
  %acc_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %acc_0 = load ptr, ptr %acc_addr_0, align 8
  %3 = call ptr @"Factorial.$raw_fun_3286"(ptr null, ptr %acc_0, ptr %1)
  ret ptr %3
}

define internal ptr @"Factorial.#fun_closure_3299"(ptr %0, ptr %1) {
  %acc_addr_0 = getelementptr { ptr, ptr }, ptr %0, i32 0, i32 0
  %acc_0 = load ptr, ptr %acc_addr_0, align 8
  %n_addr_0 = getelementptr { ptr, ptr }, ptr %0, i32 0, i32 1
  %n_0 = load ptr, ptr %n_addr_0, align 8
  %3 = call ptr @"Factorial.$raw_fun_3293"(ptr null, ptr %acc_0, ptr %n_0, ptr %1)
  ret ptr %3
}

define internal ptr @"Factorial.#let_closure_3300"(ptr %0, ptr %1) {
  %n_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %n_0 = load ptr, ptr %n_addr_0, align 8
...
define internal ptr @"Factorial.#let_closure_3301"(ptr %0, ptr %1) {
  %n_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %n_0 = load ptr, ptr %n_addr_0, align 8
...
define internal i64 @"Factorial.#let_closure_3302"(ptr %0, i64 %1) {
...
define internal ptr @"Factorial.$raw_let_3296"(ptr %0, ptr %"Factorial.$x_122_0", ptr %"Factorial.$y_123_0") {
...
"switch_branch_Builtin.Int64#_1":                 ; preds = %"switch_branch_Builtin.Int64#_0"
  ...
  store ptr @"Factorial.#let_closure_3302", ptr %let_func_0, align 8
...
define internal i64 @"Factorial.#let_closure_3303"(ptr %0, i64 %1) {
...
define internal ptr @"Builtin.subInt64#"(ptr %0, i64 %"Builtin.$x_2255_0") {
  ...
  store ptr @"Factorial.#let_closure_3303", ptr %let_func_0, align 8
  ret ptr %2
}
...
define internal ptr @"Factorial.$raw_let_3278"(ptr %0, ptr %"Factorial.$n_167_0", ptr %"Factorial.$int64#_3036_0") {
...
"switch_branch_Builtin.Int64#_0":                 ; preds = %1
  ...
  %5 = getelementptr { i64 }, ptr %4, i32 0, i32 0
  %6 = load i64, ptr %5, align 4
  %7 = getelementptr { i8, <8 x i8> }, ptr %"Factorial.$int64#_3036_0", i32 0, i32 0
  %8 = load i8, ptr %7, align 1
  switch i8 %8, label %switch_default_0 [
    i8 0, label %"switch_branch_Builtin.Int64#_1"
  ]
...
"switch_branch_Builtin.Int64#_1":                 ; preds = %"switch_branch_Builtin.Int64#_0"
  %9 = getelementptr { i8, { i64 } }, ptr %"Factorial.$int64#_3036_0", i32 0, i32 1
  %10 = getelementptr { i64 }, ptr %9, i32 0, i32 0
  %11 = load i64, ptr %10, align 4
...
define internal i32 @"Factorial.#let_closure_3304"(ptr %0, i64 %1) {
  %p_addr_0 = getelementptr { i64 }, ptr %0, i32 0, i32 0
  %p_0 = load i64, ptr %p_addr_0, align 4
...
"switch_branch_Builtin.Int64#_1":                 ; preds = %"switch_branch_Builtin.Int64#_0"
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 1
  store ptr @"Factorial.#let_closure_3304", ptr %let_func_0, align 8
...
define internal ptr @"Factorial.#let_closure_3305"(ptr %0, ptr %1) {
  %n_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %n_0 = load ptr, ptr %n_addr_0, align 8
  %3 = call ptr @"Factorial.$raw_let_3291"(ptr null, ptr %n_0, ptr %1)
  ret ptr %3
}

define internal ptr @"Factorial.#let_closure_3306"(ptr %0, ptr %1) {
  %n_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %n_0 = load ptr, ptr %n_addr_0, align 8
  %3 = call ptr @"Factorial.$raw_let_3292"(ptr null, ptr %n_0, ptr %1)
  ret ptr %3
}

define internal ptr @"Factorial.$raw_fun_3293"(ptr %0, ptr %"Factorial.$acc_168_0", ptr %"Factorial.$n_167_0", ptr %"Factorial.$$__183_0") {
  %2 = call ptr @malgo_malloc(i64 ptrtoint (ptr getelementptr inbounds ({ i8, { i64 } }, ptr null, i32 1) to i64))
  %3 = getelementptr { i8, { i64 } }, ptr %2, i32 0, i32 0
  store i8 0, ptr %3, align 1
  %4 = getelementptr { i8, { i64 } }, ptr %2, i32 0, i32 1, i32 0
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %5, i32 0, i32 1
  store ptr @"Factorial.#let_closure_3305", ptr %let_func_0, align 8
  ...
  store ptr @"Factorial.#let_closure_3306", ptr %let_func_1, align 8
...
define internal i64 @"Factorial.#let_closure_3307"(ptr %0, i64 %1) {
  %p_addr_0 = getelementptr { i64 }, ptr %0, i32 0, i32 0
  %p_0 = load i64, ptr %p_addr_0, align 4
...
"switch_branch_Builtin.Int64#_1":                 ; preds = %"switch_branch_Builtin.Int64#_0"
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 1
  store ptr @"Factorial.#let_closure_3307", ptr %let_func_0, align 8
...
define internal i32 @"Factorial.#let_closure_3308"(ptr %0, i64 %1) {
  %x_addr_0 = getelementptr { i64 }, ptr %0, i32 0, i32 0
  %x_0 = load i64, ptr %x_addr_0, align 4
...
define internal ptr @"Builtin.eqInt64#"(ptr %0, i64 %"Builtin.$x_3607_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"Factorial.#let_closure_3308", ptr %let_func_0, align 8
  ret ptr %2
}
...
define internal ptr @"Factorial.#let_closure_3309"(ptr %0, ptr %1) {
  %x_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %x_0 = load ptr, ptr %x_addr_0, align 8
  %3 = call ptr @"Factorial.$raw_let_3295"(ptr null, ptr %x_0, ptr %1)
  ret ptr %3
}
...
define internal ptr @Factorial.-(ptr %0, ptr %"Factorial.$x_110_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"Factorial.#let_closure_3309", ptr %let_func_0, align 8
  ret ptr %2
}
...
define internal ptr @"Factorial.#let_closure_3310"(ptr %0, ptr %1) {
  %x_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %x_0 = load ptr, ptr %x_addr_0, align 8
  %3 = call ptr @"Factorial.$raw_let_3294"(ptr null, ptr %x_0, ptr %1)
  ret ptr %3
}
...
define internal ptr @"Factorial.=="(ptr %0, ptr %"Factorial.$x_98_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"Factorial.#let_closure_3310", ptr %let_func_0, align 8
  ret ptr %2
}
...
define internal ptr @"Factorial.#let_closure_3311"(ptr %0, ptr %1) {
...
"switch_branch_Builtin.Int64#_0":                 ; preds = %1
  ...
  store ptr @"Factorial.#let_closure_3311", ptr %let_func_0, align 8
...
define internal ptr @"Factorial.#let_closure_3312"(ptr %0, ptr %1) {
  %n_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %n_0 = load ptr, ptr %n_addr_0, align 8
...
define internal ptr @Factorial.factAcc(ptr %0, ptr %"Factorial.$n_134_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"Factorial.#let_closure_3312", ptr %let_func_0, align 8
  ret ptr %2
}

define internal i64 @"Factorial.#let_closure_3313"(ptr %0, i64 %1) {
  %p_addr_0 = getelementptr { i64 }, ptr %0, i32 0, i32 0
  %p_0 = load i64, ptr %p_addr_0, align 4
...
define internal ptr @"Factorial.$raw_let_3295"(ptr %0, ptr %"Factorial.$x_110_0", ptr %"Factorial.$y_111_0") {
...
"switch_branch_Builtin.Int64#_1":                 ; preds = %"switch_branch_Builtin.Int64#_0"
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 1
  store ptr @"Factorial.#let_closure_3313", ptr %let_func_0, align 8
  %13 = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 0
  %14 = load ptr, ptr %13, align 8
  %15 = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 1
  %16 = load ptr, ptr %15, align 8
...
define internal i64 @"Factorial.#let_closure_3314"(ptr %0, i64 %1) {
  %p_addr_0 = getelementptr { i64 }, ptr %0, i32 0, i32 0
  %p_0 = load i64, ptr %p_addr_0, align 4
...
"switch_branch_Builtin.Int64#_1":                 ; preds = %"switch_branch_Builtin.Int64#_0"
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 1
  store ptr @"Factorial.#let_closure_3314", ptr %let_func_0, align 8
...
define internal i32 @"Factorial.#let_closure_3315"(ptr %0, i64 %1) {
  %p_addr_0 = getelementptr { i64 }, ptr %0, i32 0, i32 0
  %p_0 = load i64, ptr %p_addr_0, align 4
...
define internal ptr @"Factorial.$raw_let_3294"(ptr %0, ptr %"Factorial.$x_98_0", ptr %"Factorial.$y_99_0") {
...
"switch_branch_Builtin.Int64#_1":                 ; preds = %"switch_branch_Builtin.Int64#_0"
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 1
  store ptr @"Factorial.#let_closure_3315", ptr %let_func_0, align 8
  %13 = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 0
  %14 = load ptr, ptr %13, align 8
  %15 = getelementptr { ptr, ptr }, ptr %12, i32 0, i32 1
  %16 = load ptr, ptr %15, align 8
...
define internal ptr @"Factorial.$raw_fun_3286"(ptr %0, ptr %"Factorial.$acc_168_0", ptr %"Factorial.$$__178_0") {
  ret ptr %"Factorial.$acc_168_0"
}
...
define internal ptr @"Factorial.#let_closure_3316"(ptr %0, ptr %1) {
  %x_addr_0 = getelementptr { ptr }, ptr %0, i32 0, i32 0
  %x_0 = load ptr, ptr %x_addr_0, align 8
  %3 = call ptr @"Factorial.$raw_let_3296"(ptr null, ptr %x_0, ptr %1)
  ret ptr %3
}
...
define internal ptr @"Factorial.*"(ptr %0, ptr %"Factorial.$x_122_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"Factorial.#let_closure_3316", ptr %let_func_0, align 8
  ret ptr %2
}

define internal ptr @"Factorial.$raw_let_3292"(ptr %0, ptr %"Factorial.$n_167_0", ptr %"Factorial.$int64#_3040_0") {
  %2 = getelementptr { i8, <8 x i8> }, ptr %"Factorial.$n_167_0", i32 0, i32 0
  %3 = load i8, ptr %2, align 1
  switch i8 %3, label %switch_default_1 [
    i8 0, label %"switch_branch_Builtin.Int64#_0"
...
"switch_branch_Builtin.Int64#_0":                 ; preds = %1
  ...
  %5 = getelementptr { i64 }, ptr %4, i32 0, i32 0
  %6 = load i64, ptr %5, align 4
  %7 = getelementptr { i8, <8 x i8> }, ptr %"Factorial.$int64#_3040_0", i32 0, i32 0
  %8 = load i8, ptr %7, align 1
  switch i8 %8, label %switch_default_0 [
    i8 0, label %"switch_branch_Builtin.Int64#_1"
  ]
...
"switch_branch_Builtin.Int64#_1":                 ; preds = %"switch_branch_Builtin.Int64#_0"
  %9 = getelementptr { i8, { i64 } }, ptr %"Factorial.$int64#_3040_0", i32 0, i32 1
  %10 = getelementptr { i64 }, ptr %9, i32 0, i32 0
  %11 = load i64, ptr %10, align 4
...
define internal ptr @"Factorial.$raw_let_3291"(ptr %0, ptr %"Factorial.$n_167_0", ptr %"Factorial.$int64#_3038_0") {
  %2 = getelementptr { i8, <8 x i8> }, ptr %"Factorial.$n_167_0", i32 0, i32 0
  %3 = load i8, ptr %2, align 1
  switch i8 %3, label %switch_default_1 [
    i8 0, label %"switch_branch_Builtin.Int64#_0"
...
"switch_branch_Builtin.Int64#_0":                 ; preds = %1
  ...
  %5 = getelementptr { i64 }, ptr %4, i32 0, i32 0
  %6 = load i64, ptr %5, align 4
  %7 = getelementptr { i8, <8 x i8> }, ptr %"Factorial.$int64#_3038_0", i32 0, i32 0
  %8 = load i8, ptr %7, align 1
  switch i8 %8, label %switch_default_0 [
    i8 0, label %"switch_branch_Builtin.Int64#_1"
  ]
...
"switch_branch_Builtin.Int64#_1":                 ; preds = %"switch_branch_Builtin.Int64#_0"
  %9 = getelementptr { i8, { i64 } }, ptr %"Factorial.$int64#_3038_0", i32 0, i32 1
  %10 = getelementptr { i64 }, ptr %9, i32 0, i32 0
  %11 = load i64, ptr %10, align 4
...
define internal i64 @"Factorial.#let_closure_3317"(ptr %0, i64 %1) {
  %x_addr_0 = getelementptr { i64 }, ptr %0, i32 0, i32 0
  %x_0 = load i64, ptr %x_addr_0, align 4
...
define internal ptr @"Builtin.mulInt64#"(ptr %0, i64 %"Builtin.$x_2496_0") {
  ...
  store ptr %let_capture_0, ptr %let_capture_1, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i32 0, i32 1
  store ptr @"Factorial.#let_closure_3317", ptr %let_func_0, align 8
  ret ptr %2
}
