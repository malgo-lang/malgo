...
define internal ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_3731"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readnone %1) #0 {
  %cast_0 = load ptr, ptr %0, align 8
  ret ptr %cast_0
}

define internal i32 @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_3732"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
...
; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind readonly willreturn
define internal ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_3733"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readnone %1) #0 {
  %cast_0 = load ptr, ptr %0, align 8
  ret ptr %cast_0
}
...
; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind readonly willreturn
define internal ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_3735"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readnone %1) #0 {
...
"switch_branch_runtime/malgo/Prelude.mlg.Nothing_0.i": ; preds = %1
  ...
  store ptr @str3730, ptr %12, align 8
  %13 = tail call ptr @malgo_print_string(ptr noundef nonnull @str3730)
  ...
  store ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_3731", ptr %let_func_0.i, align 8
...
"switch_branch_runtime/malgo/Prelude.mlg.Just_0.i": ; preds = %1
  ...
  store ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_3733", ptr %let_func_2.i, align 8
...
"test/testcases/malgo/ToplevelVariable.mlg.main.exit": ; preds = %"switch_branch_runtime/malgo/Prelude.mlg.Nothing_0.i", %"switch_branch_runtime/malgo/Prelude.mlg.Just_0.i"
  ...
  %"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_3734.sink.i" = phi ptr [ @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_3734", %"switch_branch_runtime/malgo/Prelude.mlg.Just_0.i" ], [ @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_3732", %"switch_branch_runtime/malgo/Prelude.mlg.Nothing_0.i" ]
  ...
  store ptr %"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_3734.sink.i", ptr %let_func_3.i, align 8
