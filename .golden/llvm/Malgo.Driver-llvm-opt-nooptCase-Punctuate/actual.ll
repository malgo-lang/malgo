...
define internal ptr @"Punctuate.#let_closure_289"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
  %p_0 = load ptr, ptr %0, align 8
  %3 = tail call ptr @malgo_string_append(ptr %p_0, ptr %1)
  ret ptr %3
}

define internal ptr @"Punctuate.#let_closure_365"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %1) {
...
switch_branch_Prelude.Cons_0.i:                   ; preds = %2
  ...
  store ptr @"Punctuate.#let_closure_393", ptr %let_func_0.i.i, align 8
...
common.ret1:                                      ; preds = %switch_branch_Prelude.Nil_0.i, %switch_branch_Prelude.Nil_1.i, %switch_branch_Prelude.Cons_1.i
  %common.ret1.op = phi ptr [ %23, %switch_branch_Prelude.Cons_1.i ], [ %4, %switch_branch_Prelude.Nil_0.i ], [ %14, %switch_branch_Prelude.Nil_1.i ]
...
switch_branch_Prelude.Cons_1.i:                   ; preds = %switch_branch_Prelude.Cons_0.i
  ...
  store ptr @"Punctuate.#let_closure_393", ptr %let_func_0.i5.i, align 8
  ...
  store ptr @"Punctuate.#let_closure_365", ptr %let_func_0.i7.i, align 8
  %17 = tail call ptr @"Punctuate.#let_closure_365"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %let_capture_0.i6.i, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %8)
...
define internal ptr @"Punctuate.#let_closure_388"(ptr nocapture nofree readonly %0, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %1) {
  %3 = load i8, ptr %1, align 1
  %switch.i = icmp eq i8 %3, 0
  br i1 %switch.i, label %switch_branch_Prelude.Nil_0.i, label %switch_branch_Prelude.Cons_0.i
...
common.ret1:                                      ; preds = %switch_branch_Prelude.Cons_0.i, %switch_branch_Prelude.Nil_0.i
  %common.ret1.op = phi ptr [ %4, %switch_branch_Prelude.Nil_0.i ], [ %18, %switch_branch_Prelude.Cons_0.i ]
  ret ptr %common.ret1.op
...
switch_branch_Prelude.Cons_0.i:                   ; preds = %2
  ...
  store ptr @"Punctuate.#let_closure_388", ptr %let_func_0.i2.i, align 8
  %15 = tail call ptr @"Punctuate.#let_closure_388"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %let_capture_0.i1.i, ptr nocapture nofree readonly %8)
...
define internal noundef ptr @"Punctuate.#let_closure_393"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nofree %1) {
  %p_0 = load ptr, ptr %0, align 8
...
common.ret:                                       ; preds = %switch_branch_Punctuate.SList_0, %switch_branch_Punctuate.SInt_0, %switch_branch_Punctuate.Symbol_0
  %common.ret.op = phi ptr [ %13, %switch_branch_Punctuate.Symbol_0 ], [ %26, %switch_branch_Punctuate.SInt_0 ], [ %50, %switch_branch_Punctuate.SList_0 ]
...
switch_branch_Punctuate.Symbol_0:                 ; preds = %1
  ...
  store ptr @str397, ptr %6, align 8
  ...
  store ptr @"Punctuate.#let_closure_440", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"Punctuate.#let_closure_418", ptr %let_func_0.i.i.i, align 8
  ...
  store ptr @"Punctuate.#let_closure_289", ptr %let_func_0.i.i.i.i.i, align 8
...
switch_branch_Punctuate.SInt_0:                   ; preds = %1
  ...
  store ptr @"Punctuate.#let_closure_440", ptr %let_func_0.i.i2, align 8
...
switch_branch_Punctuate.SList_0:                  ; preds = %1
  ...
  store ptr @"Punctuate.#let_closure_365", ptr %let_func_0.i, align 8
  ...
  store ptr @"Punctuate.#let_closure_388", ptr %let_func_0.i6, align 8
  %37 = tail call ptr @"Punctuate.#let_closure_388"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %let_capture_0.i5, ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %28)
  %38 = load ptr, ptr %34, align 8
  %39 = load ptr, ptr %let_func_0.i, align 8
  %40 = tail call ptr %39(ptr %38, ptr %37)
  %41 = tail call fastcc ptr @Prelude.concatString(ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %40)
...
define internal ptr @"Punctuate.#let_closure_418"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr %1) {
  ...
  store ptr @"Punctuate.#let_closure_289", ptr %let_func_0.i.i, align 8
  %p_0.i.i = load ptr, ptr %let_capture_0.i.i, align 8
  %4 = tail call ptr @malgo_string_append(ptr %p_0.i.i, ptr %1)
  ret ptr %4
}

define internal noundef ptr @"Punctuate.#let_closure_440"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 8 %1) {
  ...
  store ptr @"Punctuate.#let_closure_418", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"Punctuate.#let_closure_289", ptr %let_func_0.i.i.i.i, align 8
...
define internal fastcc ptr @Prelude.concatString(ptr nocapture nofree noundef nonnull readonly dereferenceable(1) %"Prelude.$nil_974_0") unnamed_addr {
...
switch_branch_Prelude.Nil_0:                      ; preds = %0
  ...
  store ptr @str248, ptr %3, align 8
  br label %common.ret
...
switch_branch_Prelude.Cons_0:                     ; preds = %0
  ...
  store ptr @"Punctuate.#let_closure_440", ptr %let_func_0.i, align 8
  %9 = tail call fastcc ptr @Prelude.concatString(ptr nocapture nofree readonly %7)
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  store i8 0, ptr %5, align 1
  %6 = getelementptr { i8, { ptr } }, ptr %5, i64 0, i32 1, i32 0
  store ptr @str428, ptr %6, align 8
  %7 = tail call ptr @malgo_malloc(i64 noundef 16)
  ...
  store ptr @str429, ptr %11, align 8
  ...
  store ptr %let_capture_0.i1.i, ptr %14, align 8
  %let_func_0.i2.i = getelementptr { ptr, ptr }, ptr %14, i64 0, i32 1
  store ptr @"Punctuate.#let_closure_393", ptr %let_func_0.i2.i, align 8
  %15 = tail call ptr @malgo_malloc(i64 noundef 16)
  store i8 0, ptr %15, align 1
  %16 = getelementptr { i8, { ptr } }, ptr %15, i64 0, i32 1, i32 0
  store ptr @str430, ptr %16, align 8
  %17 = tail call ptr @malgo_malloc(i64 noundef 16)
  store i8 0, ptr %17, align 1
  %18 = getelementptr { i8, { ptr } }, ptr %17, i64 0, i32 1, i32 0
  ...
  store ptr @"Punctuate.#let_closure_393", ptr %let_func_0.i4.i, align 8
  ...
  store ptr @"Punctuate.#let_closure_393", ptr %let_func_0.i6.i, align 8
  ...
  store ptr @"Punctuate.#let_closure_393", ptr %let_func_0.i8.i, align 8
  ...
  %46 = tail call ptr @Punctuate.show(ptr poison, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(1) %44)
