; ModuleID = '/workspaces/malgo/.malgo-work/Factorial.ll'
...
define internal i32 @"Factorial.#let_closure_3263"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  %p_0 = load i64, ptr %0, align 4
  %3 = tail call i32 @malgo_eq_int64_t(i64 %p_0, i64 %1)
  ret i32 %3
}

define internal i64 @"Factorial.#let_closure_3264"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  %p_0 = load i64, ptr %0, align 4
  %3 = tail call i64 @malgo_mul_int64_t(i64 %p_0, i64 %1)
  ret i64 %3
}

define internal i64 @"Factorial.#let_closure_3265"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  %p_0 = load i64, ptr %0, align 4
...
define internal i64 @"Factorial.#let_closure_3266"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
...
define internal ptr @"Builtin.subInt64#"(ptr nocapture nofree readnone %0, i64 %"Builtin.$x_2255_0") {
  ...
  store ptr @"Factorial.#let_closure_3266", ptr %let_func_0, align 8
  ret ptr %2
}

define internal i64 @"Factorial.#let_closure_3267"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  %x_0 = load i64, ptr %0, align 4
...
define internal ptr @"Builtin.mulInt64#"(ptr nocapture nofree readnone %0, i64 %"Builtin.$x_2496_0") {
  ...
  store ptr %let_capture_0, ptr %2, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i64 0, i32 1
  store ptr @"Factorial.#let_closure_3267", ptr %let_func_0, align 8
  ret ptr %2
}
...
define internal i32 @"Factorial.#let_closure_3268"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(8) %0, i64 %1) {
  %x_0 = load i64, ptr %0, align 4
...
define internal ptr @"Builtin.eqInt64#"(ptr nocapture nofree readnone %0, i64 %"Builtin.$x_3607_0") {
  ...
  store ptr %let_capture_0, ptr %2, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %2, i64 0, i32 1
  store ptr @"Factorial.#let_closure_3268", ptr %let_func_0, align 8
  ret ptr %2
}

define internal ptr @"Factorial.#let_closure_3269"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(24) %0, ptr nocapture nofree readonly align 4 %1) {
...
define internal ptr @"Factorial.#fun_closure_3270"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readnone %1) #0 {
  %acc_0 = load ptr, ptr %0, align 8
  ret ptr %acc_0
}

define internal ptr @"Factorial.#let_closure_3272"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(24) %0, ptr nocapture nofree readonly align 4 %1) {
"switch_branch_Builtin.Int64#_0":
  %"subInt64#_0" = load ptr, ptr %0, align 8
...
define internal ptr @"Factorial.#let_closure_3273"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(24) %0, ptr nocapture nofree readonly align 4 %1) {
"switch_branch_Builtin.Int64#_0":
...
define internal noundef ptr @"Factorial.#fun_closure_3271"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(40) %0, ptr nocapture nofree readnone %1) {
  %acc_0 = load ptr, ptr %0, align 8
  %"subInt64#_addr_0" = getelementptr { ptr, ptr, ptr, ptr, ptr }, ptr %0, i64 0, i32 1
  %"subInt64#_0" = load ptr, ptr %"subInt64#_addr_0", align 8
  %"Int64#_addr_0" = getelementptr { ptr, ptr, ptr, ptr, ptr }, ptr %0, i64 0, i32 2
  %"Int64#_0" = load ptr, ptr %"Int64#_addr_0", align 8
  %n_addr_0 = getelementptr { ptr, ptr, ptr, ptr, ptr }, ptr %0, i64 0, i32 3
  %n_0 = load ptr, ptr %n_addr_0, align 8
  %"mulInt64#_addr_0" = getelementptr { ptr, ptr, ptr, ptr, ptr }, ptr %0, i64 0, i32 4
  %"mulInt64#_0" = load ptr, ptr %"mulInt64#_addr_0", align 8
  ...
  store ptr %"subInt64#_0", ptr %let_capture_0, align 8
  ...
  store ptr @"Factorial.#let_closure_3272", ptr %let_func_0, align 8
  ...
  store ptr @"Factorial.#let_closure_3265", ptr %let_func_0.i, align 8
  ...
  store ptr @"Factorial.#let_closure_3273", ptr %let_func_1, align 8
  ...
  store ptr @"Factorial.#let_closure_3264", ptr %let_func_0.i3, align 8
  ...
  %17 = tail call fastcc noundef ptr @"Factorial.$factAcc_curry_166"(ptr nofree noundef nonnull align 4 dereferenceable(1) %9, ptr nofree noundef nonnull align 4 dereferenceable(1) %15)
  ret ptr %17
}

define internal noundef ptr @"Factorial.#let_closure_3274"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
...
define internal noundef ptr @"Factorial.#let_closure_3275"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  %n_0 = load ptr, ptr %0, align 8
  %3 = getelementptr i8, ptr %n_0, i64 4
  %n_0.val = load i64, ptr %3, align 4
  %4 = getelementptr i8, ptr %1, i64 4
  ...
  store ptr %let_capture_0.i, ptr %5, align 8
  %let_func_0.i = getelementptr { ptr, ptr }, ptr %5, i64 0, i32 1
  store ptr @"Factorial.#let_closure_3264", ptr %let_func_0.i, align 8
...
define internal fastcc noundef ptr @"Factorial.$factAcc_curry_166"(ptr nofree noundef nonnull align 4 dereferenceable(1) %"Factorial.$n_167_0", ptr nofree noundef nonnull align 4 dereferenceable(1) %"Factorial.$acc_168_0") unnamed_addr {
  br label %tailrecurse

tailrecurse:                                      ; preds = %switch_branch_Builtin.False_0, %0
  %"Factorial.$n_167_0.tr" = phi ptr [ %"Factorial.$n_167_0", %0 ], [ %23, %switch_branch_Builtin.False_0 ]
  %"Factorial.$acc_168_0.tr" = phi ptr [ %"Factorial.$acc_168_0", %0 ], [ %30, %switch_branch_Builtin.False_0 ]
  ...
  store ptr %"Factorial.$n_167_0.tr", ptr %n_0, align 8
  store ptr %let_capture_0, ptr %3, align 8
  %let_func_0 = getelementptr { ptr, ptr }, ptr %3, i64 0, i32 1
  store ptr @"Factorial.#let_closure_3269", ptr %let_func_0, align 8
  %6 = getelementptr i8, ptr %"Factorial.$n_167_0.tr", i64 4
  %"Factorial.$n_167_0.val" = load i64, ptr %6, align 4
  %.val = load i64, ptr %2, align 4
  %7 = tail call ptr @malgo_malloc(i64 noundef 16)
  %let_capture_0.i = tail call ptr @malgo_malloc(i64 noundef 8)
  store i64 %"Factorial.$n_167_0.val", ptr %let_capture_0.i, align 4
  store ptr %let_capture_0.i, ptr %7, align 8
  %let_func_0.i = getelementptr { ptr, ptr }, ptr %7, i64 0, i32 1
  store ptr @"Factorial.#let_closure_3263", ptr %let_func_0.i, align 8
  %8 = tail call i32 @malgo_eq_int64_t(i64 %"Factorial.$n_167_0.val", i64 %.val)
  ...
  store ptr %"Factorial.$acc_168_0.tr", ptr %fun_capture_0, align 8
  store ptr %fun_capture_0, ptr %10, align 8
  %fun_func_0 = getelementptr { ptr, ptr }, ptr %10, i64 0, i32 1
  store ptr @"Factorial.#fun_closure_3270", ptr %fun_func_0, align 8
  %11 = tail call ptr @malgo_malloc(i64 noundef 16)
  %fun_capture_2 = tail call ptr @malgo_malloc(i64 noundef 40)
  store ptr %"Factorial.$acc_168_0.tr", ptr %fun_capture_2, align 8
  %12 = tail call ptr @malgo_malloc(i64 noundef 16)
  store ptr null, ptr %12, align 8
  %"subInt64#_func_0" = getelementptr { ptr, ptr }, ptr %12, i64 0, i32 1
  ...
  %"Int64#_func_0" = getelementptr { ptr, ptr }, ptr %13, i64 0, i32 1
  store ptr @"Builtin.Int64#", ptr %"Int64#_func_0", align 8
  %"Int64#_0" = getelementptr { ptr, ptr, ptr, ptr, ptr }, ptr %fun_capture_2, i64 0, i32 2
  store ptr %13, ptr %"Int64#_0", align 8
  %n_1 = getelementptr { ptr, ptr, ptr, ptr, ptr }, ptr %fun_capture_2, i64 0, i32 3
  store ptr %"Factorial.$n_167_0.tr", ptr %n_1, align 8
  ...
  %"mulInt64#_0" = getelementptr { ptr, ptr, ptr, ptr, ptr }, ptr %fun_capture_2, i64 0, i32 4
  ...
  store ptr @"Factorial.#fun_closure_3271", ptr %fun_func_1, align 8
...
switch_branch_Builtin.False_0:                    ; preds = %tailrecurse
  ...
  store ptr %"Factorial.$n_167_0.tr", ptr %let_capture_2, align 8
  store ptr %let_capture_2, ptr %19, align 8
  %let_func_1 = getelementptr { ptr, ptr }, ptr %19, i64 0, i32 1
  store ptr @"Factorial.#let_closure_3274", ptr %let_func_1, align 8
  ...
  store ptr @"Factorial.#let_closure_3265", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"Factorial.#let_closure_3264", ptr %let_func_0.i.i5, align 8
...
switch_branch_Builtin.True_0:                     ; preds = %tailrecurse
  ret ptr %"Factorial.$acc_168_0.tr"
}

define internal ptr @"Factorial.#let_closure_3283"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(16) %1) {
...
define noundef i32 @main(ptr nocapture nofree readnone %0) local_unnamed_addr {
  ...
  %7 = tail call fastcc ptr @"Factorial.$factAcc_curry_166"(ptr nofree noundef nonnull align 4 dereferenceable(1) %3, ptr nofree noundef nonnull align 4 dereferenceable(1) %5)
  ...
  store ptr @"Factorial.#let_closure_3283", ptr %let_func_0.i, align 8
