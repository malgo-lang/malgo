...
define internal i32 @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_165"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  ...
  store ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_172", ptr %let_func_0.i.i, align 8
  %p_0.i.i = load i32, ptr %let_capture_0.i.i, align 4
  %4 = tail call i32 @malgo_add_int32_t(i32 %p_0.i.i, i32 %1)
  ret i32 %4
}

define internal i32 @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_172"(ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) %0, i32 %1) {
  %p_0 = load i32, ptr %0, align 4
  %3 = tail call i32 @malgo_add_int32_t(i32 %p_0, i32 %1)
  ret i32 %3
}

define internal noundef ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_288"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readonly align 4 %1) {
  ...
  store ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_165", ptr %let_func_0.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_172", ptr %let_func_0.i.i.i.i, align 8
...
define internal ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_293"(ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) %0, ptr nocapture nofree readnone %1) #0 {
...
define internal ptr @"runtime/malgo/Prelude.mlg.identity"(ptr nocapture nofree readnone %0, ptr nofree readnone returned %"runtime/malgo/Prelude.mlg.$x_890_0") #1 {
...
"switch_branch_runtime/malgo/Prelude.mlg.Nothing_0.i.i": ; preds = %1
  ...
  store ptr @str343, ptr %16, align 8
  %17 = tail call ptr @malgo_print_string(ptr noundef nonnull @str343)
...
"test/testcases/malgo/ToplevelVariable.mlg.main.exit": ; preds = %"switch_branch_runtime/malgo/Prelude.mlg.Nothing_0.i.i", %"switch_branch_runtime/malgo/Prelude.mlg.Just_0.i.i"
  ...
  store ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_293", ptr %let_func_0.i.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_288", ptr %let_func_0.i.i3.i, align 8
  ...
  store ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_165", ptr %let_func_0.i.i.i.i.i, align 8
  ...
  store ptr @"test/testcases/malgo/ToplevelVariable.mlg.#let_closure_172", ptr %let_func_0.i.i.i.i.i.i.i, align 8
